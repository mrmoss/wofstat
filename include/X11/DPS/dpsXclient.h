#pragma ident	"@(#)dpsXclient.h	35.3	05/07/96 SMI"
/*
...
extern void XDPSFreezeContext(DPSContext ctxt);

  /* Notify a context that is not in "frozen" mode to stop
     execution and enter into "frozen" mode.  */
