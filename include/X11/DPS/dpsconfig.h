#pragma ident	"@(#)dpsconfig.h	35.5	05/17/95 SMI"
/*
 * dpsconfig.h
 *
...
/*
 * We're using "i386" to detect 80x86 boxes, which may not work in general
 * but does work for Sun.  We need a better solution
 */
...
#if defined(CROSS_PPC) || defined(__ppc)
#define IEEEFLOAT 1
#endif
