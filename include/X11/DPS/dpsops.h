...
extern void DPSarc( /* DPSContext ctxt; double x, y, r, angle1, angle2; */ );

extern void DPSarcn( /* DPSContext ctxt; double x, y, r, angle1, angle2; */ );

extern void DPSarct( /* DPSContext ctxt; double x1, y1, x2, y2, r; */ );

extern void DPSarcto( /* DPSContext ctxt; double x1, y1, x2, y2, r; float *xt1, *yt1, *xt2, *yt2; */ );

extern void DPSarray( /* DPSContext ctxt; int len; */ );

extern void DPSashow( /* DPSContext ctxt; double x, y; char *s; */ );

extern void DPSastore( /* DPSContext ctxt; */ );

extern void DPSatan( /* DPSContext ctxt; */ );

extern void DPSawidthshow( /* DPSContext ctxt; double cx, cy; int c; double ax, ay; char *s; */ );
...
extern void DPScurveto( /* DPSContext ctxt; double x1, y1, x2, y2, x3, y3; */ );
...
extern void DPSdtransform( /* DPSContext ctxt; double x1, y1; float *x2, *y2; */ );
...
extern void DPSidtransform( /* DPSContext ctxt; double x1, y1; float *x2, *y2; */ );
...
extern void DPSineofill( /* DPSContext ctxt; double x, y; int *b; */ );

extern void DPSinfill( /* DPSContext ctxt; double x, y; int *b; */ );
...
extern void DPSinstroke( /* DPSContext ctxt; double x, y; int *b; */ );

extern void DPSinueofill( /* DPSContext ctxt; double x, y; char nums[]; int n; char ops[]; int l; int *b; */ );

extern void DPSinufill( /* DPSContext ctxt; double x, y; char nums[]; int n; char ops[]; int l; int *b; */ );

extern void DPSinustroke( /* DPSContext ctxt; double x, y; char nums[]; int n; char ops[]; int l; int *b; */ );

extern void DPSinvertmatrix( /* DPSContext ctxt; */ );

extern void DPSitransform( /* DPSContext ctxt; double x1, y1; float *x2, *y2; */ );
...
extern void DPSlineto( /* DPSContext ctxt; double x, y; */ );
...
extern void DPSmoveto( /* DPSContext ctxt; double x, y; */ );
...
extern void DPSrcurveto( /* DPSContext ctxt; double x1, y1, x2, y2, x3, y3; */ );
...
extern void DPSrectclip( /* DPSContext ctxt; double x, y, w, h; */ );

extern void DPSrectfill( /* DPSContext ctxt; double x, y, w, h; */ );

extern void DPSrectstroke( /* DPSContext ctxt; double x, y, w, h; */ );

extern void DPSrectviewclip( /* DPSContext ctxt; double x, y, w, h; */ );
...
extern void DPSrlineto( /* DPSContext ctxt; double x, y; */ );

extern void DPSrmoveto( /* DPSContext ctxt; double x, y; */ );
...
extern void DPSscale( /* DPSContext ctxt; double x, y; */ );
...
extern void DPSselectfont( /* DPSContext ctxt; char *name; double scale; */ );
...
extern void DPSsetXrgbactual( /* DPSContext ctxt; double r, g, b; int *success; */ );

extern void DPSsetbbox( /* DPSContext ctxt; double llx, lly, urx, ury; */ );

extern void DPSsetblackgeneration( /* DPSContext ctxt; */ );

extern void DPSsetcachedevice( /* DPSContext ctxt; double wx, wy, llx, lly, urx, ury; */ );

extern void DPSsetcachelimit( /* DPSContext ctxt; int n; */ );

extern void DPSsetcacheparams( /* DPSContext ctxt; */ );

extern void DPSsetcharwidth( /* DPSContext ctxt; double wx, wy; */ );

extern void DPSsetcmykcolor( /* DPSContext ctxt; double c, m, y, k; */ );
...
extern void DPSsetdash( /* DPSContext ctxt; float pat[]; int size; double offset; */ );
...
extern void DPSsethalftonephase( /* DPSContext ctxt; double x, y; */ );

extern void DPSsethsbcolor( /* DPSContext ctxt; double h, s, b; */ );
...
extern void DPSsetrgbcolor( /* DPSContext ctxt; double r, g, b; */ );
...
extern void DPStransform( /* DPSContext ctxt; double x1, y1; float *x2, *y2; */ );

extern void DPStranslate( /* DPSContext ctxt; double x, y; */ );
...
extern void DPSwidthshow( /* DPSContext ctxt; double x, y; int c; char *s; */ );
