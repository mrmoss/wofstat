...
extern void PSarc( /* double x, y, r, angle1, angle2; */ );

extern void PSarcn( /* double x, y, r, angle1, angle2; */ );

extern void PSarct( /* double x1, y1, x2, y2, r; */ );

extern void PSarcto( /* double x1, y1, x2, y2, r; float *xt1, *yt1, *xt2, *yt2; */ );

extern void PSarray( /* int len; */ );

extern void PSashow( /* double x, y; char *s; */ );

extern void PSastore();

extern void PSatan();

extern void PSawidthshow( /* double cx, cy; int c; double ax, ay; char *s; */ );
...
extern void PScurveto( /* double x1, y1, x2, y2, x3, y3; */ );
...
extern void PSdtransform( /* double x1, y1; float *x2, *y2; */ );
...
extern void PSidtransform( /* double x1, y1; float *x2, *y2; */ );
...
extern void PSineofill( /* double x, y; int *b; */ );

extern void PSinfill( /* double x, y; int *b; */ );
...
extern void PSinstroke( /* double x, y; int *b; */ );

extern void PSinueofill( /* double x, y; char nums[]; int n; char ops[]; int l; int *b; */ );

extern void PSinufill( /* double x, y; char nums[]; int n; char ops[]; int l; int *b; */ );

extern void PSinustroke( /* double x, y; char nums[]; int n; char ops[]; int l; int *b; */ );

extern void PSinvertmatrix();

extern void PSitransform( /* double x1, y1; float *x2, *y2; */ );
...
extern void PSlineto( /* double x, y; */ );
...
extern void PSmoveto( /* double x, y; */ );
...
extern void PSrcurveto( /* double x1, y1, x2, y2, x3, y3; */ );
...
extern void PSrectclip( /* double x, y, w, h; */ );

extern void PSrectfill( /* double x, y, w, h; */ );

extern void PSrectstroke( /* double x, y, w, h; */ );

extern void PSrectviewclip( /* double x, y, w, h; */ );
...
extern void PSrlineto( /* double x, y; */ );

extern void PSrmoveto( /* double x, y; */ );
...
extern void PSscale( /* double x, y; */ );
...
extern void PSselectfont( /* char *name; double scale; */ );
...
extern void PSsetXrgbactual( /* double r, g, b; int *success; */ );

extern void PSsetbbox( /* double llx, lly, urx, ury; */ );

extern void PSsetblackgeneration();

extern void PSsetcachedevice( /* double wx, wy, llx, lly, urx, ury; */ );

extern void PSsetcachelimit( /* int n; */ );

extern void PSsetcacheparams();

extern void PSsetcharwidth( /* double wx, wy; */ );

extern void PSsetcmykcolor( /* double c, m, y, k; */ );
...
extern void PSsetdash( /* float pat[]; int size; double offset; */ );
...
extern void PSsethalftonephase( /* double x, y; */ );

extern void PSsethsbcolor( /* double h, s, b; */ );
...
extern void PSsetrgbcolor( /* double r, g, b; */ );
...
extern void PStransform( /* double x1, y1; float *x2, *y2; */ );

extern void PStranslate( /* double x, y; */ );
...
extern void PSwidthshow( /* double x, y; int c; char *s; */ );
