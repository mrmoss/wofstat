...
typedef Boolean (*MeasureLineProc)(XmTextWidget, LineNum, XmTextPosition,
											  XmTextPosition *, LineTableExtraRec **);
...
extern void _XmTextFreeContextData(Widget, XtPointer, XtPointer);
extern void _XmTextResetClipOrigin(XmTextWidget, XmTextPosition, Boolean);
extern void _XmTextAdjustGC(XmTextWidget);
extern Boolean _XmTextShouldWordWrap(XmTextWidget);
extern Boolean _XmTextScrollable(XmTextWidget);
extern XmTextPosition _XmTextFindLineEnd(XmTextWidget, XmTextPosition, LineTableExtra *);
extern void _XmTextOutputGetSecResData(XmSecondaryResourceData *);
extern int _XmTextGetNumberLines(XmTextWidget);
extern void _XmTextMovingCursorPosition(XmTextWidget, XmTextPosition);
extern void _XmTextDrawDestination(XmTextWidget);
extern void _XmTextClearDestination(XmTextWidget, Boolean);
extern void _XmTextDestinationVisible(Widget, Boolean);
extern void _XmTextChangeBlinkBehavior(XmTextWidget, Boolean);
extern void _XmTextOutputCreate(Widget, ArgList, Cardinal);
extern Boolean _XmTextGetBaselines(Widget, Dimension **, int *);
extern Boolean _XmTextGetDisplayRect(Widget, XRectangle *);
extern void _XmTextMarginsProc(Widget, XmBaselineMargins *);
extern void _XmTextChangeHOffset(XmTextWidget, int);
extern void _XmTextToggleCursorGC(Widget);
