...
/*
 *	XmP.h	version 1.15, last updated 02/07/15.
*/
...
extern Pixel _XmAccessColorData(XmColorData *, unsigned char);


/********    End Misc Function Declarations    ********/
...
extern Boolean	_XmInstallImage(XImage *, char *, int, int);
...
extern Boolean	_XmGetPixmapData(Screen *, Pixmap, char **, int *, Pixel *,
										  Pixel *, int *, int *, unsigned int, unsigned int);
extern Pixmap	_XmGetPixmap(Screen *, char *, int, Pixel, Pixel);
extern Boolean _XmInstallPixmap(Pixmap, Screen *, char *, Pixel, Pixel);
extern Boolean _XmInstallPixmapByDepth(Pixmap,Screen *, char *, Pixel, Pixel, int);
