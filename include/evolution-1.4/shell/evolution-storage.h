...
EvolutionStorageResult  evolution_storage_removed_folder       (EvolutionStorage                *evolution_storage,
								const char                      *path);
EvolutionStorageResult evolution_storage_reset_folder	       (EvolutionStorage 		*evolution_storage,
								const char 			*path,
								const char 			*physical_uri);
gboolean                evolution_storage_folder_exists        (EvolutionStorage                *evolution_storage,
								const char                      *path);
gboolean		evolution_storage_folder_subscribed    (EvolutionStorage 		*evolution_storage,
				 				const char 			*path);
gboolean		evolution_storage_folder_subfolders_exist (EvolutionStorage 		*evolution_storage,
				 				const char 			*path);
