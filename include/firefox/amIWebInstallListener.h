/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM /jds/packages/BUILD/SUNWfirefox-10.0.2/firefox/toolkit/mozapps/extensions/amIWebInstallListener.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE amIWebInstallListener : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD OnWebInstallBlocked(nsIDOMWindow *aWindow, nsIURI *aUri, nsIVariant **aInstalls, PRUint32 aCount, bool *_retval NS_OUTPARAM) = 0;
  ...
  NS_SCRIPTABLE NS_IMETHOD OnWebInstallRequested(nsIDOMWindow *aWindow, nsIURI *aUri, nsIVariant **aInstalls, PRUint32 aCount, bool *_retval NS_OUTPARAM) = 0;
...
#define NS_DECL_AMIWEBINSTALLLISTENER \
  ...
  NS_SCRIPTABLE NS_IMETHOD OnWebInstallBlocked(nsIDOMWindow *aWindow, nsIURI *aUri, nsIVariant **aInstalls, PRUint32 aCount, bool *_retval NS_OUTPARAM); \
  NS_SCRIPTABLE NS_IMETHOD OnWebInstallRequested(nsIDOMWindow *aWindow, nsIURI *aUri, nsIVariant **aInstalls, PRUint32 aCount, bool *_retval NS_OUTPARAM); 
...
#define NS_FORWARD_AMIWEBINSTALLLISTENER(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD OnWebInstallBlocked(nsIDOMWindow *aWindow, nsIURI *aUri, nsIVariant **aInstalls, PRUint32 aCount, bool *_retval NS_OUTPARAM) { return _to OnWebInstallBlocked(aWindow, aUri, aInstalls, aCount, _retval); } \
  NS_SCRIPTABLE NS_IMETHOD OnWebInstallRequested(nsIDOMWindow *aWindow, nsIURI *aUri, nsIVariant **aInstalls, PRUint32 aCount, bool *_retval NS_OUTPARAM) { return _to OnWebInstallRequested(aWindow, aUri, aInstalls, aCount, _retval); } 
...
#define NS_FORWARD_SAFE_AMIWEBINSTALLLISTENER(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD OnWebInstallBlocked(nsIDOMWindow *aWindow, nsIURI *aUri, nsIVariant **aInstalls, PRUint32 aCount, bool *_retval NS_OUTPARAM) { return !_to ? NS_ERROR_NULL_POINTER : _to->OnWebInstallBlocked(aWindow, aUri, aInstalls, aCount, _retval); } \
  NS_SCRIPTABLE NS_IMETHOD OnWebInstallRequested(nsIDOMWindow *aWindow, nsIURI *aUri, nsIVariant **aInstalls, PRUint32 aCount, bool *_retval NS_OUTPARAM) { return !_to ? NS_ERROR_NULL_POINTER : _to->OnWebInstallRequested(aWindow, aUri, aInstalls, aCount, _retval); } 
...
/* boolean onWebInstallBlocked (in nsIDOMWindow aWindow, in nsIURI aUri, [array, size_is (aCount)] in nsIVariant aInstalls, [optional] in PRUint32 aCount); */
NS_IMETHODIMP amWebInstallListener::OnWebInstallBlocked(nsIDOMWindow *aWindow, nsIURI *aUri, nsIVariant **aInstalls, PRUint32 aCount, bool *_retval NS_OUTPARAM)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}

/* boolean onWebInstallRequested (in nsIDOMWindow aWindow, in nsIURI aUri, [array, size_is (aCount)] in nsIVariant aInstalls, [optional] in PRUint32 aCount); */
NS_IMETHODIMP amWebInstallListener::OnWebInstallRequested(nsIDOMWindow *aWindow, nsIURI *aUri, nsIVariant **aInstalls, PRUint32 aCount, bool *_retval NS_OUTPARAM)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
