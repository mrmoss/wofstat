/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM /jds/packages/BUILD/SUNWfirefox-10.0.2/firefox/toolkit/components/exthelper/extIApplication.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE extIPreference : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD SetLocked(bool aLocked) = 0;

  /* readonly attribute boolean modified; */
  NS_SCRIPTABLE NS_IMETHOD GetModified(bool *aModified) = 0;
...
#define NS_DECL_EXTIPREFERENCE \
  ...
  NS_SCRIPTABLE NS_IMETHOD SetLocked(bool aLocked); \
  NS_SCRIPTABLE NS_IMETHOD GetModified(bool *aModified); \
...
#define NS_FORWARD_EXTIPREFERENCE(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD SetLocked(bool aLocked) { return _to SetLocked(aLocked); } \
  NS_SCRIPTABLE NS_IMETHOD GetModified(bool *aModified) { return _to GetModified(aModified); } \
...
#define NS_FORWARD_SAFE_EXTIPREFERENCE(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD SetLocked(bool aLocked) { return !_to ? NS_ERROR_NULL_POINTER : _to->SetLocked(aLocked); } \
  NS_SCRIPTABLE NS_IMETHOD GetModified(bool *aModified) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetModified(aModified); } \
...
class NS_NO_VTABLE NS_SCRIPTABLE extIExtension : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD GetFirstRun(bool *aFirstRun) = 0;
...
#define NS_DECL_EXTIEXTENSION \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetFirstRun(bool *aFirstRun); \
...
#define NS_FORWARD_EXTIEXTENSION(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetFirstRun(bool *aFirstRun) { return _to GetFirstRun(aFirstRun); } \
...
#define NS_FORWARD_SAFE_EXTIEXTENSION(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetFirstRun(bool *aFirstRun) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetFirstRun(aFirstRun); } \
...
class NS_NO_VTABLE NS_SCRIPTABLE extIExtensions : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD Has(const nsAString & aId, bool *_retval NS_OUTPARAM) = 0;
...
#define NS_DECL_EXTIEXTENSIONS \
  NS_SCRIPTABLE NS_IMETHOD GetAll(nsIVariant * *aAll); \
  NS_SCRIPTABLE NS_IMETHOD Has(const nsAString & aId, bool *_retval NS_OUTPARAM); \
  NS_SCRIPTABLE NS_IMETHOD Get(const nsAString & aId, extIExtension * *_retval NS_OUTPARAM); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_EXTIEXTENSIONS(_to) \
  NS_SCRIPTABLE NS_IMETHOD GetAll(nsIVariant * *aAll) { return _to GetAll(aAll); } \
  NS_SCRIPTABLE NS_IMETHOD Has(const nsAString & aId, bool *_retval NS_OUTPARAM) { return _to Has(aId, _retval); } \
...
#define NS_FORWARD_SAFE_EXTIEXTENSIONS(_to) \
  NS_SCRIPTABLE NS_IMETHOD GetAll(nsIVariant * *aAll) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetAll(aAll); } \
  NS_SCRIPTABLE NS_IMETHOD Has(const nsAString & aId, bool *_retval NS_OUTPARAM) { return !_to ? NS_ERROR_NULL_POINTER : _to->Has(aId, _retval); } \
...
/* boolean has (in AString aId); */
NS_IMETHODIMP _MYCLASS_::Has(const nsAString & aId, bool *_retval NS_OUTPARAM)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
...
class NS_NO_VTABLE NS_SCRIPTABLE extIApplication : public nsISupports {
 public: 
  ...
  /* boolean quit (); */
  NS_SCRIPTABLE NS_IMETHOD Quit(bool *_retval NS_OUTPARAM) = 0;

  /* boolean restart (); */
  NS_SCRIPTABLE NS_IMETHOD Restart(bool *_retval NS_OUTPARAM) = 0;
...
#define NS_DECL_EXTIAPPLICATION \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetStorage(extISessionStorage * *aStorage); \
  NS_SCRIPTABLE NS_IMETHOD GetEvents(extIEvents * *aEvents); \
  NS_SCRIPTABLE NS_IMETHOD Quit(bool *_retval NS_OUTPARAM); \
  NS_SCRIPTABLE NS_IMETHOD Restart(bool *_retval NS_OUTPARAM); 
...
#define NS_FORWARD_EXTIAPPLICATION(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetStorage(extISessionStorage * *aStorage) { return _to GetStorage(aStorage); } \
  NS_SCRIPTABLE NS_IMETHOD GetEvents(extIEvents * *aEvents) { return _to GetEvents(aEvents); } \
  NS_SCRIPTABLE NS_IMETHOD Quit(bool *_retval NS_OUTPARAM) { return _to Quit(_retval); } \
  NS_SCRIPTABLE NS_IMETHOD Restart(bool *_retval NS_OUTPARAM) { return _to Restart(_retval); } 
...
#define NS_FORWARD_SAFE_EXTIAPPLICATION(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetStorage(extISessionStorage * *aStorage) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetStorage(aStorage); } \
  NS_SCRIPTABLE NS_IMETHOD GetEvents(extIEvents * *aEvents) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetEvents(aEvents); } \
  NS_SCRIPTABLE NS_IMETHOD Quit(bool *_retval NS_OUTPARAM) { return !_to ? NS_ERROR_NULL_POINTER : _to->Quit(_retval); } \
  NS_SCRIPTABLE NS_IMETHOD Restart(bool *_retval NS_OUTPARAM) { return !_to ? NS_ERROR_NULL_POINTER : _to->Restart(_retval); } 
...
/* boolean quit (); */
NS_IMETHODIMP _MYCLASS_::Quit(bool *_retval NS_OUTPARAM)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}

/* boolean restart (); */
NS_IMETHODIMP _MYCLASS_::Restart(bool *_retval NS_OUTPARAM)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
