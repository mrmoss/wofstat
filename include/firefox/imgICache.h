/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM /jds/packages/BUILD/SUNWfirefox-10.0.2/firefox/image/public/imgICache.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE imgICache : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD ClearCache(bool chrome) = 0;
...
#define NS_DECL_IMGICACHE \
  NS_SCRIPTABLE NS_IMETHOD ClearCache(bool chrome); \
...
#define NS_FORWARD_IMGICACHE(_to) \
  NS_SCRIPTABLE NS_IMETHOD ClearCache(bool chrome) { return _to ClearCache(chrome); } \
...
#define NS_FORWARD_SAFE_IMGICACHE(_to) \
  NS_SCRIPTABLE NS_IMETHOD ClearCache(bool chrome) { return !_to ? NS_ERROR_NULL_POINTER : _to->ClearCache(chrome); } \
