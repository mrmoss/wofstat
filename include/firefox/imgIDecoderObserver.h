/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM /jds/packages/BUILD/SUNWfirefox-10.0.2/firefox/image/public/imgIDecoderObserver.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE imgIDecoderObserver : public imgIContainerObserver {
 public: 
  ...
  NS_IMETHOD OnDataAvailable(imgIRequest *aRequest, bool aCurrentFrame, const nsIntRect *aRect) = 0;
  ...
  NS_SCRIPTABLE NS_IMETHOD OnStopRequest(imgIRequest *aRequest, bool aIsLastPart) = 0;
...
#define NS_DECL_IMGIDECODEROBSERVER \
  ...
  NS_IMETHOD OnDataAvailable(imgIRequest *aRequest, bool aCurrentFrame, const nsIntRect *aRect); \
  ...
  NS_SCRIPTABLE NS_IMETHOD OnStopRequest(imgIRequest *aRequest, bool aIsLastPart); \
...
#define NS_FORWARD_IMGIDECODEROBSERVER(_to) \
  ...
  NS_IMETHOD OnDataAvailable(imgIRequest *aRequest, bool aCurrentFrame, const nsIntRect *aRect) { return _to OnDataAvailable(aRequest, aCurrentFrame, aRect); } \
  ...
  NS_SCRIPTABLE NS_IMETHOD OnStopRequest(imgIRequest *aRequest, bool aIsLastPart) { return _to OnStopRequest(aRequest, aIsLastPart); } \
...
#define NS_FORWARD_SAFE_IMGIDECODEROBSERVER(_to) \
  ...
  NS_IMETHOD OnDataAvailable(imgIRequest *aRequest, bool aCurrentFrame, const nsIntRect *aRect) { return !_to ? NS_ERROR_NULL_POINTER : _to->OnDataAvailable(aRequest, aCurrentFrame, aRect); } \
  ...
  NS_SCRIPTABLE NS_IMETHOD OnStopRequest(imgIRequest *aRequest, bool aIsLastPart) { return !_to ? NS_ERROR_NULL_POINTER : _to->OnStopRequest(aRequest, aIsLastPart); } \
...
/* [noscript] void onDataAvailable (in imgIRequest aRequest, in boolean aCurrentFrame, [const] in nsIntRect aRect); */
NS_IMETHODIMP _MYCLASS_::OnDataAvailable(imgIRequest *aRequest, bool aCurrentFrame, const nsIntRect *aRect)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
...
/* void onStopRequest (in imgIRequest aRequest, in boolean aIsLastPart); */
NS_IMETHODIMP _MYCLASS_::OnStopRequest(imgIRequest *aRequest, bool aIsLastPart)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
