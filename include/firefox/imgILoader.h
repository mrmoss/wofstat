/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM /jds/packages/BUILD/SUNWfirefox-10.0.2/firefox/image/public/imgILoader.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE imgILoader : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD SupportImageWithMimeType(const char * mimeType, bool *_retval NS_OUTPARAM) = 0;
...
#define NS_DECL_IMGILOADER \
  ...
  NS_SCRIPTABLE NS_IMETHOD SupportImageWithMimeType(const char * mimeType, bool *_retval NS_OUTPARAM); 
...
#define NS_FORWARD_IMGILOADER(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD SupportImageWithMimeType(const char * mimeType, bool *_retval NS_OUTPARAM) { return _to SupportImageWithMimeType(mimeType, _retval); } 
...
#define NS_FORWARD_SAFE_IMGILOADER(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD SupportImageWithMimeType(const char * mimeType, bool *_retval NS_OUTPARAM) { return !_to ? NS_ERROR_NULL_POINTER : _to->SupportImageWithMimeType(mimeType, _retval); } 
...
/* boolean supportImageWithMimeType (in string mimeType); */
NS_IMETHODIMP _MYCLASS_::SupportImageWithMimeType(const char * mimeType, bool *_retval NS_OUTPARAM)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
