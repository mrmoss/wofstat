/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM /jds/packages/BUILD/SUNWfirefox-10.0.2/firefox/layout/inspector/public/inICSSValueSearch.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE inICSSValueSearch : public inISearchProcess {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD GetReturnRelativeURLs(bool *aReturnRelativeURLs) = 0;
  NS_SCRIPTABLE NS_IMETHOD SetReturnRelativeURLs(bool aReturnRelativeURLs) = 0;

  /* attribute boolean normalizeChromeURLs; */
  NS_SCRIPTABLE NS_IMETHOD GetNormalizeChromeURLs(bool *aNormalizeChromeURLs) = 0;
  NS_SCRIPTABLE NS_IMETHOD SetNormalizeChromeURLs(bool aNormalizeChromeURLs) = 0;
...
#define NS_DECL_INICSSVALUESEARCH \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetReturnRelativeURLs(bool *aReturnRelativeURLs); \
  NS_SCRIPTABLE NS_IMETHOD SetReturnRelativeURLs(bool aReturnRelativeURLs); \
  NS_SCRIPTABLE NS_IMETHOD GetNormalizeChromeURLs(bool *aNormalizeChromeURLs); \
  NS_SCRIPTABLE NS_IMETHOD SetNormalizeChromeURLs(bool aNormalizeChromeURLs); \
...
#define NS_FORWARD_INICSSVALUESEARCH(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetReturnRelativeURLs(bool *aReturnRelativeURLs) { return _to GetReturnRelativeURLs(aReturnRelativeURLs); } \
  NS_SCRIPTABLE NS_IMETHOD SetReturnRelativeURLs(bool aReturnRelativeURLs) { return _to SetReturnRelativeURLs(aReturnRelativeURLs); } \
  NS_SCRIPTABLE NS_IMETHOD GetNormalizeChromeURLs(bool *aNormalizeChromeURLs) { return _to GetNormalizeChromeURLs(aNormalizeChromeURLs); } \
  NS_SCRIPTABLE NS_IMETHOD SetNormalizeChromeURLs(bool aNormalizeChromeURLs) { return _to SetNormalizeChromeURLs(aNormalizeChromeURLs); } \
...
#define NS_FORWARD_SAFE_INICSSVALUESEARCH(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetReturnRelativeURLs(bool *aReturnRelativeURLs) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetReturnRelativeURLs(aReturnRelativeURLs); } \
  NS_SCRIPTABLE NS_IMETHOD SetReturnRelativeURLs(bool aReturnRelativeURLs) { return !_to ? NS_ERROR_NULL_POINTER : _to->SetReturnRelativeURLs(aReturnRelativeURLs); } \
  NS_SCRIPTABLE NS_IMETHOD GetNormalizeChromeURLs(bool *aNormalizeChromeURLs) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetNormalizeChromeURLs(aNormalizeChromeURLs); } \
  NS_SCRIPTABLE NS_IMETHOD SetNormalizeChromeURLs(bool aNormalizeChromeURLs) { return !_to ? NS_ERROR_NULL_POINTER : _to->SetNormalizeChromeURLs(aNormalizeChromeURLs); } \
