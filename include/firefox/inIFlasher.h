/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM /jds/packages/BUILD/SUNWfirefox-10.0.2/firefox/layout/inspector/public/inIFlasher.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE inIFlasher : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD GetInvert(bool *aInvert) = 0;
  NS_SCRIPTABLE NS_IMETHOD SetInvert(bool aInvert) = 0;
...
#define NS_DECL_INIFLASHER \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetInvert(bool *aInvert); \
  NS_SCRIPTABLE NS_IMETHOD SetInvert(bool aInvert); \
...
#define NS_FORWARD_INIFLASHER(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetInvert(bool *aInvert) { return _to GetInvert(aInvert); } \
  NS_SCRIPTABLE NS_IMETHOD SetInvert(bool aInvert) { return _to SetInvert(aInvert); } \
...
#define NS_FORWARD_SAFE_INIFLASHER(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetInvert(bool *aInvert) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetInvert(aInvert); } \
  NS_SCRIPTABLE NS_IMETHOD SetInvert(bool aInvert) { return !_to ? NS_ERROR_NULL_POINTER : _to->SetInvert(aInvert); } \
