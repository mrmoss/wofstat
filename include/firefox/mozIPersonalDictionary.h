/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM /jds/packages/BUILD/SUNWfirefox-10.0.2/firefox/extensions/spellcheck/idl/mozIPersonalDictionary.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE mozIPersonalDictionary : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD Check(const PRUnichar * word, const PRUnichar * lang, bool *_retval NS_OUTPARAM) = 0;
...
#define NS_DECL_MOZIPERSONALDICTIONARY \
  ...
  NS_SCRIPTABLE NS_IMETHOD Check(const PRUnichar * word, const PRUnichar * lang, bool *_retval NS_OUTPARAM); \
...
#define NS_FORWARD_MOZIPERSONALDICTIONARY(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD Check(const PRUnichar * word, const PRUnichar * lang, bool *_retval NS_OUTPARAM) { return _to Check(word, lang, _retval); } \
...
#define NS_FORWARD_SAFE_MOZIPERSONALDICTIONARY(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD Check(const PRUnichar * word, const PRUnichar * lang, bool *_retval NS_OUTPARAM) { return !_to ? NS_ERROR_NULL_POINTER : _to->Check(word, lang, _retval); } \
...
/* boolean check (in wstring word, in wstring lang); */
NS_IMETHODIMP _MYCLASS_::Check(const PRUnichar * word, const PRUnichar * lang, bool *_retval NS_OUTPARAM)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
