/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM /jds/packages/BUILD/SUNWfirefox-10.0.2/firefox/storage/public/mozIStorageStatement.idl
 */
...
class NS_SCRIPTABLE mozIStorageStatement : public mozIStorageBaseStatement {
 public: 
  ...
  /* boolean executeStep (); */
  NS_SCRIPTABLE NS_IMETHOD ExecuteStep(bool *_retval NS_OUTPARAM) = 0;
  ...
  NS_SCRIPTABLE NS_IMETHOD GetIsNull(PRUint32 aIndex, bool *_retval NS_OUTPARAM) = 0;
...
#define NS_DECL_MOZISTORAGESTATEMENT \
  ...
  NS_SCRIPTABLE NS_IMETHOD ExecuteStep(bool *_retval NS_OUTPARAM); \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetIsNull(PRUint32 aIndex, bool *_retval NS_OUTPARAM); \
...
#define NS_FORWARD_MOZISTORAGESTATEMENT(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD ExecuteStep(bool *_retval NS_OUTPARAM) { return _to ExecuteStep(_retval); } \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetIsNull(PRUint32 aIndex, bool *_retval NS_OUTPARAM) { return _to GetIsNull(aIndex, _retval); } \
...
#define NS_FORWARD_SAFE_MOZISTORAGESTATEMENT(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD ExecuteStep(bool *_retval NS_OUTPARAM) { return !_to ? NS_ERROR_NULL_POINTER : _to->ExecuteStep(_retval); } \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetIsNull(PRUint32 aIndex, bool *_retval NS_OUTPARAM) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetIsNull(aIndex, _retval); } \
...
/* boolean executeStep (); */
NS_IMETHODIMP _MYCLASS_::ExecuteStep(bool *_retval NS_OUTPARAM)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
...
/* boolean getIsNull (in unsigned long aIndex); */
NS_IMETHODIMP _MYCLASS_::GetIsNull(PRUint32 aIndex, bool *_retval NS_OUTPARAM)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
