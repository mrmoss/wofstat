/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM /jds/packages/BUILD/SUNWfirefox-10.0.2/firefox/storage/public/mozIStorageVacuumParticipant.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE mozIStorageVacuumParticipant : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD OnBeginVacuum(bool *_retval NS_OUTPARAM) = 0;

  /* void onEndVacuum (in boolean aSucceeded); */
  NS_SCRIPTABLE NS_IMETHOD OnEndVacuum(bool aSucceeded) = 0;
...
#define NS_DECL_MOZISTORAGEVACUUMPARTICIPANT \
  ...
  NS_SCRIPTABLE NS_IMETHOD OnBeginVacuum(bool *_retval NS_OUTPARAM); \
  NS_SCRIPTABLE NS_IMETHOD OnEndVacuum(bool aSucceeded); 
...
#define NS_FORWARD_MOZISTORAGEVACUUMPARTICIPANT(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD OnBeginVacuum(bool *_retval NS_OUTPARAM) { return _to OnBeginVacuum(_retval); } \
  NS_SCRIPTABLE NS_IMETHOD OnEndVacuum(bool aSucceeded) { return _to OnEndVacuum(aSucceeded); } 
...
#define NS_FORWARD_SAFE_MOZISTORAGEVACUUMPARTICIPANT(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD OnBeginVacuum(bool *_retval NS_OUTPARAM) { return !_to ? NS_ERROR_NULL_POINTER : _to->OnBeginVacuum(_retval); } \
  NS_SCRIPTABLE NS_IMETHOD OnEndVacuum(bool aSucceeded) { return !_to ? NS_ERROR_NULL_POINTER : _to->OnEndVacuum(aSucceeded); } 
...
/* boolean onBeginVacuum (); */
NS_IMETHODIMP _MYCLASS_::OnBeginVacuum(bool *_retval NS_OUTPARAM)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
