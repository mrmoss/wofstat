/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM /jds/packages/BUILD/SUNWfirefox-10.0.2/firefox/security/manager/ssl/public/nsIASN1Sequence.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIASN1Sequence : public nsIASN1Object {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD GetIsValidContainer(bool *aIsValidContainer) = 0;
  NS_SCRIPTABLE NS_IMETHOD SetIsValidContainer(bool aIsValidContainer) = 0;

  /* attribute boolean isExpanded; */
  NS_SCRIPTABLE NS_IMETHOD GetIsExpanded(bool *aIsExpanded) = 0;
  NS_SCRIPTABLE NS_IMETHOD SetIsExpanded(bool aIsExpanded) = 0;
...
#define NS_DECL_NSIASN1SEQUENCE \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetIsValidContainer(bool *aIsValidContainer); \
  NS_SCRIPTABLE NS_IMETHOD SetIsValidContainer(bool aIsValidContainer); \
  NS_SCRIPTABLE NS_IMETHOD GetIsExpanded(bool *aIsExpanded); \
  NS_SCRIPTABLE NS_IMETHOD SetIsExpanded(bool aIsExpanded); 
...
#define NS_FORWARD_NSIASN1SEQUENCE(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetIsValidContainer(bool *aIsValidContainer) { return _to GetIsValidContainer(aIsValidContainer); } \
  NS_SCRIPTABLE NS_IMETHOD SetIsValidContainer(bool aIsValidContainer) { return _to SetIsValidContainer(aIsValidContainer); } \
  NS_SCRIPTABLE NS_IMETHOD GetIsExpanded(bool *aIsExpanded) { return _to GetIsExpanded(aIsExpanded); } \
  NS_SCRIPTABLE NS_IMETHOD SetIsExpanded(bool aIsExpanded) { return _to SetIsExpanded(aIsExpanded); } 
...
#define NS_FORWARD_SAFE_NSIASN1SEQUENCE(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetIsValidContainer(bool *aIsValidContainer) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetIsValidContainer(aIsValidContainer); } \
  NS_SCRIPTABLE NS_IMETHOD SetIsValidContainer(bool aIsValidContainer) { return !_to ? NS_ERROR_NULL_POINTER : _to->SetIsValidContainer(aIsValidContainer); } \
  NS_SCRIPTABLE NS_IMETHOD GetIsExpanded(bool *aIsExpanded) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetIsExpanded(aIsExpanded); } \
  NS_SCRIPTABLE NS_IMETHOD SetIsExpanded(bool aIsExpanded) { return !_to ? NS_ERROR_NULL_POINTER : _to->SetIsExpanded(aIsExpanded); } 
