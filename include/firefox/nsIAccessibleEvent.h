/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM /jds/packages/BUILD/SUNWfirefox-10.0.2/firefox/accessible/public/nsIAccessibleEvent.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIAccessibleEvent : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD GetIsFromUserInput(bool *aIsFromUserInput) = 0;
...
#define NS_DECL_NSIACCESSIBLEEVENT \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetIsFromUserInput(bool *aIsFromUserInput); 
...
#define NS_FORWARD_NSIACCESSIBLEEVENT(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetIsFromUserInput(bool *aIsFromUserInput) { return _to GetIsFromUserInput(aIsFromUserInput); } 
...
#define NS_FORWARD_SAFE_NSIACCESSIBLEEVENT(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetIsFromUserInput(bool *aIsFromUserInput) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetIsFromUserInput(aIsFromUserInput); } 
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIAccessibleStateChangeEvent : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD IsExtraState(bool *_retval NS_OUTPARAM) = 0;

  /* boolean isEnabled (); */
  NS_SCRIPTABLE NS_IMETHOD IsEnabled(bool *_retval NS_OUTPARAM) = 0;
...
#define NS_DECL_NSIACCESSIBLESTATECHANGEEVENT \
  ...
  NS_SCRIPTABLE NS_IMETHOD IsExtraState(bool *_retval NS_OUTPARAM); \
  NS_SCRIPTABLE NS_IMETHOD IsEnabled(bool *_retval NS_OUTPARAM); 
...
#define NS_FORWARD_NSIACCESSIBLESTATECHANGEEVENT(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD IsExtraState(bool *_retval NS_OUTPARAM) { return _to IsExtraState(_retval); } \
  NS_SCRIPTABLE NS_IMETHOD IsEnabled(bool *_retval NS_OUTPARAM) { return _to IsEnabled(_retval); } 
...
#define NS_FORWARD_SAFE_NSIACCESSIBLESTATECHANGEEVENT(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD IsExtraState(bool *_retval NS_OUTPARAM) { return !_to ? NS_ERROR_NULL_POINTER : _to->IsExtraState(_retval); } \
  NS_SCRIPTABLE NS_IMETHOD IsEnabled(bool *_retval NS_OUTPARAM) { return !_to ? NS_ERROR_NULL_POINTER : _to->IsEnabled(_retval); } 
...
/* boolean isExtraState (); */
NS_IMETHODIMP nsAccessibleStateChangeEvent::IsExtraState(bool *_retval NS_OUTPARAM)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}

/* boolean isEnabled (); */
NS_IMETHODIMP nsAccessibleStateChangeEvent::IsEnabled(bool *_retval NS_OUTPARAM)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIAccessibleTextChangeEvent : public nsISupports {
 public: 
  ...
  /* boolean isInserted (); */
  NS_SCRIPTABLE NS_IMETHOD IsInserted(bool *_retval NS_OUTPARAM) = 0;
...
#define NS_DECL_NSIACCESSIBLETEXTCHANGEEVENT \
  ...
  NS_SCRIPTABLE NS_IMETHOD IsInserted(bool *_retval NS_OUTPARAM); \
...
#define NS_FORWARD_NSIACCESSIBLETEXTCHANGEEVENT(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD IsInserted(bool *_retval NS_OUTPARAM) { return _to IsInserted(_retval); } \
...
#define NS_FORWARD_SAFE_NSIACCESSIBLETEXTCHANGEEVENT(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD IsInserted(bool *_retval NS_OUTPARAM) { return !_to ? NS_ERROR_NULL_POINTER : _to->IsInserted(_retval); } \
...
/* boolean isInserted (); */
NS_IMETHODIMP nsAccessibleTextChangeEvent::IsInserted(bool *_retval NS_OUTPARAM)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
