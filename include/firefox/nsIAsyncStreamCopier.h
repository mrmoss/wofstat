/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM /jds/packages/BUILD/SUNWfirefox-10.0.2/firefox/netwerk/base/public/nsIAsyncStreamCopier.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIAsyncStreamCopier : public nsIRequest {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD Init(nsIInputStream *aSource, nsIOutputStream *aSink, nsIEventTarget *aTarget, bool aSourceBuffered, bool aSinkBuffered, PRUint32 aChunkSize, bool aCloseSource, bool aCloseSink) = 0;
...
#define NS_DECL_NSIASYNCSTREAMCOPIER \
  NS_SCRIPTABLE NS_IMETHOD Init(nsIInputStream *aSource, nsIOutputStream *aSink, nsIEventTarget *aTarget, bool aSourceBuffered, bool aSinkBuffered, PRUint32 aChunkSize, bool aCloseSource, bool aCloseSink); \
...
#define NS_FORWARD_NSIASYNCSTREAMCOPIER(_to) \
  NS_SCRIPTABLE NS_IMETHOD Init(nsIInputStream *aSource, nsIOutputStream *aSink, nsIEventTarget *aTarget, bool aSourceBuffered, bool aSinkBuffered, PRUint32 aChunkSize, bool aCloseSource, bool aCloseSink) { return _to Init(aSource, aSink, aTarget, aSourceBuffered, aSinkBuffered, aChunkSize, aCloseSource, aCloseSink); } \
...
#define NS_FORWARD_SAFE_NSIASYNCSTREAMCOPIER(_to) \
  NS_SCRIPTABLE NS_IMETHOD Init(nsIInputStream *aSource, nsIOutputStream *aSink, nsIEventTarget *aTarget, bool aSourceBuffered, bool aSinkBuffered, PRUint32 aChunkSize, bool aCloseSource, bool aCloseSink) { return !_to ? NS_ERROR_NULL_POINTER : _to->Init(aSource, aSink, aTarget, aSourceBuffered, aSinkBuffered, aChunkSize, aCloseSource, aCloseSink); } \
...
/* void init (in nsIInputStream aSource, in nsIOutputStream aSink, in nsIEventTarget aTarget, in boolean aSourceBuffered, in boolean aSinkBuffered, in unsigned long aChunkSize, in boolean aCloseSource, in boolean aCloseSink); */
NS_IMETHODIMP nsAsyncStreamCopier::Init(nsIInputStream *aSource, nsIOutputStream *aSink, nsIEventTarget *aTarget, bool aSourceBuffered, bool aSinkBuffered, PRUint32 aChunkSize, bool aCloseSource, bool aCloseSink)
{
