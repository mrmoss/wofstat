/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM /jds/packages/BUILD/SUNWfirefox-10.0.2/firefox/xpcom/ds/nsIAtom.idl
 */
...
class NS_SCRIPTABLE nsIAtom : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD ScriptableEquals(const nsAString & aString, bool *_retval NS_OUTPARAM) = 0;
...
#define NS_DECL_NSIATOM \
  ...
  NS_SCRIPTABLE NS_IMETHOD ScriptableEquals(const nsAString & aString, bool *_retval NS_OUTPARAM); \
...
#define NS_FORWARD_NSIATOM(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD ScriptableEquals(const nsAString & aString, bool *_retval NS_OUTPARAM) { return _to ScriptableEquals(aString, _retval); } \
...
#define NS_FORWARD_SAFE_NSIATOM(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD ScriptableEquals(const nsAString & aString, bool *_retval NS_OUTPARAM) { return !_to ? NS_ERROR_NULL_POINTER : _to->ScriptableEquals(aString, _retval); } \
...
/* [binaryname(ScriptableEquals)] boolean equals (in AString aString); */
NS_IMETHODIMP nsAtom::ScriptableEquals(const nsAString & aString, bool *_retval NS_OUTPARAM)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
