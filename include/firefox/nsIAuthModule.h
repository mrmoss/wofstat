/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM /jds/packages/BUILD/SUNWfirefox-10.0.2/firefox/netwerk/base/public/nsIAuthModule.idl
 */
...
class NS_NO_VTABLE nsIAuthModule : public nsISupports {
 public: 
  ...
  NS_IMETHOD Wrap(const void *aInToken, PRUint32 aInTokenLength, bool confidential, void **aOutToken NS_OUTPARAM, PRUint32 *aOutTokenLength NS_OUTPARAM) = 0;
...
#define NS_DECL_NSIAUTHMODULE \
  ...
  NS_IMETHOD Wrap(const void *aInToken, PRUint32 aInTokenLength, bool confidential, void **aOutToken NS_OUTPARAM, PRUint32 *aOutTokenLength NS_OUTPARAM); \
...
#define NS_FORWARD_NSIAUTHMODULE(_to) \
  ...
  NS_IMETHOD Wrap(const void *aInToken, PRUint32 aInTokenLength, bool confidential, void **aOutToken NS_OUTPARAM, PRUint32 *aOutTokenLength NS_OUTPARAM) { return _to Wrap(aInToken, aInTokenLength, confidential, aOutToken, aOutTokenLength); } \
...
#define NS_FORWARD_SAFE_NSIAUTHMODULE(_to) \
  ...
  NS_IMETHOD Wrap(const void *aInToken, PRUint32 aInTokenLength, bool confidential, void **aOutToken NS_OUTPARAM, PRUint32 *aOutTokenLength NS_OUTPARAM) { return !_to ? NS_ERROR_NULL_POINTER : _to->Wrap(aInToken, aInTokenLength, confidential, aOutToken, aOutTokenLength); } \
...
/* void wrap ([const] in voidPtr aInToken, in unsigned long aInTokenLength, in boolean confidential, out voidPtr aOutToken, out unsigned long aOutTokenLength); */
NS_IMETHODIMP nsAuthModule::Wrap(const void *aInToken, PRUint32 aInTokenLength, bool confidential, void **aOutToken NS_OUTPARAM, PRUint32 *aOutTokenLength NS_OUTPARAM)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
