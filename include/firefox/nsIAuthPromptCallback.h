/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM /jds/packages/BUILD/SUNWfirefox-10.0.2/firefox/netwerk/base/public/nsIAuthPromptCallback.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIAuthPromptCallback : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD OnAuthCancelled(nsISupports *aContext, bool userCancel) = 0;
...
#define NS_DECL_NSIAUTHPROMPTCALLBACK \
  ...
  NS_SCRIPTABLE NS_IMETHOD OnAuthCancelled(nsISupports *aContext, bool userCancel); 
...
#define NS_FORWARD_NSIAUTHPROMPTCALLBACK(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD OnAuthCancelled(nsISupports *aContext, bool userCancel) { return _to OnAuthCancelled(aContext, userCancel); } 
...
#define NS_FORWARD_SAFE_NSIAUTHPROMPTCALLBACK(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD OnAuthCancelled(nsISupports *aContext, bool userCancel) { return !_to ? NS_ERROR_NULL_POINTER : _to->OnAuthCancelled(aContext, userCancel); } 
