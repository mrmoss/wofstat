/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM /jds/packages/BUILD/SUNWfirefox-10.0.2/firefox/toolkit/components/autocomplete/nsIAutoCompleteController.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIAutoCompleteController : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD HandleEnter(bool aIsPopupSelection, bool *_retval NS_OUTPARAM) = 0;

  /* boolean handleEscape (); */
  NS_SCRIPTABLE NS_IMETHOD HandleEscape(bool *_retval NS_OUTPARAM) = 0;
  ...
  NS_SCRIPTABLE NS_IMETHOD HandleKeyNavigation(PRUint32 key, bool *_retval NS_OUTPARAM) = 0;

  /* boolean handleDelete (); */
  NS_SCRIPTABLE NS_IMETHOD HandleDelete(bool *_retval NS_OUTPARAM) = 0;
...
#define NS_DECL_NSIAUTOCOMPLETECONTROLLER \
  ...
  NS_SCRIPTABLE NS_IMETHOD HandleEnter(bool aIsPopupSelection, bool *_retval NS_OUTPARAM); \
  NS_SCRIPTABLE NS_IMETHOD HandleEscape(bool *_retval NS_OUTPARAM); \
  ...
  NS_SCRIPTABLE NS_IMETHOD HandleKeyNavigation(PRUint32 key, bool *_retval NS_OUTPARAM); \
  NS_SCRIPTABLE NS_IMETHOD HandleDelete(bool *_retval NS_OUTPARAM); \
...
#define NS_FORWARD_NSIAUTOCOMPLETECONTROLLER(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD HandleEnter(bool aIsPopupSelection, bool *_retval NS_OUTPARAM) { return _to HandleEnter(aIsPopupSelection, _retval); } \
  NS_SCRIPTABLE NS_IMETHOD HandleEscape(bool *_retval NS_OUTPARAM) { return _to HandleEscape(_retval); } \
  ...
  NS_SCRIPTABLE NS_IMETHOD HandleKeyNavigation(PRUint32 key, bool *_retval NS_OUTPARAM) { return _to HandleKeyNavigation(key, _retval); } \
  NS_SCRIPTABLE NS_IMETHOD HandleDelete(bool *_retval NS_OUTPARAM) { return _to HandleDelete(_retval); } \
...
#define NS_FORWARD_SAFE_NSIAUTOCOMPLETECONTROLLER(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD HandleEnter(bool aIsPopupSelection, bool *_retval NS_OUTPARAM) { return !_to ? NS_ERROR_NULL_POINTER : _to->HandleEnter(aIsPopupSelection, _retval); } \
  NS_SCRIPTABLE NS_IMETHOD HandleEscape(bool *_retval NS_OUTPARAM) { return !_to ? NS_ERROR_NULL_POINTER : _to->HandleEscape(_retval); } \
  ...
  NS_SCRIPTABLE NS_IMETHOD HandleKeyNavigation(PRUint32 key, bool *_retval NS_OUTPARAM) { return !_to ? NS_ERROR_NULL_POINTER : _to->HandleKeyNavigation(key, _retval); } \
  NS_SCRIPTABLE NS_IMETHOD HandleDelete(bool *_retval NS_OUTPARAM) { return !_to ? NS_ERROR_NULL_POINTER : _to->HandleDelete(_retval); } \
...
/* boolean handleEnter (in boolean aIsPopupSelection); */
NS_IMETHODIMP nsAutoCompleteController::HandleEnter(bool aIsPopupSelection, bool *_retval NS_OUTPARAM)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}

/* boolean handleEscape (); */
NS_IMETHODIMP nsAutoCompleteController::HandleEscape(bool *_retval NS_OUTPARAM)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
...
/* boolean handleKeyNavigation (in unsigned long key); */
NS_IMETHODIMP nsAutoCompleteController::HandleKeyNavigation(PRUint32 key, bool *_retval NS_OUTPARAM)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}

/* boolean handleDelete (); */
NS_IMETHODIMP nsAutoCompleteController::HandleDelete(bool *_retval NS_OUTPARAM)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
