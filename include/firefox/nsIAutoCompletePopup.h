/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM /jds/packages/BUILD/SUNWfirefox-10.0.2/firefox/toolkit/components/autocomplete/nsIAutoCompletePopup.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIAutoCompletePopup : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD SelectBy(bool reverse, bool page) = 0;
...
#define NS_DECL_NSIAUTOCOMPLETEPOPUP \
  ...
  NS_SCRIPTABLE NS_IMETHOD SelectBy(bool reverse, bool page); 
...
#define NS_FORWARD_NSIAUTOCOMPLETEPOPUP(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD SelectBy(bool reverse, bool page) { return _to SelectBy(reverse, page); } 
...
#define NS_FORWARD_SAFE_NSIAUTOCOMPLETEPOPUP(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD SelectBy(bool reverse, bool page) { return !_to ? NS_ERROR_NULL_POINTER : _to->SelectBy(reverse, page); } 
