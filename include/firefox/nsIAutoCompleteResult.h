/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM /jds/packages/BUILD/SUNWfirefox-10.0.2/firefox/toolkit/components/autocomplete/nsIAutoCompleteResult.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIAutoCompleteResult : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD RemoveValueAt(PRInt32 rowIndex, bool removeFromDb) = 0;
...
#define NS_DECL_NSIAUTOCOMPLETERESULT \
  ...
  NS_SCRIPTABLE NS_IMETHOD RemoveValueAt(PRInt32 rowIndex, bool removeFromDb); 
...
#define NS_FORWARD_NSIAUTOCOMPLETERESULT(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD RemoveValueAt(PRInt32 rowIndex, bool removeFromDb) { return _to RemoveValueAt(rowIndex, removeFromDb); } 
...
#define NS_FORWARD_SAFE_NSIAUTOCOMPLETERESULT(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD RemoveValueAt(PRInt32 rowIndex, bool removeFromDb) { return !_to ? NS_ERROR_NULL_POINTER : _to->RemoveValueAt(rowIndex, removeFromDb); } 
...
/* void removeValueAt (in long rowIndex, in boolean removeFromDb); */
NS_IMETHODIMP nsAutoCompleteResult::RemoveValueAt(PRInt32 rowIndex, bool removeFromDb)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
