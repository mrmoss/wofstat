/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM /jds/packages/BUILD/SUNWfirefox-10.0.2/firefox/widget/public/nsIBidiKeyboard.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIBidiKeyboard : public nsISupports {
 public: 
  ...
  /* boolean isLangRTL (); */
  NS_SCRIPTABLE NS_IMETHOD IsLangRTL(bool *_retval NS_OUTPARAM) = 0;
  ...
  NS_SCRIPTABLE NS_IMETHOD GetHaveBidiKeyboards(bool *aHaveBidiKeyboards) = 0;
...
#define NS_DECL_NSIBIDIKEYBOARD \
  NS_SCRIPTABLE NS_IMETHOD IsLangRTL(bool *_retval NS_OUTPARAM); \
  NS_SCRIPTABLE NS_IMETHOD SetLangFromBidiLevel(PRUint8 aLevel); \
  NS_SCRIPTABLE NS_IMETHOD GetHaveBidiKeyboards(bool *aHaveBidiKeyboards); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSIBIDIKEYBOARD(_to) \
  NS_SCRIPTABLE NS_IMETHOD IsLangRTL(bool *_retval NS_OUTPARAM) { return _to IsLangRTL(_retval); } \
  NS_SCRIPTABLE NS_IMETHOD SetLangFromBidiLevel(PRUint8 aLevel) { return _to SetLangFromBidiLevel(aLevel); } \
  NS_SCRIPTABLE NS_IMETHOD GetHaveBidiKeyboards(bool *aHaveBidiKeyboards) { return _to GetHaveBidiKeyboards(aHaveBidiKeyboards); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_NSIBIDIKEYBOARD(_to) \
  NS_SCRIPTABLE NS_IMETHOD IsLangRTL(bool *_retval NS_OUTPARAM) { return !_to ? NS_ERROR_NULL_POINTER : _to->IsLangRTL(_retval); } \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetHaveBidiKeyboards(bool *aHaveBidiKeyboards) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetHaveBidiKeyboards(aHaveBidiKeyboards); } 
...
/* boolean isLangRTL (); */
NS_IMETHODIMP nsBidiKeyboard::IsLangRTL(bool *_retval NS_OUTPARAM)
{
