/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM /jds/packages/BUILD/SUNWfirefox-10.0.2/firefox/xpcom/io/nsIBinaryInputStream.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIBinaryInputStream : public nsIInputStream {
 public: 
  ...
  /* boolean readBoolean (); */
  NS_SCRIPTABLE NS_IMETHOD ReadBoolean(bool *_retval NS_OUTPARAM) = 0;
...
#define NS_DECL_NSIBINARYINPUTSTREAM \
  ...
  NS_SCRIPTABLE NS_IMETHOD ReadBoolean(bool *_retval NS_OUTPARAM); \
...
#define NS_FORWARD_NSIBINARYINPUTSTREAM(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD ReadBoolean(bool *_retval NS_OUTPARAM) { return _to ReadBoolean(_retval); } \
...
#define NS_FORWARD_SAFE_NSIBINARYINPUTSTREAM(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD ReadBoolean(bool *_retval NS_OUTPARAM) { return !_to ? NS_ERROR_NULL_POINTER : _to->ReadBoolean(_retval); } \
...
/* boolean readBoolean (); */
NS_IMETHODIMP nsBinaryInputStream::ReadBoolean(bool *_retval NS_OUTPARAM)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
