/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM /jds/packages/BUILD/SUNWfirefox-10.0.2/firefox/toolkit/components/places/nsIBrowserHistory.idl
 */
...
#define NS_IBROWSERHISTORY_IID_STR "d092f5a5-33a8-456c-ac89-6ae6f880bd04"

#define NS_IBROWSERHISTORY_IID \
  {0xd092f5a5, 0x33a8, 0x456c, \
    { 0xac, 0x89, 0x6a, 0xe6, 0xf8, 0x80, 0xbd, 0x04 }}
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIBrowserHistory : public nsIGlobalHistory2 {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD RemovePagesFromHost(const nsACString & aHost, bool aEntireDomain) = 0;
...
#define NS_DECL_NSIBROWSERHISTORY \
  ...
  NS_SCRIPTABLE NS_IMETHOD RemovePagesFromHost(const nsACString & aHost, bool aEntireDomain); \
...
#define NS_FORWARD_NSIBROWSERHISTORY(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD RemovePagesFromHost(const nsACString & aHost, bool aEntireDomain) { return _to RemovePagesFromHost(aHost, aEntireDomain); } \
...
#define NS_FORWARD_SAFE_NSIBROWSERHISTORY(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD RemovePagesFromHost(const nsACString & aHost, bool aEntireDomain) { return !_to ? NS_ERROR_NULL_POINTER : _to->RemovePagesFromHost(aHost, aEntireDomain); } \
