/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM /jds/packages/BUILD/SUNWfirefox-10.0.2/firefox/netwerk/base/public/nsIByteRangeRequest.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIByteRangeRequest : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD GetIsByteRangeRequest(bool *aIsByteRangeRequest) = 0;
...
#define NS_DECL_NSIBYTERANGEREQUEST \
  NS_SCRIPTABLE NS_IMETHOD GetIsByteRangeRequest(bool *aIsByteRangeRequest); \
...
#define NS_FORWARD_NSIBYTERANGEREQUEST(_to) \
  NS_SCRIPTABLE NS_IMETHOD GetIsByteRangeRequest(bool *aIsByteRangeRequest) { return _to GetIsByteRangeRequest(aIsByteRangeRequest); } \
...
#define NS_FORWARD_SAFE_NSIBYTERANGEREQUEST(_to) \
  NS_SCRIPTABLE NS_IMETHOD GetIsByteRangeRequest(bool *aIsByteRangeRequest) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetIsByteRangeRequest(aIsByteRangeRequest); } \
