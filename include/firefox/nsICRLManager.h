/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM /jds/packages/BUILD/SUNWfirefox-10.0.2/firefox/security/manager/ssl/public/nsICRLManager.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsICRLManager : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD ImportCrl(PRUint8 *data, PRUint32 length, nsIURI *uri, PRUint32 type, bool doSilentDownload, const PRUnichar * crlKey) = 0;

  /* boolean updateCRLFromURL (in wstring url, in wstring key); */
  NS_SCRIPTABLE NS_IMETHOD UpdateCRLFromURL(const PRUnichar * url, const PRUnichar * key, bool *_retval NS_OUTPARAM) = 0;
...
#define NS_DECL_NSICRLMANAGER \
  NS_SCRIPTABLE NS_IMETHOD ImportCrl(PRUint8 *data, PRUint32 length, nsIURI *uri, PRUint32 type, bool doSilentDownload, const PRUnichar * crlKey); \
  NS_SCRIPTABLE NS_IMETHOD UpdateCRLFromURL(const PRUnichar * url, const PRUnichar * key, bool *_retval NS_OUTPARAM); \
...
#define NS_FORWARD_NSICRLMANAGER(_to) \
  NS_SCRIPTABLE NS_IMETHOD ImportCrl(PRUint8 *data, PRUint32 length, nsIURI *uri, PRUint32 type, bool doSilentDownload, const PRUnichar * crlKey) { return _to ImportCrl(data, length, uri, type, doSilentDownload, crlKey); } \
  NS_SCRIPTABLE NS_IMETHOD UpdateCRLFromURL(const PRUnichar * url, const PRUnichar * key, bool *_retval NS_OUTPARAM) { return _to UpdateCRLFromURL(url, key, _retval); } \
...
#define NS_FORWARD_SAFE_NSICRLMANAGER(_to) \
  NS_SCRIPTABLE NS_IMETHOD ImportCrl(PRUint8 *data, PRUint32 length, nsIURI *uri, PRUint32 type, bool doSilentDownload, const PRUnichar * crlKey) { return !_to ? NS_ERROR_NULL_POINTER : _to->ImportCrl(data, length, uri, type, doSilentDownload, crlKey); } \
  NS_SCRIPTABLE NS_IMETHOD UpdateCRLFromURL(const PRUnichar * url, const PRUnichar * key, bool *_retval NS_OUTPARAM) { return !_to ? NS_ERROR_NULL_POINTER : _to->UpdateCRLFromURL(url, key, _retval); } \
...
/* void importCrl ([array, size_is (length)] in octet data, in unsigned long length, in nsIURI uri, in unsigned long type, in boolean doSilentDownload, in wstring crlKey); */
NS_IMETHODIMP nsCRLManager::ImportCrl(PRUint8 *data, PRUint32 length, nsIURI *uri, PRUint32 type, bool doSilentDownload, const PRUnichar * crlKey)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}

/* boolean updateCRLFromURL (in wstring url, in wstring key); */
NS_IMETHODIMP nsCRLManager::UpdateCRLFromURL(const PRUnichar * url, const PRUnichar * key, bool *_retval NS_OUTPARAM)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
