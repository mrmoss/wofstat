/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM /jds/packages/BUILD/SUNWfirefox-10.0.2/firefox/netwerk/base/public/nsICacheInfoChannel.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsICacheInfoChannel : public nsISupports {
 public: 
  ...
  /* boolean isFromCache (); */
  NS_SCRIPTABLE NS_IMETHOD IsFromCache(bool *_retval NS_OUTPARAM) = 0;
...
#define NS_DECL_NSICACHEINFOCHANNEL \
  ...
  NS_SCRIPTABLE NS_IMETHOD IsFromCache(bool *_retval NS_OUTPARAM); 
...
#define NS_FORWARD_NSICACHEINFOCHANNEL(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD IsFromCache(bool *_retval NS_OUTPARAM) { return _to IsFromCache(_retval); } 
...
#define NS_FORWARD_SAFE_NSICACHEINFOCHANNEL(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD IsFromCache(bool *_retval NS_OUTPARAM) { return !_to ? NS_ERROR_NULL_POINTER : _to->IsFromCache(_retval); } 
...
/* boolean isFromCache (); */
NS_IMETHODIMP nsCacheInfoChannel::IsFromCache(bool *_retval NS_OUTPARAM)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
