/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM /jds/packages/BUILD/SUNWfirefox-10.0.2/firefox/layout/forms/nsICapturePicker.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsICapturePicker : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD ModeMayBeAvailable(PRUint32 mode, bool *_retval NS_OUTPARAM) = 0;
...
#define NS_DECL_NSICAPTUREPICKER \
  ...
  NS_SCRIPTABLE NS_IMETHOD ModeMayBeAvailable(PRUint32 mode, bool *_retval NS_OUTPARAM); \
...
#define NS_FORWARD_NSICAPTUREPICKER(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD ModeMayBeAvailable(PRUint32 mode, bool *_retval NS_OUTPARAM) { return _to ModeMayBeAvailable(mode, _retval); } \
...
#define NS_FORWARD_SAFE_NSICAPTUREPICKER(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD ModeMayBeAvailable(PRUint32 mode, bool *_retval NS_OUTPARAM) { return !_to ? NS_ERROR_NULL_POINTER : _to->ModeMayBeAvailable(mode, _retval); } \
...
/* boolean modeMayBeAvailable (in unsigned long mode); */
NS_IMETHODIMP nsCapturePicker::ModeMayBeAvailable(PRUint32 mode, bool *_retval NS_OUTPARAM)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
