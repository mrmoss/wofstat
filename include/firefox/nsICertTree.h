/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM /jds/packages/BUILD/SUNWfirefox-10.0.2/firefox/security/manager/ssl/public/nsICertTree.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsICertTree : public nsITreeView {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD IsHostPortOverride(PRUint32 index, bool *_retval NS_OUTPARAM) = 0;
...
#define NS_DECL_NSICERTTREE \
  ...
  NS_SCRIPTABLE NS_IMETHOD IsHostPortOverride(PRUint32 index, bool *_retval NS_OUTPARAM); \
...
#define NS_FORWARD_NSICERTTREE(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD IsHostPortOverride(PRUint32 index, bool *_retval NS_OUTPARAM) { return _to IsHostPortOverride(index, _retval); } \
...
#define NS_FORWARD_SAFE_NSICERTTREE(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD IsHostPortOverride(PRUint32 index, bool *_retval NS_OUTPARAM) { return !_to ? NS_ERROR_NULL_POINTER : _to->IsHostPortOverride(index, _retval); } \
...
/* boolean isHostPortOverride (in unsigned long index); */
NS_IMETHODIMP nsCertTree::IsHostPortOverride(PRUint32 index, bool *_retval NS_OUTPARAM)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
