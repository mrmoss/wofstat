/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM /jds/packages/BUILD/SUNWfirefox-10.0.2/firefox/intl/chardet/public/nsICharsetResolver.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsICharsetResolver : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD RequestCharset(nsIWebNavigation *aWebNavigation, nsIChannel *aChannel, bool *aWantCharset NS_OUTPARAM, nsISupports * *aClosure NS_OUTPARAM, nsACString & _retval NS_OUTPARAM) = 0;
...
#define NS_DECL_NSICHARSETRESOLVER \
  NS_SCRIPTABLE NS_IMETHOD RequestCharset(nsIWebNavigation *aWebNavigation, nsIChannel *aChannel, bool *aWantCharset NS_OUTPARAM, nsISupports * *aClosure NS_OUTPARAM, nsACString & _retval NS_OUTPARAM); \
...
#define NS_FORWARD_NSICHARSETRESOLVER(_to) \
  NS_SCRIPTABLE NS_IMETHOD RequestCharset(nsIWebNavigation *aWebNavigation, nsIChannel *aChannel, bool *aWantCharset NS_OUTPARAM, nsISupports * *aClosure NS_OUTPARAM, nsACString & _retval NS_OUTPARAM) { return _to RequestCharset(aWebNavigation, aChannel, aWantCharset, aClosure, _retval); } \
...
#define NS_FORWARD_SAFE_NSICHARSETRESOLVER(_to) \
  NS_SCRIPTABLE NS_IMETHOD RequestCharset(nsIWebNavigation *aWebNavigation, nsIChannel *aChannel, bool *aWantCharset NS_OUTPARAM, nsISupports * *aClosure NS_OUTPARAM, nsACString & _retval NS_OUTPARAM) { return !_to ? NS_ERROR_NULL_POINTER : _to->RequestCharset(aWebNavigation, aChannel, aWantCharset, aClosure, _retval); } \
...
/* ACString requestCharset (in nsIWebNavigation aWebNavigation, in nsIChannel aChannel, out boolean aWantCharset, out nsISupports aClosure); */
NS_IMETHODIMP nsCharsetResolver::RequestCharset(nsIWebNavigation *aWebNavigation, nsIChannel *aChannel, bool *aWantCharset NS_OUTPARAM, nsISupports * *aClosure NS_OUTPARAM, nsACString & _retval NS_OUTPARAM)
{
