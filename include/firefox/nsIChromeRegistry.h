/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM /jds/packages/BUILD/SUNWfirefox-10.0.2/firefox/chrome/public/nsIChromeRegistry.idl
 */
...
#define NS_FORWARD_SAFE_NSICHROMEREGISTRY(_to) \
  ...
  NS_IMETHOD_(bool) WrappersEnabled(nsIURI *aURI) { return !_to ? NS_ERROR_NULL_POINTER : _to->WrappersEnabled(aURI); } 
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIXULChromeRegistry : public nsIChromeRegistry {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD IsLocaleRTL(const nsACString & package, bool *_retval NS_OUTPARAM) = 0;

  /* void refreshSkins (); */
  NS_SCRIPTABLE NS_IMETHOD RefreshSkins(void) = 0;

  /* boolean allowScriptsForPackage (in nsIURI url); */
  NS_SCRIPTABLE NS_IMETHOD AllowScriptsForPackage(nsIURI *url, bool *_retval NS_OUTPARAM) = 0;

  /* boolean allowContentToAccess (in nsIURI url); */
  NS_SCRIPTABLE NS_IMETHOD AllowContentToAccess(nsIURI *url, bool *_retval NS_OUTPARAM) = 0;
...
#define NS_DECL_NSIXULCHROMEREGISTRY \
  ...
  NS_SCRIPTABLE NS_IMETHOD IsLocaleRTL(const nsACString & package, bool *_retval NS_OUTPARAM); \
  NS_SCRIPTABLE NS_IMETHOD RefreshSkins(void); \
  NS_SCRIPTABLE NS_IMETHOD AllowScriptsForPackage(nsIURI *url, bool *_retval NS_OUTPARAM); \
  NS_SCRIPTABLE NS_IMETHOD AllowContentToAccess(nsIURI *url, bool *_retval NS_OUTPARAM); 
...
#define NS_FORWARD_NSIXULCHROMEREGISTRY(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD IsLocaleRTL(const nsACString & package, bool *_retval NS_OUTPARAM) { return _to IsLocaleRTL(package, _retval); } \
  NS_SCRIPTABLE NS_IMETHOD RefreshSkins(void) { return _to RefreshSkins(); } \
  NS_SCRIPTABLE NS_IMETHOD AllowScriptsForPackage(nsIURI *url, bool *_retval NS_OUTPARAM) { return _to AllowScriptsForPackage(url, _retval); } \
  NS_SCRIPTABLE NS_IMETHOD AllowContentToAccess(nsIURI *url, bool *_retval NS_OUTPARAM) { return _to AllowContentToAccess(url, _retval); } 
...
#define NS_FORWARD_SAFE_NSIXULCHROMEREGISTRY(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD IsLocaleRTL(const nsACString & package, bool *_retval NS_OUTPARAM) { return !_to ? NS_ERROR_NULL_POINTER : _to->IsLocaleRTL(package, _retval); } \
  NS_SCRIPTABLE NS_IMETHOD RefreshSkins(void) { return !_to ? NS_ERROR_NULL_POINTER : _to->RefreshSkins(); } \
  NS_SCRIPTABLE NS_IMETHOD AllowScriptsForPackage(nsIURI *url, bool *_retval NS_OUTPARAM) { return !_to ? NS_ERROR_NULL_POINTER : _to->AllowScriptsForPackage(url, _retval); } \
  NS_SCRIPTABLE NS_IMETHOD AllowContentToAccess(nsIURI *url, bool *_retval NS_OUTPARAM) { return !_to ? NS_ERROR_NULL_POINTER : _to->AllowContentToAccess(url, _retval); } 
...
/* boolean isLocaleRTL (in ACString package); */
NS_IMETHODIMP nsXULChromeRegistry::IsLocaleRTL(const nsACString & package, bool *_retval NS_OUTPARAM)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
...
/* boolean allowScriptsForPackage (in nsIURI url); */
NS_IMETHODIMP nsXULChromeRegistry::AllowScriptsForPackage(nsIURI *url, bool *_retval NS_OUTPARAM)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}

/* boolean allowContentToAccess (in nsIURI url); */
NS_IMETHODIMP nsXULChromeRegistry::AllowContentToAccess(nsIURI *url, bool *_retval NS_OUTPARAM)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
