/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM /jds/packages/BUILD/SUNWfirefox-10.0.2/firefox/security/manager/ssl/public/nsIClientAuthDialogs.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIClientAuthDialogs : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD ChooseCertificate(nsIInterfaceRequestor *ctx, const PRUnichar * cn, const PRUnichar * organization, const PRUnichar * issuer, const PRUnichar * *certNickList, const PRUnichar * *certDetailsList, PRUint32 count, PRInt32 *selectedIndex NS_OUTPARAM, bool *canceled NS_OUTPARAM) = 0;
...
#define NS_DECL_NSICLIENTAUTHDIALOGS \
  NS_SCRIPTABLE NS_IMETHOD ChooseCertificate(nsIInterfaceRequestor *ctx, const PRUnichar * cn, const PRUnichar * organization, const PRUnichar * issuer, const PRUnichar * *certNickList, const PRUnichar * *certDetailsList, PRUint32 count, PRInt32 *selectedIndex NS_OUTPARAM, bool *canceled NS_OUTPARAM); 
...
/* void ChooseCertificate (in nsIInterfaceRequestor ctx, in wstring cn, in wstring organization, in wstring issuer, [array, size_is (count)] in wstring certNickList, [array, size_is (count)] in wstring certDetailsList, in unsigned long count, out long selectedIndex, out boolean canceled); */
NS_IMETHODIMP nsClientAuthDialogs::ChooseCertificate(nsIInterfaceRequestor *ctx, const PRUnichar * cn, const PRUnichar * organization, const PRUnichar * issuer, const PRUnichar * *certNickList, const PRUnichar * *certDetailsList, PRUint32 count, PRInt32 *selectedIndex NS_OUTPARAM, bool *canceled NS_OUTPARAM)
{
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIClientAuthUserDecision : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD GetRememberClientAuthCertificate(bool *aRememberClientAuthCertificate) = 0;
  NS_SCRIPTABLE NS_IMETHOD SetRememberClientAuthCertificate(bool aRememberClientAuthCertificate) = 0;
...
#define NS_DECL_NSICLIENTAUTHUSERDECISION \
  NS_SCRIPTABLE NS_IMETHOD GetRememberClientAuthCertificate(bool *aRememberClientAuthCertificate); \
  NS_SCRIPTABLE NS_IMETHOD SetRememberClientAuthCertificate(bool aRememberClientAuthCertificate); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSICLIENTAUTHUSERDECISION(_to) \
  NS_SCRIPTABLE NS_IMETHOD GetRememberClientAuthCertificate(bool *aRememberClientAuthCertificate) { return _to GetRememberClientAuthCertificate(aRememberClientAuthCertificate); } \
  NS_SCRIPTABLE NS_IMETHOD SetRememberClientAuthCertificate(bool aRememberClientAuthCertificate) { return _to SetRememberClientAuthCertificate(aRememberClientAuthCertificate); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_NSICLIENTAUTHUSERDECISION(_to) \
  NS_SCRIPTABLE NS_IMETHOD GetRememberClientAuthCertificate(bool *aRememberClientAuthCertificate) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetRememberClientAuthCertificate(aRememberClientAuthCertificate); } \
  NS_SCRIPTABLE NS_IMETHOD SetRememberClientAuthCertificate(bool aRememberClientAuthCertificate) { return !_to ? NS_ERROR_NULL_POINTER : _to->SetRememberClientAuthCertificate(aRememberClientAuthCertificate); } 
