/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM /jds/packages/BUILD/SUNWfirefox-10.0.2/firefox/widget/public/nsIClipboard.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIClipboard : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD HasDataMatchingFlavors(const char * *aFlavorList, PRUint32 aLength, PRInt32 aWhichClipboard, bool *_retval NS_OUTPARAM) = 0;

  /* boolean supportsSelectionClipboard (); */
  NS_SCRIPTABLE NS_IMETHOD SupportsSelectionClipboard(bool *_retval NS_OUTPARAM) = 0;
...
#define NS_DECL_NSICLIPBOARD \
  ...
  NS_SCRIPTABLE NS_IMETHOD HasDataMatchingFlavors(const char * *aFlavorList, PRUint32 aLength, PRInt32 aWhichClipboard, bool *_retval NS_OUTPARAM); \
  NS_SCRIPTABLE NS_IMETHOD SupportsSelectionClipboard(bool *_retval NS_OUTPARAM); 
...
#define NS_FORWARD_NSICLIPBOARD(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD HasDataMatchingFlavors(const char * *aFlavorList, PRUint32 aLength, PRInt32 aWhichClipboard, bool *_retval NS_OUTPARAM) { return _to HasDataMatchingFlavors(aFlavorList, aLength, aWhichClipboard, _retval); } \
  NS_SCRIPTABLE NS_IMETHOD SupportsSelectionClipboard(bool *_retval NS_OUTPARAM) { return _to SupportsSelectionClipboard(_retval); } 
...
#define NS_FORWARD_SAFE_NSICLIPBOARD(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD HasDataMatchingFlavors(const char * *aFlavorList, PRUint32 aLength, PRInt32 aWhichClipboard, bool *_retval NS_OUTPARAM) { return !_to ? NS_ERROR_NULL_POINTER : _to->HasDataMatchingFlavors(aFlavorList, aLength, aWhichClipboard, _retval); } \
  NS_SCRIPTABLE NS_IMETHOD SupportsSelectionClipboard(bool *_retval NS_OUTPARAM) { return !_to ? NS_ERROR_NULL_POINTER : _to->SupportsSelectionClipboard(_retval); } 
...
/* boolean hasDataMatchingFlavors ([array, size_is (aLength)] in string aFlavorList, in unsigned long aLength, in long aWhichClipboard); */
NS_IMETHODIMP nsClipboard::HasDataMatchingFlavors(const char * *aFlavorList, PRUint32 aLength, PRInt32 aWhichClipboard, bool *_retval NS_OUTPARAM)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}

/* boolean supportsSelectionClipboard (); */
NS_IMETHODIMP nsClipboard::SupportsSelectionClipboard(bool *_retval NS_OUTPARAM)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
