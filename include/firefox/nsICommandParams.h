/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM /jds/packages/BUILD/SUNWfirefox-10.0.2/firefox/embedding/components/commandhandler/public/nsICommandParams.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsICommandParams : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD GetBooleanValue(const char * name, bool *_retval NS_OUTPARAM) = 0;
  ...
  NS_SCRIPTABLE NS_IMETHOD SetBooleanValue(const char * name, bool value) = 0;
  ...
  NS_SCRIPTABLE NS_IMETHOD HasMoreElements(bool *_retval NS_OUTPARAM) = 0;
...
#define NS_DECL_NSICOMMANDPARAMS \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetBooleanValue(const char * name, bool *_retval NS_OUTPARAM); \
  ...
  NS_SCRIPTABLE NS_IMETHOD SetBooleanValue(const char * name, bool value); \
  ...
  NS_SCRIPTABLE NS_IMETHOD HasMoreElements(bool *_retval NS_OUTPARAM); \
...
#define NS_FORWARD_NSICOMMANDPARAMS(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetBooleanValue(const char * name, bool *_retval NS_OUTPARAM) { return _to GetBooleanValue(name, _retval); } \
  ...
  NS_SCRIPTABLE NS_IMETHOD SetBooleanValue(const char * name, bool value) { return _to SetBooleanValue(name, value); } \
  ...
  NS_SCRIPTABLE NS_IMETHOD HasMoreElements(bool *_retval NS_OUTPARAM) { return _to HasMoreElements(_retval); } \
...
#define NS_FORWARD_SAFE_NSICOMMANDPARAMS(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetBooleanValue(const char * name, bool *_retval NS_OUTPARAM) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetBooleanValue(name, _retval); } \
  ...
  NS_SCRIPTABLE NS_IMETHOD SetBooleanValue(const char * name, bool value) { return !_to ? NS_ERROR_NULL_POINTER : _to->SetBooleanValue(name, value); } \
  ...
  NS_SCRIPTABLE NS_IMETHOD HasMoreElements(bool *_retval NS_OUTPARAM) { return !_to ? NS_ERROR_NULL_POINTER : _to->HasMoreElements(_retval); } \
...
/* boolean getBooleanValue (in string name); */
NS_IMETHODIMP nsCommandParams::GetBooleanValue(const char * name, bool *_retval NS_OUTPARAM)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
...
/* boolean hasMoreElements (); */
NS_IMETHODIMP nsCommandParams::HasMoreElements(bool *_retval NS_OUTPARAM)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
