/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM /jds/packages/BUILD/SUNWfirefox-10.0.2/firefox/xpcom/components/nsIComponentRegistrar.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIComponentRegistrar : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD IsCIDRegistered(const nsCID & aClass, bool *_retval NS_OUTPARAM) = 0;

  /* boolean isContractIDRegistered (in string aContractID); */
  NS_SCRIPTABLE NS_IMETHOD IsContractIDRegistered(const char * aContractID, bool *_retval NS_OUTPARAM) = 0;
...
#define NS_DECL_NSICOMPONENTREGISTRAR \
  ...
  NS_SCRIPTABLE NS_IMETHOD IsCIDRegistered(const nsCID & aClass, bool *_retval NS_OUTPARAM); \
  NS_SCRIPTABLE NS_IMETHOD IsContractIDRegistered(const char * aContractID, bool *_retval NS_OUTPARAM); \
...
#define NS_FORWARD_NSICOMPONENTREGISTRAR(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD IsCIDRegistered(const nsCID & aClass, bool *_retval NS_OUTPARAM) { return _to IsCIDRegistered(aClass, _retval); } \
  NS_SCRIPTABLE NS_IMETHOD IsContractIDRegistered(const char * aContractID, bool *_retval NS_OUTPARAM) { return _to IsContractIDRegistered(aContractID, _retval); } \
...
#define NS_FORWARD_SAFE_NSICOMPONENTREGISTRAR(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD IsCIDRegistered(const nsCID & aClass, bool *_retval NS_OUTPARAM) { return !_to ? NS_ERROR_NULL_POINTER : _to->IsCIDRegistered(aClass, _retval); } \
  NS_SCRIPTABLE NS_IMETHOD IsContractIDRegistered(const char * aContractID, bool *_retval NS_OUTPARAM) { return !_to ? NS_ERROR_NULL_POINTER : _to->IsContractIDRegistered(aContractID, _retval); } \
...
/* boolean isCIDRegistered (in nsCIDRef aClass); */
NS_IMETHODIMP nsComponentRegistrar::IsCIDRegistered(const nsCID & aClass, bool *_retval NS_OUTPARAM)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}

/* boolean isContractIDRegistered (in string aContractID); */
NS_IMETHODIMP nsComponentRegistrar::IsContractIDRegistered(const char * aContractID, bool *_retval NS_OUTPARAM)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
