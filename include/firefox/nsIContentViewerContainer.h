/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM /jds/packages/BUILD/SUNWfirefox-10.0.2/firefox/docshell/base/nsIContentViewerContainer.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIContentViewerContainer : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD SetIsPrinting(bool aIsPrinting) = 0;
...
#define NS_DECL_NSICONTENTVIEWERCONTAINER \
  ...
  NS_SCRIPTABLE NS_IMETHOD SetIsPrinting(bool aIsPrinting); 
...
#define NS_FORWARD_NSICONTENTVIEWERCONTAINER(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD SetIsPrinting(bool aIsPrinting) { return _to SetIsPrinting(aIsPrinting); } 
...
#define NS_FORWARD_SAFE_NSICONTENTVIEWERCONTAINER(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD SetIsPrinting(bool aIsPrinting) { return !_to ? NS_ERROR_NULL_POINTER : _to->SetIsPrinting(aIsPrinting); } 
