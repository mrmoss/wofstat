/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM /jds/packages/BUILD/SUNWfirefox-10.0.2/firefox/docshell/base/nsIContentViewerEdit.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIContentViewerEdit : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD GetCopyable(bool *aCopyable) = 0;

  /* void copyLinkLocation (); */
  NS_SCRIPTABLE NS_IMETHOD CopyLinkLocation(void) = 0;

  /* readonly attribute boolean inLink; */
  NS_SCRIPTABLE NS_IMETHOD GetInLink(bool *aInLink) = 0;
  ...
  NS_SCRIPTABLE NS_IMETHOD GetInImage(bool *aInImage) = 0;

  /* AString getContents (in string aMimeType, in boolean aSelectionOnly); */
  NS_SCRIPTABLE NS_IMETHOD GetContents(const char * aMimeType, bool aSelectionOnly, nsAString & _retval NS_OUTPARAM) = 0;

  /* readonly attribute boolean canGetContents; */
  NS_SCRIPTABLE NS_IMETHOD GetCanGetContents(bool *aCanGetContents) = 0;
...
#define NS_DECL_NSICONTENTVIEWEREDIT \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetCopyable(bool *aCopyable); \
  NS_SCRIPTABLE NS_IMETHOD CopyLinkLocation(void); \
  NS_SCRIPTABLE NS_IMETHOD GetInLink(bool *aInLink); \
  NS_SCRIPTABLE NS_IMETHOD CopyImage(PRInt32 aCopyFlags); \
  NS_SCRIPTABLE NS_IMETHOD GetInImage(bool *aInImage); \
  NS_SCRIPTABLE NS_IMETHOD GetContents(const char * aMimeType, bool aSelectionOnly, nsAString & _retval NS_OUTPARAM); \
  NS_SCRIPTABLE NS_IMETHOD GetCanGetContents(bool *aCanGetContents); 
...
#define NS_FORWARD_NSICONTENTVIEWEREDIT(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetCopyable(bool *aCopyable) { return _to GetCopyable(aCopyable); } \
  NS_SCRIPTABLE NS_IMETHOD CopyLinkLocation(void) { return _to CopyLinkLocation(); } \
  NS_SCRIPTABLE NS_IMETHOD GetInLink(bool *aInLink) { return _to GetInLink(aInLink); } \
  NS_SCRIPTABLE NS_IMETHOD CopyImage(PRInt32 aCopyFlags) { return _to CopyImage(aCopyFlags); } \
  NS_SCRIPTABLE NS_IMETHOD GetInImage(bool *aInImage) { return _to GetInImage(aInImage); } \
  NS_SCRIPTABLE NS_IMETHOD GetContents(const char * aMimeType, bool aSelectionOnly, nsAString & _retval NS_OUTPARAM) { return _to GetContents(aMimeType, aSelectionOnly, _retval); } \
  NS_SCRIPTABLE NS_IMETHOD GetCanGetContents(bool *aCanGetContents) { return _to GetCanGetContents(aCanGetContents); } 
...
#define NS_FORWARD_SAFE_NSICONTENTVIEWEREDIT(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetCopyable(bool *aCopyable) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetCopyable(aCopyable); } \
  NS_SCRIPTABLE NS_IMETHOD CopyLinkLocation(void) { return !_to ? NS_ERROR_NULL_POINTER : _to->CopyLinkLocation(); } \
  NS_SCRIPTABLE NS_IMETHOD GetInLink(bool *aInLink) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetInLink(aInLink); } \
  NS_SCRIPTABLE NS_IMETHOD CopyImage(PRInt32 aCopyFlags) { return !_to ? NS_ERROR_NULL_POINTER : _to->CopyImage(aCopyFlags); } \
  NS_SCRIPTABLE NS_IMETHOD GetInImage(bool *aInImage) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetInImage(aInImage); } \
  NS_SCRIPTABLE NS_IMETHOD GetContents(const char * aMimeType, bool aSelectionOnly, nsAString & _retval NS_OUTPARAM) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetContents(aMimeType, aSelectionOnly, _retval); } \
  NS_SCRIPTABLE NS_IMETHOD GetCanGetContents(bool *aCanGetContents) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetCanGetContents(aCanGetContents); } 
...
/* AString getContents (in string aMimeType, in boolean aSelectionOnly); */
NS_IMETHODIMP nsContentViewerEdit::GetContents(const char * aMimeType, bool aSelectionOnly, nsAString & _retval NS_OUTPARAM)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
