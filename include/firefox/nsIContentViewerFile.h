/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM /jds/packages/BUILD/SUNWfirefox-10.0.2/firefox/docshell/base/nsIContentViewerFile.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIContentViewerFile : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD GetPrintable(bool *aPrintable) = 0;
...
#define NS_DECL_NSICONTENTVIEWERFILE \
  NS_SCRIPTABLE NS_IMETHOD GetPrintable(bool *aPrintable); \
...
#define NS_FORWARD_NSICONTENTVIEWERFILE(_to) \
  NS_SCRIPTABLE NS_IMETHOD GetPrintable(bool *aPrintable) { return _to GetPrintable(aPrintable); } \
...
#define NS_FORWARD_SAFE_NSICONTENTVIEWERFILE(_to) \
  NS_SCRIPTABLE NS_IMETHOD GetPrintable(bool *aPrintable) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetPrintable(aPrintable); } \
