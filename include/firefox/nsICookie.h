/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM /jds/packages/BUILD/SUNWfirefox-10.0.2/firefox/netwerk/cookie/nsICookie.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsICookie : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD GetIsDomain(bool *aIsDomain) = 0;
  ...
  NS_SCRIPTABLE NS_IMETHOD GetIsSecure(bool *aIsSecure) = 0;
...
#define NS_DECL_NSICOOKIE \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetIsDomain(bool *aIsDomain); \
  NS_SCRIPTABLE NS_IMETHOD GetHost(nsACString & aHost); \
  NS_SCRIPTABLE NS_IMETHOD GetPath(nsACString & aPath); \
  NS_SCRIPTABLE NS_IMETHOD GetIsSecure(bool *aIsSecure); \
...
#define NS_FORWARD_NSICOOKIE(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetIsDomain(bool *aIsDomain) { return _to GetIsDomain(aIsDomain); } \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetIsSecure(bool *aIsSecure) { return _to GetIsSecure(aIsSecure); } \
...
#define NS_FORWARD_SAFE_NSICOOKIE(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetIsDomain(bool *aIsDomain) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetIsDomain(aIsDomain); } \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetIsSecure(bool *aIsSecure) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetIsSecure(aIsSecure); } \
