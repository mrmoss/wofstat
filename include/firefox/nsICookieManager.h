/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM /jds/packages/BUILD/SUNWfirefox-10.0.2/firefox/netwerk/cookie/nsICookieManager.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsICookieManager : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD Remove(const nsACString & aHost, const nsACString & aName, const nsACString & aPath, bool aBlocked) = 0;
...
#define NS_DECL_NSICOOKIEMANAGER \
  ...
  NS_SCRIPTABLE NS_IMETHOD Remove(const nsACString & aHost, const nsACString & aName, const nsACString & aPath, bool aBlocked); 
...
#define NS_FORWARD_NSICOOKIEMANAGER(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD Remove(const nsACString & aHost, const nsACString & aName, const nsACString & aPath, bool aBlocked) { return _to Remove(aHost, aName, aPath, aBlocked); } 
...
#define NS_FORWARD_SAFE_NSICOOKIEMANAGER(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD Remove(const nsACString & aHost, const nsACString & aName, const nsACString & aPath, bool aBlocked) { return !_to ? NS_ERROR_NULL_POINTER : _to->Remove(aHost, aName, aPath, aBlocked); } 
