/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM /jds/packages/BUILD/SUNWfirefox-10.0.2/firefox/netwerk/cookie/nsICookiePermission.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsICookiePermission : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD CanSetCookie(nsIURI *aURI, nsIChannel *aChannel, nsICookie2 *aCookie, bool *aIsSession NS_INOUTPARAM, PRInt64 *aExpiry NS_INOUTPARAM, bool *_retval NS_OUTPARAM) = 0;
...
#define NS_DECL_NSICOOKIEPERMISSION \
  ...
  NS_SCRIPTABLE NS_IMETHOD CanSetCookie(nsIURI *aURI, nsIChannel *aChannel, nsICookie2 *aCookie, bool *aIsSession NS_INOUTPARAM, PRInt64 *aExpiry NS_INOUTPARAM, bool *_retval NS_OUTPARAM); \
...
#define NS_FORWARD_NSICOOKIEPERMISSION(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD CanSetCookie(nsIURI *aURI, nsIChannel *aChannel, nsICookie2 *aCookie, bool *aIsSession NS_INOUTPARAM, PRInt64 *aExpiry NS_INOUTPARAM, bool *_retval NS_OUTPARAM) { return _to CanSetCookie(aURI, aChannel, aCookie, aIsSession, aExpiry, _retval); } \
...
#define NS_FORWARD_SAFE_NSICOOKIEPERMISSION(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD CanSetCookie(nsIURI *aURI, nsIChannel *aChannel, nsICookie2 *aCookie, bool *aIsSession NS_INOUTPARAM, PRInt64 *aExpiry NS_INOUTPARAM, bool *_retval NS_OUTPARAM) { return !_to ? NS_ERROR_NULL_POINTER : _to->CanSetCookie(aURI, aChannel, aCookie, aIsSession, aExpiry, _retval); } \
...
/* boolean canSetCookie (in nsIURI aURI, in nsIChannel aChannel, in nsICookie2 aCookie, inout boolean aIsSession, inout PRInt64 aExpiry); */
NS_IMETHODIMP nsCookiePermission::CanSetCookie(nsIURI *aURI, nsIChannel *aChannel, nsICookie2 *aCookie, bool *aIsSession NS_INOUTPARAM, PRInt64 *aExpiry NS_INOUTPARAM, bool *_retval NS_OUTPARAM)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
