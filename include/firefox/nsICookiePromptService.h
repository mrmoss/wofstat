/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM /jds/packages/BUILD/SUNWfirefox-10.0.2/firefox/extensions/cookie/nsICookiePromptService.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsICookiePromptService : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD CookieDialog(nsIDOMWindow *parent, nsICookie *cookie, const nsACString & hostname, PRInt32 cookiesFromHost, bool changingCookie, bool *rememberDecision NS_OUTPARAM, PRInt32 *_retval NS_OUTPARAM) = 0;
...
#define NS_DECL_NSICOOKIEPROMPTSERVICE \
  NS_SCRIPTABLE NS_IMETHOD CookieDialog(nsIDOMWindow *parent, nsICookie *cookie, const nsACString & hostname, PRInt32 cookiesFromHost, bool changingCookie, bool *rememberDecision NS_OUTPARAM, PRInt32 *_retval NS_OUTPARAM); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSICOOKIEPROMPTSERVICE(_to) \
  NS_SCRIPTABLE NS_IMETHOD CookieDialog(nsIDOMWindow *parent, nsICookie *cookie, const nsACString & hostname, PRInt32 cookiesFromHost, bool changingCookie, bool *rememberDecision NS_OUTPARAM, PRInt32 *_retval NS_OUTPARAM) { return _to CookieDialog(parent, cookie, hostname, cookiesFromHost, changingCookie, rememberDecision, _retval); } 
...
/* long cookieDialog (in nsIDOMWindow parent, in nsICookie cookie, in ACString hostname, in long cookiesFromHost, in boolean changingCookie, out boolean rememberDecision); */
NS_IMETHODIMP nsCookiePromptService::CookieDialog(nsIDOMWindow *parent, nsICookie *cookie, const nsACString & hostname, PRInt32 cookiesFromHost, bool changingCookie, bool *rememberDecision NS_OUTPARAM, PRInt32 *_retval NS_OUTPARAM)
{
