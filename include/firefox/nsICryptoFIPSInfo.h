/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM /jds/packages/BUILD/SUNWfirefox-10.0.2/firefox/netwerk/base/public/nsICryptoFIPSInfo.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsICryptoFIPSInfo : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD GetIsFIPSModeActive(bool *aIsFIPSModeActive) = 0;
...
#define NS_DECL_NSICRYPTOFIPSINFO \
  NS_SCRIPTABLE NS_IMETHOD GetIsFIPSModeActive(bool *aIsFIPSModeActive); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSICRYPTOFIPSINFO(_to) \
  NS_SCRIPTABLE NS_IMETHOD GetIsFIPSModeActive(bool *aIsFIPSModeActive) { return _to GetIsFIPSModeActive(aIsFIPSModeActive); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_NSICRYPTOFIPSINFO(_to) \
  NS_SCRIPTABLE NS_IMETHOD GetIsFIPSModeActive(bool *aIsFIPSModeActive) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetIsFIPSModeActive(aIsFIPSModeActive); } 
