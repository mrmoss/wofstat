/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM /jds/packages/BUILD/SUNWfirefox-10.0.2/firefox/netwerk/base/public/nsICryptoHash.idl
 */
...
/* ACString finish (in boolean aASCII); */
NS_IMETHODIMP nsCryptoHash::Finish(bool aASCII, nsACString & _retval NS_OUTPARAM)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
