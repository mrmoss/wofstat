/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM /jds/packages/BUILD/SUNWfirefox-10.0.2/firefox/netwerk/dns/nsIDNSRecord.idl
 */
...
/* boolean hasMore (); */
NS_IMETHODIMP nsDNSRecord::HasMore(bool *_retval NS_OUTPARAM)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
