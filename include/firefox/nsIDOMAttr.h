/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM /jds/packages/BUILD/SUNWfirefox-10.0.2/firefox/dom/interfaces/core/nsIDOMAttr.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIDOMAttr : public nsIDOMNode {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD GetSpecified(bool *aSpecified) = 0;
  ...
  NS_SCRIPTABLE NS_IMETHOD GetIsId(bool *aIsId) = 0;
...
#define NS_DECL_NSIDOMATTR \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetSpecified(bool *aSpecified); \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetIsId(bool *aIsId); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSIDOMATTR(_to) \
  NS_SCRIPTABLE NS_IMETHOD GetName(nsAString & aName) { return _to GetName(aName); } \
  NS_SCRIPTABLE NS_IMETHOD GetSpecified(bool *aSpecified) { return _to GetSpecified(aSpecified); } \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetIsId(bool *aIsId) { return _to GetIsId(aIsId); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_NSIDOMATTR(_to) \
  NS_SCRIPTABLE NS_IMETHOD GetName(nsAString & aName) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetName(aName); } \
  NS_SCRIPTABLE NS_IMETHOD GetSpecified(bool *aSpecified) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetSpecified(aSpecified); } \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetIsId(bool *aIsId) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetIsId(aIsId); } 
