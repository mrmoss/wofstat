/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM /jds/packages/BUILD/SUNWfirefox-10.0.2/firefox/dom/interfaces/base/nsIDOMClientInformation.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIDOMClientInformation : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD MozIsLocallyAvailable(const nsAString & uri, bool whenOffline, bool *_retval NS_OUTPARAM) = 0;
...
#define NS_DECL_NSIDOMCLIENTINFORMATION \
  ...
  NS_SCRIPTABLE NS_IMETHOD MozIsLocallyAvailable(const nsAString & uri, bool whenOffline, bool *_retval NS_OUTPARAM); 
...
#define NS_FORWARD_NSIDOMCLIENTINFORMATION(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD MozIsLocallyAvailable(const nsAString & uri, bool whenOffline, bool *_retval NS_OUTPARAM) { return _to MozIsLocallyAvailable(uri, whenOffline, _retval); } 
...
#define NS_FORWARD_SAFE_NSIDOMCLIENTINFORMATION(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD MozIsLocallyAvailable(const nsAString & uri, bool whenOffline, bool *_retval NS_OUTPARAM) { return !_to ? NS_ERROR_NULL_POINTER : _to->MozIsLocallyAvailable(uri, whenOffline, _retval); } 
...
/* boolean mozIsLocallyAvailable (in DOMString uri, in boolean whenOffline); */
NS_IMETHODIMP nsDOMClientInformation::MozIsLocallyAvailable(const nsAString & uri, bool whenOffline, bool *_retval NS_OUTPARAM)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
