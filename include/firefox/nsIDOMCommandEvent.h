/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM /jds/packages/BUILD/SUNWfirefox-10.0.2/firefox/dom/interfaces/events/nsIDOMCommandEvent.idl
 */
...
#define NS_IDOMCOMMANDEVENT_IID_STR "cfdbc647-847f-4bd9-8595-5dd0a1592b7b"

#define NS_IDOMCOMMANDEVENT_IID \
  {0xcfdbc647, 0x847f, 0x4bd9, \
    { 0x85, 0x95, 0x5d, 0xd0, 0xa1, 0x59, 0x2b, 0x7b }}
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIDOMCommandEvent : public nsIDOMEvent {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD InitCommandEvent(const nsAString & typeArg, bool canBubbleArg, bool canCancelArg, const nsAString & command) = 0;
...
#define NS_DECL_NSIDOMCOMMANDEVENT \
  ...
  NS_SCRIPTABLE NS_IMETHOD InitCommandEvent(const nsAString & typeArg, bool canBubbleArg, bool canCancelArg, const nsAString & command); 
...
#define NS_FORWARD_NSIDOMCOMMANDEVENT(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD InitCommandEvent(const nsAString & typeArg, bool canBubbleArg, bool canCancelArg, const nsAString & command) { return _to InitCommandEvent(typeArg, canBubbleArg, canCancelArg, command); } 
...
#define NS_FORWARD_SAFE_NSIDOMCOMMANDEVENT(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD InitCommandEvent(const nsAString & typeArg, bool canBubbleArg, bool canCancelArg, const nsAString & command) { return !_to ? NS_ERROR_NULL_POINTER : _to->InitCommandEvent(typeArg, canBubbleArg, canCancelArg, command); } 
