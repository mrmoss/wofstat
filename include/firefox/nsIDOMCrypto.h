/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM /jds/packages/BUILD/SUNWfirefox-10.0.2/firefox/dom/interfaces/base/nsIDOMCrypto.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIDOMCrypto : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD GetEnableSmartCardEvents(bool *aEnableSmartCardEvents) = 0;
  NS_SCRIPTABLE NS_IMETHOD SetEnableSmartCardEvents(bool aEnableSmartCardEvents) = 0;
  ...
  NS_SCRIPTABLE NS_IMETHOD ImportUserCertificates(const nsAString & nickname, const nsAString & cmmfResponse, bool doForcedBackup, nsAString & _retval NS_OUTPARAM) = 0;
...
#define NS_DECL_NSIDOMCRYPTO \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetEnableSmartCardEvents(bool *aEnableSmartCardEvents); \
  NS_SCRIPTABLE NS_IMETHOD SetEnableSmartCardEvents(bool aEnableSmartCardEvents); \
  NS_SCRIPTABLE NS_IMETHOD GenerateCRMFRequest(nsIDOMCRMFObject * *_retval NS_OUTPARAM); \
  NS_SCRIPTABLE NS_IMETHOD ImportUserCertificates(const nsAString & nickname, const nsAString & cmmfResponse, bool doForcedBackup, nsAString & _retval NS_OUTPARAM); \
...
#define NS_FORWARD_NSIDOMCRYPTO(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetEnableSmartCardEvents(bool *aEnableSmartCardEvents) { return _to GetEnableSmartCardEvents(aEnableSmartCardEvents); } \
  NS_SCRIPTABLE NS_IMETHOD SetEnableSmartCardEvents(bool aEnableSmartCardEvents) { return _to SetEnableSmartCardEvents(aEnableSmartCardEvents); } \
  NS_SCRIPTABLE NS_IMETHOD GenerateCRMFRequest(nsIDOMCRMFObject * *_retval NS_OUTPARAM) { return _to GenerateCRMFRequest(_retval); } \
  NS_SCRIPTABLE NS_IMETHOD ImportUserCertificates(const nsAString & nickname, const nsAString & cmmfResponse, bool doForcedBackup, nsAString & _retval NS_OUTPARAM) { return _to ImportUserCertificates(nickname, cmmfResponse, doForcedBackup, _retval); } \
...
#define NS_FORWARD_SAFE_NSIDOMCRYPTO(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetEnableSmartCardEvents(bool *aEnableSmartCardEvents) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetEnableSmartCardEvents(aEnableSmartCardEvents); } \
  NS_SCRIPTABLE NS_IMETHOD SetEnableSmartCardEvents(bool aEnableSmartCardEvents) { return !_to ? NS_ERROR_NULL_POINTER : _to->SetEnableSmartCardEvents(aEnableSmartCardEvents); } \
  ...
  NS_SCRIPTABLE NS_IMETHOD ImportUserCertificates(const nsAString & nickname, const nsAString & cmmfResponse, bool doForcedBackup, nsAString & _retval NS_OUTPARAM) { return !_to ? NS_ERROR_NULL_POINTER : _to->ImportUserCertificates(nickname, cmmfResponse, doForcedBackup, _retval); } \
...
/* DOMString importUserCertificates (in DOMString nickname, in DOMString cmmfResponse, in boolean doForcedBackup); */
NS_IMETHODIMP nsDOMCrypto::ImportUserCertificates(const nsAString & nickname, const nsAString & cmmfResponse, bool doForcedBackup, nsAString & _retval NS_OUTPARAM)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
