/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM /jds/packages/BUILD/SUNWfirefox-10.0.2/firefox/security/manager/ssl/public/nsIDOMCryptoDialogs.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIDOMCryptoDialogs : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD ConfirmKeyEscrow(nsIX509Cert *escrowAuthority, bool *_retval NS_OUTPARAM) = 0;
...
#define NS_DECL_NSIDOMCRYPTODIALOGS \
  NS_SCRIPTABLE NS_IMETHOD ConfirmKeyEscrow(nsIX509Cert *escrowAuthority, bool *_retval NS_OUTPARAM); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSIDOMCRYPTODIALOGS(_to) \
  NS_SCRIPTABLE NS_IMETHOD ConfirmKeyEscrow(nsIX509Cert *escrowAuthority, bool *_retval NS_OUTPARAM) { return _to ConfirmKeyEscrow(escrowAuthority, _retval); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_NSIDOMCRYPTODIALOGS(_to) \
  NS_SCRIPTABLE NS_IMETHOD ConfirmKeyEscrow(nsIX509Cert *escrowAuthority, bool *_retval NS_OUTPARAM) { return !_to ? NS_ERROR_NULL_POINTER : _to->ConfirmKeyEscrow(escrowAuthority, _retval); } 
...
/* boolean ConfirmKeyEscrow (in nsIX509Cert escrowAuthority); */
NS_IMETHODIMP nsDOMCryptoDialogs::ConfirmKeyEscrow(nsIX509Cert *escrowAuthority, bool *_retval NS_OUTPARAM)
{
