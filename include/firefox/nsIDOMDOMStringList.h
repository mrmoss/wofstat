/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM /jds/packages/BUILD/SUNWfirefox-10.0.2/firefox/dom/interfaces/core/nsIDOMDOMStringList.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIDOMDOMStringList : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD Contains(const nsAString & str, bool *_retval NS_OUTPARAM) = 0;
...
#define NS_DECL_NSIDOMDOMSTRINGLIST \
  ...
  NS_SCRIPTABLE NS_IMETHOD Contains(const nsAString & str, bool *_retval NS_OUTPARAM); 
...
#define NS_FORWARD_NSIDOMDOMSTRINGLIST(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD Contains(const nsAString & str, bool *_retval NS_OUTPARAM) { return _to Contains(str, _retval); } 
...
#define NS_FORWARD_SAFE_NSIDOMDOMSTRINGLIST(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD Contains(const nsAString & str, bool *_retval NS_OUTPARAM) { return !_to ? NS_ERROR_NULL_POINTER : _to->Contains(str, _retval); } 
...
/* boolean contains (in DOMString str); */
NS_IMETHODIMP nsDOMDOMStringList::Contains(const nsAString & str, bool *_retval NS_OUTPARAM)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
