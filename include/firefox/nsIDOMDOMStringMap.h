/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM /jds/packages/BUILD/SUNWfirefox-10.0.2/firefox/dom/interfaces/html/nsIDOMDOMStringMap.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIDOMDOMStringMap : public nsISupports {
 public: 
  ...
  NS_IMETHOD_(bool) HasDataAttr(const nsAString & prop) = 0;
...
#define NS_DECL_NSIDOMDOMSTRINGMAP \
  NS_IMETHOD_(bool) HasDataAttr(const nsAString & prop); \
...
#define NS_FORWARD_NSIDOMDOMSTRINGMAP(_to) \
  NS_IMETHOD_(bool) HasDataAttr(const nsAString & prop) { return _to HasDataAttr(prop); } \
...
#define NS_FORWARD_SAFE_NSIDOMDOMSTRINGMAP(_to) \
  NS_IMETHOD_(bool) HasDataAttr(const nsAString & prop) { return !_to ? NS_ERROR_NULL_POINTER : _to->HasDataAttr(prop); } \
...
/* [notxpcom] boolean hasDataAttr (in DOMString prop); */
NS_IMETHODIMP_(bool) nsDOMDOMStringMap::HasDataAttr(const nsAString & prop)
{
