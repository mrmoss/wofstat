/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM /jds/packages/BUILD/SUNWfirefox-10.0.2/firefox/dom/interfaces/core/nsIDOMDOMTokenList.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIDOMDOMTokenList : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD Contains(const nsAString & token, bool *_retval NS_OUTPARAM) = 0;
  ...
  NS_SCRIPTABLE NS_IMETHOD Toggle(const nsAString & token, bool *_retval NS_OUTPARAM) = 0;
...
#define NS_DECL_NSIDOMDOMTOKENLIST \
  ...
  NS_SCRIPTABLE NS_IMETHOD Contains(const nsAString & token, bool *_retval NS_OUTPARAM); \
  NS_SCRIPTABLE NS_IMETHOD Add(const nsAString & token); \
  NS_SCRIPTABLE NS_IMETHOD Remove(const nsAString & token); \
  NS_SCRIPTABLE NS_IMETHOD Toggle(const nsAString & token, bool *_retval NS_OUTPARAM); \
...
#define NS_FORWARD_NSIDOMDOMTOKENLIST(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD Contains(const nsAString & token, bool *_retval NS_OUTPARAM) { return _to Contains(token, _retval); } \
  ...
  NS_SCRIPTABLE NS_IMETHOD Toggle(const nsAString & token, bool *_retval NS_OUTPARAM) { return _to Toggle(token, _retval); } \
...
#define NS_FORWARD_SAFE_NSIDOMDOMTOKENLIST(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD Contains(const nsAString & token, bool *_retval NS_OUTPARAM) { return !_to ? NS_ERROR_NULL_POINTER : _to->Contains(token, _retval); } \
  ...
  NS_SCRIPTABLE NS_IMETHOD Toggle(const nsAString & token, bool *_retval NS_OUTPARAM) { return !_to ? NS_ERROR_NULL_POINTER : _to->Toggle(token, _retval); } \
...
/* boolean contains ([Null (Stringify)] in DOMString token); */
NS_IMETHODIMP nsDOMDOMTokenList::Contains(const nsAString & token, bool *_retval NS_OUTPARAM)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
...
/* boolean toggle ([Null (Stringify)] in DOMString token); */
NS_IMETHODIMP nsDOMDOMTokenList::Toggle(const nsAString & token, bool *_retval NS_OUTPARAM)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
