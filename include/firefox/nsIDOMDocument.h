/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM /jds/packages/BUILD/SUNWfirefox-10.0.2/firefox/dom/interfaces/core/nsIDOMDocument.idl
 */
...
#define NS_IDOMDOCUMENT_IID_STR "5c3bff4d-ae7f-4c93-948c-519589672c30"

#define NS_IDOMDOCUMENT_IID \
  {0x5c3bff4d, 0xae7f, 0x4c93, \
    { 0x94, 0x8c, 0x51, 0x95, 0x89, 0x67, 0x2c, 0x30 }}
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIDOMDocument : public nsIDOMNode {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD ImportNode(nsIDOMNode *importedNode, bool deep, PRUint8 _argc, nsIDOMNode * *_retval NS_OUTPARAM) = 0;
  ...
  NS_SCRIPTABLE NS_IMETHOD CreateNodeIterator(nsIDOMNode *root, PRUint32 whatToShow, nsIDOMNodeFilter *filter, bool entityReferenceExpansion, nsIDOMNodeIterator * *_retval NS_OUTPARAM) = 0;
  ...
  NS_SCRIPTABLE NS_IMETHOD CreateTreeWalker(nsIDOMNode *root, PRUint32 whatToShow, nsIDOMNodeFilter *filter, bool entityReferenceExpansion, nsIDOMTreeWalker * *_retval NS_OUTPARAM) = 0;
  ...
  /* boolean hasFocus (); */
  NS_SCRIPTABLE NS_IMETHOD HasFocus(bool *_retval NS_OUTPARAM) = 0;
  ...
  NS_SCRIPTABLE NS_IMETHOD GetMozSyntheticDocument(bool *aMozSyntheticDocument) = 0;
  ...
  NS_SCRIPTABLE NS_IMETHOD GetMozFullScreen(bool *aMozFullScreen) = 0;

  /* readonly attribute boolean mozFullScreenEnabled; */
  NS_SCRIPTABLE NS_IMETHOD GetMozFullScreenEnabled(bool *aMozFullScreenEnabled) = 0;
  ...
  NS_SCRIPTABLE NS_IMETHOD GetMozHidden(bool *aMozHidden) = 0;

  /* readonly attribute DOMString mozVisibilityState; */
  NS_SCRIPTABLE NS_IMETHOD GetMozVisibilityState(nsAString & aMozVisibilityState) = 0;
...
#define NS_DECL_NSIDOMDOCUMENT \
  ...
  NS_SCRIPTABLE NS_IMETHOD ImportNode(nsIDOMNode *importedNode, bool deep, PRUint8 _argc, nsIDOMNode * *_retval NS_OUTPARAM); \
  ...
  NS_SCRIPTABLE NS_IMETHOD CreateNodeIterator(nsIDOMNode *root, PRUint32 whatToShow, nsIDOMNodeFilter *filter, bool entityReferenceExpansion, nsIDOMNodeIterator * *_retval NS_OUTPARAM); \
  NS_SCRIPTABLE NS_IMETHOD CreateTreeWalker(nsIDOMNode *root, PRUint32 whatToShow, nsIDOMNodeFilter *filter, bool entityReferenceExpansion, nsIDOMTreeWalker * *_retval NS_OUTPARAM); \
  ...
  NS_SCRIPTABLE NS_IMETHOD HasFocus(bool *_retval NS_OUTPARAM); \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetMozSyntheticDocument(bool *aMozSyntheticDocument); \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetMozFullScreen(bool *aMozFullScreen); \
  NS_SCRIPTABLE NS_IMETHOD GetMozFullScreenEnabled(bool *aMozFullScreenEnabled); \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetMozHidden(bool *aMozHidden); \
  NS_SCRIPTABLE NS_IMETHOD GetMozVisibilityState(nsAString & aMozVisibilityState); 
...
#define NS_FORWARD_NSIDOMDOCUMENT(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD ImportNode(nsIDOMNode *importedNode, bool deep, PRUint8 _argc, nsIDOMNode * *_retval NS_OUTPARAM) { return _to ImportNode(importedNode, deep, _argc, _retval); } \
  ...
  NS_SCRIPTABLE NS_IMETHOD CreateNodeIterator(nsIDOMNode *root, PRUint32 whatToShow, nsIDOMNodeFilter *filter, bool entityReferenceExpansion, nsIDOMNodeIterator * *_retval NS_OUTPARAM) { return _to CreateNodeIterator(root, whatToShow, filter, entityReferenceExpansion, _retval); } \
  NS_SCRIPTABLE NS_IMETHOD CreateTreeWalker(nsIDOMNode *root, PRUint32 whatToShow, nsIDOMNodeFilter *filter, bool entityReferenceExpansion, nsIDOMTreeWalker * *_retval NS_OUTPARAM) { return _to CreateTreeWalker(root, whatToShow, filter, entityReferenceExpansion, _retval); } \
  ...
  NS_SCRIPTABLE NS_IMETHOD HasFocus(bool *_retval NS_OUTPARAM) { return _to HasFocus(_retval); } \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetMozSyntheticDocument(bool *aMozSyntheticDocument) { return _to GetMozSyntheticDocument(aMozSyntheticDocument); } \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetMozFullScreen(bool *aMozFullScreen) { return _to GetMozFullScreen(aMozFullScreen); } \
  NS_SCRIPTABLE NS_IMETHOD GetMozFullScreenEnabled(bool *aMozFullScreenEnabled) { return _to GetMozFullScreenEnabled(aMozFullScreenEnabled); } \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetMozHidden(bool *aMozHidden) { return _to GetMozHidden(aMozHidden); } \
  NS_SCRIPTABLE NS_IMETHOD GetMozVisibilityState(nsAString & aMozVisibilityState) { return _to GetMozVisibilityState(aMozVisibilityState); } 
...
#define NS_FORWARD_SAFE_NSIDOMDOCUMENT(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD ImportNode(nsIDOMNode *importedNode, bool deep, PRUint8 _argc, nsIDOMNode * *_retval NS_OUTPARAM) { return !_to ? NS_ERROR_NULL_POINTER : _to->ImportNode(importedNode, deep, _argc, _retval); } \
  ...
  NS_SCRIPTABLE NS_IMETHOD CreateNodeIterator(nsIDOMNode *root, PRUint32 whatToShow, nsIDOMNodeFilter *filter, bool entityReferenceExpansion, nsIDOMNodeIterator * *_retval NS_OUTPARAM) { return !_to ? NS_ERROR_NULL_POINTER : _to->CreateNodeIterator(root, whatToShow, filter, entityReferenceExpansion, _retval); } \
  NS_SCRIPTABLE NS_IMETHOD CreateTreeWalker(nsIDOMNode *root, PRUint32 whatToShow, nsIDOMNodeFilter *filter, bool entityReferenceExpansion, nsIDOMTreeWalker * *_retval NS_OUTPARAM) { return !_to ? NS_ERROR_NULL_POINTER : _to->CreateTreeWalker(root, whatToShow, filter, entityReferenceExpansion, _retval); } \
  ...
  NS_SCRIPTABLE NS_IMETHOD HasFocus(bool *_retval NS_OUTPARAM) { return !_to ? NS_ERROR_NULL_POINTER : _to->HasFocus(_retval); } \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetMozSyntheticDocument(bool *aMozSyntheticDocument) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetMozSyntheticDocument(aMozSyntheticDocument); } \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetMozFullScreen(bool *aMozFullScreen) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetMozFullScreen(aMozFullScreen); } \
  NS_SCRIPTABLE NS_IMETHOD GetMozFullScreenEnabled(bool *aMozFullScreenEnabled) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetMozFullScreenEnabled(aMozFullScreenEnabled); } \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetMozHidden(bool *aMozHidden) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetMozHidden(aMozHidden); } \
  NS_SCRIPTABLE NS_IMETHOD GetMozVisibilityState(nsAString & aMozVisibilityState) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetMozVisibilityState(aMozVisibilityState); } 
...
/* [optional_argc] nsIDOMNode importNode (in nsIDOMNode importedNode, [optional] in boolean deep) raises (DOMException); */
NS_IMETHODIMP nsDOMDocument::ImportNode(nsIDOMNode *importedNode, bool deep, PRUint8 _argc, nsIDOMNode * *_retval NS_OUTPARAM)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
...
/* nsIDOMNodeIterator createNodeIterator (in nsIDOMNode root, in unsigned long whatToShow, in nsIDOMNodeFilter filter, in boolean entityReferenceExpansion) raises (DOMException); */
NS_IMETHODIMP nsDOMDocument::CreateNodeIterator(nsIDOMNode *root, PRUint32 whatToShow, nsIDOMNodeFilter *filter, bool entityReferenceExpansion, nsIDOMNodeIterator * *_retval NS_OUTPARAM)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}

/* nsIDOMTreeWalker createTreeWalker (in nsIDOMNode root, in unsigned long whatToShow, in nsIDOMNodeFilter filter, in boolean entityReferenceExpansion) raises (DOMException); */
NS_IMETHODIMP nsDOMDocument::CreateTreeWalker(nsIDOMNode *root, PRUint32 whatToShow, nsIDOMNodeFilter *filter, bool entityReferenceExpansion, nsIDOMTreeWalker * *_retval NS_OUTPARAM)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
...
/* boolean hasFocus (); */
NS_IMETHODIMP nsDOMDocument::HasFocus(bool *_retval NS_OUTPARAM)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
