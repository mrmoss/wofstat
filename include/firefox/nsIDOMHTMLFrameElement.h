/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM /jds/packages/BUILD/SUNWfirefox-10.0.2/firefox/dom/interfaces/html/nsIDOMHTMLFrameElement.idl
 */
...
#define NS_IDOMHTMLFRAMEELEMENT_IID_STR "6de9d59d-42fd-44df-bb41-22cd64a85d4f"

#define NS_IDOMHTMLFRAMEELEMENT_IID \
  {0x6de9d59d, 0x42fd, 0x44df, \
    { 0xbb, 0x41, 0x22, 0xcd, 0x64, 0xa8, 0x5d, 0x4f }}
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIDOMHTMLFrameElement : public nsIDOMHTMLElement {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD GetNoResize(bool *aNoResize) = 0;
  NS_SCRIPTABLE NS_IMETHOD SetNoResize(bool aNoResize) = 0;
...
#define NS_DECL_NSIDOMHTMLFRAMEELEMENT \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetNoResize(bool *aNoResize); \
  NS_SCRIPTABLE NS_IMETHOD SetNoResize(bool aNoResize); \
...
#define NS_FORWARD_NSIDOMHTMLFRAMEELEMENT(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetNoResize(bool *aNoResize) { return _to GetNoResize(aNoResize); } \
  NS_SCRIPTABLE NS_IMETHOD SetNoResize(bool aNoResize) { return _to SetNoResize(aNoResize); } \
...
#define NS_FORWARD_SAFE_NSIDOMHTMLFRAMEELEMENT(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetNoResize(bool *aNoResize) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetNoResize(aNoResize); } \
  NS_SCRIPTABLE NS_IMETHOD SetNoResize(bool aNoResize) { return !_to ? NS_ERROR_NULL_POINTER : _to->SetNoResize(aNoResize); } \
