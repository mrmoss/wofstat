/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM /jds/packages/BUILD/SUNWfirefox-10.0.2/firefox/dom/interfaces/html/nsIDOMHTMLImageElement.idl
 */
...
#define NS_IDOMHTMLIMAGEELEMENT_IID_STR "02dbe3c7-e75e-4a35-989c-b6f6d7a3108f"

#define NS_IDOMHTMLIMAGEELEMENT_IID \
  {0x02dbe3c7, 0xe75e, 0x4a35, \
    { 0x98, 0x9c, 0xb6, 0xf6, 0xd7, 0xa3, 0x10, 0x8f }}
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIDOMHTMLImageElement : public nsIDOMHTMLElement {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD GetIsMap(bool *aIsMap) = 0;
  NS_SCRIPTABLE NS_IMETHOD SetIsMap(bool aIsMap) = 0;
  ...
  NS_SCRIPTABLE NS_IMETHOD GetComplete(bool *aComplete) = 0;
...
#define NS_DECL_NSIDOMHTMLIMAGEELEMENT \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetIsMap(bool *aIsMap); \
  NS_SCRIPTABLE NS_IMETHOD SetIsMap(bool aIsMap); \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetComplete(bool *aComplete); \
...
#define NS_FORWARD_NSIDOMHTMLIMAGEELEMENT(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetIsMap(bool *aIsMap) { return _to GetIsMap(aIsMap); } \
  NS_SCRIPTABLE NS_IMETHOD SetIsMap(bool aIsMap) { return _to SetIsMap(aIsMap); } \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetComplete(bool *aComplete) { return _to GetComplete(aComplete); } \
...
#define NS_FORWARD_SAFE_NSIDOMHTMLIMAGEELEMENT(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetIsMap(bool *aIsMap) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetIsMap(aIsMap); } \
  NS_SCRIPTABLE NS_IMETHOD SetIsMap(bool aIsMap) { return !_to ? NS_ERROR_NULL_POINTER : _to->SetIsMap(aIsMap); } \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetComplete(bool *aComplete) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetComplete(aComplete); } \
