/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM /jds/packages/BUILD/SUNWfirefox-10.0.2/firefox/dom/interfaces/html/nsIDOMHTMLObjectElement.idl
 */
...
#define NS_IDOMHTMLOBJECTELEMENT_IID_STR "5d873128-d4e3-4e89-8900-599155167105"

#define NS_IDOMHTMLOBJECTELEMENT_IID \
  {0x5d873128, 0xd4e3, 0x4e89, \
    { 0x89, 0x00, 0x59, 0x91, 0x55, 0x16, 0x71, 0x05 }}
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIDOMHTMLObjectElement : public nsIDOMHTMLElement {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD GetDeclare(bool *aDeclare) = 0;
  NS_SCRIPTABLE NS_IMETHOD SetDeclare(bool aDeclare) = 0;
...
#define NS_DECL_NSIDOMHTMLOBJECTELEMENT \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetDeclare(bool *aDeclare); \
  NS_SCRIPTABLE NS_IMETHOD SetDeclare(bool aDeclare); \
...
#define NS_FORWARD_NSIDOMHTMLOBJECTELEMENT(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetDeclare(bool *aDeclare) { return _to GetDeclare(aDeclare); } \
  NS_SCRIPTABLE NS_IMETHOD SetDeclare(bool aDeclare) { return _to SetDeclare(aDeclare); } \
...
#define NS_FORWARD_SAFE_NSIDOMHTMLOBJECTELEMENT(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetDeclare(bool *aDeclare) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetDeclare(aDeclare); } \
  NS_SCRIPTABLE NS_IMETHOD SetDeclare(bool aDeclare) { return !_to ? NS_ERROR_NULL_POINTER : _to->SetDeclare(aDeclare); } \
...
/* boolean checkValidity (); */
NS_IMETHODIMP nsDOMHTMLObjectElement::CheckValidity(bool *_retval NS_OUTPARAM)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
