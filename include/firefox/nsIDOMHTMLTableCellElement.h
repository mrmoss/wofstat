/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM /jds/packages/BUILD/SUNWfirefox-10.0.2/firefox/dom/interfaces/html/nsIDOMHTMLTableCellElement.idl
 */
...
#define NS_IDOMHTMLTABLECELLELEMENT_IID_STR "03dd5118-7eaf-4bd3-a4a7-77f3f7eb8539"

#define NS_IDOMHTMLTABLECELLELEMENT_IID \
  {0x03dd5118, 0x7eaf, 0x4bd3, \
    { 0xa4, 0xa7, 0x77, 0xf3, 0xf7, 0xeb, 0x85, 0x39 }}
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIDOMHTMLTableCellElement : public nsIDOMHTMLElement {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD GetNoWrap(bool *aNoWrap) = 0;
  NS_SCRIPTABLE NS_IMETHOD SetNoWrap(bool aNoWrap) = 0;
...
#define NS_DECL_NSIDOMHTMLTABLECELLELEMENT \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetNoWrap(bool *aNoWrap); \
  NS_SCRIPTABLE NS_IMETHOD SetNoWrap(bool aNoWrap); \
...
#define NS_FORWARD_NSIDOMHTMLTABLECELLELEMENT(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetNoWrap(bool *aNoWrap) { return _to GetNoWrap(aNoWrap); } \
  NS_SCRIPTABLE NS_IMETHOD SetNoWrap(bool aNoWrap) { return _to SetNoWrap(aNoWrap); } \
...
#define NS_FORWARD_SAFE_NSIDOMHTMLTABLECELLELEMENT(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetNoWrap(bool *aNoWrap) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetNoWrap(aNoWrap); } \
  NS_SCRIPTABLE NS_IMETHOD SetNoWrap(bool aNoWrap) { return !_to ? NS_ERROR_NULL_POINTER : _to->SetNoWrap(aNoWrap); } \
