/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM /jds/packages/BUILD/SUNWfirefox-10.0.2/firefox/dom/interfaces/base/nsIDOMJSWindow.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIDOMJSWindow : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD SetResizable(bool resizable) = 0;
...
#define NS_DECL_NSIDOMJSWINDOW \
  ...
  NS_SCRIPTABLE NS_IMETHOD SetResizable(bool resizable); \
...
#define NS_FORWARD_NSIDOMJSWINDOW(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD SetResizable(bool resizable) { return _to SetResizable(resizable); } \
...
#define NS_FORWARD_SAFE_NSIDOMJSWINDOW(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD SetResizable(bool resizable) { return !_to ? NS_ERROR_NULL_POINTER : _to->SetResizable(resizable); } \
