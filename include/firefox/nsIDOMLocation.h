/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM /jds/packages/BUILD/SUNWfirefox-10.0.2/firefox/dom/interfaces/base/nsIDOMLocation.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIDOMLocation : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD Reload(bool forceget) = 0;
...
#define NS_DECL_NSIDOMLOCATION \
  ...
  NS_SCRIPTABLE NS_IMETHOD Reload(bool forceget); \
...
#define NS_FORWARD_NSIDOMLOCATION(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD Reload(bool forceget) { return _to Reload(forceget); } \
...
#define NS_FORWARD_SAFE_NSIDOMLOCATION(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD Reload(bool forceget) { return !_to ? NS_ERROR_NULL_POINTER : _to->Reload(forceget); } \
