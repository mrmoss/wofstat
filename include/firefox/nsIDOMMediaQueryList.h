/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM /jds/packages/BUILD/SUNWfirefox-10.0.2/firefox/dom/interfaces/base/nsIDOMMediaQueryList.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIDOMMediaQueryList : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD GetMatches(bool *aMatches) = 0;
...
#define NS_DECL_NSIDOMMEDIAQUERYLIST \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetMatches(bool *aMatches); \
...
#define NS_FORWARD_NSIDOMMEDIAQUERYLIST(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetMatches(bool *aMatches) { return _to GetMatches(aMatches); } \
...
#define NS_FORWARD_SAFE_NSIDOMMEDIAQUERYLIST(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetMatches(bool *aMatches) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetMatches(aMatches); } \
