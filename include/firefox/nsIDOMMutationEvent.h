/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM /jds/packages/BUILD/SUNWfirefox-10.0.2/firefox/dom/interfaces/events/nsIDOMMutationEvent.idl
 */
...
#define NS_IDOMMUTATIONEVENT_IID_STR "72b3ddba-6cbb-4011-ac3b-50bd900b223d"

#define NS_IDOMMUTATIONEVENT_IID \
  {0x72b3ddba, 0x6cbb, 0x4011, \
    { 0xac, 0x3b, 0x50, 0xbd, 0x90, 0x0b, 0x22, 0x3d }}
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIDOMMutationEvent : public nsIDOMEvent {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD InitMutationEvent(const nsAString & typeArg, bool canBubbleArg, bool cancelableArg, nsIDOMNode *relatedNodeArg, const nsAString & prevValueArg, const nsAString & newValueArg, const nsAString & attrNameArg, PRUint16 attrChangeArg) = 0;
...
#define NS_DECL_NSIDOMMUTATIONEVENT \
  ...
  NS_SCRIPTABLE NS_IMETHOD InitMutationEvent(const nsAString & typeArg, bool canBubbleArg, bool cancelableArg, nsIDOMNode *relatedNodeArg, const nsAString & prevValueArg, const nsAString & newValueArg, const nsAString & attrNameArg, PRUint16 attrChangeArg); 
...
/* void initMutationEvent (in DOMString typeArg, in boolean canBubbleArg, in boolean cancelableArg, in nsIDOMNode relatedNodeArg, in DOMString prevValueArg, in DOMString newValueArg, in DOMString attrNameArg, in unsigned short attrChangeArg); */
NS_IMETHODIMP nsDOMMutationEvent::InitMutationEvent(const nsAString & typeArg, bool canBubbleArg, bool cancelableArg, nsIDOMNode *relatedNodeArg, const nsAString & prevValueArg, const nsAString & newValueArg, const nsAString & attrNameArg, PRUint16 attrChangeArg)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
