/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM /jds/packages/BUILD/SUNWfirefox-10.0.2/firefox/dom/interfaces/range/nsIDOMNSRange.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIDOMNSRange : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD IsPointInRange(nsIDOMNode *parent, PRInt32 offset, bool *_retval NS_OUTPARAM) = 0;
...
#define NS_DECL_NSIDOMNSRANGE \
  ...
  NS_SCRIPTABLE NS_IMETHOD IsPointInRange(nsIDOMNode *parent, PRInt32 offset, bool *_retval NS_OUTPARAM); \
...
#define NS_FORWARD_NSIDOMNSRANGE(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD IsPointInRange(nsIDOMNode *parent, PRInt32 offset, bool *_retval NS_OUTPARAM) { return _to IsPointInRange(parent, offset, _retval); } \
...
#define NS_FORWARD_SAFE_NSIDOMNSRANGE(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD IsPointInRange(nsIDOMNode *parent, PRInt32 offset, bool *_retval NS_OUTPARAM) { return !_to ? NS_ERROR_NULL_POINTER : _to->IsPointInRange(parent, offset, _retval); } \
...
/* boolean isPointInRange (in nsIDOMNode parent, in long offset); */
NS_IMETHODIMP nsDOMNSRange::IsPointInRange(nsIDOMNode *parent, PRInt32 offset, bool *_retval NS_OUTPARAM)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
