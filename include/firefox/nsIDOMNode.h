/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM /jds/packages/BUILD/SUNWfirefox-10.0.2/firefox/dom/interfaces/core/nsIDOMNode.idl
 */
...
#define NS_IDOMNODE_IID_STR "ce82fb71-60f2-4c38-be31-de5f2f90dada"

#define NS_IDOMNODE_IID \
  {0xce82fb71, 0x60f2, 0x4c38, \
    { 0xbe, 0x31, 0xde, 0x5f, 0x2f, 0x90, 0xda, 0xda }}
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIDOMNode : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD HasChildNodes(bool *_retval NS_OUTPARAM) = 0;

  /* nsIDOMNode cloneNode (in boolean deep); */
  NS_SCRIPTABLE NS_IMETHOD CloneNode(bool deep, nsIDOMNode * *_retval NS_OUTPARAM) = 0;

  /* void normalize (); */
  NS_SCRIPTABLE NS_IMETHOD Normalize(void) = 0;

  /* boolean isSupported (in DOMString feature, in DOMString version); */
  NS_SCRIPTABLE NS_IMETHOD IsSupported(const nsAString & feature, const nsAString & version, bool *_retval NS_OUTPARAM) = 0;
  ...
  NS_SCRIPTABLE NS_IMETHOD HasAttributes(bool *_retval NS_OUTPARAM) = 0;
  ...
  NS_SCRIPTABLE NS_IMETHOD IsDefaultNamespace(const nsAString & namespaceURI, bool *_retval NS_OUTPARAM) = 0;
  ...
  NS_SCRIPTABLE NS_IMETHOD IsEqualNode(nsIDOMNode *arg, bool *_retval NS_OUTPARAM) = 0;
  ...
  NS_SCRIPTABLE NS_IMETHOD Contains(nsIDOMNode *aOther, bool *_retval NS_OUTPARAM) = 0;
...
#define NS_DECL_NSIDOMNODE \
  ...
  NS_SCRIPTABLE NS_IMETHOD HasChildNodes(bool *_retval NS_OUTPARAM); \
  NS_SCRIPTABLE NS_IMETHOD CloneNode(bool deep, nsIDOMNode * *_retval NS_OUTPARAM); \
  NS_SCRIPTABLE NS_IMETHOD Normalize(void); \
  NS_SCRIPTABLE NS_IMETHOD IsSupported(const nsAString & feature, const nsAString & version, bool *_retval NS_OUTPARAM); \
  ...
  NS_SCRIPTABLE NS_IMETHOD HasAttributes(bool *_retval NS_OUTPARAM); \
  ...
  NS_SCRIPTABLE NS_IMETHOD IsDefaultNamespace(const nsAString & namespaceURI, bool *_retval NS_OUTPARAM); \
  NS_SCRIPTABLE NS_IMETHOD LookupNamespaceURI(const nsAString & prefix, nsAString & _retval NS_OUTPARAM); \
  NS_SCRIPTABLE NS_IMETHOD IsEqualNode(nsIDOMNode *arg, bool *_retval NS_OUTPARAM); \
  ...
  NS_SCRIPTABLE NS_IMETHOD Contains(nsIDOMNode *aOther, bool *_retval NS_OUTPARAM); 
...
#define NS_FORWARD_NSIDOMNODE(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD HasChildNodes(bool *_retval NS_OUTPARAM) { return _to HasChildNodes(_retval); } \
  NS_SCRIPTABLE NS_IMETHOD CloneNode(bool deep, nsIDOMNode * *_retval NS_OUTPARAM) { return _to CloneNode(deep, _retval); } \
  NS_SCRIPTABLE NS_IMETHOD Normalize(void) { return _to Normalize(); } \
  NS_SCRIPTABLE NS_IMETHOD IsSupported(const nsAString & feature, const nsAString & version, bool *_retval NS_OUTPARAM) { return _to IsSupported(feature, version, _retval); } \
  ...
  NS_SCRIPTABLE NS_IMETHOD HasAttributes(bool *_retval NS_OUTPARAM) { return _to HasAttributes(_retval); } \
  ...
  NS_SCRIPTABLE NS_IMETHOD IsDefaultNamespace(const nsAString & namespaceURI, bool *_retval NS_OUTPARAM) { return _to IsDefaultNamespace(namespaceURI, _retval); } \
  ...
  NS_SCRIPTABLE NS_IMETHOD IsEqualNode(nsIDOMNode *arg, bool *_retval NS_OUTPARAM) { return _to IsEqualNode(arg, _retval); } \
  ...
  NS_SCRIPTABLE NS_IMETHOD Contains(nsIDOMNode *aOther, bool *_retval NS_OUTPARAM) { return _to Contains(aOther, _retval); } 
...
#define NS_FORWARD_SAFE_NSIDOMNODE(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD HasChildNodes(bool *_retval NS_OUTPARAM) { return !_to ? NS_ERROR_NULL_POINTER : _to->HasChildNodes(_retval); } \
  NS_SCRIPTABLE NS_IMETHOD CloneNode(bool deep, nsIDOMNode * *_retval NS_OUTPARAM) { return !_to ? NS_ERROR_NULL_POINTER : _to->CloneNode(deep, _retval); } \
  NS_SCRIPTABLE NS_IMETHOD Normalize(void) { return !_to ? NS_ERROR_NULL_POINTER : _to->Normalize(); } \
  NS_SCRIPTABLE NS_IMETHOD IsSupported(const nsAString & feature, const nsAString & version, bool *_retval NS_OUTPARAM) { return !_to ? NS_ERROR_NULL_POINTER : _to->IsSupported(feature, version, _retval); } \
  ...
  NS_SCRIPTABLE NS_IMETHOD HasAttributes(bool *_retval NS_OUTPARAM) { return !_to ? NS_ERROR_NULL_POINTER : _to->HasAttributes(_retval); } \
  ...
  NS_SCRIPTABLE NS_IMETHOD IsDefaultNamespace(const nsAString & namespaceURI, bool *_retval NS_OUTPARAM) { return !_to ? NS_ERROR_NULL_POINTER : _to->IsDefaultNamespace(namespaceURI, _retval); } \
  ...
  NS_SCRIPTABLE NS_IMETHOD IsEqualNode(nsIDOMNode *arg, bool *_retval NS_OUTPARAM) { return !_to ? NS_ERROR_NULL_POINTER : _to->IsEqualNode(arg, _retval); } \
  ...
  NS_SCRIPTABLE NS_IMETHOD Contains(nsIDOMNode *aOther, bool *_retval NS_OUTPARAM) { return !_to ? NS_ERROR_NULL_POINTER : _to->Contains(aOther, _retval); } 
...
/* boolean hasChildNodes (); */
NS_IMETHODIMP nsDOMNode::HasChildNodes(bool *_retval NS_OUTPARAM)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}

/* nsIDOMNode cloneNode (in boolean deep); */
NS_IMETHODIMP nsDOMNode::CloneNode(bool deep, nsIDOMNode * *_retval NS_OUTPARAM)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
...
/* boolean isSupported (in DOMString feature, in DOMString version); */
NS_IMETHODIMP nsDOMNode::IsSupported(const nsAString & feature, const nsAString & version, bool *_retval NS_OUTPARAM)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
...
/* boolean hasAttributes (); */
NS_IMETHODIMP nsDOMNode::HasAttributes(bool *_retval NS_OUTPARAM)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
...
/* boolean isDefaultNamespace (in DOMString namespaceURI); */
NS_IMETHODIMP nsDOMNode::IsDefaultNamespace(const nsAString & namespaceURI, bool *_retval NS_OUTPARAM)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
...
/* boolean isEqualNode (in nsIDOMNode arg); */
NS_IMETHODIMP nsDOMNode::IsEqualNode(nsIDOMNode *arg, bool *_retval NS_OUTPARAM)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
...
/* boolean contains (in nsIDOMNode aOther); */
NS_IMETHODIMP nsDOMNode::Contains(nsIDOMNode *aOther, bool *_retval NS_OUTPARAM)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
