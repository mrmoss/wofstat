/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM /jds/packages/BUILD/SUNWfirefox-10.0.2/firefox/dom/interfaces/traversal/nsIDOMNodeIterator.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIDOMNodeIterator : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD GetExpandEntityReferences(bool *aExpandEntityReferences) = 0;
  ...
  NS_SCRIPTABLE NS_IMETHOD GetPointerBeforeReferenceNode(bool *aPointerBeforeReferenceNode) = 0;
...
#define NS_DECL_NSIDOMNODEITERATOR \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetExpandEntityReferences(bool *aExpandEntityReferences); \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetPointerBeforeReferenceNode(bool *aPointerBeforeReferenceNode); 
...
#define NS_FORWARD_NSIDOMNODEITERATOR(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetExpandEntityReferences(bool *aExpandEntityReferences) { return _to GetExpandEntityReferences(aExpandEntityReferences); } \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetPointerBeforeReferenceNode(bool *aPointerBeforeReferenceNode) { return _to GetPointerBeforeReferenceNode(aPointerBeforeReferenceNode); } 
...
#define NS_FORWARD_SAFE_NSIDOMNODEITERATOR(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetExpandEntityReferences(bool *aExpandEntityReferences) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetExpandEntityReferences(aExpandEntityReferences); } \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetPointerBeforeReferenceNode(bool *aPointerBeforeReferenceNode) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetPointerBeforeReferenceNode(aPointerBeforeReferenceNode); } 
...
/* readonly attribute boolean expandEntityReferences; */
NS_IMETHODIMP nsDOMNodeIterator::GetExpandEntityReferences(bool *aExpandEntityReferences)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
