/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM /jds/packages/BUILD/SUNWfirefox-10.0.2/firefox/dom/interfaces/offline/nsIDOMOfflineResourceList.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIDOMOfflineResourceList : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD MozHasItem(const nsAString & uri, bool *_retval NS_OUTPARAM) = 0;
...
#define NS_DECL_NSIDOMOFFLINERESOURCELIST \
  ...
  NS_SCRIPTABLE NS_IMETHOD MozHasItem(const nsAString & uri, bool *_retval NS_OUTPARAM); \
...
#define NS_FORWARD_NSIDOMOFFLINERESOURCELIST(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD MozHasItem(const nsAString & uri, bool *_retval NS_OUTPARAM) { return _to MozHasItem(uri, _retval); } \
...
#define NS_FORWARD_SAFE_NSIDOMOFFLINERESOURCELIST(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD MozHasItem(const nsAString & uri, bool *_retval NS_OUTPARAM) { return !_to ? NS_ERROR_NULL_POINTER : _to->MozHasItem(uri, _retval); } \
...
/* boolean mozHasItem (in DOMString uri); */
NS_IMETHODIMP nsDOMOfflineResourceList::MozHasItem(const nsAString & uri, bool *_retval NS_OUTPARAM)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
