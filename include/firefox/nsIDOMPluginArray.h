/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM /jds/packages/BUILD/SUNWfirefox-10.0.2/firefox/dom/interfaces/base/nsIDOMPluginArray.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIDOMPluginArray : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD Refresh(bool reloadDocuments) = 0;
...
#define NS_DECL_NSIDOMPLUGINARRAY \
  ...
  NS_SCRIPTABLE NS_IMETHOD Refresh(bool reloadDocuments); 
...
#define NS_FORWARD_NSIDOMPLUGINARRAY(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD Refresh(bool reloadDocuments) { return _to Refresh(reloadDocuments); } 
...
#define NS_FORWARD_SAFE_NSIDOMPLUGINARRAY(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD Refresh(bool reloadDocuments) { return !_to ? NS_ERROR_NULL_POINTER : _to->Refresh(reloadDocuments); } 
