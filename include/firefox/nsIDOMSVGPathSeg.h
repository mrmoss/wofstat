/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM /jds/packages/BUILD/SUNWfirefox-10.0.2/firefox/dom/interfaces/svg/nsIDOMSVGPathSeg.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIDOMSVGPathSegArcAbs : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD GetLargeArcFlag(bool *aLargeArcFlag) = 0;
  NS_SCRIPTABLE NS_IMETHOD SetLargeArcFlag(bool aLargeArcFlag) = 0;

  /* attribute boolean sweepFlag; */
  NS_SCRIPTABLE NS_IMETHOD GetSweepFlag(bool *aSweepFlag) = 0;
  NS_SCRIPTABLE NS_IMETHOD SetSweepFlag(bool aSweepFlag) = 0;
...
#define NS_DECL_NSIDOMSVGPATHSEGARCABS \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetLargeArcFlag(bool *aLargeArcFlag); \
  NS_SCRIPTABLE NS_IMETHOD SetLargeArcFlag(bool aLargeArcFlag); \
  NS_SCRIPTABLE NS_IMETHOD GetSweepFlag(bool *aSweepFlag); \
  NS_SCRIPTABLE NS_IMETHOD SetSweepFlag(bool aSweepFlag); 
...
#define NS_FORWARD_NSIDOMSVGPATHSEGARCABS(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetLargeArcFlag(bool *aLargeArcFlag) { return _to GetLargeArcFlag(aLargeArcFlag); } \
  NS_SCRIPTABLE NS_IMETHOD SetLargeArcFlag(bool aLargeArcFlag) { return _to SetLargeArcFlag(aLargeArcFlag); } \
  NS_SCRIPTABLE NS_IMETHOD GetSweepFlag(bool *aSweepFlag) { return _to GetSweepFlag(aSweepFlag); } \
  NS_SCRIPTABLE NS_IMETHOD SetSweepFlag(bool aSweepFlag) { return _to SetSweepFlag(aSweepFlag); } 
...
#define NS_FORWARD_SAFE_NSIDOMSVGPATHSEGARCABS(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetLargeArcFlag(bool *aLargeArcFlag) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetLargeArcFlag(aLargeArcFlag); } \
  NS_SCRIPTABLE NS_IMETHOD SetLargeArcFlag(bool aLargeArcFlag) { return !_to ? NS_ERROR_NULL_POINTER : _to->SetLargeArcFlag(aLargeArcFlag); } \
  NS_SCRIPTABLE NS_IMETHOD GetSweepFlag(bool *aSweepFlag) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetSweepFlag(aSweepFlag); } \
  NS_SCRIPTABLE NS_IMETHOD SetSweepFlag(bool aSweepFlag) { return !_to ? NS_ERROR_NULL_POINTER : _to->SetSweepFlag(aSweepFlag); } 
...
/* attribute boolean largeArcFlag; */
NS_IMETHODIMP nsDOMSVGPathSegArcAbs::GetLargeArcFlag(bool *aLargeArcFlag)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
NS_IMETHODIMP nsDOMSVGPathSegArcAbs::SetLargeArcFlag(bool aLargeArcFlag)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}

/* attribute boolean sweepFlag; */
NS_IMETHODIMP nsDOMSVGPathSegArcAbs::GetSweepFlag(bool *aSweepFlag)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
NS_IMETHODIMP nsDOMSVGPathSegArcAbs::SetSweepFlag(bool aSweepFlag)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
...
/* attribute boolean largeArcFlag; */
NS_IMETHODIMP nsDOMSVGPathSegArcRel::GetLargeArcFlag(bool *aLargeArcFlag)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
NS_IMETHODIMP nsDOMSVGPathSegArcRel::SetLargeArcFlag(bool aLargeArcFlag)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}

/* attribute boolean sweepFlag; */
NS_IMETHODIMP nsDOMSVGPathSegArcRel::GetSweepFlag(bool *aSweepFlag)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
NS_IMETHODIMP nsDOMSVGPathSegArcRel::SetSweepFlag(bool aSweepFlag)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
