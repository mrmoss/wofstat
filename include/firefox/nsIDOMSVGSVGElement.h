/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM /jds/packages/BUILD/SUNWfirefox-10.0.2/firefox/dom/interfaces/svg/nsIDOMSVGSVGElement.idl
 */
...
#define NS_IDOMSVGSVGELEMENT_IID_STR "e7ff88bd-26f8-4f2e-b01c-4e7b80d45117"

#define NS_IDOMSVGSVGELEMENT_IID \
  {0xe7ff88bd, 0x26f8, 0x4f2e, \
    { 0xb0, 0x1c, 0x4e, 0x7b, 0x80, 0xd4, 0x51, 0x17 }}
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIDOMSVGSVGElement : public nsIDOMSVGElement {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD GetUseCurrentView(bool *aUseCurrentView) = 0;
  NS_SCRIPTABLE NS_IMETHOD SetUseCurrentView(bool aUseCurrentView) = 0;
  ...
  NS_SCRIPTABLE NS_IMETHOD AnimationsPaused(bool *_retval NS_OUTPARAM) = 0;
  ...
  NS_SCRIPTABLE NS_IMETHOD CheckIntersection(nsIDOMSVGElement *element, nsIDOMSVGRect *rect, bool *_retval NS_OUTPARAM) = 0;

  /* boolean checkEnclosure (in nsIDOMSVGElement element, in nsIDOMSVGRect rect); */
  NS_SCRIPTABLE NS_IMETHOD CheckEnclosure(nsIDOMSVGElement *element, nsIDOMSVGRect *rect, bool *_retval NS_OUTPARAM) = 0;
...
#define NS_DECL_NSIDOMSVGSVGELEMENT \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetUseCurrentView(bool *aUseCurrentView); \
  NS_SCRIPTABLE NS_IMETHOD SetUseCurrentView(bool aUseCurrentView); \
  ...
  NS_SCRIPTABLE NS_IMETHOD AnimationsPaused(bool *_retval NS_OUTPARAM); \
  ...
  NS_SCRIPTABLE NS_IMETHOD CheckIntersection(nsIDOMSVGElement *element, nsIDOMSVGRect *rect, bool *_retval NS_OUTPARAM); \
  NS_SCRIPTABLE NS_IMETHOD CheckEnclosure(nsIDOMSVGElement *element, nsIDOMSVGRect *rect, bool *_retval NS_OUTPARAM); \
...
#define NS_FORWARD_NSIDOMSVGSVGELEMENT(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetUseCurrentView(bool *aUseCurrentView) { return _to GetUseCurrentView(aUseCurrentView); } \
  NS_SCRIPTABLE NS_IMETHOD SetUseCurrentView(bool aUseCurrentView) { return _to SetUseCurrentView(aUseCurrentView); } \
  ...
  NS_SCRIPTABLE NS_IMETHOD AnimationsPaused(bool *_retval NS_OUTPARAM) { return _to AnimationsPaused(_retval); } \
  ...
  NS_SCRIPTABLE NS_IMETHOD CheckIntersection(nsIDOMSVGElement *element, nsIDOMSVGRect *rect, bool *_retval NS_OUTPARAM) { return _to CheckIntersection(element, rect, _retval); } \
  NS_SCRIPTABLE NS_IMETHOD CheckEnclosure(nsIDOMSVGElement *element, nsIDOMSVGRect *rect, bool *_retval NS_OUTPARAM) { return _to CheckEnclosure(element, rect, _retval); } \
...
#define NS_FORWARD_SAFE_NSIDOMSVGSVGELEMENT(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetUseCurrentView(bool *aUseCurrentView) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetUseCurrentView(aUseCurrentView); } \
  NS_SCRIPTABLE NS_IMETHOD SetUseCurrentView(bool aUseCurrentView) { return !_to ? NS_ERROR_NULL_POINTER : _to->SetUseCurrentView(aUseCurrentView); } \
  ...
  NS_SCRIPTABLE NS_IMETHOD AnimationsPaused(bool *_retval NS_OUTPARAM) { return !_to ? NS_ERROR_NULL_POINTER : _to->AnimationsPaused(_retval); } \
  ...
  NS_SCRIPTABLE NS_IMETHOD CheckIntersection(nsIDOMSVGElement *element, nsIDOMSVGRect *rect, bool *_retval NS_OUTPARAM) { return !_to ? NS_ERROR_NULL_POINTER : _to->CheckIntersection(element, rect, _retval); } \
  NS_SCRIPTABLE NS_IMETHOD CheckEnclosure(nsIDOMSVGElement *element, nsIDOMSVGRect *rect, bool *_retval NS_OUTPARAM) { return !_to ? NS_ERROR_NULL_POINTER : _to->CheckEnclosure(element, rect, _retval); } \
...
NS_IMETHODIMP nsDOMSVGSVGElement::SetUseCurrentView(bool aUseCurrentView)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
...
/* boolean animationsPaused (); */
NS_IMETHODIMP nsDOMSVGSVGElement::AnimationsPaused(bool *_retval NS_OUTPARAM)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
...
/* boolean checkIntersection (in nsIDOMSVGElement element, in nsIDOMSVGRect rect); */
NS_IMETHODIMP nsDOMSVGSVGElement::CheckIntersection(nsIDOMSVGElement *element, nsIDOMSVGRect *rect, bool *_retval NS_OUTPARAM)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}

/* boolean checkEnclosure (in nsIDOMSVGElement element, in nsIDOMSVGRect rect); */
NS_IMETHODIMP nsDOMSVGSVGElement::CheckEnclosure(nsIDOMSVGElement *element, nsIDOMSVGRect *rect, bool *_retval NS_OUTPARAM)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
