/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM /jds/packages/BUILD/SUNWfirefox-10.0.2/firefox/dom/interfaces/storage/nsIDOMStorageItem.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIDOMStorageItem : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD GetSecure(bool *aSecure) = 0;
  NS_SCRIPTABLE NS_IMETHOD SetSecure(bool aSecure) = 0;
...
#define NS_DECL_NSIDOMSTORAGEITEM \
  NS_SCRIPTABLE NS_IMETHOD GetSecure(bool *aSecure); \
  NS_SCRIPTABLE NS_IMETHOD SetSecure(bool aSecure); \
...
#define NS_FORWARD_NSIDOMSTORAGEITEM(_to) \
  NS_SCRIPTABLE NS_IMETHOD GetSecure(bool *aSecure) { return _to GetSecure(aSecure); } \
  NS_SCRIPTABLE NS_IMETHOD SetSecure(bool aSecure) { return _to SetSecure(aSecure); } \
...
#define NS_FORWARD_SAFE_NSIDOMSTORAGEITEM(_to) \
  NS_SCRIPTABLE NS_IMETHOD GetSecure(bool *aSecure) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetSecure(aSecure); } \
  NS_SCRIPTABLE NS_IMETHOD SetSecure(bool aSecure) { return !_to ? NS_ERROR_NULL_POINTER : _to->SetSecure(aSecure); } \
