/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM /jds/packages/BUILD/SUNWfirefox-10.0.2/firefox/dom/interfaces/events/nsIDOMTouchEvent.idl
 */
...
#define NS_IDOMTOUCHEVENT_IID_STR "0cc687df-0ed5-4b7f-b89d-cbb99b21d23a"

#define NS_IDOMTOUCHEVENT_IID \
  {0x0cc687df, 0x0ed5, 0x4b7f, \
    { 0xb8, 0x9d, 0xcb, 0xb9, 0x9b, 0x21, 0xd2, 0x3a }}
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIDOMTouchEvent : public nsIDOMUIEvent {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD InitTouchEvent(const nsAString & type, bool canBubble, bool cancelable, nsIDOMWindow *view, PRInt32 detail, bool ctrlKey, bool altKey, bool shiftKey, bool metaKey, nsIDOMTouchList *touches, nsIDOMTouchList *targetTouches, nsIDOMTouchList *changedTouches) = 0;
...
#define NS_DECL_NSIDOMTOUCHEVENT \
  ...
  NS_SCRIPTABLE NS_IMETHOD InitTouchEvent(const nsAString & type, bool canBubble, bool cancelable, nsIDOMWindow *view, PRInt32 detail, bool ctrlKey, bool altKey, bool shiftKey, bool metaKey, nsIDOMTouchList *touches, nsIDOMTouchList *targetTouches, nsIDOMTouchList *changedTouches); 
...
/* void initTouchEvent (in DOMString type, in boolean canBubble, in boolean cancelable, in nsIDOMWindow view, in long detail, in boolean ctrlKey, in boolean altKey, in boolean shiftKey, in boolean metaKey, in nsIDOMTouchList touches, in nsIDOMTouchList targetTouches, in nsIDOMTouchList changedTouches); */
NS_IMETHODIMP nsDOMTouchEvent::InitTouchEvent(const nsAString & type, bool canBubble, bool cancelable, nsIDOMWindow *view, PRInt32 detail, bool ctrlKey, bool altKey, bool shiftKey, bool metaKey, nsIDOMTouchList *touches, nsIDOMTouchList *targetTouches, nsIDOMTouchList *changedTouches)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
