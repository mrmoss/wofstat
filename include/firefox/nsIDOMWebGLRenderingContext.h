/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM /jds/packages/BUILD/SUNWfirefox-10.0.2/firefox/dom/interfaces/canvas/nsIDOMWebGLRenderingContext.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIWebGLExtensionStandardDerivatives : public nsIWebGLExtension {
 public: 
  ...
  enum { FRAGMENT_SHADER_DERIVATIVE_HINT_OES = 35723U };
