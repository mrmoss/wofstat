/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM /jds/packages/BUILD/SUNWfirefox-10.0.2/firefox/dom/interfaces/xpath/nsIDOMXPathResult.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIDOMXPathResult : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD GetInvalidIteratorState(bool *aInvalidIteratorState) = 0;
...
#define NS_DECL_NSIDOMXPATHRESULT \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetInvalidIteratorState(bool *aInvalidIteratorState); \
...
#define NS_FORWARD_NSIDOMXPATHRESULT(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetInvalidIteratorState(bool *aInvalidIteratorState) { return _to GetInvalidIteratorState(aInvalidIteratorState); } \
...
#define NS_FORWARD_SAFE_NSIDOMXPATHRESULT(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetInvalidIteratorState(bool *aInvalidIteratorState) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetInvalidIteratorState(aInvalidIteratorState); } \
