/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM /jds/packages/BUILD/SUNWfirefox-10.0.2/firefox/dom/interfaces/xul/nsIDOMXULCommandDispatcher.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIDOMXULCommandDispatcher : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD GetSuppressFocusScroll(bool *aSuppressFocusScroll) = 0;
  NS_SCRIPTABLE NS_IMETHOD SetSuppressFocusScroll(bool aSuppressFocusScroll) = 0;
...
#define NS_DECL_NSIDOMXULCOMMANDDISPATCHER \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetSuppressFocusScroll(bool *aSuppressFocusScroll); \
  NS_SCRIPTABLE NS_IMETHOD SetSuppressFocusScroll(bool aSuppressFocusScroll); 
...
#define NS_FORWARD_NSIDOMXULCOMMANDDISPATCHER(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetSuppressFocusScroll(bool *aSuppressFocusScroll) { return _to GetSuppressFocusScroll(aSuppressFocusScroll); } \
  NS_SCRIPTABLE NS_IMETHOD SetSuppressFocusScroll(bool aSuppressFocusScroll) { return _to SetSuppressFocusScroll(aSuppressFocusScroll); } 
...
#define NS_FORWARD_SAFE_NSIDOMXULCOMMANDDISPATCHER(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetSuppressFocusScroll(bool *aSuppressFocusScroll) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetSuppressFocusScroll(aSuppressFocusScroll); } \
  NS_SCRIPTABLE NS_IMETHOD SetSuppressFocusScroll(bool aSuppressFocusScroll) { return !_to ? NS_ERROR_NULL_POINTER : _to->SetSuppressFocusScroll(aSuppressFocusScroll); } 
