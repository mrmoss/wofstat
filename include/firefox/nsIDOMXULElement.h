/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM /jds/packages/BUILD/SUNWfirefox-10.0.2/firefox/dom/interfaces/xul/nsIDOMXULElement.idl
 */
...
#define NS_IDOMXULELEMENT_IID_STR "a98a4472-a549-4b84-b9ea-e6eb679228dd"

#define NS_IDOMXULELEMENT_IID \
  {0xa98a4472, 0xa549, 0x4b84, \
    { 0xb9, 0xea, 0xe6, 0xeb, 0x67, 0x92, 0x28, 0xdd }}
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIDOMXULElement : public nsIDOMElement {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD SetCollapsed(bool aCollapsed) = 0;
  ...
  NS_SCRIPTABLE NS_IMETHOD GetAllowEvents(bool *aAllowEvents) = 0;
  NS_SCRIPTABLE NS_IMETHOD SetAllowEvents(bool aAllowEvents) = 0;
...
#define NS_DECL_NSIDOMXULELEMENT \
  ...
  NS_SCRIPTABLE NS_IMETHOD SetCollapsed(bool aCollapsed); \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetAllowEvents(bool *aAllowEvents); \
  NS_SCRIPTABLE NS_IMETHOD SetAllowEvents(bool aAllowEvents); \
...
#define NS_FORWARD_NSIDOMXULELEMENT(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD SetCollapsed(bool aCollapsed) { return _to SetCollapsed(aCollapsed); } \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetAllowEvents(bool *aAllowEvents) { return _to GetAllowEvents(aAllowEvents); } \
  NS_SCRIPTABLE NS_IMETHOD SetAllowEvents(bool aAllowEvents) { return _to SetAllowEvents(aAllowEvents); } \
...
#define NS_FORWARD_SAFE_NSIDOMXULELEMENT(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD SetCollapsed(bool aCollapsed) { return !_to ? NS_ERROR_NULL_POINTER : _to->SetCollapsed(aCollapsed); } \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetAllowEvents(bool *aAllowEvents) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetAllowEvents(aAllowEvents); } \
  NS_SCRIPTABLE NS_IMETHOD SetAllowEvents(bool aAllowEvents) { return !_to ? NS_ERROR_NULL_POINTER : _to->SetAllowEvents(aAllowEvents); } \
