/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM /jds/packages/BUILD/SUNWfirefox-10.0.2/firefox/xpcom/base/nsIDebug2.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIDebug2 : public nsIDebug {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD GetIsDebugBuild(bool *aIsDebugBuild) = 0;
...
#define NS_DECL_NSIDEBUG2 \
  NS_SCRIPTABLE NS_IMETHOD GetIsDebugBuild(bool *aIsDebugBuild); \
  NS_SCRIPTABLE NS_IMETHOD GetAssertionCount(PRInt32 *aAssertionCount); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSIDEBUG2(_to) \
  NS_SCRIPTABLE NS_IMETHOD GetIsDebugBuild(bool *aIsDebugBuild) { return _to GetIsDebugBuild(aIsDebugBuild); } \
...
#define NS_FORWARD_SAFE_NSIDEBUG2(_to) \
  NS_SCRIPTABLE NS_IMETHOD GetIsDebugBuild(bool *aIsDebugBuild) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetIsDebugBuild(aIsDebugBuild); } \
