/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM /jds/packages/BUILD/SUNWfirefox-10.0.2/firefox/docshell/base/nsIDocShellTreeItem.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIDocShellTreeItem : public nsIDocShellTreeNode {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD NameEquals(const PRUnichar * name, bool *_retval NS_OUTPARAM) = 0;
...
#define NS_DECL_NSIDOCSHELLTREEITEM \
  ...
  NS_SCRIPTABLE NS_IMETHOD NameEquals(const PRUnichar * name, bool *_retval NS_OUTPARAM); \
...
#define NS_FORWARD_NSIDOCSHELLTREEITEM(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD NameEquals(const PRUnichar * name, bool *_retval NS_OUTPARAM) { return _to NameEquals(name, _retval); } \
...
#define NS_FORWARD_SAFE_NSIDOCSHELLTREEITEM(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD NameEquals(const PRUnichar * name, bool *_retval NS_OUTPARAM) { return !_to ? NS_ERROR_NULL_POINTER : _to->NameEquals(name, _retval); } \
...
/* boolean nameEquals (in wstring name); */
NS_IMETHODIMP nsDocShellTreeItem::NameEquals(const PRUnichar * name, bool *_retval NS_OUTPARAM)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
