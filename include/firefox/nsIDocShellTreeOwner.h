/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM /jds/packages/BUILD/SUNWfirefox-10.0.2/firefox/docshell/base/nsIDocShellTreeOwner.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIDocShellTreeOwner : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD ContentShellAdded(nsIDocShellTreeItem *aContentShell, bool aPrimary, bool aTargetable, const nsAString & aID) = 0;
  ...
  NS_SCRIPTABLE NS_IMETHOD SetPersistence(bool aPersistPosition, bool aPersistSize, bool aPersistSizeMode) = 0;

  /* void getPersistence (out boolean aPersistPosition, out boolean aPersistSize, out boolean aPersistSizeMode); */
  NS_SCRIPTABLE NS_IMETHOD GetPersistence(bool *aPersistPosition NS_OUTPARAM, bool *aPersistSize NS_OUTPARAM, bool *aPersistSizeMode NS_OUTPARAM) = 0;
...
#define NS_DECL_NSIDOCSHELLTREEOWNER \
  ...
  NS_SCRIPTABLE NS_IMETHOD ContentShellAdded(nsIDocShellTreeItem *aContentShell, bool aPrimary, bool aTargetable, const nsAString & aID); \
  ...
  NS_SCRIPTABLE NS_IMETHOD SetPersistence(bool aPersistPosition, bool aPersistSize, bool aPersistSizeMode); \
  NS_SCRIPTABLE NS_IMETHOD GetPersistence(bool *aPersistPosition NS_OUTPARAM, bool *aPersistSize NS_OUTPARAM, bool *aPersistSizeMode NS_OUTPARAM); \
...
#define NS_FORWARD_NSIDOCSHELLTREEOWNER(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD ContentShellAdded(nsIDocShellTreeItem *aContentShell, bool aPrimary, bool aTargetable, const nsAString & aID) { return _to ContentShellAdded(aContentShell, aPrimary, aTargetable, aID); } \
  ...
  NS_SCRIPTABLE NS_IMETHOD SetPersistence(bool aPersistPosition, bool aPersistSize, bool aPersistSizeMode) { return _to SetPersistence(aPersistPosition, aPersistSize, aPersistSizeMode); } \
  NS_SCRIPTABLE NS_IMETHOD GetPersistence(bool *aPersistPosition NS_OUTPARAM, bool *aPersistSize NS_OUTPARAM, bool *aPersistSizeMode NS_OUTPARAM) { return _to GetPersistence(aPersistPosition, aPersistSize, aPersistSizeMode); } \
...
#define NS_FORWARD_SAFE_NSIDOCSHELLTREEOWNER(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD ContentShellAdded(nsIDocShellTreeItem *aContentShell, bool aPrimary, bool aTargetable, const nsAString & aID) { return !_to ? NS_ERROR_NULL_POINTER : _to->ContentShellAdded(aContentShell, aPrimary, aTargetable, aID); } \
  ...
  NS_SCRIPTABLE NS_IMETHOD SetPersistence(bool aPersistPosition, bool aPersistSize, bool aPersistSizeMode) { return !_to ? NS_ERROR_NULL_POINTER : _to->SetPersistence(aPersistPosition, aPersistSize, aPersistSizeMode); } \
  NS_SCRIPTABLE NS_IMETHOD GetPersistence(bool *aPersistPosition NS_OUTPARAM, bool *aPersistSize NS_OUTPARAM, bool *aPersistSizeMode NS_OUTPARAM) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetPersistence(aPersistPosition, aPersistSize, aPersistSizeMode); } \
...
/* void getPersistence (out boolean aPersistPosition, out boolean aPersistSize, out boolean aPersistSizeMode); */
NS_IMETHODIMP nsDocShellTreeOwner::GetPersistence(bool *aPersistPosition NS_OUTPARAM, bool *aPersistSize NS_OUTPARAM, bool *aPersistSizeMode NS_OUTPARAM)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
