/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM /jds/packages/BUILD/SUNWfirefox-10.0.2/firefox/intl/chardet/public/nsIDocumentCharsetInfo.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIDocumentCharsetInfo : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD GetForcedDetector(bool *aForcedDetector) = 0;
  NS_SCRIPTABLE NS_IMETHOD SetForcedDetector(bool aForcedDetector) = 0;
...
#define NS_DECL_NSIDOCUMENTCHARSETINFO \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetForcedDetector(bool *aForcedDetector); \
  NS_SCRIPTABLE NS_IMETHOD SetForcedDetector(bool aForcedDetector); \
...
#define NS_FORWARD_NSIDOCUMENTCHARSETINFO(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetForcedDetector(bool *aForcedDetector) { return _to GetForcedDetector(aForcedDetector); } \
  NS_SCRIPTABLE NS_IMETHOD SetForcedDetector(bool aForcedDetector) { return _to SetForcedDetector(aForcedDetector); } \
...
#define NS_FORWARD_SAFE_NSIDOCUMENTCHARSETINFO(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetForcedDetector(bool *aForcedDetector) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetForcedDetector(aForcedDetector); } \
  NS_SCRIPTABLE NS_IMETHOD SetForcedDetector(bool aForcedDetector) { return !_to ? NS_ERROR_NULL_POINTER : _to->SetForcedDetector(aForcedDetector); } \
...
/* attribute boolean forcedDetector; */
NS_IMETHODIMP nsDocumentCharsetInfo::GetForcedDetector(bool *aForcedDetector)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
NS_IMETHODIMP nsDocumentCharsetInfo::SetForcedDetector(bool aForcedDetector)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
