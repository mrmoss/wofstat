/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM /jds/packages/BUILD/SUNWfirefox-10.0.2/firefox/editor/idl/nsIDocumentStateListener.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIDocumentStateListener : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD NotifyDocumentStateChanged(bool nowDirty) = 0;
...
#define NS_DECL_NSIDOCUMENTSTATELISTENER \
  ...
  NS_SCRIPTABLE NS_IMETHOD NotifyDocumentStateChanged(bool nowDirty); 
...
#define NS_FORWARD_NSIDOCUMENTSTATELISTENER(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD NotifyDocumentStateChanged(bool nowDirty) { return _to NotifyDocumentStateChanged(nowDirty); } 
...
#define NS_FORWARD_SAFE_NSIDOCUMENTSTATELISTENER(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD NotifyDocumentStateChanged(bool nowDirty) { return !_to ? NS_ERROR_NULL_POINTER : _to->NotifyDocumentStateChanged(nowDirty); } 
