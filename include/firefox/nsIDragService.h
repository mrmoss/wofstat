/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM /jds/packages/BUILD/SUNWfirefox-10.0.2/firefox/widget/public/nsIDragService.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIDragService : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD EndDragSession(bool aDoneDrag) = 0;
...
#define NS_DECL_NSIDRAGSERVICE \
  ...
  NS_SCRIPTABLE NS_IMETHOD EndDragSession(bool aDoneDrag); \
...
#define NS_FORWARD_NSIDRAGSERVICE(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD EndDragSession(bool aDoneDrag) { return _to EndDragSession(aDoneDrag); } \
...
#define NS_FORWARD_SAFE_NSIDRAGSERVICE(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD EndDragSession(bool aDoneDrag) { return !_to ? NS_ERROR_NULL_POINTER : _to->EndDragSession(aDoneDrag); } \
