/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM /jds/packages/BUILD/SUNWfirefox-10.0.2/firefox/widget/public/nsIDragSession.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIDragSession : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD GetCanDrop(bool *aCanDrop) = 0;
  NS_SCRIPTABLE NS_IMETHOD SetCanDrop(bool aCanDrop) = 0;

  /* attribute boolean onlyChromeDrop; */
  NS_SCRIPTABLE NS_IMETHOD GetOnlyChromeDrop(bool *aOnlyChromeDrop) = 0;
  NS_SCRIPTABLE NS_IMETHOD SetOnlyChromeDrop(bool aOnlyChromeDrop) = 0;
  ...
  NS_SCRIPTABLE NS_IMETHOD IsDataFlavorSupported(const char * aDataFlavor, bool *_retval NS_OUTPARAM) = 0;
...
#define NS_DECL_NSIDRAGSESSION \
  NS_SCRIPTABLE NS_IMETHOD GetCanDrop(bool *aCanDrop); \
  NS_SCRIPTABLE NS_IMETHOD SetCanDrop(bool aCanDrop); \
  NS_SCRIPTABLE NS_IMETHOD GetOnlyChromeDrop(bool *aOnlyChromeDrop); \
  NS_SCRIPTABLE NS_IMETHOD SetOnlyChromeDrop(bool aOnlyChromeDrop); \
  ...
  NS_SCRIPTABLE NS_IMETHOD IsDataFlavorSupported(const char * aDataFlavor, bool *_retval NS_OUTPARAM); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSIDRAGSESSION(_to) \
  NS_SCRIPTABLE NS_IMETHOD GetCanDrop(bool *aCanDrop) { return _to GetCanDrop(aCanDrop); } \
  NS_SCRIPTABLE NS_IMETHOD SetCanDrop(bool aCanDrop) { return _to SetCanDrop(aCanDrop); } \
  NS_SCRIPTABLE NS_IMETHOD GetOnlyChromeDrop(bool *aOnlyChromeDrop) { return _to GetOnlyChromeDrop(aOnlyChromeDrop); } \
  NS_SCRIPTABLE NS_IMETHOD SetOnlyChromeDrop(bool aOnlyChromeDrop) { return _to SetOnlyChromeDrop(aOnlyChromeDrop); } \
  ...
  NS_SCRIPTABLE NS_IMETHOD IsDataFlavorSupported(const char * aDataFlavor, bool *_retval NS_OUTPARAM) { return _to IsDataFlavorSupported(aDataFlavor, _retval); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_NSIDRAGSESSION(_to) \
  NS_SCRIPTABLE NS_IMETHOD GetCanDrop(bool *aCanDrop) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetCanDrop(aCanDrop); } \
  NS_SCRIPTABLE NS_IMETHOD SetCanDrop(bool aCanDrop) { return !_to ? NS_ERROR_NULL_POINTER : _to->SetCanDrop(aCanDrop); } \
  NS_SCRIPTABLE NS_IMETHOD GetOnlyChromeDrop(bool *aOnlyChromeDrop) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetOnlyChromeDrop(aOnlyChromeDrop); } \
  NS_SCRIPTABLE NS_IMETHOD SetOnlyChromeDrop(bool aOnlyChromeDrop) { return !_to ? NS_ERROR_NULL_POINTER : _to->SetOnlyChromeDrop(aOnlyChromeDrop); } \
  ...
  NS_SCRIPTABLE NS_IMETHOD IsDataFlavorSupported(const char * aDataFlavor, bool *_retval NS_OUTPARAM) { return !_to ? NS_ERROR_NULL_POINTER : _to->IsDataFlavorSupported(aDataFlavor, _retval); } 
...
/* boolean isDataFlavorSupported (in string aDataFlavor); */
NS_IMETHODIMP nsDragSession::IsDataFlavorSupported(const char * aDataFlavor, bool *_retval NS_OUTPARAM)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
