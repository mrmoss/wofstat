/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM /jds/packages/BUILD/SUNWfirefox-10.0.2/firefox/editor/composer/public/nsIEditingSession.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIEditingSession : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD MakeWindowEditable(nsIDOMWindow *window, const char * aEditorType, bool doAfterUriLoad, bool aMakeWholeDocumentEditable, bool aInteractive) = 0;

  /* boolean windowIsEditable (in nsIDOMWindow window); */
  NS_SCRIPTABLE NS_IMETHOD WindowIsEditable(nsIDOMWindow *window, bool *_retval NS_OUTPARAM) = 0;
  ...
  NS_SCRIPTABLE NS_IMETHOD GetJsAndPluginsDisabled(bool *aJsAndPluginsDisabled) = 0;
...
#define NS_DECL_NSIEDITINGSESSION \
  ...
  NS_SCRIPTABLE NS_IMETHOD MakeWindowEditable(nsIDOMWindow *window, const char * aEditorType, bool doAfterUriLoad, bool aMakeWholeDocumentEditable, bool aInteractive); \
  NS_SCRIPTABLE NS_IMETHOD WindowIsEditable(nsIDOMWindow *window, bool *_retval NS_OUTPARAM); \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetJsAndPluginsDisabled(bool *aJsAndPluginsDisabled); 
...
#define NS_FORWARD_NSIEDITINGSESSION(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD MakeWindowEditable(nsIDOMWindow *window, const char * aEditorType, bool doAfterUriLoad, bool aMakeWholeDocumentEditable, bool aInteractive) { return _to MakeWindowEditable(window, aEditorType, doAfterUriLoad, aMakeWholeDocumentEditable, aInteractive); } \
  NS_SCRIPTABLE NS_IMETHOD WindowIsEditable(nsIDOMWindow *window, bool *_retval NS_OUTPARAM) { return _to WindowIsEditable(window, _retval); } \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetJsAndPluginsDisabled(bool *aJsAndPluginsDisabled) { return _to GetJsAndPluginsDisabled(aJsAndPluginsDisabled); } 
...
#define NS_FORWARD_SAFE_NSIEDITINGSESSION(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD MakeWindowEditable(nsIDOMWindow *window, const char * aEditorType, bool doAfterUriLoad, bool aMakeWholeDocumentEditable, bool aInteractive) { return !_to ? NS_ERROR_NULL_POINTER : _to->MakeWindowEditable(window, aEditorType, doAfterUriLoad, aMakeWholeDocumentEditable, aInteractive); } \
  NS_SCRIPTABLE NS_IMETHOD WindowIsEditable(nsIDOMWindow *window, bool *_retval NS_OUTPARAM) { return !_to ? NS_ERROR_NULL_POINTER : _to->WindowIsEditable(window, _retval); } \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetJsAndPluginsDisabled(bool *aJsAndPluginsDisabled) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetJsAndPluginsDisabled(aJsAndPluginsDisabled); } 
...
/* boolean windowIsEditable (in nsIDOMWindow window); */
NS_IMETHODIMP nsEditingSession::WindowIsEditable(nsIDOMWindow *window, bool *_retval NS_OUTPARAM)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
