/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM /jds/packages/BUILD/SUNWfirefox-10.0.2/firefox/docshell/base/nsIEditorDocShell.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIEditorDocShell : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD GetHasEditingSession(bool *aHasEditingSession) = 0;

  /* void makeEditable (in boolean inWaitForUriLoad); */
  NS_SCRIPTABLE NS_IMETHOD MakeEditable(bool inWaitForUriLoad) = 0;
...
#define NS_DECL_NSIEDITORDOCSHELL \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetHasEditingSession(bool *aHasEditingSession); \
  NS_SCRIPTABLE NS_IMETHOD MakeEditable(bool inWaitForUriLoad); 
...
#define NS_FORWARD_NSIEDITORDOCSHELL(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetHasEditingSession(bool *aHasEditingSession) { return _to GetHasEditingSession(aHasEditingSession); } \
  NS_SCRIPTABLE NS_IMETHOD MakeEditable(bool inWaitForUriLoad) { return _to MakeEditable(inWaitForUriLoad); } 
...
#define NS_FORWARD_SAFE_NSIEDITORDOCSHELL(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetHasEditingSession(bool *aHasEditingSession) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetHasEditingSession(aHasEditingSession); } \
  NS_SCRIPTABLE NS_IMETHOD MakeEditable(bool inWaitForUriLoad) { return !_to ? NS_ERROR_NULL_POINTER : _to->MakeEditable(inWaitForUriLoad); } 
...
/* readonly attribute boolean editable; */
NS_IMETHODIMP nsEditorDocShell::GetEditable(bool *aEditable)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}

/* readonly attribute boolean hasEditingSession; */
NS_IMETHODIMP nsEditorDocShell::GetHasEditingSession(bool *aHasEditingSession)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}

/* void makeEditable (in boolean inWaitForUriLoad); */
NS_IMETHODIMP nsEditorDocShell::MakeEditable(bool inWaitForUriLoad)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
