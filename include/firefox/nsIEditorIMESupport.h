/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM /jds/packages/BUILD/SUNWfirefox-10.0.2/firefox/editor/idl/nsIEditorIMESupport.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIEditorIMESupport : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD GetComposing(bool *aComposing) = 0;
...
#define NS_DECL_NSIEDITORIMESUPPORT \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetComposing(bool *aComposing); 
...
#define NS_FORWARD_NSIEDITORIMESUPPORT(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetComposing(bool *aComposing) { return _to GetComposing(aComposing); } 
...
#define NS_FORWARD_SAFE_NSIEDITORIMESUPPORT(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetComposing(bool *aComposing) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetComposing(aComposing); } 
