/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM /jds/packages/BUILD/SUNWfirefox-10.0.2/firefox/editor/idl/nsIEditorStyleSheets.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIEditorStyleSheets : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD EnableStyleSheet(const nsAString & aURL, bool aEnable) = 0;
...
#define NS_DECL_NSIEDITORSTYLESHEETS \
  ...
  NS_SCRIPTABLE NS_IMETHOD EnableStyleSheet(const nsAString & aURL, bool aEnable); \
...
#define NS_FORWARD_NSIEDITORSTYLESHEETS(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD EnableStyleSheet(const nsAString & aURL, bool aEnable) { return _to EnableStyleSheet(aURL, aEnable); } \
...
#define NS_FORWARD_SAFE_NSIEDITORSTYLESHEETS(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD EnableStyleSheet(const nsAString & aURL, bool aEnable) { return !_to ? NS_ERROR_NULL_POINTER : _to->EnableStyleSheet(aURL, aEnable); } \
