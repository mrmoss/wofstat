/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM /jds/packages/BUILD/SUNWfirefox-10.0.2/firefox/netwerk/base/public/nsIEncodedChannel.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIEncodedChannel : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD GetApplyConversion(bool *aApplyConversion) = 0;
  NS_SCRIPTABLE NS_IMETHOD SetApplyConversion(bool aApplyConversion) = 0;
...
#define NS_DECL_NSIENCODEDCHANNEL \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetApplyConversion(bool *aApplyConversion); \
  NS_SCRIPTABLE NS_IMETHOD SetApplyConversion(bool aApplyConversion); 
...
#define NS_FORWARD_NSIENCODEDCHANNEL(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetApplyConversion(bool *aApplyConversion) { return _to GetApplyConversion(aApplyConversion); } \
  NS_SCRIPTABLE NS_IMETHOD SetApplyConversion(bool aApplyConversion) { return _to SetApplyConversion(aApplyConversion); } 
...
#define NS_FORWARD_SAFE_NSIENCODEDCHANNEL(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetApplyConversion(bool *aApplyConversion) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetApplyConversion(aApplyConversion); } \
  NS_SCRIPTABLE NS_IMETHOD SetApplyConversion(bool aApplyConversion) { return !_to ? NS_ERROR_NULL_POINTER : _to->SetApplyConversion(aApplyConversion); } 
