/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM /jds/packages/BUILD/SUNWfirefox-10.0.2/firefox/xpcom/threads/nsIEnvironment.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIEnvironment : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD Exists(const nsAString & aName, bool *_retval NS_OUTPARAM) = 0;
...
#define NS_DECL_NSIENVIRONMENT \
  ...
  NS_SCRIPTABLE NS_IMETHOD Exists(const nsAString & aName, bool *_retval NS_OUTPARAM); 
...
#define NS_FORWARD_NSIENVIRONMENT(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD Exists(const nsAString & aName, bool *_retval NS_OUTPARAM) { return _to Exists(aName, _retval); } 
...
#define NS_FORWARD_SAFE_NSIENVIRONMENT(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD Exists(const nsAString & aName, bool *_retval NS_OUTPARAM) { return !_to ? NS_ERROR_NULL_POINTER : _to->Exists(aName, _retval); } 
...
/* boolean exists (in AString aName); */
NS_IMETHODIMP nsEnvironment::Exists(const nsAString & aName, bool *_retval NS_OUTPARAM)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
