/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM /jds/packages/BUILD/SUNWfirefox-10.0.2/firefox/content/events/public/nsIEventListenerService.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIEventListenerInfo : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD GetCapturing(bool *aCapturing) = 0;

  /* readonly attribute boolean allowsUntrusted; */
  NS_SCRIPTABLE NS_IMETHOD GetAllowsUntrusted(bool *aAllowsUntrusted) = 0;

  /* readonly attribute boolean inSystemEventGroup; */
  NS_SCRIPTABLE NS_IMETHOD GetInSystemEventGroup(bool *aInSystemEventGroup) = 0;
...
#define NS_DECL_NSIEVENTLISTENERINFO \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetCapturing(bool *aCapturing); \
  NS_SCRIPTABLE NS_IMETHOD GetAllowsUntrusted(bool *aAllowsUntrusted); \
  NS_SCRIPTABLE NS_IMETHOD GetInSystemEventGroup(bool *aInSystemEventGroup); \
...
#define NS_FORWARD_NSIEVENTLISTENERINFO(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetCapturing(bool *aCapturing) { return _to GetCapturing(aCapturing); } \
  NS_SCRIPTABLE NS_IMETHOD GetAllowsUntrusted(bool *aAllowsUntrusted) { return _to GetAllowsUntrusted(aAllowsUntrusted); } \
  NS_SCRIPTABLE NS_IMETHOD GetInSystemEventGroup(bool *aInSystemEventGroup) { return _to GetInSystemEventGroup(aInSystemEventGroup); } \
...
#define NS_FORWARD_SAFE_NSIEVENTLISTENERINFO(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetCapturing(bool *aCapturing) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetCapturing(aCapturing); } \
  NS_SCRIPTABLE NS_IMETHOD GetAllowsUntrusted(bool *aAllowsUntrusted) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetAllowsUntrusted(aAllowsUntrusted); } \
  NS_SCRIPTABLE NS_IMETHOD GetInSystemEventGroup(bool *aInSystemEventGroup) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetInSystemEventGroup(aInSystemEventGroup); } \
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIEventListenerService : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD HasListenersFor(nsIDOMEventTarget *aEventTarget, const nsAString & aType, bool *_retval NS_OUTPARAM) = 0;
  ...
  NS_SCRIPTABLE NS_IMETHOD AddSystemEventListener(nsIDOMEventTarget *target, const nsAString & type, nsIDOMEventListener *listener, bool useCapture) = 0;
  ...
  NS_SCRIPTABLE NS_IMETHOD RemoveSystemEventListener(nsIDOMEventTarget *target, const nsAString & type, nsIDOMEventListener *listener, bool useCapture) = 0;
...
#define NS_DECL_NSIEVENTLISTENERSERVICE \
  ...
  NS_SCRIPTABLE NS_IMETHOD HasListenersFor(nsIDOMEventTarget *aEventTarget, const nsAString & aType, bool *_retval NS_OUTPARAM); \
  NS_SCRIPTABLE NS_IMETHOD AddSystemEventListener(nsIDOMEventTarget *target, const nsAString & type, nsIDOMEventListener *listener, bool useCapture); \
  NS_SCRIPTABLE NS_IMETHOD RemoveSystemEventListener(nsIDOMEventTarget *target, const nsAString & type, nsIDOMEventListener *listener, bool useCapture); 
...
#define NS_FORWARD_NSIEVENTLISTENERSERVICE(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD HasListenersFor(nsIDOMEventTarget *aEventTarget, const nsAString & aType, bool *_retval NS_OUTPARAM) { return _to HasListenersFor(aEventTarget, aType, _retval); } \
  NS_SCRIPTABLE NS_IMETHOD AddSystemEventListener(nsIDOMEventTarget *target, const nsAString & type, nsIDOMEventListener *listener, bool useCapture) { return _to AddSystemEventListener(target, type, listener, useCapture); } \
  NS_SCRIPTABLE NS_IMETHOD RemoveSystemEventListener(nsIDOMEventTarget *target, const nsAString & type, nsIDOMEventListener *listener, bool useCapture) { return _to RemoveSystemEventListener(target, type, listener, useCapture); } 
...
#define NS_FORWARD_SAFE_NSIEVENTLISTENERSERVICE(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD HasListenersFor(nsIDOMEventTarget *aEventTarget, const nsAString & aType, bool *_retval NS_OUTPARAM) { return !_to ? NS_ERROR_NULL_POINTER : _to->HasListenersFor(aEventTarget, aType, _retval); } \
  NS_SCRIPTABLE NS_IMETHOD AddSystemEventListener(nsIDOMEventTarget *target, const nsAString & type, nsIDOMEventListener *listener, bool useCapture) { return !_to ? NS_ERROR_NULL_POINTER : _to->AddSystemEventListener(target, type, listener, useCapture); } \
  NS_SCRIPTABLE NS_IMETHOD RemoveSystemEventListener(nsIDOMEventTarget *target, const nsAString & type, nsIDOMEventListener *listener, bool useCapture) { return !_to ? NS_ERROR_NULL_POINTER : _to->RemoveSystemEventListener(target, type, listener, useCapture); } 
...
/* boolean hasListenersFor (in nsIDOMEventTarget aEventTarget, in DOMString aType); */
NS_IMETHODIMP nsEventListenerService::HasListenersFor(nsIDOMEventTarget *aEventTarget, const nsAString & aType, bool *_retval NS_OUTPARAM)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
