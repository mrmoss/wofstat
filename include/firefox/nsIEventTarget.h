/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM /jds/packages/BUILD/SUNWfirefox-10.0.2/firefox/xpcom/threads/nsIEventTarget.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIEventTarget : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD IsOnCurrentThread(bool *_retval NS_OUTPARAM) = 0;
...
#define NS_DECL_NSIEVENTTARGET \
  ...
  NS_SCRIPTABLE NS_IMETHOD IsOnCurrentThread(bool *_retval NS_OUTPARAM); 
...
#define NS_FORWARD_NSIEVENTTARGET(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD IsOnCurrentThread(bool *_retval NS_OUTPARAM) { return _to IsOnCurrentThread(_retval); } 
...
#define NS_FORWARD_SAFE_NSIEVENTTARGET(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD IsOnCurrentThread(bool *_retval NS_OUTPARAM) { return !_to ? NS_ERROR_NULL_POINTER : _to->IsOnCurrentThread(_retval); } 
...
/* boolean isOnCurrentThread (); */
NS_IMETHODIMP nsEventTarget::IsOnCurrentThread(bool *_retval NS_OUTPARAM)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
