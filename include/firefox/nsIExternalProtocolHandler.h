/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM /jds/packages/BUILD/SUNWfirefox-10.0.2/firefox/netwerk/base/public/nsIExternalProtocolHandler.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIExternalProtocolHandler : public nsIProtocolHandler {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD ExternalAppExistsForScheme(const nsACString & scheme, bool *_retval NS_OUTPARAM) = 0;
...
#define NS_DECL_NSIEXTERNALPROTOCOLHANDLER \
  NS_SCRIPTABLE NS_IMETHOD ExternalAppExistsForScheme(const nsACString & scheme, bool *_retval NS_OUTPARAM); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSIEXTERNALPROTOCOLHANDLER(_to) \
  NS_SCRIPTABLE NS_IMETHOD ExternalAppExistsForScheme(const nsACString & scheme, bool *_retval NS_OUTPARAM) { return _to ExternalAppExistsForScheme(scheme, _retval); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_NSIEXTERNALPROTOCOLHANDLER(_to) \
  NS_SCRIPTABLE NS_IMETHOD ExternalAppExistsForScheme(const nsACString & scheme, bool *_retval NS_OUTPARAM) { return !_to ? NS_ERROR_NULL_POINTER : _to->ExternalAppExistsForScheme(scheme, _retval); } 
...
/* boolean externalAppExistsForScheme (in ACString scheme); */
NS_IMETHODIMP nsExternalProtocolHandler::ExternalAppExistsForScheme(const nsACString & scheme, bool *_retval NS_OUTPARAM)
{
