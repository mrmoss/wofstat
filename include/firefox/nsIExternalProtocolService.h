/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM /jds/packages/BUILD/SUNWfirefox-10.0.2/firefox/uriloader/exthandler/nsIExternalProtocolService.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIExternalProtocolService : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD ExternalProtocolHandlerExists(const char * aProtocolScheme, bool *_retval NS_OUTPARAM) = 0;

  /* boolean isExposedProtocol (in string aProtocolScheme); */
  NS_SCRIPTABLE NS_IMETHOD IsExposedProtocol(const char * aProtocolScheme, bool *_retval NS_OUTPARAM) = 0;
  ...
  NS_SCRIPTABLE NS_IMETHOD GetProtocolHandlerInfoFromOS(const nsACString & aProtocolScheme, bool *aFound NS_OUTPARAM, nsIHandlerInfo * *_retval NS_OUTPARAM) = 0;

  /* void setProtocolHandlerDefaults (in nsIHandlerInfo aHandlerInfo, in boolean aOSHandlerExists); */
  NS_SCRIPTABLE NS_IMETHOD SetProtocolHandlerDefaults(nsIHandlerInfo *aHandlerInfo, bool aOSHandlerExists) = 0;
...
#define NS_DECL_NSIEXTERNALPROTOCOLSERVICE \
  NS_SCRIPTABLE NS_IMETHOD ExternalProtocolHandlerExists(const char * aProtocolScheme, bool *_retval NS_OUTPARAM); \
  NS_SCRIPTABLE NS_IMETHOD IsExposedProtocol(const char * aProtocolScheme, bool *_retval NS_OUTPARAM); \
  NS_SCRIPTABLE NS_IMETHOD GetProtocolHandlerInfo(const nsACString & aProtocolScheme, nsIHandlerInfo * *_retval NS_OUTPARAM); \
  NS_SCRIPTABLE NS_IMETHOD GetProtocolHandlerInfoFromOS(const nsACString & aProtocolScheme, bool *aFound NS_OUTPARAM, nsIHandlerInfo * *_retval NS_OUTPARAM); \
  NS_SCRIPTABLE NS_IMETHOD SetProtocolHandlerDefaults(nsIHandlerInfo *aHandlerInfo, bool aOSHandlerExists); \
...
#define NS_FORWARD_NSIEXTERNALPROTOCOLSERVICE(_to) \
  NS_SCRIPTABLE NS_IMETHOD ExternalProtocolHandlerExists(const char * aProtocolScheme, bool *_retval NS_OUTPARAM) { return _to ExternalProtocolHandlerExists(aProtocolScheme, _retval); } \
  NS_SCRIPTABLE NS_IMETHOD IsExposedProtocol(const char * aProtocolScheme, bool *_retval NS_OUTPARAM) { return _to IsExposedProtocol(aProtocolScheme, _retval); } \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetProtocolHandlerInfoFromOS(const nsACString & aProtocolScheme, bool *aFound NS_OUTPARAM, nsIHandlerInfo * *_retval NS_OUTPARAM) { return _to GetProtocolHandlerInfoFromOS(aProtocolScheme, aFound, _retval); } \
  NS_SCRIPTABLE NS_IMETHOD SetProtocolHandlerDefaults(nsIHandlerInfo *aHandlerInfo, bool aOSHandlerExists) { return _to SetProtocolHandlerDefaults(aHandlerInfo, aOSHandlerExists); } \
...
#define NS_FORWARD_SAFE_NSIEXTERNALPROTOCOLSERVICE(_to) \
  NS_SCRIPTABLE NS_IMETHOD ExternalProtocolHandlerExists(const char * aProtocolScheme, bool *_retval NS_OUTPARAM) { return !_to ? NS_ERROR_NULL_POINTER : _to->ExternalProtocolHandlerExists(aProtocolScheme, _retval); } \
  NS_SCRIPTABLE NS_IMETHOD IsExposedProtocol(const char * aProtocolScheme, bool *_retval NS_OUTPARAM) { return !_to ? NS_ERROR_NULL_POINTER : _to->IsExposedProtocol(aProtocolScheme, _retval); } \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetProtocolHandlerInfoFromOS(const nsACString & aProtocolScheme, bool *aFound NS_OUTPARAM, nsIHandlerInfo * *_retval NS_OUTPARAM) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetProtocolHandlerInfoFromOS(aProtocolScheme, aFound, _retval); } \
  NS_SCRIPTABLE NS_IMETHOD SetProtocolHandlerDefaults(nsIHandlerInfo *aHandlerInfo, bool aOSHandlerExists) { return !_to ? NS_ERROR_NULL_POINTER : _to->SetProtocolHandlerDefaults(aHandlerInfo, aOSHandlerExists); } \
...
/* boolean externalProtocolHandlerExists (in string aProtocolScheme); */
NS_IMETHODIMP nsExternalProtocolService::ExternalProtocolHandlerExists(const char * aProtocolScheme, bool *_retval NS_OUTPARAM)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}

/* boolean isExposedProtocol (in string aProtocolScheme); */
NS_IMETHODIMP nsExternalProtocolService::IsExposedProtocol(const char * aProtocolScheme, bool *_retval NS_OUTPARAM)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
...
/* nsIHandlerInfo getProtocolHandlerInfoFromOS (in ACString aProtocolScheme, out boolean aFound); */
NS_IMETHODIMP nsExternalProtocolService::GetProtocolHandlerInfoFromOS(const nsACString & aProtocolScheme, bool *aFound NS_OUTPARAM, nsIHandlerInfo * *_retval NS_OUTPARAM)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
