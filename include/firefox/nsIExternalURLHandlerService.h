/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM /jds/packages/BUILD/SUNWfirefox-10.0.2/firefox/uriloader/exthandler/nsIExternalURLHandlerService.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIExternalURLHandlerService : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD GetURLHandlerInfoFromOS(nsIURI *aURL, bool *aFound NS_OUTPARAM, nsIHandlerInfo * *_retval NS_OUTPARAM) = 0;
...
#define NS_DECL_NSIEXTERNALURLHANDLERSERVICE \
  NS_SCRIPTABLE NS_IMETHOD GetURLHandlerInfoFromOS(nsIURI *aURL, bool *aFound NS_OUTPARAM, nsIHandlerInfo * *_retval NS_OUTPARAM); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSIEXTERNALURLHANDLERSERVICE(_to) \
  NS_SCRIPTABLE NS_IMETHOD GetURLHandlerInfoFromOS(nsIURI *aURL, bool *aFound NS_OUTPARAM, nsIHandlerInfo * *_retval NS_OUTPARAM) { return _to GetURLHandlerInfoFromOS(aURL, aFound, _retval); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_NSIEXTERNALURLHANDLERSERVICE(_to) \
  NS_SCRIPTABLE NS_IMETHOD GetURLHandlerInfoFromOS(nsIURI *aURL, bool *aFound NS_OUTPARAM, nsIHandlerInfo * *_retval NS_OUTPARAM) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetURLHandlerInfoFromOS(aURL, aFound, _retval); } 
...
/* nsIHandlerInfo getURLHandlerInfoFromOS (in nsIURI aURL, out boolean aFound); */
NS_IMETHODIMP nsExternalURLHandlerService::GetURLHandlerInfoFromOS(nsIURI *aURL, bool *aFound NS_OUTPARAM, nsIHandlerInfo * *_retval NS_OUTPARAM)
{
