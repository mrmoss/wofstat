/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM /jds/packages/BUILD/SUNWfirefox-10.0.2/firefox/netwerk/protocol/ftp/nsIFTPChannel.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIFTPEventSink : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD OnFTPControlLog(bool server, const char * msg) = 0;
...
#define NS_DECL_NSIFTPEVENTSINK \
  NS_SCRIPTABLE NS_IMETHOD OnFTPControlLog(bool server, const char * msg); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSIFTPEVENTSINK(_to) \
  NS_SCRIPTABLE NS_IMETHOD OnFTPControlLog(bool server, const char * msg) { return _to OnFTPControlLog(server, msg); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_NSIFTPEVENTSINK(_to) \
  NS_SCRIPTABLE NS_IMETHOD OnFTPControlLog(bool server, const char * msg) { return !_to ? NS_ERROR_NULL_POINTER : _to->OnFTPControlLog(server, msg); } 
