/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM /jds/packages/BUILD/SUNWfirefox-10.0.2/firefox/xpcom/components/nsIFactory.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIFactory : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD LockFactory(bool lock) = 0;
...
#define NS_DECL_NSIFACTORY \
  ...
  NS_SCRIPTABLE NS_IMETHOD LockFactory(bool lock); 
...
#define NS_FORWARD_NSIFACTORY(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD LockFactory(bool lock) { return _to LockFactory(lock); } 
...
#define NS_FORWARD_SAFE_NSIFACTORY(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD LockFactory(bool lock) { return !_to ? NS_ERROR_NULL_POINTER : _to->LockFactory(lock); } 
