/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM /jds/packages/BUILD/SUNWfirefox-10.0.2/firefox/toolkit/components/feeds/nsIFeedListener.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIFeedProgressListener : public nsIFeedResultListener {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD ReportError(const nsAString & errorText, PRInt32 lineNumber, bool bozo) = 0;
...
#define NS_DECL_NSIFEEDPROGRESSLISTENER \
  NS_SCRIPTABLE NS_IMETHOD ReportError(const nsAString & errorText, PRInt32 lineNumber, bool bozo); \
...
#define NS_FORWARD_NSIFEEDPROGRESSLISTENER(_to) \
  NS_SCRIPTABLE NS_IMETHOD ReportError(const nsAString & errorText, PRInt32 lineNumber, bool bozo) { return _to ReportError(errorText, lineNumber, bozo); } \
...
#define NS_FORWARD_SAFE_NSIFEEDPROGRESSLISTENER(_to) \
  NS_SCRIPTABLE NS_IMETHOD ReportError(const nsAString & errorText, PRInt32 lineNumber, bool bozo) { return !_to ? NS_ERROR_NULL_POINTER : _to->ReportError(errorText, lineNumber, bozo); } \
...
/* void reportError (in AString errorText, in long lineNumber, in boolean bozo); */
NS_IMETHODIMP nsFeedProgressListener::ReportError(const nsAString & errorText, PRInt32 lineNumber, bool bozo)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
