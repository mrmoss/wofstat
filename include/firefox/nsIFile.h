/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM /jds/packages/BUILD/SUNWfirefox-10.0.2/firefox/xpcom/io/nsIFile.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIFile : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD Remove(bool recursive) = 0;
  ...
  /* boolean exists (); */
  NS_SCRIPTABLE NS_IMETHOD Exists(bool *_retval NS_OUTPARAM) = 0;

  /* boolean isWritable (); */
  NS_SCRIPTABLE NS_IMETHOD IsWritable(bool *_retval NS_OUTPARAM) = 0;

  /* boolean isReadable (); */
  NS_SCRIPTABLE NS_IMETHOD IsReadable(bool *_retval NS_OUTPARAM) = 0;

  /* boolean isExecutable (); */
  NS_SCRIPTABLE NS_IMETHOD IsExecutable(bool *_retval NS_OUTPARAM) = 0;

  /* boolean isHidden (); */
  NS_SCRIPTABLE NS_IMETHOD IsHidden(bool *_retval NS_OUTPARAM) = 0;

  /* boolean isDirectory (); */
  NS_SCRIPTABLE NS_IMETHOD IsDirectory(bool *_retval NS_OUTPARAM) = 0;

  /* boolean isFile (); */
  NS_SCRIPTABLE NS_IMETHOD IsFile(bool *_retval NS_OUTPARAM) = 0;

  /* boolean isSymlink (); */
  NS_SCRIPTABLE NS_IMETHOD IsSymlink(bool *_retval NS_OUTPARAM) = 0;

  /* boolean isSpecial (); */
  NS_SCRIPTABLE NS_IMETHOD IsSpecial(bool *_retval NS_OUTPARAM) = 0;
  ...
  NS_SCRIPTABLE NS_IMETHOD Equals(nsIFile *inFile, bool *_retval NS_OUTPARAM) = 0;

  /* boolean contains (in nsIFile inFile, in boolean recur); */
  NS_SCRIPTABLE NS_IMETHOD Contains(nsIFile *inFile, bool recur, bool *_retval NS_OUTPARAM) = 0;
...
#define NS_DECL_NSIFILE \
  ...
  NS_SCRIPTABLE NS_IMETHOD Remove(bool recursive); \
  ...
  NS_SCRIPTABLE NS_IMETHOD Exists(bool *_retval NS_OUTPARAM); \
  NS_SCRIPTABLE NS_IMETHOD IsWritable(bool *_retval NS_OUTPARAM); \
  NS_SCRIPTABLE NS_IMETHOD IsReadable(bool *_retval NS_OUTPARAM); \
  NS_SCRIPTABLE NS_IMETHOD IsExecutable(bool *_retval NS_OUTPARAM); \
  NS_SCRIPTABLE NS_IMETHOD IsHidden(bool *_retval NS_OUTPARAM); \
  NS_SCRIPTABLE NS_IMETHOD IsDirectory(bool *_retval NS_OUTPARAM); \
  NS_SCRIPTABLE NS_IMETHOD IsFile(bool *_retval NS_OUTPARAM); \
  NS_SCRIPTABLE NS_IMETHOD IsSymlink(bool *_retval NS_OUTPARAM); \
  NS_SCRIPTABLE NS_IMETHOD IsSpecial(bool *_retval NS_OUTPARAM); \
  ...
  NS_SCRIPTABLE NS_IMETHOD Equals(nsIFile *inFile, bool *_retval NS_OUTPARAM); \
  NS_SCRIPTABLE NS_IMETHOD Contains(nsIFile *inFile, bool recur, bool *_retval NS_OUTPARAM); \
...
#define NS_FORWARD_NSIFILE(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD Remove(bool recursive) { return _to Remove(recursive); } \
  ...
  NS_SCRIPTABLE NS_IMETHOD Exists(bool *_retval NS_OUTPARAM) { return _to Exists(_retval); } \
  NS_SCRIPTABLE NS_IMETHOD IsWritable(bool *_retval NS_OUTPARAM) { return _to IsWritable(_retval); } \
  NS_SCRIPTABLE NS_IMETHOD IsReadable(bool *_retval NS_OUTPARAM) { return _to IsReadable(_retval); } \
  NS_SCRIPTABLE NS_IMETHOD IsExecutable(bool *_retval NS_OUTPARAM) { return _to IsExecutable(_retval); } \
  NS_SCRIPTABLE NS_IMETHOD IsHidden(bool *_retval NS_OUTPARAM) { return _to IsHidden(_retval); } \
  NS_SCRIPTABLE NS_IMETHOD IsDirectory(bool *_retval NS_OUTPARAM) { return _to IsDirectory(_retval); } \
  NS_SCRIPTABLE NS_IMETHOD IsFile(bool *_retval NS_OUTPARAM) { return _to IsFile(_retval); } \
  NS_SCRIPTABLE NS_IMETHOD IsSymlink(bool *_retval NS_OUTPARAM) { return _to IsSymlink(_retval); } \
  NS_SCRIPTABLE NS_IMETHOD IsSpecial(bool *_retval NS_OUTPARAM) { return _to IsSpecial(_retval); } \
  ...
  NS_SCRIPTABLE NS_IMETHOD Equals(nsIFile *inFile, bool *_retval NS_OUTPARAM) { return _to Equals(inFile, _retval); } \
  NS_SCRIPTABLE NS_IMETHOD Contains(nsIFile *inFile, bool recur, bool *_retval NS_OUTPARAM) { return _to Contains(inFile, recur, _retval); } \
...
#define NS_FORWARD_SAFE_NSIFILE(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD Remove(bool recursive) { return !_to ? NS_ERROR_NULL_POINTER : _to->Remove(recursive); } \
  ...
  NS_SCRIPTABLE NS_IMETHOD Exists(bool *_retval NS_OUTPARAM) { return !_to ? NS_ERROR_NULL_POINTER : _to->Exists(_retval); } \
  NS_SCRIPTABLE NS_IMETHOD IsWritable(bool *_retval NS_OUTPARAM) { return !_to ? NS_ERROR_NULL_POINTER : _to->IsWritable(_retval); } \
  NS_SCRIPTABLE NS_IMETHOD IsReadable(bool *_retval NS_OUTPARAM) { return !_to ? NS_ERROR_NULL_POINTER : _to->IsReadable(_retval); } \
  NS_SCRIPTABLE NS_IMETHOD IsExecutable(bool *_retval NS_OUTPARAM) { return !_to ? NS_ERROR_NULL_POINTER : _to->IsExecutable(_retval); } \
  NS_SCRIPTABLE NS_IMETHOD IsHidden(bool *_retval NS_OUTPARAM) { return !_to ? NS_ERROR_NULL_POINTER : _to->IsHidden(_retval); } \
  NS_SCRIPTABLE NS_IMETHOD IsDirectory(bool *_retval NS_OUTPARAM) { return !_to ? NS_ERROR_NULL_POINTER : _to->IsDirectory(_retval); } \
  NS_SCRIPTABLE NS_IMETHOD IsFile(bool *_retval NS_OUTPARAM) { return !_to ? NS_ERROR_NULL_POINTER : _to->IsFile(_retval); } \
  NS_SCRIPTABLE NS_IMETHOD IsSymlink(bool *_retval NS_OUTPARAM) { return !_to ? NS_ERROR_NULL_POINTER : _to->IsSymlink(_retval); } \
  NS_SCRIPTABLE NS_IMETHOD IsSpecial(bool *_retval NS_OUTPARAM) { return !_to ? NS_ERROR_NULL_POINTER : _to->IsSpecial(_retval); } \
  ...
  NS_SCRIPTABLE NS_IMETHOD Equals(nsIFile *inFile, bool *_retval NS_OUTPARAM) { return !_to ? NS_ERROR_NULL_POINTER : _to->Equals(inFile, _retval); } \
  NS_SCRIPTABLE NS_IMETHOD Contains(nsIFile *inFile, bool recur, bool *_retval NS_OUTPARAM) { return !_to ? NS_ERROR_NULL_POINTER : _to->Contains(inFile, recur, _retval); } \
...
/* boolean exists (); */
NS_IMETHODIMP nsFile::Exists(bool *_retval NS_OUTPARAM)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}

/* boolean isWritable (); */
NS_IMETHODIMP nsFile::IsWritable(bool *_retval NS_OUTPARAM)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}

/* boolean isReadable (); */
NS_IMETHODIMP nsFile::IsReadable(bool *_retval NS_OUTPARAM)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}

/* boolean isExecutable (); */
NS_IMETHODIMP nsFile::IsExecutable(bool *_retval NS_OUTPARAM)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}

/* boolean isHidden (); */
NS_IMETHODIMP nsFile::IsHidden(bool *_retval NS_OUTPARAM)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}

/* boolean isDirectory (); */
NS_IMETHODIMP nsFile::IsDirectory(bool *_retval NS_OUTPARAM)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}

/* boolean isFile (); */
NS_IMETHODIMP nsFile::IsFile(bool *_retval NS_OUTPARAM)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}

/* boolean isSymlink (); */
NS_IMETHODIMP nsFile::IsSymlink(bool *_retval NS_OUTPARAM)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}

/* boolean isSpecial (); */
NS_IMETHODIMP nsFile::IsSpecial(bool *_retval NS_OUTPARAM)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
...
/* boolean equals (in nsIFile inFile); */
NS_IMETHODIMP nsFile::Equals(nsIFile *inFile, bool *_retval NS_OUTPARAM)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}

/* boolean contains (in nsIFile inFile, in boolean recur); */
NS_IMETHODIMP nsFile::Contains(nsIFile *inFile, bool recur, bool *_retval NS_OUTPARAM)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
