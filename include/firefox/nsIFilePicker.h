/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM /jds/packages/BUILD/SUNWfirefox-10.0.2/firefox/widget/public/nsIFilePicker.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIFilePicker : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD GetAddToRecentDocs(bool *aAddToRecentDocs) = 0;
  NS_SCRIPTABLE NS_IMETHOD SetAddToRecentDocs(bool aAddToRecentDocs) = 0;
...
#define NS_DECL_NSIFILEPICKER \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetAddToRecentDocs(bool *aAddToRecentDocs); \
  NS_SCRIPTABLE NS_IMETHOD SetAddToRecentDocs(bool aAddToRecentDocs); \
...
#define NS_FORWARD_NSIFILEPICKER(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetAddToRecentDocs(bool *aAddToRecentDocs) { return _to GetAddToRecentDocs(aAddToRecentDocs); } \
  NS_SCRIPTABLE NS_IMETHOD SetAddToRecentDocs(bool aAddToRecentDocs) { return _to SetAddToRecentDocs(aAddToRecentDocs); } \
...
#define NS_FORWARD_SAFE_NSIFILEPICKER(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetAddToRecentDocs(bool *aAddToRecentDocs) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetAddToRecentDocs(aAddToRecentDocs); } \
  NS_SCRIPTABLE NS_IMETHOD SetAddToRecentDocs(bool aAddToRecentDocs) { return !_to ? NS_ERROR_NULL_POINTER : _to->SetAddToRecentDocs(aAddToRecentDocs); } \
