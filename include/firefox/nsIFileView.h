/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM /jds/packages/BUILD/SUNWfirefox-10.0.2/firefox/toolkit/components/filepicker/nsIFileView.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIFileView : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD GetShowHiddenFiles(bool *aShowHiddenFiles) = 0;
  NS_SCRIPTABLE NS_IMETHOD SetShowHiddenFiles(bool aShowHiddenFiles) = 0;

  /* attribute boolean showOnlyDirectories; */
  NS_SCRIPTABLE NS_IMETHOD GetShowOnlyDirectories(bool *aShowOnlyDirectories) = 0;
  NS_SCRIPTABLE NS_IMETHOD SetShowOnlyDirectories(bool aShowOnlyDirectories) = 0;
  ...
  NS_SCRIPTABLE NS_IMETHOD GetReverseSort(bool *aReverseSort) = 0;

  /* void sort (in short sortType, in boolean reverseSort); */
  NS_SCRIPTABLE NS_IMETHOD Sort(PRInt16 sortType, bool reverseSort) = 0;
...
#define NS_DECL_NSIFILEVIEW \
  NS_SCRIPTABLE NS_IMETHOD GetShowHiddenFiles(bool *aShowHiddenFiles); \
  NS_SCRIPTABLE NS_IMETHOD SetShowHiddenFiles(bool aShowHiddenFiles); \
  NS_SCRIPTABLE NS_IMETHOD GetShowOnlyDirectories(bool *aShowOnlyDirectories); \
  NS_SCRIPTABLE NS_IMETHOD SetShowOnlyDirectories(bool aShowOnlyDirectories); \
  NS_SCRIPTABLE NS_IMETHOD GetSortType(PRInt16 *aSortType); \
  NS_SCRIPTABLE NS_IMETHOD GetReverseSort(bool *aReverseSort); \
  NS_SCRIPTABLE NS_IMETHOD Sort(PRInt16 sortType, bool reverseSort); \
...
#define NS_FORWARD_NSIFILEVIEW(_to) \
  NS_SCRIPTABLE NS_IMETHOD GetShowHiddenFiles(bool *aShowHiddenFiles) { return _to GetShowHiddenFiles(aShowHiddenFiles); } \
  NS_SCRIPTABLE NS_IMETHOD SetShowHiddenFiles(bool aShowHiddenFiles) { return _to SetShowHiddenFiles(aShowHiddenFiles); } \
  NS_SCRIPTABLE NS_IMETHOD GetShowOnlyDirectories(bool *aShowOnlyDirectories) { return _to GetShowOnlyDirectories(aShowOnlyDirectories); } \
  NS_SCRIPTABLE NS_IMETHOD SetShowOnlyDirectories(bool aShowOnlyDirectories) { return _to SetShowOnlyDirectories(aShowOnlyDirectories); } \
  NS_SCRIPTABLE NS_IMETHOD GetSortType(PRInt16 *aSortType) { return _to GetSortType(aSortType); } \
  NS_SCRIPTABLE NS_IMETHOD GetReverseSort(bool *aReverseSort) { return _to GetReverseSort(aReverseSort); } \
  NS_SCRIPTABLE NS_IMETHOD Sort(PRInt16 sortType, bool reverseSort) { return _to Sort(sortType, reverseSort); } \
...
#define NS_FORWARD_SAFE_NSIFILEVIEW(_to) \
  NS_SCRIPTABLE NS_IMETHOD GetShowHiddenFiles(bool *aShowHiddenFiles) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetShowHiddenFiles(aShowHiddenFiles); } \
  NS_SCRIPTABLE NS_IMETHOD SetShowHiddenFiles(bool aShowHiddenFiles) { return !_to ? NS_ERROR_NULL_POINTER : _to->SetShowHiddenFiles(aShowHiddenFiles); } \
  NS_SCRIPTABLE NS_IMETHOD GetShowOnlyDirectories(bool *aShowOnlyDirectories) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetShowOnlyDirectories(aShowOnlyDirectories); } \
  NS_SCRIPTABLE NS_IMETHOD SetShowOnlyDirectories(bool aShowOnlyDirectories) { return !_to ? NS_ERROR_NULL_POINTER : _to->SetShowOnlyDirectories(aShowOnlyDirectories); } \
  NS_SCRIPTABLE NS_IMETHOD GetSortType(PRInt16 *aSortType) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetSortType(aSortType); } \
  NS_SCRIPTABLE NS_IMETHOD GetReverseSort(bool *aReverseSort) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetReverseSort(aReverseSort); } \
  NS_SCRIPTABLE NS_IMETHOD Sort(PRInt16 sortType, bool reverseSort) { return !_to ? NS_ERROR_NULL_POINTER : _to->Sort(sortType, reverseSort); } \
...
/* void sort (in short sortType, in boolean reverseSort); */
NS_IMETHODIMP nsFileView::Sort(PRInt16 sortType, bool reverseSort)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
