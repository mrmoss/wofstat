/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM /jds/packages/BUILD/SUNWfirefox-10.0.2/firefox/gfx/src/nsIFontEnumerator.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIFontEnumerator : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD HaveFontFor(const char * aLangGroup, bool *aResult NS_OUTPARAM) = 0;
  ...
  NS_SCRIPTABLE NS_IMETHOD UpdateFontList(bool *_retval NS_OUTPARAM) = 0;
...
#define NS_DECL_NSIFONTENUMERATOR \
  ...
  NS_SCRIPTABLE NS_IMETHOD HaveFontFor(const char * aLangGroup, bool *aResult NS_OUTPARAM); \
  NS_SCRIPTABLE NS_IMETHOD GetDefaultFont(const char * aLangGroup, const char * aGeneric, PRUnichar * *_retval NS_OUTPARAM); \
  NS_SCRIPTABLE NS_IMETHOD UpdateFontList(bool *_retval NS_OUTPARAM); \
...
#define NS_FORWARD_NSIFONTENUMERATOR(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD HaveFontFor(const char * aLangGroup, bool *aResult NS_OUTPARAM) { return _to HaveFontFor(aLangGroup, aResult); } \
  ...
  NS_SCRIPTABLE NS_IMETHOD UpdateFontList(bool *_retval NS_OUTPARAM) { return _to UpdateFontList(_retval); } \
...
#define NS_FORWARD_SAFE_NSIFONTENUMERATOR(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD HaveFontFor(const char * aLangGroup, bool *aResult NS_OUTPARAM) { return !_to ? NS_ERROR_NULL_POINTER : _to->HaveFontFor(aLangGroup, aResult); } \
  ...
  NS_SCRIPTABLE NS_IMETHOD UpdateFontList(bool *_retval NS_OUTPARAM) { return !_to ? NS_ERROR_NULL_POINTER : _to->UpdateFontList(_retval); } \
...
/* void HaveFontFor (in string aLangGroup, [retval] out boolean aResult); */
NS_IMETHODIMP nsFontEnumerator::HaveFontFor(const char * aLangGroup, bool *aResult NS_OUTPARAM)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
...
/* boolean updateFontList (); */
NS_IMETHODIMP nsFontEnumerator::UpdateFontList(bool *_retval NS_OUTPARAM)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
