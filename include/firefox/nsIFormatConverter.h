/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM /jds/packages/BUILD/SUNWfirefox-10.0.2/firefox/widget/public/nsIFormatConverter.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIFormatConverter : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD CanConvert(const char * aFromDataFlavor, const char * aToDataFlavor, bool *_retval NS_OUTPARAM) = 0;
...
#define NS_DECL_NSIFORMATCONVERTER \
  ...
  NS_SCRIPTABLE NS_IMETHOD CanConvert(const char * aFromDataFlavor, const char * aToDataFlavor, bool *_retval NS_OUTPARAM); \
...
#define NS_FORWARD_NSIFORMATCONVERTER(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD CanConvert(const char * aFromDataFlavor, const char * aToDataFlavor, bool *_retval NS_OUTPARAM) { return _to CanConvert(aFromDataFlavor, aToDataFlavor, _retval); } \
...
#define NS_FORWARD_SAFE_NSIFORMATCONVERTER(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD CanConvert(const char * aFromDataFlavor, const char * aToDataFlavor, bool *_retval NS_OUTPARAM) { return !_to ? NS_ERROR_NULL_POINTER : _to->CanConvert(aFromDataFlavor, aToDataFlavor, _retval); } \
...
/* boolean canConvert (in string aFromDataFlavor, in string aToDataFlavor); */
NS_IMETHODIMP nsFormatConverter::CanConvert(const char * aFromDataFlavor, const char * aToDataFlavor, bool *_retval NS_OUTPARAM)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
