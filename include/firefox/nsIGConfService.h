/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM /jds/packages/BUILD/SUNWfirefox-10.0.2/firefox/xpcom/system/nsIGConfService.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIGConfService : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD GetBool(const nsACString & key, bool *_retval NS_OUTPARAM) = 0;
  ...
  NS_SCRIPTABLE NS_IMETHOD SetBool(const nsACString & key, bool value) = 0;
  ...
  NS_SCRIPTABLE NS_IMETHOD GetAppForProtocol(const nsACString & scheme, bool *enabled NS_OUTPARAM, nsACString & _retval NS_OUTPARAM) = 0;

  /* boolean handlerRequiresTerminal (in AUTF8String scheme); */
  NS_SCRIPTABLE NS_IMETHOD HandlerRequiresTerminal(const nsACString & scheme, bool *_retval NS_OUTPARAM) = 0;
...
#define NS_DECL_NSIGCONFSERVICE \
  NS_SCRIPTABLE NS_IMETHOD GetBool(const nsACString & key, bool *_retval NS_OUTPARAM); \
  ...
  NS_SCRIPTABLE NS_IMETHOD SetBool(const nsACString & key, bool value); \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetAppForProtocol(const nsACString & scheme, bool *enabled NS_OUTPARAM, nsACString & _retval NS_OUTPARAM); \
  NS_SCRIPTABLE NS_IMETHOD HandlerRequiresTerminal(const nsACString & scheme, bool *_retval NS_OUTPARAM); \
...
#define NS_FORWARD_NSIGCONFSERVICE(_to) \
  NS_SCRIPTABLE NS_IMETHOD GetBool(const nsACString & key, bool *_retval NS_OUTPARAM) { return _to GetBool(key, _retval); } \
  ...
  NS_SCRIPTABLE NS_IMETHOD SetBool(const nsACString & key, bool value) { return _to SetBool(key, value); } \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetAppForProtocol(const nsACString & scheme, bool *enabled NS_OUTPARAM, nsACString & _retval NS_OUTPARAM) { return _to GetAppForProtocol(scheme, enabled, _retval); } \
  NS_SCRIPTABLE NS_IMETHOD HandlerRequiresTerminal(const nsACString & scheme, bool *_retval NS_OUTPARAM) { return _to HandlerRequiresTerminal(scheme, _retval); } \
...
#define NS_FORWARD_SAFE_NSIGCONFSERVICE(_to) \
  NS_SCRIPTABLE NS_IMETHOD GetBool(const nsACString & key, bool *_retval NS_OUTPARAM) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetBool(key, _retval); } \
  ...
  NS_SCRIPTABLE NS_IMETHOD SetBool(const nsACString & key, bool value) { return !_to ? NS_ERROR_NULL_POINTER : _to->SetBool(key, value); } \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetAppForProtocol(const nsACString & scheme, bool *enabled NS_OUTPARAM, nsACString & _retval NS_OUTPARAM) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetAppForProtocol(scheme, enabled, _retval); } \
  NS_SCRIPTABLE NS_IMETHOD HandlerRequiresTerminal(const nsACString & scheme, bool *_retval NS_OUTPARAM) { return !_to ? NS_ERROR_NULL_POINTER : _to->HandlerRequiresTerminal(scheme, _retval); } \
...
/* boolean getBool (in AUTF8String key); */
NS_IMETHODIMP nsGConfService::GetBool(const nsACString & key, bool *_retval NS_OUTPARAM)
{
...
/* AUTF8String getAppForProtocol (in AUTF8String scheme, out boolean enabled); */
NS_IMETHODIMP nsGConfService::GetAppForProtocol(const nsACString & scheme, bool *enabled NS_OUTPARAM, nsACString & _retval NS_OUTPARAM)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}

/* boolean handlerRequiresTerminal (in AUTF8String scheme); */
NS_IMETHODIMP nsGConfService::HandlerRequiresTerminal(const nsACString & scheme, bool *_retval NS_OUTPARAM)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
