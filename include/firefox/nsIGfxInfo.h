/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM /jds/packages/BUILD/SUNWfirefox-10.0.2/firefox/widget/public/nsIGfxInfo.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIGfxInfo : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD GetD2DEnabled(bool *aD2DEnabled) = 0;

  /* readonly attribute boolean DWriteEnabled; */
  NS_SCRIPTABLE NS_IMETHOD GetDWriteEnabled(bool *aDWriteEnabled) = 0;

  /* readonly attribute boolean AzureEnabled; */
  NS_SCRIPTABLE NS_IMETHOD GetAzureEnabled(bool *aAzureEnabled) = 0;
  ...
  NS_SCRIPTABLE NS_IMETHOD GetIsGPU2Active(bool *aIsGPU2Active) = 0;
...
#define NS_FORWARD_NSIGFXINFO(_to) \
  NS_SCRIPTABLE NS_IMETHOD GetD2DEnabled(bool *aD2DEnabled) { return _to GetD2DEnabled(aD2DEnabled); } \
  NS_SCRIPTABLE NS_IMETHOD GetDWriteEnabled(bool *aDWriteEnabled) { return _to GetDWriteEnabled(aDWriteEnabled); } \
  NS_SCRIPTABLE NS_IMETHOD GetAzureEnabled(bool *aAzureEnabled) { return _to GetAzureEnabled(aAzureEnabled); } \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetIsGPU2Active(bool *aIsGPU2Active) { return _to GetIsGPU2Active(aIsGPU2Active); } \
...
#define NS_FORWARD_SAFE_NSIGFXINFO(_to) \
  NS_SCRIPTABLE NS_IMETHOD GetD2DEnabled(bool *aD2DEnabled) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetD2DEnabled(aD2DEnabled); } \
  NS_SCRIPTABLE NS_IMETHOD GetDWriteEnabled(bool *aDWriteEnabled) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetDWriteEnabled(aDWriteEnabled); } \
  NS_SCRIPTABLE NS_IMETHOD GetAzureEnabled(bool *aAzureEnabled) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetAzureEnabled(aAzureEnabled); } \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetIsGPU2Active(bool *aIsGPU2Active) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetIsGPU2Active(aIsGPU2Active); } \
...
/* readonly attribute boolean AzureEnabled; */
NS_IMETHODIMP nsGfxInfo::GetAzureEnabled(bool *aAzureEnabled)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
