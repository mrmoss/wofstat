/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM /jds/packages/BUILD/SUNWfirefox-10.0.2/firefox/docshell/base/nsIGlobalHistory.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIGlobalHistory : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD IsVisited(const char * aURL, bool *_retval NS_OUTPARAM) = 0;
...
#define NS_DECL_NSIGLOBALHISTORY \
  ...
  NS_SCRIPTABLE NS_IMETHOD IsVisited(const char * aURL, bool *_retval NS_OUTPARAM); 
...
#define NS_FORWARD_NSIGLOBALHISTORY(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD IsVisited(const char * aURL, bool *_retval NS_OUTPARAM) { return _to IsVisited(aURL, _retval); } 
...
#define NS_FORWARD_SAFE_NSIGLOBALHISTORY(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD IsVisited(const char * aURL, bool *_retval NS_OUTPARAM) { return !_to ? NS_ERROR_NULL_POINTER : _to->IsVisited(aURL, _retval); } 
...
/* boolean isVisited (in string aURL); */
NS_IMETHODIMP nsGlobalHistory::IsVisited(const char * aURL, bool *_retval NS_OUTPARAM)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
