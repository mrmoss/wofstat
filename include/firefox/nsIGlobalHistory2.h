/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM /jds/packages/BUILD/SUNWfirefox-10.0.2/firefox/docshell/base/nsIGlobalHistory2.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIGlobalHistory2 : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD AddURI(nsIURI *aURI, bool aRedirect, bool aToplevel, nsIURI *aReferrer) = 0;

  /* boolean isVisited (in nsIURI aURI); */
  NS_SCRIPTABLE NS_IMETHOD IsVisited(nsIURI *aURI, bool *_retval NS_OUTPARAM) = 0;
...
#define NS_DECL_NSIGLOBALHISTORY2 \
  NS_SCRIPTABLE NS_IMETHOD AddURI(nsIURI *aURI, bool aRedirect, bool aToplevel, nsIURI *aReferrer); \
  NS_SCRIPTABLE NS_IMETHOD IsVisited(nsIURI *aURI, bool *_retval NS_OUTPARAM); \
...
#define NS_FORWARD_NSIGLOBALHISTORY2(_to) \
  NS_SCRIPTABLE NS_IMETHOD AddURI(nsIURI *aURI, bool aRedirect, bool aToplevel, nsIURI *aReferrer) { return _to AddURI(aURI, aRedirect, aToplevel, aReferrer); } \
  NS_SCRIPTABLE NS_IMETHOD IsVisited(nsIURI *aURI, bool *_retval NS_OUTPARAM) { return _to IsVisited(aURI, _retval); } \
...
#define NS_FORWARD_SAFE_NSIGLOBALHISTORY2(_to) \
  NS_SCRIPTABLE NS_IMETHOD AddURI(nsIURI *aURI, bool aRedirect, bool aToplevel, nsIURI *aReferrer) { return !_to ? NS_ERROR_NULL_POINTER : _to->AddURI(aURI, aRedirect, aToplevel, aReferrer); } \
  NS_SCRIPTABLE NS_IMETHOD IsVisited(nsIURI *aURI, bool *_retval NS_OUTPARAM) { return !_to ? NS_ERROR_NULL_POINTER : _to->IsVisited(aURI, _retval); } \
...
/* boolean isVisited (in nsIURI aURI); */
NS_IMETHODIMP nsGlobalHistory2::IsVisited(nsIURI *aURI, bool *_retval NS_OUTPARAM)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
