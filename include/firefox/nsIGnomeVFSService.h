/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM /jds/packages/BUILD/SUNWfirefox-10.0.2/firefox/xpcom/system/nsIGnomeVFSService.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIGnomeVFSMimeApp : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD GetCanOpenMultipleFiles(bool *aCanOpenMultipleFiles) = 0;
  ...
  NS_SCRIPTABLE NS_IMETHOD GetRequiresTerminal(bool *aRequiresTerminal) = 0;
...
#define NS_DECL_NSIGNOMEVFSMIMEAPP \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetCanOpenMultipleFiles(bool *aCanOpenMultipleFiles); \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetRequiresTerminal(bool *aRequiresTerminal); \
...
#define NS_FORWARD_NSIGNOMEVFSMIMEAPP(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetCanOpenMultipleFiles(bool *aCanOpenMultipleFiles) { return _to GetCanOpenMultipleFiles(aCanOpenMultipleFiles); } \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetRequiresTerminal(bool *aRequiresTerminal) { return _to GetRequiresTerminal(aRequiresTerminal); } \
...
#define NS_FORWARD_SAFE_NSIGNOMEVFSMIMEAPP(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetCanOpenMultipleFiles(bool *aCanOpenMultipleFiles) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetCanOpenMultipleFiles(aCanOpenMultipleFiles); } \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetRequiresTerminal(bool *aRequiresTerminal) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetRequiresTerminal(aRequiresTerminal); } \
