/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM /jds/packages/BUILD/SUNWfirefox-10.0.2/firefox/editor/idl/nsIHTMLInlineTableEditor.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIHTMLInlineTableEditor : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD GetInlineTableEditingEnabled(bool *aInlineTableEditingEnabled) = 0;
  NS_SCRIPTABLE NS_IMETHOD SetInlineTableEditingEnabled(bool aInlineTableEditingEnabled) = 0;
...
#define NS_DECL_NSIHTMLINLINETABLEEDITOR \
  NS_SCRIPTABLE NS_IMETHOD GetInlineTableEditingEnabled(bool *aInlineTableEditingEnabled); \
  NS_SCRIPTABLE NS_IMETHOD SetInlineTableEditingEnabled(bool aInlineTableEditingEnabled); \
...
#define NS_FORWARD_NSIHTMLINLINETABLEEDITOR(_to) \
  NS_SCRIPTABLE NS_IMETHOD GetInlineTableEditingEnabled(bool *aInlineTableEditingEnabled) { return _to GetInlineTableEditingEnabled(aInlineTableEditingEnabled); } \
  NS_SCRIPTABLE NS_IMETHOD SetInlineTableEditingEnabled(bool aInlineTableEditingEnabled) { return _to SetInlineTableEditingEnabled(aInlineTableEditingEnabled); } \
...
#define NS_FORWARD_SAFE_NSIHTMLINLINETABLEEDITOR(_to) \
  NS_SCRIPTABLE NS_IMETHOD GetInlineTableEditingEnabled(bool *aInlineTableEditingEnabled) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetInlineTableEditingEnabled(aInlineTableEditingEnabled); } \
  NS_SCRIPTABLE NS_IMETHOD SetInlineTableEditingEnabled(bool aInlineTableEditingEnabled) { return !_to ? NS_ERROR_NULL_POINTER : _to->SetInlineTableEditingEnabled(aInlineTableEditingEnabled); } \
