/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM /jds/packages/BUILD/SUNWfirefox-10.0.2/firefox/editor/idl/nsIHTMLObjectResizer.idl
 */
...
class NS_SCRIPTABLE nsIHTMLObjectResizer : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD GetObjectResizingEnabled(bool *aObjectResizingEnabled) = 0;
  NS_SCRIPTABLE NS_IMETHOD SetObjectResizingEnabled(bool aObjectResizingEnabled) = 0;
...
#define NS_DECL_NSIHTMLOBJECTRESIZER \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetObjectResizingEnabled(bool *aObjectResizingEnabled); \
  NS_SCRIPTABLE NS_IMETHOD SetObjectResizingEnabled(bool aObjectResizingEnabled); \
...
#define NS_FORWARD_NSIHTMLOBJECTRESIZER(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetObjectResizingEnabled(bool *aObjectResizingEnabled) { return _to GetObjectResizingEnabled(aObjectResizingEnabled); } \
  NS_SCRIPTABLE NS_IMETHOD SetObjectResizingEnabled(bool aObjectResizingEnabled) { return _to SetObjectResizingEnabled(aObjectResizingEnabled); } \
...
#define NS_FORWARD_SAFE_NSIHTMLOBJECTRESIZER(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetObjectResizingEnabled(bool *aObjectResizingEnabled) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetObjectResizingEnabled(aObjectResizingEnabled); } \
  NS_SCRIPTABLE NS_IMETHOD SetObjectResizingEnabled(bool aObjectResizingEnabled) { return !_to ? NS_ERROR_NULL_POINTER : _to->SetObjectResizingEnabled(aObjectResizingEnabled); } \
