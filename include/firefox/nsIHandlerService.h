/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM /jds/packages/BUILD/SUNWfirefox-10.0.2/firefox/uriloader/exthandler/nsIHandlerService.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIHandlerService : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD Exists(nsIHandlerInfo *aHandlerInfo, bool *_retval NS_OUTPARAM) = 0;
...
#define NS_DECL_NSIHANDLERSERVICE \
  ...
  NS_SCRIPTABLE NS_IMETHOD Exists(nsIHandlerInfo *aHandlerInfo, bool *_retval NS_OUTPARAM); \
...
#define NS_FORWARD_NSIHANDLERSERVICE(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD Exists(nsIHandlerInfo *aHandlerInfo, bool *_retval NS_OUTPARAM) { return _to Exists(aHandlerInfo, _retval); } \
...
#define NS_FORWARD_SAFE_NSIHANDLERSERVICE(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD Exists(nsIHandlerInfo *aHandlerInfo, bool *_retval NS_OUTPARAM) { return !_to ? NS_ERROR_NULL_POINTER : _to->Exists(aHandlerInfo, _retval); } \
...
/* boolean exists (in nsIHandlerInfo aHandlerInfo); */
NS_IMETHODIMP nsHandlerService::Exists(nsIHandlerInfo *aHandlerInfo, bool *_retval NS_OUTPARAM)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
