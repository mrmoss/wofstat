/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM /jds/packages/BUILD/SUNWfirefox-10.0.2/firefox/docshell/shistory/public/nsIHistoryEntry.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIHistoryEntry : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD GetIsSubFrame(bool *aIsSubFrame) = 0;
...
#define NS_DECL_NSIHISTORYENTRY \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetIsSubFrame(bool *aIsSubFrame); 
...
#define NS_FORWARD_NSIHISTORYENTRY(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetIsSubFrame(bool *aIsSubFrame) { return _to GetIsSubFrame(aIsSubFrame); } 
...
#define NS_FORWARD_SAFE_NSIHISTORYENTRY(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetIsSubFrame(bool *aIsSubFrame) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetIsSubFrame(aIsSubFrame); } 
