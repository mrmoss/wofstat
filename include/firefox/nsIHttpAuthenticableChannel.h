/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM /jds/packages/BUILD/SUNWfirefox-10.0.2/firefox/netwerk/protocol/http/nsIHttpAuthenticableChannel.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIHttpAuthenticableChannel : public nsIProxiedChannel {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD GetIsSSL(bool *aIsSSL) = 0;

  /* readonly attribute boolean proxyMethodIsConnect; */
  NS_SCRIPTABLE NS_IMETHOD GetProxyMethodIsConnect(bool *aProxyMethodIsConnect) = 0;
  ...
  NS_SCRIPTABLE NS_IMETHOD OnAuthCancelled(bool userCancel) = 0;
...
#define NS_DECL_NSIHTTPAUTHENTICABLECHANNEL \
  NS_SCRIPTABLE NS_IMETHOD GetIsSSL(bool *aIsSSL); \
  NS_SCRIPTABLE NS_IMETHOD GetProxyMethodIsConnect(bool *aProxyMethodIsConnect); \
  ...
  NS_SCRIPTABLE NS_IMETHOD OnAuthCancelled(bool userCancel); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSIHTTPAUTHENTICABLECHANNEL(_to) \
  NS_SCRIPTABLE NS_IMETHOD GetIsSSL(bool *aIsSSL) { return _to GetIsSSL(aIsSSL); } \
  NS_SCRIPTABLE NS_IMETHOD GetProxyMethodIsConnect(bool *aProxyMethodIsConnect) { return _to GetProxyMethodIsConnect(aProxyMethodIsConnect); } \
  ...
  NS_SCRIPTABLE NS_IMETHOD OnAuthCancelled(bool userCancel) { return _to OnAuthCancelled(userCancel); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_NSIHTTPAUTHENTICABLECHANNEL(_to) \
  NS_SCRIPTABLE NS_IMETHOD GetIsSSL(bool *aIsSSL) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetIsSSL(aIsSSL); } \
  NS_SCRIPTABLE NS_IMETHOD GetProxyMethodIsConnect(bool *aProxyMethodIsConnect) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetProxyMethodIsConnect(aProxyMethodIsConnect); } \
  ...
  NS_SCRIPTABLE NS_IMETHOD OnAuthCancelled(bool userCancel) { return !_to ? NS_ERROR_NULL_POINTER : _to->OnAuthCancelled(userCancel); } 
