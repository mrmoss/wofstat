/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM /jds/packages/BUILD/SUNWfirefox-10.0.2/firefox/netwerk/protocol/http/nsIHttpAuthenticator.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIHttpAuthenticator : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD ChallengeReceived(nsIHttpAuthenticableChannel *aChannel, const char * aChallenge, bool aProxyAuth, nsISupports * *aSessionState NS_INOUTPARAM, nsISupports * *aContinuationState NS_INOUTPARAM, bool *aInvalidatesIdentity NS_OUTPARAM) = 0;
...
#define NS_DECL_NSIHTTPAUTHENTICATOR \
  NS_SCRIPTABLE NS_IMETHOD ChallengeReceived(nsIHttpAuthenticableChannel *aChannel, const char * aChallenge, bool aProxyAuth, nsISupports * *aSessionState NS_INOUTPARAM, nsISupports * *aContinuationState NS_INOUTPARAM, bool *aInvalidatesIdentity NS_OUTPARAM); \
...
/* void challengeReceived (in nsIHttpAuthenticableChannel aChannel, in string aChallenge, in boolean aProxyAuth, inout nsISupports aSessionState, inout nsISupports aContinuationState, out boolean aInvalidatesIdentity); */
NS_IMETHODIMP nsHttpAuthenticator::ChallengeReceived(nsIHttpAuthenticableChannel *aChannel, const char * aChallenge, bool aProxyAuth, nsISupports * *aSessionState NS_INOUTPARAM, nsISupports * *aContinuationState NS_INOUTPARAM, bool *aInvalidatesIdentity NS_OUTPARAM)
{
