/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM /jds/packages/BUILD/SUNWfirefox-10.0.2/firefox/netwerk/protocol/http/nsIHttpChannel.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIHttpChannel : public nsIChannel {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD SetRequestHeader(const nsACString & aHeader, const nsACString & aValue, bool aMerge) = 0;
  ...
  NS_SCRIPTABLE NS_IMETHOD GetAllowPipelining(bool *aAllowPipelining) = 0;
  NS_SCRIPTABLE NS_IMETHOD SetAllowPipelining(bool aAllowPipelining) = 0;
  ...
  NS_SCRIPTABLE NS_IMETHOD GetRequestSucceeded(bool *aRequestSucceeded) = 0;
  ...
  NS_SCRIPTABLE NS_IMETHOD SetResponseHeader(const nsACString & header, const nsACString & value, bool merge) = 0;

  /* void visitResponseHeaders (in nsIHttpHeaderVisitor aVisitor); */
  NS_SCRIPTABLE NS_IMETHOD VisitResponseHeaders(nsIHttpHeaderVisitor *aVisitor) = 0;

  /* boolean isNoStoreResponse (); */
  NS_SCRIPTABLE NS_IMETHOD IsNoStoreResponse(bool *_retval NS_OUTPARAM) = 0;

  /* boolean isNoCacheResponse (); */
  NS_SCRIPTABLE NS_IMETHOD IsNoCacheResponse(bool *_retval NS_OUTPARAM) = 0;
...
#define NS_DECL_NSIHTTPCHANNEL \
  ...
  NS_SCRIPTABLE NS_IMETHOD SetRequestHeader(const nsACString & aHeader, const nsACString & aValue, bool aMerge); \
  NS_SCRIPTABLE NS_IMETHOD VisitRequestHeaders(nsIHttpHeaderVisitor *aVisitor); \
  NS_SCRIPTABLE NS_IMETHOD GetAllowPipelining(bool *aAllowPipelining); \
  NS_SCRIPTABLE NS_IMETHOD SetAllowPipelining(bool aAllowPipelining); \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetRequestSucceeded(bool *aRequestSucceeded); \
  NS_SCRIPTABLE NS_IMETHOD GetResponseHeader(const nsACString & header, nsACString & _retval NS_OUTPARAM); \
  NS_SCRIPTABLE NS_IMETHOD SetResponseHeader(const nsACString & header, const nsACString & value, bool merge); \
  NS_SCRIPTABLE NS_IMETHOD VisitResponseHeaders(nsIHttpHeaderVisitor *aVisitor); \
  NS_SCRIPTABLE NS_IMETHOD IsNoStoreResponse(bool *_retval NS_OUTPARAM); \
  NS_SCRIPTABLE NS_IMETHOD IsNoCacheResponse(bool *_retval NS_OUTPARAM); 
...
#define NS_FORWARD_NSIHTTPCHANNEL(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD SetRequestHeader(const nsACString & aHeader, const nsACString & aValue, bool aMerge) { return _to SetRequestHeader(aHeader, aValue, aMerge); } \
  NS_SCRIPTABLE NS_IMETHOD VisitRequestHeaders(nsIHttpHeaderVisitor *aVisitor) { return _to VisitRequestHeaders(aVisitor); } \
  NS_SCRIPTABLE NS_IMETHOD GetAllowPipelining(bool *aAllowPipelining) { return _to GetAllowPipelining(aAllowPipelining); } \
  NS_SCRIPTABLE NS_IMETHOD SetAllowPipelining(bool aAllowPipelining) { return _to SetAllowPipelining(aAllowPipelining); } \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetRequestSucceeded(bool *aRequestSucceeded) { return _to GetRequestSucceeded(aRequestSucceeded); } \
  ...
  NS_SCRIPTABLE NS_IMETHOD SetResponseHeader(const nsACString & header, const nsACString & value, bool merge) { return _to SetResponseHeader(header, value, merge); } \
  NS_SCRIPTABLE NS_IMETHOD VisitResponseHeaders(nsIHttpHeaderVisitor *aVisitor) { return _to VisitResponseHeaders(aVisitor); } \
  NS_SCRIPTABLE NS_IMETHOD IsNoStoreResponse(bool *_retval NS_OUTPARAM) { return _to IsNoStoreResponse(_retval); } \
  NS_SCRIPTABLE NS_IMETHOD IsNoCacheResponse(bool *_retval NS_OUTPARAM) { return _to IsNoCacheResponse(_retval); } 
...
#define NS_FORWARD_SAFE_NSIHTTPCHANNEL(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD SetRequestHeader(const nsACString & aHeader, const nsACString & aValue, bool aMerge) { return !_to ? NS_ERROR_NULL_POINTER : _to->SetRequestHeader(aHeader, aValue, aMerge); } \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetAllowPipelining(bool *aAllowPipelining) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetAllowPipelining(aAllowPipelining); } \
  NS_SCRIPTABLE NS_IMETHOD SetAllowPipelining(bool aAllowPipelining) { return !_to ? NS_ERROR_NULL_POINTER : _to->SetAllowPipelining(aAllowPipelining); } \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetRequestSucceeded(bool *aRequestSucceeded) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetRequestSucceeded(aRequestSucceeded); } \
  ...
  NS_SCRIPTABLE NS_IMETHOD SetResponseHeader(const nsACString & header, const nsACString & value, bool merge) { return !_to ? NS_ERROR_NULL_POINTER : _to->SetResponseHeader(header, value, merge); } \
  ...
  NS_SCRIPTABLE NS_IMETHOD IsNoStoreResponse(bool *_retval NS_OUTPARAM) { return !_to ? NS_ERROR_NULL_POINTER : _to->IsNoStoreResponse(_retval); } \
  NS_SCRIPTABLE NS_IMETHOD IsNoCacheResponse(bool *_retval NS_OUTPARAM) { return !_to ? NS_ERROR_NULL_POINTER : _to->IsNoCacheResponse(_retval); } 
...
/* boolean isNoStoreResponse (); */
NS_IMETHODIMP nsHttpChannel::IsNoStoreResponse(bool *_retval NS_OUTPARAM)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}

/* boolean isNoCacheResponse (); */
NS_IMETHODIMP nsHttpChannel::IsNoCacheResponse(bool *_retval NS_OUTPARAM)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
