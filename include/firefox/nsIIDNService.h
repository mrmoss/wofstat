/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM /jds/packages/BUILD/SUNWfirefox-10.0.2/firefox/netwerk/dns/nsIIDNService.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIIDNService : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD IsACE(const nsACString & input, bool *_retval NS_OUTPARAM) = 0;
  ...
  NS_SCRIPTABLE NS_IMETHOD ConvertToDisplayIDN(const nsACString & input, bool *isASCII NS_OUTPARAM, nsACString & _retval NS_OUTPARAM) = 0;
...
#define NS_DECL_NSIIDNSERVICE \
  ...
  NS_SCRIPTABLE NS_IMETHOD IsACE(const nsACString & input, bool *_retval NS_OUTPARAM); \
  NS_SCRIPTABLE NS_IMETHOD Normalize(const nsACString & input, nsACString & _retval NS_OUTPARAM); \
  NS_SCRIPTABLE NS_IMETHOD ConvertToDisplayIDN(const nsACString & input, bool *isASCII NS_OUTPARAM, nsACString & _retval NS_OUTPARAM); 
...
#define NS_FORWARD_NSIIDNSERVICE(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD IsACE(const nsACString & input, bool *_retval NS_OUTPARAM) { return _to IsACE(input, _retval); } \
  ...
  NS_SCRIPTABLE NS_IMETHOD ConvertToDisplayIDN(const nsACString & input, bool *isASCII NS_OUTPARAM, nsACString & _retval NS_OUTPARAM) { return _to ConvertToDisplayIDN(input, isASCII, _retval); } 
...
#define NS_FORWARD_SAFE_NSIIDNSERVICE(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD IsACE(const nsACString & input, bool *_retval NS_OUTPARAM) { return !_to ? NS_ERROR_NULL_POINTER : _to->IsACE(input, _retval); } \
  ...
  NS_SCRIPTABLE NS_IMETHOD ConvertToDisplayIDN(const nsACString & input, bool *isASCII NS_OUTPARAM, nsACString & _retval NS_OUTPARAM) { return !_to ? NS_ERROR_NULL_POINTER : _to->ConvertToDisplayIDN(input, isASCII, _retval); } 
...
/* boolean isACE (in ACString input); */
NS_IMETHODIMP nsIDNService::IsACE(const nsACString & input, bool *_retval NS_OUTPARAM)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
...
/* AUTF8String convertToDisplayIDN (in AUTF8String input, out boolean isASCII); */
NS_IMETHODIMP nsIDNService::ConvertToDisplayIDN(const nsACString & input, bool *isASCII NS_OUTPARAM, nsACString & _retval NS_OUTPARAM)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
