/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM /jds/packages/BUILD/SUNWfirefox-10.0.2/firefox/netwerk/base/public/nsIIOService.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIIOService : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD GetOffline(bool *aOffline) = 0;
  NS_SCRIPTABLE NS_IMETHOD SetOffline(bool aOffline) = 0;

  /* boolean allowPort (in long aPort, in string aScheme); */
  NS_SCRIPTABLE NS_IMETHOD AllowPort(PRInt32 aPort, const char * aScheme, bool *_retval NS_OUTPARAM) = 0;
...
#define NS_DECL_NSIIOSERVICE \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetOffline(bool *aOffline); \
  NS_SCRIPTABLE NS_IMETHOD SetOffline(bool aOffline); \
  NS_SCRIPTABLE NS_IMETHOD AllowPort(PRInt32 aPort, const char * aScheme, bool *_retval NS_OUTPARAM); \
...
#define NS_FORWARD_NSIIOSERVICE(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetOffline(bool *aOffline) { return _to GetOffline(aOffline); } \
  NS_SCRIPTABLE NS_IMETHOD SetOffline(bool aOffline) { return _to SetOffline(aOffline); } \
  NS_SCRIPTABLE NS_IMETHOD AllowPort(PRInt32 aPort, const char * aScheme, bool *_retval NS_OUTPARAM) { return _to AllowPort(aPort, aScheme, _retval); } \
...
#define NS_FORWARD_SAFE_NSIIOSERVICE(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetOffline(bool *aOffline) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetOffline(aOffline); } \
  NS_SCRIPTABLE NS_IMETHOD SetOffline(bool aOffline) { return !_to ? NS_ERROR_NULL_POINTER : _to->SetOffline(aOffline); } \
  NS_SCRIPTABLE NS_IMETHOD AllowPort(PRInt32 aPort, const char * aScheme, bool *_retval NS_OUTPARAM) { return !_to ? NS_ERROR_NULL_POINTER : _to->AllowPort(aPort, aScheme, _retval); } \
...
/* boolean allowPort (in long aPort, in string aScheme); */
NS_IMETHODIMP nsIOService::AllowPort(PRInt32 aPort, const char * aScheme, bool *_retval NS_OUTPARAM)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
