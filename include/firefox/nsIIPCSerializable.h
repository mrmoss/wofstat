/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM /jds/packages/BUILD/SUNWfirefox-10.0.2/firefox/netwerk/base/public/nsIIPCSerializable.idl
 */
...
class NS_NO_VTABLE nsIIPCSerializable : public nsISupports {
 public: 
  ...
  NS_IMETHOD_(bool) Read(const IPC::Message *msg, void* *iter) = 0;
...
#define NS_DECL_NSIIPCSERIALIZABLE \
  NS_IMETHOD_(bool) Read(const IPC::Message *msg, void* *iter); \
  NS_IMETHOD_(void) Write(IPC::Message *msg); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSIIPCSERIALIZABLE(_to) \
  NS_IMETHOD_(bool) Read(const IPC::Message *msg, void* *iter) { return _to Read(msg, iter); } \
...
#define NS_FORWARD_SAFE_NSIIPCSERIALIZABLE(_to) \
  NS_IMETHOD_(bool) Read(const IPC::Message *msg, void* *iter) { return !_to ? NS_ERROR_NULL_POINTER : _to->Read(msg, iter); } \
...
/* [notxpcom] boolean read (in ConstMessage msg, in Iterator iter); */
NS_IMETHODIMP_(bool) nsIPCSerializable::Read(const IPC::Message *msg, void* *iter)
{
