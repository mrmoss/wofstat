/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM /jds/packages/BUILD/SUNWfirefox-10.0.2/firefox/content/html/document/public/nsIImageDocument.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIImageDocument : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD GetImageResizingEnabled(bool *aImageResizingEnabled) = 0;

  /* readonly attribute boolean imageIsOverflowing; */
  NS_SCRIPTABLE NS_IMETHOD GetImageIsOverflowing(bool *aImageIsOverflowing) = 0;

  /* readonly attribute boolean imageIsResized; */
  NS_SCRIPTABLE NS_IMETHOD GetImageIsResized(bool *aImageIsResized) = 0;
...
#define NS_DECL_NSIIMAGEDOCUMENT \
  NS_SCRIPTABLE NS_IMETHOD GetImageResizingEnabled(bool *aImageResizingEnabled); \
  NS_SCRIPTABLE NS_IMETHOD GetImageIsOverflowing(bool *aImageIsOverflowing); \
  NS_SCRIPTABLE NS_IMETHOD GetImageIsResized(bool *aImageIsResized); \
...
#define NS_FORWARD_NSIIMAGEDOCUMENT(_to) \
  NS_SCRIPTABLE NS_IMETHOD GetImageResizingEnabled(bool *aImageResizingEnabled) { return _to GetImageResizingEnabled(aImageResizingEnabled); } \
  NS_SCRIPTABLE NS_IMETHOD GetImageIsOverflowing(bool *aImageIsOverflowing) { return _to GetImageIsOverflowing(aImageIsOverflowing); } \
  NS_SCRIPTABLE NS_IMETHOD GetImageIsResized(bool *aImageIsResized) { return _to GetImageIsResized(aImageIsResized); } \
...
#define NS_FORWARD_SAFE_NSIIMAGEDOCUMENT(_to) \
  NS_SCRIPTABLE NS_IMETHOD GetImageResizingEnabled(bool *aImageResizingEnabled) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetImageResizingEnabled(aImageResizingEnabled); } \
  NS_SCRIPTABLE NS_IMETHOD GetImageIsOverflowing(bool *aImageIsOverflowing) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetImageIsOverflowing(aImageIsOverflowing); } \
  NS_SCRIPTABLE NS_IMETHOD GetImageIsResized(bool *aImageIsResized) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetImageIsResized(aImageIsResized); } \
