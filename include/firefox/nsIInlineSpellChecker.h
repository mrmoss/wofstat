/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM /jds/packages/BUILD/SUNWfirefox-10.0.2/firefox/editor/txtsvc/public/nsIInlineSpellChecker.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIInlineSpellChecker : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD GetEnableRealTimeSpell(bool *aEnableRealTimeSpell) = 0;
  NS_SCRIPTABLE NS_IMETHOD SetEnableRealTimeSpell(bool aEnableRealTimeSpell) = 0;
...
#define NS_DECL_NSIINLINESPELLCHECKER \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetEnableRealTimeSpell(bool *aEnableRealTimeSpell); \
  NS_SCRIPTABLE NS_IMETHOD SetEnableRealTimeSpell(bool aEnableRealTimeSpell); \
...
#define NS_FORWARD_NSIINLINESPELLCHECKER(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetEnableRealTimeSpell(bool *aEnableRealTimeSpell) { return _to GetEnableRealTimeSpell(aEnableRealTimeSpell); } \
  NS_SCRIPTABLE NS_IMETHOD SetEnableRealTimeSpell(bool aEnableRealTimeSpell) { return _to SetEnableRealTimeSpell(aEnableRealTimeSpell); } \
...
#define NS_FORWARD_SAFE_NSIINLINESPELLCHECKER(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetEnableRealTimeSpell(bool *aEnableRealTimeSpell) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetEnableRealTimeSpell(aEnableRealTimeSpell); } \
  NS_SCRIPTABLE NS_IMETHOD SetEnableRealTimeSpell(bool aEnableRealTimeSpell) { return !_to ? NS_ERROR_NULL_POINTER : _to->SetEnableRealTimeSpell(aEnableRealTimeSpell); } \
