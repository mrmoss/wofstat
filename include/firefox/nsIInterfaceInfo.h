/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM /jds/packages/BUILD/SUNWfirefox-10.0.2/firefox/xpcom/reflect/xptinfo/public/nsIInterfaceInfo.idl
 */
...
class NS_NO_VTABLE nsIInterfaceInfo : public nsISupports {
 public: 
  ...
  NS_IMETHOD IsScriptable(bool *_retval NS_OUTPARAM) = 0;

  /* boolean isBuiltinClass (); */
  NS_IMETHOD IsBuiltinClass(bool *_retval NS_OUTPARAM) = 0;
  ...
  NS_IMETHOD IsIID(const nsIID *IID, bool *_retval NS_OUTPARAM) = 0;
  ...
  /* boolean isFunction (); */
  NS_IMETHOD IsFunction(bool *_retval NS_OUTPARAM) = 0;

  /* boolean hasAncestor (in nsIIDPtr iid); */
  NS_IMETHOD HasAncestor(const nsIID *iid, bool *_retval NS_OUTPARAM) = 0;
...
#define NS_DECL_NSIINTERFACEINFO \
  ...
  NS_IMETHOD IsScriptable(bool *_retval NS_OUTPARAM); \
  NS_IMETHOD IsBuiltinClass(bool *_retval NS_OUTPARAM); \
  ...
  NS_IMETHOD IsIID(const nsIID *IID, bool *_retval NS_OUTPARAM); \
  NS_IMETHOD GetNameShared(const char * *name NS_OUTPARAM); \
  NS_IMETHOD GetIIDShared(const nsIID **iid NS_OUTPARAM); \
  NS_IMETHOD IsFunction(bool *_retval NS_OUTPARAM); \
  NS_IMETHOD HasAncestor(const nsIID *iid, bool *_retval NS_OUTPARAM); \
...
#define NS_FORWARD_NSIINTERFACEINFO(_to) \
  ...
  NS_IMETHOD IsScriptable(bool *_retval NS_OUTPARAM) { return _to IsScriptable(_retval); } \
  NS_IMETHOD IsBuiltinClass(bool *_retval NS_OUTPARAM) { return _to IsBuiltinClass(_retval); } \
  ...
  NS_IMETHOD IsIID(const nsIID *IID, bool *_retval NS_OUTPARAM) { return _to IsIID(IID, _retval); } \
  ...
  NS_IMETHOD IsFunction(bool *_retval NS_OUTPARAM) { return _to IsFunction(_retval); } \
  NS_IMETHOD HasAncestor(const nsIID *iid, bool *_retval NS_OUTPARAM) { return _to HasAncestor(iid, _retval); } \
...
#define NS_FORWARD_SAFE_NSIINTERFACEINFO(_to) \
  ...
  NS_IMETHOD IsScriptable(bool *_retval NS_OUTPARAM) { return !_to ? NS_ERROR_NULL_POINTER : _to->IsScriptable(_retval); } \
  NS_IMETHOD IsBuiltinClass(bool *_retval NS_OUTPARAM) { return !_to ? NS_ERROR_NULL_POINTER : _to->IsBuiltinClass(_retval); } \
  ...
  NS_IMETHOD IsIID(const nsIID *IID, bool *_retval NS_OUTPARAM) { return !_to ? NS_ERROR_NULL_POINTER : _to->IsIID(IID, _retval); } \
  ...
  NS_IMETHOD IsFunction(bool *_retval NS_OUTPARAM) { return !_to ? NS_ERROR_NULL_POINTER : _to->IsFunction(_retval); } \
  NS_IMETHOD HasAncestor(const nsIID *iid, bool *_retval NS_OUTPARAM) { return !_to ? NS_ERROR_NULL_POINTER : _to->HasAncestor(iid, _retval); } \
...
/* boolean isScriptable (); */
NS_IMETHODIMP nsInterfaceInfo::IsScriptable(bool *_retval NS_OUTPARAM)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}

/* boolean isBuiltinClass (); */
NS_IMETHODIMP nsInterfaceInfo::IsBuiltinClass(bool *_retval NS_OUTPARAM)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
...
/* boolean isIID (in nsIIDPtr IID); */
NS_IMETHODIMP nsInterfaceInfo::IsIID(const nsIID *IID, bool *_retval NS_OUTPARAM)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
...
/* boolean isFunction (); */
NS_IMETHODIMP nsInterfaceInfo::IsFunction(bool *_retval NS_OUTPARAM)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}

/* boolean hasAncestor (in nsIIDPtr iid); */
NS_IMETHODIMP nsInterfaceInfo::HasAncestor(const nsIID *iid, bool *_retval NS_OUTPARAM)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
