/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM /jds/packages/BUILD/SUNWfirefox-10.0.2/firefox/xpcom/reflect/xptinfo/public/nsIInterfaceInfoManager.idl
 */
...
class NS_NO_VTABLE nsIInterfaceInfoSuperManager : public nsIInterfaceInfoManager {
 public: 
  ...
  NS_IMETHOD HasAdditionalManagers(bool *_retval NS_OUTPARAM) = 0;
...
#define NS_DECL_NSIINTERFACEINFOSUPERMANAGER \
  ...
  NS_IMETHOD HasAdditionalManagers(bool *_retval NS_OUTPARAM); \
...
#define NS_FORWARD_NSIINTERFACEINFOSUPERMANAGER(_to) \
  ...
  NS_IMETHOD HasAdditionalManagers(bool *_retval NS_OUTPARAM) { return _to HasAdditionalManagers(_retval); } \
...
#define NS_FORWARD_SAFE_NSIINTERFACEINFOSUPERMANAGER(_to) \
  ...
  NS_IMETHOD HasAdditionalManagers(bool *_retval NS_OUTPARAM) { return !_to ? NS_ERROR_NULL_POINTER : _to->HasAdditionalManagers(_retval); } \
...
/* boolean hasAdditionalManagers (); */
NS_IMETHODIMP nsInterfaceInfoSuperManager::HasAdditionalManagers(bool *_retval NS_OUTPARAM)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
