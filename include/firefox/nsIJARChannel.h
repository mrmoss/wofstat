/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM /jds/packages/BUILD/SUNWfirefox-10.0.2/firefox/modules/libjar/nsIJARChannel.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIJARChannel : public nsIChannel {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD GetIsUnsafe(bool *aIsUnsafe) = 0;
...
#define NS_DECL_NSIJARCHANNEL \
  NS_SCRIPTABLE NS_IMETHOD GetIsUnsafe(bool *aIsUnsafe); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSIJARCHANNEL(_to) \
  NS_SCRIPTABLE NS_IMETHOD GetIsUnsafe(bool *aIsUnsafe) { return _to GetIsUnsafe(aIsUnsafe); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_NSIJARCHANNEL(_to) \
  NS_SCRIPTABLE NS_IMETHOD GetIsUnsafe(bool *aIsUnsafe) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetIsUnsafe(aIsUnsafe); } 
