/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM /jds/packages/BUILD/SUNWfirefox-10.0.2/firefox/dom/interfaces/json/nsIJSON.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIJSON : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD EncodeToStream(nsIOutputStream *stream, const char * charset, bool writeBOM) = 0;
...
#define NS_DECL_NSIJSON \
  ...
  NS_SCRIPTABLE NS_IMETHOD EncodeToStream(nsIOutputStream *stream, const char * charset, bool writeBOM); \
...
#define NS_FORWARD_NSIJSON(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD EncodeToStream(nsIOutputStream *stream, const char * charset, bool writeBOM) { return _to EncodeToStream(stream, charset, writeBOM); } \
...
#define NS_FORWARD_SAFE_NSIJSON(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD EncodeToStream(nsIOutputStream *stream, const char * charset, bool writeBOM) { return !_to ? NS_ERROR_NULL_POINTER : _to->EncodeToStream(stream, charset, writeBOM); } \
...
/* [deprecated] void encodeToStream (in nsIOutputStream stream, in string charset, in boolean writeBOM); */
NS_IMETHODIMP nsJSON::EncodeToStream(nsIOutputStream *stream, const char * charset, bool writeBOM)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
