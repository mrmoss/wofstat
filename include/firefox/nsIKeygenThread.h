/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM /jds/packages/BUILD/SUNWfirefox-10.0.2/firefox/security/manager/ssl/public/nsIKeygenThread.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIKeygenThread : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD UserCanceled(bool *threadAlreadyClosedDialog NS_OUTPARAM) = 0;
...
#define NS_DECL_NSIKEYGENTHREAD \
  ...
  NS_SCRIPTABLE NS_IMETHOD UserCanceled(bool *threadAlreadyClosedDialog NS_OUTPARAM); 
...
#define NS_FORWARD_NSIKEYGENTHREAD(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD UserCanceled(bool *threadAlreadyClosedDialog NS_OUTPARAM) { return _to UserCanceled(threadAlreadyClosedDialog); } 
...
#define NS_FORWARD_SAFE_NSIKEYGENTHREAD(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD UserCanceled(bool *threadAlreadyClosedDialog NS_OUTPARAM) { return !_to ? NS_ERROR_NULL_POINTER : _to->UserCanceled(threadAlreadyClosedDialog); } 
...
/* void userCanceled (out boolean threadAlreadyClosedDialog); */
NS_IMETHODIMP nsKeygenThread::UserCanceled(bool *threadAlreadyClosedDialog NS_OUTPARAM)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
