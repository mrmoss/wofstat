/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM /jds/packages/BUILD/SUNWfirefox-10.0.2/firefox/toolkit/components/places/nsILivemarkService.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsILivemarkService : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD IsLivemark(PRInt64 folder, bool *_retval NS_OUTPARAM) = 0;
...
#define NS_DECL_NSILIVEMARKSERVICE \
  ...
  NS_SCRIPTABLE NS_IMETHOD IsLivemark(PRInt64 folder, bool *_retval NS_OUTPARAM); \
...
#define NS_FORWARD_NSILIVEMARKSERVICE(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD IsLivemark(PRInt64 folder, bool *_retval NS_OUTPARAM) { return _to IsLivemark(folder, _retval); } \
...
#define NS_FORWARD_SAFE_NSILIVEMARKSERVICE(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD IsLivemark(PRInt64 folder, bool *_retval NS_OUTPARAM) { return !_to ? NS_ERROR_NULL_POINTER : _to->IsLivemark(folder, _retval); } \
...
/* boolean isLivemark (in long long folder); */
NS_IMETHODIMP nsLivemarkService::IsLivemark(PRInt64 folder, bool *_retval NS_OUTPARAM)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
