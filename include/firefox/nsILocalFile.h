/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM /jds/packages/BUILD/SUNWfirefox-10.0.2/firefox/xpcom/io/nsILocalFile.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsILocalFile : public nsIFile {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD GetFollowLinks(bool *aFollowLinks) = 0;
  NS_SCRIPTABLE NS_IMETHOD SetFollowLinks(bool aFollowLinks) = 0;

  enum { OS_READAHEAD = 1073741824U };
...
#define NS_DECL_NSILOCALFILE \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetFollowLinks(bool *aFollowLinks); \
  NS_SCRIPTABLE NS_IMETHOD SetFollowLinks(bool aFollowLinks); \
...
#define NS_FORWARD_NSILOCALFILE(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetFollowLinks(bool *aFollowLinks) { return _to GetFollowLinks(aFollowLinks); } \
  NS_SCRIPTABLE NS_IMETHOD SetFollowLinks(bool aFollowLinks) { return _to SetFollowLinks(aFollowLinks); } \
...
#define NS_FORWARD_SAFE_NSILOCALFILE(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetFollowLinks(bool *aFollowLinks) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetFollowLinks(aFollowLinks); } \
  NS_SCRIPTABLE NS_IMETHOD SetFollowLinks(bool aFollowLinks) { return !_to ? NS_ERROR_NULL_POINTER : _to->SetFollowLinks(aFollowLinks); } \
