/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM /jds/packages/BUILD/SUNWfirefox-10.0.2/firefox/toolkit/components/passwordmgr/nsILoginInfo.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsILoginInfo : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD Equals(nsILoginInfo *aLoginInfo, bool *_retval NS_OUTPARAM) = 0;

  /* boolean matches (in nsILoginInfo aLoginInfo, in boolean ignorePassword); */
  NS_SCRIPTABLE NS_IMETHOD Matches(nsILoginInfo *aLoginInfo, bool ignorePassword, bool *_retval NS_OUTPARAM) = 0;
...
#define NS_DECL_NSILOGININFO \
  ...
  NS_SCRIPTABLE NS_IMETHOD Equals(nsILoginInfo *aLoginInfo, bool *_retval NS_OUTPARAM); \
  NS_SCRIPTABLE NS_IMETHOD Matches(nsILoginInfo *aLoginInfo, bool ignorePassword, bool *_retval NS_OUTPARAM); \
...
#define NS_FORWARD_NSILOGININFO(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD Equals(nsILoginInfo *aLoginInfo, bool *_retval NS_OUTPARAM) { return _to Equals(aLoginInfo, _retval); } \
  NS_SCRIPTABLE NS_IMETHOD Matches(nsILoginInfo *aLoginInfo, bool ignorePassword, bool *_retval NS_OUTPARAM) { return _to Matches(aLoginInfo, ignorePassword, _retval); } \
...
#define NS_FORWARD_SAFE_NSILOGININFO(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD Equals(nsILoginInfo *aLoginInfo, bool *_retval NS_OUTPARAM) { return !_to ? NS_ERROR_NULL_POINTER : _to->Equals(aLoginInfo, _retval); } \
  NS_SCRIPTABLE NS_IMETHOD Matches(nsILoginInfo *aLoginInfo, bool ignorePassword, bool *_retval NS_OUTPARAM) { return !_to ? NS_ERROR_NULL_POINTER : _to->Matches(aLoginInfo, ignorePassword, _retval); } \
...
/* boolean equals (in nsILoginInfo aLoginInfo); */
NS_IMETHODIMP nsLoginInfo::Equals(nsILoginInfo *aLoginInfo, bool *_retval NS_OUTPARAM)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}

/* boolean matches (in nsILoginInfo aLoginInfo, in boolean ignorePassword); */
NS_IMETHODIMP nsLoginInfo::Matches(nsILoginInfo *aLoginInfo, bool ignorePassword, bool *_retval NS_OUTPARAM)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
