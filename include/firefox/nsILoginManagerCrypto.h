/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM /jds/packages/BUILD/SUNWfirefox-10.0.2/firefox/toolkit/components/passwordmgr/nsILoginManagerCrypto.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsILoginManagerCrypto : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD GetIsLoggedIn(bool *aIsLoggedIn) = 0;
...
#define NS_DECL_NSILOGINMANAGERCRYPTO \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetIsLoggedIn(bool *aIsLoggedIn); 
...
#define NS_FORWARD_NSILOGINMANAGERCRYPTO(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetIsLoggedIn(bool *aIsLoggedIn) { return _to GetIsLoggedIn(aIsLoggedIn); } 
...
#define NS_FORWARD_SAFE_NSILOGINMANAGERCRYPTO(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetIsLoggedIn(bool *aIsLoggedIn) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetIsLoggedIn(aIsLoggedIn); } 
