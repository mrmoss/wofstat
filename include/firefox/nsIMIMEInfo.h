/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM /jds/packages/BUILD/SUNWfirefox-10.0.2/firefox/netwerk/mime/nsIMIMEInfo.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIHandlerInfo : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD GetHasDefaultHandler(bool *aHasDefaultHandler) = 0;
  ...
  NS_SCRIPTABLE NS_IMETHOD GetAlwaysAskBeforeHandling(bool *aAlwaysAskBeforeHandling) = 0;
  NS_SCRIPTABLE NS_IMETHOD SetAlwaysAskBeforeHandling(bool aAlwaysAskBeforeHandling) = 0;
...
#define NS_DECL_NSIHANDLERINFO \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetHasDefaultHandler(bool *aHasDefaultHandler); \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetAlwaysAskBeforeHandling(bool *aAlwaysAskBeforeHandling); \
  NS_SCRIPTABLE NS_IMETHOD SetAlwaysAskBeforeHandling(bool aAlwaysAskBeforeHandling); 
...
#define NS_FORWARD_NSIHANDLERINFO(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetHasDefaultHandler(bool *aHasDefaultHandler) { return _to GetHasDefaultHandler(aHasDefaultHandler); } \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetAlwaysAskBeforeHandling(bool *aAlwaysAskBeforeHandling) { return _to GetAlwaysAskBeforeHandling(aAlwaysAskBeforeHandling); } \
  NS_SCRIPTABLE NS_IMETHOD SetAlwaysAskBeforeHandling(bool aAlwaysAskBeforeHandling) { return _to SetAlwaysAskBeforeHandling(aAlwaysAskBeforeHandling); } 
...
#define NS_FORWARD_SAFE_NSIHANDLERINFO(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetHasDefaultHandler(bool *aHasDefaultHandler) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetHasDefaultHandler(aHasDefaultHandler); } \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetAlwaysAskBeforeHandling(bool *aAlwaysAskBeforeHandling) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetAlwaysAskBeforeHandling(aAlwaysAskBeforeHandling); } \
  NS_SCRIPTABLE NS_IMETHOD SetAlwaysAskBeforeHandling(bool aAlwaysAskBeforeHandling) { return !_to ? NS_ERROR_NULL_POINTER : _to->SetAlwaysAskBeforeHandling(aAlwaysAskBeforeHandling); } 
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIMIMEInfo : public nsIHandlerInfo {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD ExtensionExists(const nsACString & aExtension, bool *_retval NS_OUTPARAM) = 0;
  ...
  NS_SCRIPTABLE NS_IMETHOD Equals(nsIMIMEInfo *aMIMEInfo, bool *_retval NS_OUTPARAM) = 0;
...
#define NS_DECL_NSIMIMEINFO \
  ...
  NS_SCRIPTABLE NS_IMETHOD ExtensionExists(const nsACString & aExtension, bool *_retval NS_OUTPARAM); \
  ...
  NS_SCRIPTABLE NS_IMETHOD Equals(nsIMIMEInfo *aMIMEInfo, bool *_retval NS_OUTPARAM); \
...
#define NS_FORWARD_NSIMIMEINFO(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD ExtensionExists(const nsACString & aExtension, bool *_retval NS_OUTPARAM) { return _to ExtensionExists(aExtension, _retval); } \
  ...
  NS_SCRIPTABLE NS_IMETHOD Equals(nsIMIMEInfo *aMIMEInfo, bool *_retval NS_OUTPARAM) { return _to Equals(aMIMEInfo, _retval); } \
...
#define NS_FORWARD_SAFE_NSIMIMEINFO(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD ExtensionExists(const nsACString & aExtension, bool *_retval NS_OUTPARAM) { return !_to ? NS_ERROR_NULL_POINTER : _to->ExtensionExists(aExtension, _retval); } \
  ...
  NS_SCRIPTABLE NS_IMETHOD Equals(nsIMIMEInfo *aMIMEInfo, bool *_retval NS_OUTPARAM) { return !_to ? NS_ERROR_NULL_POINTER : _to->Equals(aMIMEInfo, _retval); } \
...
/* boolean extensionExists (in AUTF8String aExtension); */
NS_IMETHODIMP nsMIMEInfo::ExtensionExists(const nsACString & aExtension, bool *_retval NS_OUTPARAM)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
...
/* boolean equals (in nsIMIMEInfo aMIMEInfo); */
NS_IMETHODIMP nsMIMEInfo::Equals(nsIMIMEInfo *aMIMEInfo, bool *_retval NS_OUTPARAM)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIHandlerApp : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD Equals(nsIHandlerApp *aHandlerApp, bool *_retval NS_OUTPARAM) = 0;
...
#define NS_DECL_NSIHANDLERAPP \
  ...
  NS_SCRIPTABLE NS_IMETHOD Equals(nsIHandlerApp *aHandlerApp, bool *_retval NS_OUTPARAM); \
  NS_SCRIPTABLE NS_IMETHOD LaunchWithURI(nsIURI *aURI, nsIInterfaceRequestor *aWindowContext); 
...
#define NS_FORWARD_NSIHANDLERAPP(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD Equals(nsIHandlerApp *aHandlerApp, bool *_retval NS_OUTPARAM) { return _to Equals(aHandlerApp, _retval); } \
  NS_SCRIPTABLE NS_IMETHOD LaunchWithURI(nsIURI *aURI, nsIInterfaceRequestor *aWindowContext) { return _to LaunchWithURI(aURI, aWindowContext); } 
...
#define NS_FORWARD_SAFE_NSIHANDLERAPP(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD Equals(nsIHandlerApp *aHandlerApp, bool *_retval NS_OUTPARAM) { return !_to ? NS_ERROR_NULL_POINTER : _to->Equals(aHandlerApp, _retval); } \
  NS_SCRIPTABLE NS_IMETHOD LaunchWithURI(nsIURI *aURI, nsIInterfaceRequestor *aWindowContext) { return !_to ? NS_ERROR_NULL_POINTER : _to->LaunchWithURI(aURI, aWindowContext); } 
...
/* boolean equals (in nsIHandlerApp aHandlerApp); */
NS_IMETHODIMP nsHandlerApp::Equals(nsIHandlerApp *aHandlerApp, bool *_retval NS_OUTPARAM)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
...
class NS_NO_VTABLE NS_SCRIPTABLE nsILocalHandlerApp : public nsIHandlerApp {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD ParameterExists(const nsAString & param, bool *_retval NS_OUTPARAM) = 0;
...
#define NS_DECL_NSILOCALHANDLERAPP \
  ...
  NS_SCRIPTABLE NS_IMETHOD ParameterExists(const nsAString & param, bool *_retval NS_OUTPARAM); 
...
#define NS_FORWARD_NSILOCALHANDLERAPP(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD ParameterExists(const nsAString & param, bool *_retval NS_OUTPARAM) { return _to ParameterExists(param, _retval); } 
...
#define NS_FORWARD_SAFE_NSILOCALHANDLERAPP(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD ParameterExists(const nsAString & param, bool *_retval NS_OUTPARAM) { return !_to ? NS_ERROR_NULL_POINTER : _to->ParameterExists(param, _retval); } 
...
/* boolean parameterExists (in AString param); */
NS_IMETHODIMP nsLocalHandlerApp::ParameterExists(const nsAString & param, bool *_retval NS_OUTPARAM)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
