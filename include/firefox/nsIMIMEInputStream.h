/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM /jds/packages/BUILD/SUNWfirefox-10.0.2/firefox/netwerk/base/public/nsIMIMEInputStream.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIMIMEInputStream : public nsIInputStream {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD GetAddContentLength(bool *aAddContentLength) = 0;
  NS_SCRIPTABLE NS_IMETHOD SetAddContentLength(bool aAddContentLength) = 0;
...
#define NS_DECL_NSIMIMEINPUTSTREAM \
  NS_SCRIPTABLE NS_IMETHOD GetAddContentLength(bool *aAddContentLength); \
  NS_SCRIPTABLE NS_IMETHOD SetAddContentLength(bool aAddContentLength); \
...
#define NS_FORWARD_NSIMIMEINPUTSTREAM(_to) \
  NS_SCRIPTABLE NS_IMETHOD GetAddContentLength(bool *aAddContentLength) { return _to GetAddContentLength(aAddContentLength); } \
  NS_SCRIPTABLE NS_IMETHOD SetAddContentLength(bool aAddContentLength) { return _to SetAddContentLength(aAddContentLength); } \
...
#define NS_FORWARD_SAFE_NSIMIMEINPUTSTREAM(_to) \
  NS_SCRIPTABLE NS_IMETHOD GetAddContentLength(bool *aAddContentLength) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetAddContentLength(aAddContentLength); } \
  NS_SCRIPTABLE NS_IMETHOD SetAddContentLength(bool aAddContentLength) { return !_to ? NS_ERROR_NULL_POINTER : _to->SetAddContentLength(aAddContentLength); } \
