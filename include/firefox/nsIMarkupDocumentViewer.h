/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM /jds/packages/BUILD/SUNWfirefox-10.0.2/firefox/docshell/base/nsIMarkupDocumentViewer.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIMarkupDocumentViewer : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD GetAuthorStyleDisabled(bool *aAuthorStyleDisabled) = 0;
  NS_SCRIPTABLE NS_IMETHOD SetAuthorStyleDisabled(bool aAuthorStyleDisabled) = 0;
...
#define NS_DECL_NSIMARKUPDOCUMENTVIEWER \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetAuthorStyleDisabled(bool *aAuthorStyleDisabled); \
  NS_SCRIPTABLE NS_IMETHOD SetAuthorStyleDisabled(bool aAuthorStyleDisabled); \
...
#define NS_FORWARD_NSIMARKUPDOCUMENTVIEWER(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetAuthorStyleDisabled(bool *aAuthorStyleDisabled) { return _to GetAuthorStyleDisabled(aAuthorStyleDisabled); } \
  NS_SCRIPTABLE NS_IMETHOD SetAuthorStyleDisabled(bool aAuthorStyleDisabled) { return _to SetAuthorStyleDisabled(aAuthorStyleDisabled); } \
...
#define NS_FORWARD_SAFE_NSIMARKUPDOCUMENTVIEWER(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetAuthorStyleDisabled(bool *aAuthorStyleDisabled) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetAuthorStyleDisabled(aAuthorStyleDisabled); } \
  NS_SCRIPTABLE NS_IMETHOD SetAuthorStyleDisabled(bool aAuthorStyleDisabled) { return !_to ? NS_ERROR_NULL_POINTER : _to->SetAuthorStyleDisabled(aAuthorStyleDisabled); } \
