/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM /jds/packages/BUILD/SUNWfirefox-10.0.2/firefox/xpcom/base/nsIMemory.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIMemory : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD HeapMinimize(bool immediate) = 0;

  /* boolean isLowMemory (); */
  NS_SCRIPTABLE NS_IMETHOD IsLowMemory(bool *_retval NS_OUTPARAM) = 0;
...
#define NS_DECL_NSIMEMORY \
  ...
  NS_SCRIPTABLE NS_IMETHOD HeapMinimize(bool immediate); \
  NS_SCRIPTABLE NS_IMETHOD IsLowMemory(bool *_retval NS_OUTPARAM); 
...
#define NS_FORWARD_NSIMEMORY(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD HeapMinimize(bool immediate) { return _to HeapMinimize(immediate); } \
  NS_SCRIPTABLE NS_IMETHOD IsLowMemory(bool *_retval NS_OUTPARAM) { return _to IsLowMemory(_retval); } 
...
#define NS_FORWARD_SAFE_NSIMEMORY(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD HeapMinimize(bool immediate) { return !_to ? NS_ERROR_NULL_POINTER : _to->HeapMinimize(immediate); } \
  NS_SCRIPTABLE NS_IMETHOD IsLowMemory(bool *_retval NS_OUTPARAM) { return !_to ? NS_ERROR_NULL_POINTER : _to->IsLowMemory(_retval); } 
...
/* boolean isLowMemory (); */
NS_IMETHODIMP nsMemory::IsLowMemory(bool *_retval NS_OUTPARAM)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
