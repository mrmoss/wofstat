/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM /jds/packages/BUILD/SUNWfirefox-10.0.2/firefox/layout/xul/base/public/nsIMenuBoxObject.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIMenuBoxObject : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD OpenMenu(bool openFlag) = 0;
  ...
  NS_SCRIPTABLE NS_IMETHOD HandleKeyPress(nsIDOMKeyEvent *keyEvent, bool *_retval NS_OUTPARAM) = 0;

  /* readonly attribute boolean openedWithKey; */
  NS_SCRIPTABLE NS_IMETHOD GetOpenedWithKey(bool *aOpenedWithKey) = 0;
...
#define NS_DECL_NSIMENUBOXOBJECT \
  NS_SCRIPTABLE NS_IMETHOD OpenMenu(bool openFlag); \
  ...
  NS_SCRIPTABLE NS_IMETHOD HandleKeyPress(nsIDOMKeyEvent *keyEvent, bool *_retval NS_OUTPARAM); \
  NS_SCRIPTABLE NS_IMETHOD GetOpenedWithKey(bool *aOpenedWithKey); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSIMENUBOXOBJECT(_to) \
  NS_SCRIPTABLE NS_IMETHOD OpenMenu(bool openFlag) { return _to OpenMenu(openFlag); } \
  ...
  NS_SCRIPTABLE NS_IMETHOD HandleKeyPress(nsIDOMKeyEvent *keyEvent, bool *_retval NS_OUTPARAM) { return _to HandleKeyPress(keyEvent, _retval); } \
  NS_SCRIPTABLE NS_IMETHOD GetOpenedWithKey(bool *aOpenedWithKey) { return _to GetOpenedWithKey(aOpenedWithKey); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_NSIMENUBOXOBJECT(_to) \
  NS_SCRIPTABLE NS_IMETHOD OpenMenu(bool openFlag) { return !_to ? NS_ERROR_NULL_POINTER : _to->OpenMenu(openFlag); } \
  ...
  NS_SCRIPTABLE NS_IMETHOD HandleKeyPress(nsIDOMKeyEvent *keyEvent, bool *_retval NS_OUTPARAM) { return !_to ? NS_ERROR_NULL_POINTER : _to->HandleKeyPress(keyEvent, _retval); } \
  NS_SCRIPTABLE NS_IMETHOD GetOpenedWithKey(bool *aOpenedWithKey) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetOpenedWithKey(aOpenedWithKey); } 
...
/* boolean handleKeyPress (in nsIDOMKeyEvent keyEvent); */
NS_IMETHODIMP nsMenuBoxObject::HandleKeyPress(nsIDOMKeyEvent *keyEvent, bool *_retval NS_OUTPARAM)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
