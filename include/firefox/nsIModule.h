/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM /jds/packages/BUILD/SUNWfirefox-10.0.2/firefox/xpcom/components/nsIModule.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIModule : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD CanUnload(nsIComponentManager *aCompMgr, bool *_retval NS_OUTPARAM) = 0;
...
#define NS_DECL_NSIMODULE \
  ...
  NS_SCRIPTABLE NS_IMETHOD CanUnload(nsIComponentManager *aCompMgr, bool *_retval NS_OUTPARAM); 
...
#define NS_FORWARD_NSIMODULE(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD CanUnload(nsIComponentManager *aCompMgr, bool *_retval NS_OUTPARAM) { return _to CanUnload(aCompMgr, _retval); } 
...
#define NS_FORWARD_SAFE_NSIMODULE(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD CanUnload(nsIComponentManager *aCompMgr, bool *_retval NS_OUTPARAM) { return !_to ? NS_ERROR_NULL_POINTER : _to->CanUnload(aCompMgr, _retval); } 
...
/* boolean canUnload (in nsIComponentManager aCompMgr); */
NS_IMETHODIMP nsModule::CanUnload(nsIComponentManager *aCompMgr, bool *_retval NS_OUTPARAM)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
