/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM /jds/packages/BUILD/SUNWfirefox-10.0.2/firefox/xpcom/base/nsIMutable.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIMutable : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD GetMutable(bool *aMutable) = 0;
  NS_SCRIPTABLE NS_IMETHOD SetMutable(bool aMutable) = 0;
...
#define NS_DECL_NSIMUTABLE \
  NS_SCRIPTABLE NS_IMETHOD GetMutable(bool *aMutable); \
  NS_SCRIPTABLE NS_IMETHOD SetMutable(bool aMutable); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSIMUTABLE(_to) \
  NS_SCRIPTABLE NS_IMETHOD GetMutable(bool *aMutable) { return _to GetMutable(aMutable); } \
  NS_SCRIPTABLE NS_IMETHOD SetMutable(bool aMutable) { return _to SetMutable(aMutable); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_NSIMUTABLE(_to) \
  NS_SCRIPTABLE NS_IMETHOD GetMutable(bool *aMutable) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetMutable(aMutable); } \
  NS_SCRIPTABLE NS_IMETHOD SetMutable(bool aMutable) { return !_to ? NS_ERROR_NULL_POINTER : _to->SetMutable(aMutable); } 
