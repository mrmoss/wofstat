/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM /jds/packages/BUILD/SUNWfirefox-10.0.2/firefox/netwerk/base/public/nsINSSErrorsService.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsINSSErrorsService : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD IsNSSErrorCode(PRInt32 aNSPRCode, bool *_retval NS_OUTPARAM) = 0;
...
#define NS_DECL_NSINSSERRORSSERVICE \
  NS_SCRIPTABLE NS_IMETHOD IsNSSErrorCode(PRInt32 aNSPRCode, bool *_retval NS_OUTPARAM); \
...
#define NS_FORWARD_NSINSSERRORSSERVICE(_to) \
  NS_SCRIPTABLE NS_IMETHOD IsNSSErrorCode(PRInt32 aNSPRCode, bool *_retval NS_OUTPARAM) { return _to IsNSSErrorCode(aNSPRCode, _retval); } \
...
#define NS_FORWARD_SAFE_NSINSSERRORSSERVICE(_to) \
  NS_SCRIPTABLE NS_IMETHOD IsNSSErrorCode(PRInt32 aNSPRCode, bool *_retval NS_OUTPARAM) { return !_to ? NS_ERROR_NULL_POINTER : _to->IsNSSErrorCode(aNSPRCode, _retval); } \
...
/* boolean isNSSErrorCode (in PRInt32 aNSPRCode); */
NS_IMETHODIMP nsNSSErrorsService::IsNSSErrorCode(PRInt32 aNSPRCode, bool *_retval NS_OUTPARAM)
{
