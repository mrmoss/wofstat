/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM /jds/packages/BUILD/SUNWfirefox-10.0.2/firefox/toolkit/xre/nsINativeAppSupport.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsINativeAppSupport : public nsISupports {
 public: 
  ...
  /* boolean start (); */
  NS_SCRIPTABLE NS_IMETHOD Start(bool *_retval NS_OUTPARAM) = 0;

  /* void enable (); */
  NS_SCRIPTABLE NS_IMETHOD Enable(void) = 0;

  /* boolean stop (); */
  NS_SCRIPTABLE NS_IMETHOD Stop(bool *_retval NS_OUTPARAM) = 0;
...
#define NS_DECL_NSINATIVEAPPSUPPORT \
  NS_SCRIPTABLE NS_IMETHOD Start(bool *_retval NS_OUTPARAM); \
  NS_SCRIPTABLE NS_IMETHOD Enable(void); \
  NS_SCRIPTABLE NS_IMETHOD Stop(bool *_retval NS_OUTPARAM); \
...
#define NS_FORWARD_NSINATIVEAPPSUPPORT(_to) \
  NS_SCRIPTABLE NS_IMETHOD Start(bool *_retval NS_OUTPARAM) { return _to Start(_retval); } \
  NS_SCRIPTABLE NS_IMETHOD Enable(void) { return _to Enable(); } \
  NS_SCRIPTABLE NS_IMETHOD Stop(bool *_retval NS_OUTPARAM) { return _to Stop(_retval); } \
...
#define NS_FORWARD_SAFE_NSINATIVEAPPSUPPORT(_to) \
  NS_SCRIPTABLE NS_IMETHOD Start(bool *_retval NS_OUTPARAM) { return !_to ? NS_ERROR_NULL_POINTER : _to->Start(_retval); } \
  NS_SCRIPTABLE NS_IMETHOD Enable(void) { return !_to ? NS_ERROR_NULL_POINTER : _to->Enable(); } \
  NS_SCRIPTABLE NS_IMETHOD Stop(bool *_retval NS_OUTPARAM) { return !_to ? NS_ERROR_NULL_POINTER : _to->Stop(_retval); } \
...
/* boolean start (); */
NS_IMETHODIMP nsNativeAppSupport::Start(bool *_retval NS_OUTPARAM)
{
...
/* boolean stop (); */
NS_IMETHODIMP nsNativeAppSupport::Stop(bool *_retval NS_OUTPARAM)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
