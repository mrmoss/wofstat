/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM /jds/packages/BUILD/SUNWfirefox-10.0.2/firefox/toolkit/components/places/nsINavHistoryService.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsINavHistoryContainerResultNode : public nsINavHistoryResultNode {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD GetContainerOpen(bool *aContainerOpen) = 0;
  NS_SCRIPTABLE NS_IMETHOD SetContainerOpen(bool aContainerOpen) = 0;
  ...
  NS_SCRIPTABLE NS_IMETHOD GetHasChildren(bool *aHasChildren) = 0;
  ...
  NS_SCRIPTABLE NS_IMETHOD FindNodeByDetails(const nsACString & aURIString, PRTime aTime, PRInt64 aItemId, bool aRecursive, nsINavHistoryResultNode * *_retval NS_OUTPARAM) = 0;

  /* readonly attribute boolean childrenReadOnly; */
  NS_SCRIPTABLE NS_IMETHOD GetChildrenReadOnly(bool *aChildrenReadOnly) = 0;
...
#define NS_DECL_NSINAVHISTORYCONTAINERRESULTNODE \
  NS_SCRIPTABLE NS_IMETHOD GetContainerOpen(bool *aContainerOpen); \
  NS_SCRIPTABLE NS_IMETHOD SetContainerOpen(bool aContainerOpen); \
  NS_SCRIPTABLE NS_IMETHOD GetState(PRUint16 *aState); \
  NS_SCRIPTABLE NS_IMETHOD GetHasChildren(bool *aHasChildren); \
  ...
  NS_SCRIPTABLE NS_IMETHOD FindNodeByDetails(const nsACString & aURIString, PRTime aTime, PRInt64 aItemId, bool aRecursive, nsINavHistoryResultNode * *_retval NS_OUTPARAM); \
  NS_SCRIPTABLE NS_IMETHOD GetChildrenReadOnly(bool *aChildrenReadOnly); \
...
#define NS_FORWARD_NSINAVHISTORYCONTAINERRESULTNODE(_to) \
  NS_SCRIPTABLE NS_IMETHOD GetContainerOpen(bool *aContainerOpen) { return _to GetContainerOpen(aContainerOpen); } \
  NS_SCRIPTABLE NS_IMETHOD SetContainerOpen(bool aContainerOpen) { return _to SetContainerOpen(aContainerOpen); } \
  NS_SCRIPTABLE NS_IMETHOD GetState(PRUint16 *aState) { return _to GetState(aState); } \
  NS_SCRIPTABLE NS_IMETHOD GetHasChildren(bool *aHasChildren) { return _to GetHasChildren(aHasChildren); } \
  ...
  NS_SCRIPTABLE NS_IMETHOD FindNodeByDetails(const nsACString & aURIString, PRTime aTime, PRInt64 aItemId, bool aRecursive, nsINavHistoryResultNode * *_retval NS_OUTPARAM) { return _to FindNodeByDetails(aURIString, aTime, aItemId, aRecursive, _retval); } \
  NS_SCRIPTABLE NS_IMETHOD GetChildrenReadOnly(bool *aChildrenReadOnly) { return _to GetChildrenReadOnly(aChildrenReadOnly); } \
...
#define NS_FORWARD_SAFE_NSINAVHISTORYCONTAINERRESULTNODE(_to) \
  NS_SCRIPTABLE NS_IMETHOD GetContainerOpen(bool *aContainerOpen) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetContainerOpen(aContainerOpen); } \
  NS_SCRIPTABLE NS_IMETHOD SetContainerOpen(bool aContainerOpen) { return !_to ? NS_ERROR_NULL_POINTER : _to->SetContainerOpen(aContainerOpen); } \
  NS_SCRIPTABLE NS_IMETHOD GetState(PRUint16 *aState) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetState(aState); } \
  NS_SCRIPTABLE NS_IMETHOD GetHasChildren(bool *aHasChildren) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetHasChildren(aHasChildren); } \
  ...
  NS_SCRIPTABLE NS_IMETHOD FindNodeByDetails(const nsACString & aURIString, PRTime aTime, PRInt64 aItemId, bool aRecursive, nsINavHistoryResultNode * *_retval NS_OUTPARAM) { return !_to ? NS_ERROR_NULL_POINTER : _to->FindNodeByDetails(aURIString, aTime, aItemId, aRecursive, _retval); } \
  NS_SCRIPTABLE NS_IMETHOD GetChildrenReadOnly(bool *aChildrenReadOnly) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetChildrenReadOnly(aChildrenReadOnly); } \
...
/* nsINavHistoryResultNode findNodeByDetails (in AUTF8String aURIString, in PRTime aTime, in long long aItemId, in boolean aRecursive); */
NS_IMETHODIMP nsNavHistoryContainerResultNode::FindNodeByDetails(const nsACString & aURIString, PRTime aTime, PRInt64 aItemId, bool aRecursive, nsINavHistoryResultNode * *_retval NS_OUTPARAM)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
...
class NS_NO_VTABLE NS_SCRIPTABLE nsINavHistoryResultObserver : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD Batching(bool aToggleMode) = 0;
...
#define NS_DECL_NSINAVHISTORYRESULTOBSERVER \
  ...
  NS_SCRIPTABLE NS_IMETHOD Batching(bool aToggleMode); \
...
#define NS_FORWARD_NSINAVHISTORYRESULTOBSERVER(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD Batching(bool aToggleMode) { return _to Batching(aToggleMode); } \
...
#define NS_FORWARD_SAFE_NSINAVHISTORYRESULTOBSERVER(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD Batching(bool aToggleMode) { return !_to ? NS_ERROR_NULL_POINTER : _to->Batching(aToggleMode); } \
...
class NS_NO_VTABLE NS_SCRIPTABLE nsINavHistoryResult : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD GetSuppressNotifications(bool *aSuppressNotifications) = 0;
  NS_SCRIPTABLE NS_IMETHOD SetSuppressNotifications(bool aSuppressNotifications) = 0;

  /* void addObserver (in nsINavHistoryResultObserver aObserver, in boolean aOwnsWeak); */
  NS_SCRIPTABLE NS_IMETHOD AddObserver(nsINavHistoryResultObserver *aObserver, bool aOwnsWeak) = 0;
...
#define NS_DECL_NSINAVHISTORYRESULT \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetSuppressNotifications(bool *aSuppressNotifications); \
  NS_SCRIPTABLE NS_IMETHOD SetSuppressNotifications(bool aSuppressNotifications); \
  NS_SCRIPTABLE NS_IMETHOD AddObserver(nsINavHistoryResultObserver *aObserver, bool aOwnsWeak); \
...
#define NS_FORWARD_NSINAVHISTORYRESULT(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetSuppressNotifications(bool *aSuppressNotifications) { return _to GetSuppressNotifications(aSuppressNotifications); } \
  NS_SCRIPTABLE NS_IMETHOD SetSuppressNotifications(bool aSuppressNotifications) { return _to SetSuppressNotifications(aSuppressNotifications); } \
  NS_SCRIPTABLE NS_IMETHOD AddObserver(nsINavHistoryResultObserver *aObserver, bool aOwnsWeak) { return _to AddObserver(aObserver, aOwnsWeak); } \
...
#define NS_FORWARD_SAFE_NSINAVHISTORYRESULT(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetSuppressNotifications(bool *aSuppressNotifications) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetSuppressNotifications(aSuppressNotifications); } \
  NS_SCRIPTABLE NS_IMETHOD SetSuppressNotifications(bool aSuppressNotifications) { return !_to ? NS_ERROR_NULL_POINTER : _to->SetSuppressNotifications(aSuppressNotifications); } \
  NS_SCRIPTABLE NS_IMETHOD AddObserver(nsINavHistoryResultObserver *aObserver, bool aOwnsWeak) { return !_to ? NS_ERROR_NULL_POINTER : _to->AddObserver(aObserver, aOwnsWeak); } \
...
class NS_NO_VTABLE NS_SCRIPTABLE nsINavHistoryQuery : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD GetHasBeginTime(bool *aHasBeginTime) = 0;
  ...
  NS_SCRIPTABLE NS_IMETHOD GetHasEndTime(bool *aHasEndTime) = 0;
  ...
  NS_SCRIPTABLE NS_IMETHOD GetHasSearchTerms(bool *aHasSearchTerms) = 0;
  ...
  NS_SCRIPTABLE NS_IMETHOD GetOnlyBookmarked(bool *aOnlyBookmarked) = 0;
  NS_SCRIPTABLE NS_IMETHOD SetOnlyBookmarked(bool aOnlyBookmarked) = 0;

  /* attribute boolean domainIsHost; */
  NS_SCRIPTABLE NS_IMETHOD GetDomainIsHost(bool *aDomainIsHost) = 0;
  NS_SCRIPTABLE NS_IMETHOD SetDomainIsHost(bool aDomainIsHost) = 0;
  ...
  NS_SCRIPTABLE NS_IMETHOD GetHasDomain(bool *aHasDomain) = 0;

  /* attribute boolean uriIsPrefix; */
  NS_SCRIPTABLE NS_IMETHOD GetUriIsPrefix(bool *aUriIsPrefix) = 0;
  NS_SCRIPTABLE NS_IMETHOD SetUriIsPrefix(bool aUriIsPrefix) = 0;
  ...
  NS_SCRIPTABLE NS_IMETHOD GetHasUri(bool *aHasUri) = 0;

  /* attribute boolean annotationIsNot; */
  NS_SCRIPTABLE NS_IMETHOD GetAnnotationIsNot(bool *aAnnotationIsNot) = 0;
  NS_SCRIPTABLE NS_IMETHOD SetAnnotationIsNot(bool aAnnotationIsNot) = 0;
  ...
  NS_SCRIPTABLE NS_IMETHOD GetHasAnnotation(bool *aHasAnnotation) = 0;
  ...
  NS_SCRIPTABLE NS_IMETHOD GetTagsAreNot(bool *aTagsAreNot) = 0;
  NS_SCRIPTABLE NS_IMETHOD SetTagsAreNot(bool aTagsAreNot) = 0;
...
#define NS_DECL_NSINAVHISTORYQUERY \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetHasBeginTime(bool *aHasBeginTime); \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetHasEndTime(bool *aHasEndTime); \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetHasSearchTerms(bool *aHasSearchTerms); \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetOnlyBookmarked(bool *aOnlyBookmarked); \
  NS_SCRIPTABLE NS_IMETHOD SetOnlyBookmarked(bool aOnlyBookmarked); \
  NS_SCRIPTABLE NS_IMETHOD GetDomainIsHost(bool *aDomainIsHost); \
  NS_SCRIPTABLE NS_IMETHOD SetDomainIsHost(bool aDomainIsHost); \
  NS_SCRIPTABLE NS_IMETHOD GetDomain(nsACString & aDomain); \
  NS_SCRIPTABLE NS_IMETHOD SetDomain(const nsACString & aDomain); \
  NS_SCRIPTABLE NS_IMETHOD GetHasDomain(bool *aHasDomain); \
  NS_SCRIPTABLE NS_IMETHOD GetUriIsPrefix(bool *aUriIsPrefix); \
  NS_SCRIPTABLE NS_IMETHOD SetUriIsPrefix(bool aUriIsPrefix); \
  NS_SCRIPTABLE NS_IMETHOD GetUri(nsIURI * *aUri); \
  NS_SCRIPTABLE NS_IMETHOD SetUri(nsIURI *aUri); \
  NS_SCRIPTABLE NS_IMETHOD GetHasUri(bool *aHasUri); \
  NS_SCRIPTABLE NS_IMETHOD GetAnnotationIsNot(bool *aAnnotationIsNot); \
  NS_SCRIPTABLE NS_IMETHOD SetAnnotationIsNot(bool aAnnotationIsNot); \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetHasAnnotation(bool *aHasAnnotation); \
  NS_SCRIPTABLE NS_IMETHOD GetTags(nsIVariant * *aTags); \
  NS_SCRIPTABLE NS_IMETHOD SetTags(nsIVariant *aTags); \
  NS_SCRIPTABLE NS_IMETHOD GetTagsAreNot(bool *aTagsAreNot); \
  NS_SCRIPTABLE NS_IMETHOD SetTagsAreNot(bool aTagsAreNot); \
...
#define NS_FORWARD_NSINAVHISTORYQUERY(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetHasBeginTime(bool *aHasBeginTime) { return _to GetHasBeginTime(aHasBeginTime); } \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetHasEndTime(bool *aHasEndTime) { return _to GetHasEndTime(aHasEndTime); } \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetHasSearchTerms(bool *aHasSearchTerms) { return _to GetHasSearchTerms(aHasSearchTerms); } \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetOnlyBookmarked(bool *aOnlyBookmarked) { return _to GetOnlyBookmarked(aOnlyBookmarked); } \
  NS_SCRIPTABLE NS_IMETHOD SetOnlyBookmarked(bool aOnlyBookmarked) { return _to SetOnlyBookmarked(aOnlyBookmarked); } \
  NS_SCRIPTABLE NS_IMETHOD GetDomainIsHost(bool *aDomainIsHost) { return _to GetDomainIsHost(aDomainIsHost); } \
  NS_SCRIPTABLE NS_IMETHOD SetDomainIsHost(bool aDomainIsHost) { return _to SetDomainIsHost(aDomainIsHost); } \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetHasDomain(bool *aHasDomain) { return _to GetHasDomain(aHasDomain); } \
  NS_SCRIPTABLE NS_IMETHOD GetUriIsPrefix(bool *aUriIsPrefix) { return _to GetUriIsPrefix(aUriIsPrefix); } \
  NS_SCRIPTABLE NS_IMETHOD SetUriIsPrefix(bool aUriIsPrefix) { return _to SetUriIsPrefix(aUriIsPrefix); } \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetHasUri(bool *aHasUri) { return _to GetHasUri(aHasUri); } \
  NS_SCRIPTABLE NS_IMETHOD GetAnnotationIsNot(bool *aAnnotationIsNot) { return _to GetAnnotationIsNot(aAnnotationIsNot); } \
  NS_SCRIPTABLE NS_IMETHOD SetAnnotationIsNot(bool aAnnotationIsNot) { return _to SetAnnotationIsNot(aAnnotationIsNot); } \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetHasAnnotation(bool *aHasAnnotation) { return _to GetHasAnnotation(aHasAnnotation); } \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetTagsAreNot(bool *aTagsAreNot) { return _to GetTagsAreNot(aTagsAreNot); } \
  NS_SCRIPTABLE NS_IMETHOD SetTagsAreNot(bool aTagsAreNot) { return _to SetTagsAreNot(aTagsAreNot); } \
...
#define NS_FORWARD_SAFE_NSINAVHISTORYQUERY(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetHasBeginTime(bool *aHasBeginTime) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetHasBeginTime(aHasBeginTime); } \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetHasEndTime(bool *aHasEndTime) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetHasEndTime(aHasEndTime); } \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetHasSearchTerms(bool *aHasSearchTerms) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetHasSearchTerms(aHasSearchTerms); } \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetOnlyBookmarked(bool *aOnlyBookmarked) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetOnlyBookmarked(aOnlyBookmarked); } \
  NS_SCRIPTABLE NS_IMETHOD SetOnlyBookmarked(bool aOnlyBookmarked) { return !_to ? NS_ERROR_NULL_POINTER : _to->SetOnlyBookmarked(aOnlyBookmarked); } \
  NS_SCRIPTABLE NS_IMETHOD GetDomainIsHost(bool *aDomainIsHost) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetDomainIsHost(aDomainIsHost); } \
  NS_SCRIPTABLE NS_IMETHOD SetDomainIsHost(bool aDomainIsHost) { return !_to ? NS_ERROR_NULL_POINTER : _to->SetDomainIsHost(aDomainIsHost); } \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetHasDomain(bool *aHasDomain) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetHasDomain(aHasDomain); } \
  NS_SCRIPTABLE NS_IMETHOD GetUriIsPrefix(bool *aUriIsPrefix) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetUriIsPrefix(aUriIsPrefix); } \
  NS_SCRIPTABLE NS_IMETHOD SetUriIsPrefix(bool aUriIsPrefix) { return !_to ? NS_ERROR_NULL_POINTER : _to->SetUriIsPrefix(aUriIsPrefix); } \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetHasUri(bool *aHasUri) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetHasUri(aHasUri); } \
  NS_SCRIPTABLE NS_IMETHOD GetAnnotationIsNot(bool *aAnnotationIsNot) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetAnnotationIsNot(aAnnotationIsNot); } \
  NS_SCRIPTABLE NS_IMETHOD SetAnnotationIsNot(bool aAnnotationIsNot) { return !_to ? NS_ERROR_NULL_POINTER : _to->SetAnnotationIsNot(aAnnotationIsNot); } \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetHasAnnotation(bool *aHasAnnotation) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetHasAnnotation(aHasAnnotation); } \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetTagsAreNot(bool *aTagsAreNot) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetTagsAreNot(aTagsAreNot); } \
  NS_SCRIPTABLE NS_IMETHOD SetTagsAreNot(bool aTagsAreNot) { return !_to ? NS_ERROR_NULL_POINTER : _to->SetTagsAreNot(aTagsAreNot); } \
...
class NS_NO_VTABLE NS_SCRIPTABLE nsINavHistoryQueryOptions : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD GetExcludeItems(bool *aExcludeItems) = 0;
  NS_SCRIPTABLE NS_IMETHOD SetExcludeItems(bool aExcludeItems) = 0;

  /* attribute boolean excludeQueries; */
  NS_SCRIPTABLE NS_IMETHOD GetExcludeQueries(bool *aExcludeQueries) = 0;
  NS_SCRIPTABLE NS_IMETHOD SetExcludeQueries(bool aExcludeQueries) = 0;

  /* attribute boolean excludeReadOnlyFolders; */
  NS_SCRIPTABLE NS_IMETHOD GetExcludeReadOnlyFolders(bool *aExcludeReadOnlyFolders) = 0;
  NS_SCRIPTABLE NS_IMETHOD SetExcludeReadOnlyFolders(bool aExcludeReadOnlyFolders) = 0;
  ...
  NS_SCRIPTABLE NS_IMETHOD GetExpandQueries(bool *aExpandQueries) = 0;
  NS_SCRIPTABLE NS_IMETHOD SetExpandQueries(bool aExpandQueries) = 0;

  /* attribute boolean includeHidden; */
  NS_SCRIPTABLE NS_IMETHOD GetIncludeHidden(bool *aIncludeHidden) = 0;
  NS_SCRIPTABLE NS_IMETHOD SetIncludeHidden(bool aIncludeHidden) = 0;
  ...
  NS_SCRIPTABLE NS_IMETHOD GetAsyncEnabled(bool *aAsyncEnabled) = 0;
  NS_SCRIPTABLE NS_IMETHOD SetAsyncEnabled(bool aAsyncEnabled) = 0;
...
#define NS_DECL_NSINAVHISTORYQUERYOPTIONS \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetExcludeItems(bool *aExcludeItems); \
  NS_SCRIPTABLE NS_IMETHOD SetExcludeItems(bool aExcludeItems); \
  NS_SCRIPTABLE NS_IMETHOD GetExcludeQueries(bool *aExcludeQueries); \
  NS_SCRIPTABLE NS_IMETHOD SetExcludeQueries(bool aExcludeQueries); \
  NS_SCRIPTABLE NS_IMETHOD GetExcludeReadOnlyFolders(bool *aExcludeReadOnlyFolders); \
  NS_SCRIPTABLE NS_IMETHOD SetExcludeReadOnlyFolders(bool aExcludeReadOnlyFolders); \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetExpandQueries(bool *aExpandQueries); \
  NS_SCRIPTABLE NS_IMETHOD SetExpandQueries(bool aExpandQueries); \
  NS_SCRIPTABLE NS_IMETHOD GetIncludeHidden(bool *aIncludeHidden); \
  NS_SCRIPTABLE NS_IMETHOD SetIncludeHidden(bool aIncludeHidden); \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetAsyncEnabled(bool *aAsyncEnabled); \
  NS_SCRIPTABLE NS_IMETHOD SetAsyncEnabled(bool aAsyncEnabled); \
...
#define NS_FORWARD_NSINAVHISTORYQUERYOPTIONS(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetExcludeItems(bool *aExcludeItems) { return _to GetExcludeItems(aExcludeItems); } \
  NS_SCRIPTABLE NS_IMETHOD SetExcludeItems(bool aExcludeItems) { return _to SetExcludeItems(aExcludeItems); } \
  NS_SCRIPTABLE NS_IMETHOD GetExcludeQueries(bool *aExcludeQueries) { return _to GetExcludeQueries(aExcludeQueries); } \
  NS_SCRIPTABLE NS_IMETHOD SetExcludeQueries(bool aExcludeQueries) { return _to SetExcludeQueries(aExcludeQueries); } \
  NS_SCRIPTABLE NS_IMETHOD GetExcludeReadOnlyFolders(bool *aExcludeReadOnlyFolders) { return _to GetExcludeReadOnlyFolders(aExcludeReadOnlyFolders); } \
  NS_SCRIPTABLE NS_IMETHOD SetExcludeReadOnlyFolders(bool aExcludeReadOnlyFolders) { return _to SetExcludeReadOnlyFolders(aExcludeReadOnlyFolders); } \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetExpandQueries(bool *aExpandQueries) { return _to GetExpandQueries(aExpandQueries); } \
  NS_SCRIPTABLE NS_IMETHOD SetExpandQueries(bool aExpandQueries) { return _to SetExpandQueries(aExpandQueries); } \
  NS_SCRIPTABLE NS_IMETHOD GetIncludeHidden(bool *aIncludeHidden) { return _to GetIncludeHidden(aIncludeHidden); } \
  NS_SCRIPTABLE NS_IMETHOD SetIncludeHidden(bool aIncludeHidden) { return _to SetIncludeHidden(aIncludeHidden); } \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetAsyncEnabled(bool *aAsyncEnabled) { return _to GetAsyncEnabled(aAsyncEnabled); } \
  NS_SCRIPTABLE NS_IMETHOD SetAsyncEnabled(bool aAsyncEnabled) { return _to SetAsyncEnabled(aAsyncEnabled); } \
...
#define NS_FORWARD_SAFE_NSINAVHISTORYQUERYOPTIONS(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetExcludeItems(bool *aExcludeItems) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetExcludeItems(aExcludeItems); } \
  NS_SCRIPTABLE NS_IMETHOD SetExcludeItems(bool aExcludeItems) { return !_to ? NS_ERROR_NULL_POINTER : _to->SetExcludeItems(aExcludeItems); } \
  NS_SCRIPTABLE NS_IMETHOD GetExcludeQueries(bool *aExcludeQueries) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetExcludeQueries(aExcludeQueries); } \
  NS_SCRIPTABLE NS_IMETHOD SetExcludeQueries(bool aExcludeQueries) { return !_to ? NS_ERROR_NULL_POINTER : _to->SetExcludeQueries(aExcludeQueries); } \
  NS_SCRIPTABLE NS_IMETHOD GetExcludeReadOnlyFolders(bool *aExcludeReadOnlyFolders) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetExcludeReadOnlyFolders(aExcludeReadOnlyFolders); } \
  NS_SCRIPTABLE NS_IMETHOD SetExcludeReadOnlyFolders(bool aExcludeReadOnlyFolders) { return !_to ? NS_ERROR_NULL_POINTER : _to->SetExcludeReadOnlyFolders(aExcludeReadOnlyFolders); } \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetExpandQueries(bool *aExpandQueries) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetExpandQueries(aExpandQueries); } \
  NS_SCRIPTABLE NS_IMETHOD SetExpandQueries(bool aExpandQueries) { return !_to ? NS_ERROR_NULL_POINTER : _to->SetExpandQueries(aExpandQueries); } \
  NS_SCRIPTABLE NS_IMETHOD GetIncludeHidden(bool *aIncludeHidden) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetIncludeHidden(aIncludeHidden); } \
  NS_SCRIPTABLE NS_IMETHOD SetIncludeHidden(bool aIncludeHidden) { return !_to ? NS_ERROR_NULL_POINTER : _to->SetIncludeHidden(aIncludeHidden); } \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetAsyncEnabled(bool *aAsyncEnabled) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetAsyncEnabled(aAsyncEnabled); } \
  NS_SCRIPTABLE NS_IMETHOD SetAsyncEnabled(bool aAsyncEnabled) { return !_to ? NS_ERROR_NULL_POINTER : _to->SetAsyncEnabled(aAsyncEnabled); } \
...
class NS_NO_VTABLE NS_SCRIPTABLE nsINavHistoryService : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD GetHasHistoryEntries(bool *aHasHistoryEntries) = 0;
  ...
  NS_SCRIPTABLE NS_IMETHOD CanAddURI(nsIURI *aURI, bool *_retval NS_OUTPARAM) = 0;
  ...
  NS_SCRIPTABLE NS_IMETHOD AddVisit(nsIURI *aURI, PRTime aTime, nsIURI *aReferringURI, PRInt32 aTransitionType, bool aIsRedirect, PRInt64 aSessionID, PRInt64 *_retval NS_OUTPARAM) = 0;
  ...
  NS_SCRIPTABLE NS_IMETHOD AddObserver(nsINavHistoryObserver *observer, bool ownsWeak) = 0;
  ...
  NS_SCRIPTABLE NS_IMETHOD GetHistoryDisabled(bool *aHistoryDisabled) = 0;
...
#define NS_DECL_NSINAVHISTORYSERVICE \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetHasHistoryEntries(bool *aHasHistoryEntries); \
  ...
  NS_SCRIPTABLE NS_IMETHOD CanAddURI(nsIURI *aURI, bool *_retval NS_OUTPARAM); \
  NS_SCRIPTABLE NS_IMETHOD AddVisit(nsIURI *aURI, PRTime aTime, nsIURI *aReferringURI, PRInt32 aTransitionType, bool aIsRedirect, PRInt64 aSessionID, PRInt64 *_retval NS_OUTPARAM); \
  ...
  NS_SCRIPTABLE NS_IMETHOD AddObserver(nsINavHistoryObserver *observer, bool ownsWeak); \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetHistoryDisabled(bool *aHistoryDisabled); 
...
#define NS_FORWARD_NSINAVHISTORYSERVICE(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetHasHistoryEntries(bool *aHasHistoryEntries) { return _to GetHasHistoryEntries(aHasHistoryEntries); } \
  ...
  NS_SCRIPTABLE NS_IMETHOD CanAddURI(nsIURI *aURI, bool *_retval NS_OUTPARAM) { return _to CanAddURI(aURI, _retval); } \
  NS_SCRIPTABLE NS_IMETHOD AddVisit(nsIURI *aURI, PRTime aTime, nsIURI *aReferringURI, PRInt32 aTransitionType, bool aIsRedirect, PRInt64 aSessionID, PRInt64 *_retval NS_OUTPARAM) { return _to AddVisit(aURI, aTime, aReferringURI, aTransitionType, aIsRedirect, aSessionID, _retval); } \
  ...
  NS_SCRIPTABLE NS_IMETHOD AddObserver(nsINavHistoryObserver *observer, bool ownsWeak) { return _to AddObserver(observer, ownsWeak); } \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetHistoryDisabled(bool *aHistoryDisabled) { return _to GetHistoryDisabled(aHistoryDisabled); } 
...
#define NS_FORWARD_SAFE_NSINAVHISTORYSERVICE(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetHasHistoryEntries(bool *aHasHistoryEntries) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetHasHistoryEntries(aHasHistoryEntries); } \
  ...
  NS_SCRIPTABLE NS_IMETHOD CanAddURI(nsIURI *aURI, bool *_retval NS_OUTPARAM) { return !_to ? NS_ERROR_NULL_POINTER : _to->CanAddURI(aURI, _retval); } \
  NS_SCRIPTABLE NS_IMETHOD AddVisit(nsIURI *aURI, PRTime aTime, nsIURI *aReferringURI, PRInt32 aTransitionType, bool aIsRedirect, PRInt64 aSessionID, PRInt64 *_retval NS_OUTPARAM) { return !_to ? NS_ERROR_NULL_POINTER : _to->AddVisit(aURI, aTime, aReferringURI, aTransitionType, aIsRedirect, aSessionID, _retval); } \
  ...
  NS_SCRIPTABLE NS_IMETHOD AddObserver(nsINavHistoryObserver *observer, bool ownsWeak) { return !_to ? NS_ERROR_NULL_POINTER : _to->AddObserver(observer, ownsWeak); } \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetHistoryDisabled(bool *aHistoryDisabled) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetHistoryDisabled(aHistoryDisabled); } 
...
/* boolean canAddURI (in nsIURI aURI); */
NS_IMETHODIMP nsNavHistoryService::CanAddURI(nsIURI *aURI, bool *_retval NS_OUTPARAM)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}

/* long long addVisit (in nsIURI aURI, in PRTime aTime, in nsIURI aReferringURI, in long aTransitionType, in boolean aIsRedirect, in long long aSessionID); */
NS_IMETHODIMP nsNavHistoryService::AddVisit(nsIURI *aURI, PRTime aTime, nsIURI *aReferringURI, PRInt32 aTransitionType, bool aIsRedirect, PRInt64 aSessionID, PRInt64 *_retval NS_OUTPARAM)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
