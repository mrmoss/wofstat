/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM /jds/packages/BUILD/SUNWfirefox-10.0.2/firefox/netwerk/base/public/nsINetworkLinkService.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsINetworkLinkService : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD GetIsLinkUp(bool *aIsLinkUp) = 0;

  /* readonly attribute boolean linkStatusKnown; */
  NS_SCRIPTABLE NS_IMETHOD GetLinkStatusKnown(bool *aLinkStatusKnown) = 0;
...
#define NS_DECL_NSINETWORKLINKSERVICE \
  NS_SCRIPTABLE NS_IMETHOD GetIsLinkUp(bool *aIsLinkUp); \
  NS_SCRIPTABLE NS_IMETHOD GetLinkStatusKnown(bool *aLinkStatusKnown); \
  NS_SCRIPTABLE NS_IMETHOD GetLinkType(PRUint32 *aLinkType); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSINETWORKLINKSERVICE(_to) \
  NS_SCRIPTABLE NS_IMETHOD GetIsLinkUp(bool *aIsLinkUp) { return _to GetIsLinkUp(aIsLinkUp); } \
  NS_SCRIPTABLE NS_IMETHOD GetLinkStatusKnown(bool *aLinkStatusKnown) { return _to GetLinkStatusKnown(aLinkStatusKnown); } \
...
#define NS_FORWARD_SAFE_NSINETWORKLINKSERVICE(_to) \
  NS_SCRIPTABLE NS_IMETHOD GetIsLinkUp(bool *aIsLinkUp) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetIsLinkUp(aIsLinkUp); } \
  NS_SCRIPTABLE NS_IMETHOD GetLinkStatusKnown(bool *aLinkStatusKnown) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetLinkStatusKnown(aLinkStatusKnown); } \
