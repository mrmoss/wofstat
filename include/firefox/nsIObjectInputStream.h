/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM /jds/packages/BUILD/SUNWfirefox-10.0.2/firefox/xpcom/io/nsIObjectInputStream.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIObjectInputStream : public nsIBinaryInputStream {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD ReadObject(bool aIsStrongRef, nsISupports * *_retval NS_OUTPARAM) = 0;
...
#define NS_DECL_NSIOBJECTINPUTSTREAM \
  NS_SCRIPTABLE NS_IMETHOD ReadObject(bool aIsStrongRef, nsISupports * *_retval NS_OUTPARAM); \
...
#define NS_FORWARD_NSIOBJECTINPUTSTREAM(_to) \
  NS_SCRIPTABLE NS_IMETHOD ReadObject(bool aIsStrongRef, nsISupports * *_retval NS_OUTPARAM) { return _to ReadObject(aIsStrongRef, _retval); } \
...
#define NS_FORWARD_SAFE_NSIOBJECTINPUTSTREAM(_to) \
  NS_SCRIPTABLE NS_IMETHOD ReadObject(bool aIsStrongRef, nsISupports * *_retval NS_OUTPARAM) { return !_to ? NS_ERROR_NULL_POINTER : _to->ReadObject(aIsStrongRef, _retval); } \
...
/* nsISupports readObject (in boolean aIsStrongRef); */
NS_IMETHODIMP nsObjectInputStream::ReadObject(bool aIsStrongRef, nsISupports * *_retval NS_OUTPARAM)
{
