/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM /jds/packages/BUILD/SUNWfirefox-10.0.2/firefox/xpcom/io/nsIObjectOutputStream.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIObjectOutputStream : public nsIBinaryOutputStream {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD WriteObject(nsISupports *aObject, bool aIsStrongRef) = 0;
  ...
  NS_SCRIPTABLE NS_IMETHOD WriteCompoundObject(nsISupports *aObject, const nsIID & aIID, bool aIsStrongRef) = 0;
...
#define NS_DECL_NSIOBJECTOUTPUTSTREAM \
  NS_SCRIPTABLE NS_IMETHOD WriteObject(nsISupports *aObject, bool aIsStrongRef); \
  NS_SCRIPTABLE NS_IMETHOD WriteSingleRefObject(nsISupports *aObject); \
  NS_SCRIPTABLE NS_IMETHOD WriteCompoundObject(nsISupports *aObject, const nsIID & aIID, bool aIsStrongRef); \
...
#define NS_FORWARD_NSIOBJECTOUTPUTSTREAM(_to) \
  NS_SCRIPTABLE NS_IMETHOD WriteObject(nsISupports *aObject, bool aIsStrongRef) { return _to WriteObject(aObject, aIsStrongRef); } \
  NS_SCRIPTABLE NS_IMETHOD WriteSingleRefObject(nsISupports *aObject) { return _to WriteSingleRefObject(aObject); } \
  NS_SCRIPTABLE NS_IMETHOD WriteCompoundObject(nsISupports *aObject, const nsIID & aIID, bool aIsStrongRef) { return _to WriteCompoundObject(aObject, aIID, aIsStrongRef); } \
...
#define NS_FORWARD_SAFE_NSIOBJECTOUTPUTSTREAM(_to) \
  NS_SCRIPTABLE NS_IMETHOD WriteObject(nsISupports *aObject, bool aIsStrongRef) { return !_to ? NS_ERROR_NULL_POINTER : _to->WriteObject(aObject, aIsStrongRef); } \
  ...
  NS_SCRIPTABLE NS_IMETHOD WriteCompoundObject(nsISupports *aObject, const nsIID & aIID, bool aIsStrongRef) { return !_to ? NS_ERROR_NULL_POINTER : _to->WriteCompoundObject(aObject, aIID, aIsStrongRef); } \
