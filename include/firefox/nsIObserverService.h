/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM /jds/packages/BUILD/SUNWfirefox-10.0.2/firefox/xpcom/ds/nsIObserverService.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIObserverService : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD AddObserver(nsIObserver *anObserver, const char * aTopic, bool ownsWeak) = 0;
...
#define NS_DECL_NSIOBSERVERSERVICE \
  NS_SCRIPTABLE NS_IMETHOD AddObserver(nsIObserver *anObserver, const char * aTopic, bool ownsWeak); \
...
#define NS_FORWARD_NSIOBSERVERSERVICE(_to) \
  NS_SCRIPTABLE NS_IMETHOD AddObserver(nsIObserver *anObserver, const char * aTopic, bool ownsWeak) { return _to AddObserver(anObserver, aTopic, ownsWeak); } \
...
#define NS_FORWARD_SAFE_NSIOBSERVERSERVICE(_to) \
  NS_SCRIPTABLE NS_IMETHOD AddObserver(nsIObserver *anObserver, const char * aTopic, bool ownsWeak) { return !_to ? NS_ERROR_NULL_POINTER : _to->AddObserver(anObserver, aTopic, ownsWeak); } \
