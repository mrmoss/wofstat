/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM /jds/packages/BUILD/SUNWfirefox-10.0.2/firefox/security/manager/ssl/public/nsIPKCS11ModuleDB.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIPKCS11ModuleDB : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD GetCanToggleFIPS(bool *aCanToggleFIPS) = 0;

  /* void toggleFIPSMode (); */
  NS_SCRIPTABLE NS_IMETHOD ToggleFIPSMode(void) = 0;

  /* readonly attribute boolean isFIPSEnabled; */
  NS_SCRIPTABLE NS_IMETHOD GetIsFIPSEnabled(bool *aIsFIPSEnabled) = 0;
...
#define NS_DECL_NSIPKCS11MODULEDB \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetCanToggleFIPS(bool *aCanToggleFIPS); \
  NS_SCRIPTABLE NS_IMETHOD ToggleFIPSMode(void); \
  NS_SCRIPTABLE NS_IMETHOD GetIsFIPSEnabled(bool *aIsFIPSEnabled); 
...
#define NS_FORWARD_NSIPKCS11MODULEDB(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetCanToggleFIPS(bool *aCanToggleFIPS) { return _to GetCanToggleFIPS(aCanToggleFIPS); } \
  NS_SCRIPTABLE NS_IMETHOD ToggleFIPSMode(void) { return _to ToggleFIPSMode(); } \
  NS_SCRIPTABLE NS_IMETHOD GetIsFIPSEnabled(bool *aIsFIPSEnabled) { return _to GetIsFIPSEnabled(aIsFIPSEnabled); } 
...
#define NS_FORWARD_SAFE_NSIPKCS11MODULEDB(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetCanToggleFIPS(bool *aCanToggleFIPS) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetCanToggleFIPS(aCanToggleFIPS); } \
  NS_SCRIPTABLE NS_IMETHOD ToggleFIPSMode(void) { return !_to ? NS_ERROR_NULL_POINTER : _to->ToggleFIPSMode(); } \
  NS_SCRIPTABLE NS_IMETHOD GetIsFIPSEnabled(bool *aIsFIPSEnabled) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetIsFIPSEnabled(aIsFIPSEnabled); } 
