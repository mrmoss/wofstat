/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM /jds/packages/BUILD/SUNWfirefox-10.0.2/firefox/netwerk/base/public/nsIParentRedirectingChannel.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIParentRedirectingChannel : public nsIParentChannel {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD CompleteRedirect(bool succeeded) = 0;
...
#define NS_DECL_NSIPARENTREDIRECTINGCHANNEL \
  ...
  NS_SCRIPTABLE NS_IMETHOD CompleteRedirect(bool succeeded); 
...
#define NS_FORWARD_NSIPARENTREDIRECTINGCHANNEL(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD CompleteRedirect(bool succeeded) { return _to CompleteRedirect(succeeded); } 
...
#define NS_FORWARD_SAFE_NSIPARENTREDIRECTINGCHANNEL(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD CompleteRedirect(bool succeeded) { return !_to ? NS_ERROR_NULL_POINTER : _to->CompleteRedirect(succeeded); } 
