/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM /jds/packages/BUILD/SUNWfirefox-10.0.2/firefox/editor/idl/nsIPlaintextEditor.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIPlaintextEditor : public nsISupports {
 public: 
  ...
  enum { eEditorSkipSpellCheck = 32768 };
