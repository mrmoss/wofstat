/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM /jds/packages/BUILD/SUNWfirefox-10.0.2/firefox/dom/plugins/base/nsIPluginDocument.idl
 */
...
class NS_NO_VTABLE nsIPluginDocument : public nsISupports {
 public: 
  ...
  NS_IMETHOD GetWillHandleInstantiation(bool *aWillHandleInstantiation) = 0;
...
#define NS_DECL_NSIPLUGINDOCUMENT \
  ...
  NS_IMETHOD GetWillHandleInstantiation(bool *aWillHandleInstantiation); 
...
#define NS_FORWARD_NSIPLUGINDOCUMENT(_to) \
  ...
  NS_IMETHOD GetWillHandleInstantiation(bool *aWillHandleInstantiation) { return _to GetWillHandleInstantiation(aWillHandleInstantiation); } 
...
#define NS_FORWARD_SAFE_NSIPLUGINDOCUMENT(_to) \
  ...
  NS_IMETHOD GetWillHandleInstantiation(bool *aWillHandleInstantiation) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetWillHandleInstantiation(aWillHandleInstantiation); } 
...
/* readonly attribute boolean willHandleInstantiation; */
NS_IMETHODIMP nsPluginDocument::GetWillHandleInstantiation(bool *aWillHandleInstantiation)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
