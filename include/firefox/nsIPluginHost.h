/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM /jds/packages/BUILD/SUNWfirefox-10.0.2/firefox/dom/plugins/base/nsIPluginHost.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIPluginHost : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD ReloadPlugins(bool reloadPages) = 0;
  ...
  NS_SCRIPTABLE NS_IMETHOD SiteHasData(nsIPluginTag *plugin, const nsACString & domain, bool *_retval NS_OUTPARAM) = 0;
...
#define NS_DECL_NSIPLUGINHOST \
  NS_SCRIPTABLE NS_IMETHOD ReloadPlugins(bool reloadPages); \
  ...
  NS_SCRIPTABLE NS_IMETHOD SiteHasData(nsIPluginTag *plugin, const nsACString & domain, bool *_retval NS_OUTPARAM); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSIPLUGINHOST(_to) \
  NS_SCRIPTABLE NS_IMETHOD ReloadPlugins(bool reloadPages) { return _to ReloadPlugins(reloadPages); } \
  ...
  NS_SCRIPTABLE NS_IMETHOD SiteHasData(nsIPluginTag *plugin, const nsACString & domain, bool *_retval NS_OUTPARAM) { return _to SiteHasData(plugin, domain, _retval); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_NSIPLUGINHOST(_to) \
  NS_SCRIPTABLE NS_IMETHOD ReloadPlugins(bool reloadPages) { return !_to ? NS_ERROR_NULL_POINTER : _to->ReloadPlugins(reloadPages); } \
  ...
  NS_SCRIPTABLE NS_IMETHOD SiteHasData(nsIPluginTag *plugin, const nsACString & domain, bool *_retval NS_OUTPARAM) { return !_to ? NS_ERROR_NULL_POINTER : _to->SiteHasData(plugin, domain, _retval); } 
...
/* boolean siteHasData (in nsIPluginTag plugin, in AUTF8String domain); */
NS_IMETHODIMP nsPluginHost::SiteHasData(nsIPluginTag *plugin, const nsACString & domain, bool *_retval NS_OUTPARAM)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
