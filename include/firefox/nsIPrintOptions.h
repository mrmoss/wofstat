/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM /jds/packages/BUILD/SUNWfirefox-10.0.2/firefox/widget/public/nsIPrintOptions.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIPrintOptions : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD DisplayJobProperties(const PRUnichar * aPrinter, nsIPrintSettings *aPrintSettings, bool *aDisplayed NS_OUTPARAM) = 0;
...
#define NS_DECL_NSIPRINTOPTIONS \
  ...
  NS_SCRIPTABLE NS_IMETHOD DisplayJobProperties(const PRUnichar * aPrinter, nsIPrintSettings *aPrintSettings, bool *aDisplayed NS_OUTPARAM); \
...
#define NS_FORWARD_NSIPRINTOPTIONS(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD DisplayJobProperties(const PRUnichar * aPrinter, nsIPrintSettings *aPrintSettings, bool *aDisplayed NS_OUTPARAM) { return _to DisplayJobProperties(aPrinter, aPrintSettings, aDisplayed); } \
...
#define NS_FORWARD_SAFE_NSIPRINTOPTIONS(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD DisplayJobProperties(const PRUnichar * aPrinter, nsIPrintSettings *aPrintSettings, bool *aDisplayed NS_OUTPARAM) { return !_to ? NS_ERROR_NULL_POINTER : _to->DisplayJobProperties(aPrinter, aPrintSettings, aDisplayed); } \
...
/* void displayJobProperties (in wstring aPrinter, in nsIPrintSettings aPrintSettings, out boolean aDisplayed); */
NS_IMETHODIMP nsPrintOptions::DisplayJobProperties(const PRUnichar * aPrinter, nsIPrintSettings *aPrintSettings, bool *aDisplayed NS_OUTPARAM)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
