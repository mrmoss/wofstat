/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM /jds/packages/BUILD/SUNWfirefox-10.0.2/firefox/layout/printing/nsIPrintProgress.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIPrintProgress : public nsIWebProgressListener {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD OpenProgressDialog(nsIDOMWindow *parent, const char * dialogURL, nsISupports *parameters, nsIObserver *openDialogObserver, bool *notifyOnOpen NS_OUTPARAM) = 0;

  /* void closeProgressDialog (in boolean forceClose); */
  NS_SCRIPTABLE NS_IMETHOD CloseProgressDialog(bool forceClose) = 0;
  ...
  NS_SCRIPTABLE NS_IMETHOD GetProcessCanceledByUser(bool *aProcessCanceledByUser) = 0;
  NS_SCRIPTABLE NS_IMETHOD SetProcessCanceledByUser(bool aProcessCanceledByUser) = 0;
...
#define NS_DECL_NSIPRINTPROGRESS \
  NS_SCRIPTABLE NS_IMETHOD OpenProgressDialog(nsIDOMWindow *parent, const char * dialogURL, nsISupports *parameters, nsIObserver *openDialogObserver, bool *notifyOnOpen NS_OUTPARAM); \
  NS_SCRIPTABLE NS_IMETHOD CloseProgressDialog(bool forceClose); \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetProcessCanceledByUser(bool *aProcessCanceledByUser); \
  NS_SCRIPTABLE NS_IMETHOD SetProcessCanceledByUser(bool aProcessCanceledByUser); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSIPRINTPROGRESS(_to) \
  NS_SCRIPTABLE NS_IMETHOD OpenProgressDialog(nsIDOMWindow *parent, const char * dialogURL, nsISupports *parameters, nsIObserver *openDialogObserver, bool *notifyOnOpen NS_OUTPARAM) { return _to OpenProgressDialog(parent, dialogURL, parameters, openDialogObserver, notifyOnOpen); } \
  NS_SCRIPTABLE NS_IMETHOD CloseProgressDialog(bool forceClose) { return _to CloseProgressDialog(forceClose); } \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetProcessCanceledByUser(bool *aProcessCanceledByUser) { return _to GetProcessCanceledByUser(aProcessCanceledByUser); } \
  NS_SCRIPTABLE NS_IMETHOD SetProcessCanceledByUser(bool aProcessCanceledByUser) { return _to SetProcessCanceledByUser(aProcessCanceledByUser); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_NSIPRINTPROGRESS(_to) \
  NS_SCRIPTABLE NS_IMETHOD OpenProgressDialog(nsIDOMWindow *parent, const char * dialogURL, nsISupports *parameters, nsIObserver *openDialogObserver, bool *notifyOnOpen NS_OUTPARAM) { return !_to ? NS_ERROR_NULL_POINTER : _to->OpenProgressDialog(parent, dialogURL, parameters, openDialogObserver, notifyOnOpen); } \
  NS_SCRIPTABLE NS_IMETHOD CloseProgressDialog(bool forceClose) { return !_to ? NS_ERROR_NULL_POINTER : _to->CloseProgressDialog(forceClose); } \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetProcessCanceledByUser(bool *aProcessCanceledByUser) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetProcessCanceledByUser(aProcessCanceledByUser); } \
  NS_SCRIPTABLE NS_IMETHOD SetProcessCanceledByUser(bool aProcessCanceledByUser) { return !_to ? NS_ERROR_NULL_POINTER : _to->SetProcessCanceledByUser(aProcessCanceledByUser); } 
...
/* void openProgressDialog (in nsIDOMWindow parent, in string dialogURL, in nsISupports parameters, in nsIObserver openDialogObserver, out boolean notifyOnOpen); */
NS_IMETHODIMP nsPrintProgress::OpenProgressDialog(nsIDOMWindow *parent, const char * dialogURL, nsISupports *parameters, nsIObserver *openDialogObserver, bool *notifyOnOpen NS_OUTPARAM)
{
