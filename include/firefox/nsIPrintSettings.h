/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM /jds/packages/BUILD/SUNWfirefox-10.0.2/firefox/widget/public/nsIPrintSettings.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIPrintSettings : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD SetPrintOptions(PRInt32 aType, bool aTurnOnOff) = 0;

  /* boolean GetPrintOptions (in PRInt32 aType); */
  NS_SCRIPTABLE NS_IMETHOD GetPrintOptions(PRInt32 aType, bool *_retval NS_OUTPARAM) = 0;
  ...
  NS_SCRIPTABLE NS_IMETHOD GetPrintBGColors(bool *aPrintBGColors) = 0;
  NS_SCRIPTABLE NS_IMETHOD SetPrintBGColors(bool aPrintBGColors) = 0;

  /* attribute boolean printBGImages; */
  NS_SCRIPTABLE NS_IMETHOD GetPrintBGImages(bool *aPrintBGImages) = 0;
  NS_SCRIPTABLE NS_IMETHOD SetPrintBGImages(bool aPrintBGImages) = 0;
  ...
  NS_SCRIPTABLE NS_IMETHOD GetIsCancelled(bool *aIsCancelled) = 0;
  NS_SCRIPTABLE NS_IMETHOD SetIsCancelled(bool aIsCancelled) = 0;
  ...
  NS_SCRIPTABLE NS_IMETHOD GetPrintSilent(bool *aPrintSilent) = 0;
  NS_SCRIPTABLE NS_IMETHOD SetPrintSilent(bool aPrintSilent) = 0;

  /* attribute boolean shrinkToFit; */
  NS_SCRIPTABLE NS_IMETHOD GetShrinkToFit(bool *aShrinkToFit) = 0;
  NS_SCRIPTABLE NS_IMETHOD SetShrinkToFit(bool aShrinkToFit) = 0;

  /* attribute boolean showPrintProgress; */
  NS_SCRIPTABLE NS_IMETHOD GetShowPrintProgress(bool *aShowPrintProgress) = 0;
  NS_SCRIPTABLE NS_IMETHOD SetShowPrintProgress(bool aShowPrintProgress) = 0;
  ...
  NS_SCRIPTABLE NS_IMETHOD GetDownloadFonts(bool *aDownloadFonts) = 0;
  NS_SCRIPTABLE NS_IMETHOD SetDownloadFonts(bool aDownloadFonts) = 0;

  /* attribute boolean printReversed; */
  NS_SCRIPTABLE NS_IMETHOD GetPrintReversed(bool *aPrintReversed) = 0;
  NS_SCRIPTABLE NS_IMETHOD SetPrintReversed(bool aPrintReversed) = 0;

  /* attribute boolean printInColor; */
  NS_SCRIPTABLE NS_IMETHOD GetPrintInColor(bool *aPrintInColor) = 0;
  NS_SCRIPTABLE NS_IMETHOD SetPrintInColor(bool aPrintInColor) = 0;
  ...
  NS_SCRIPTABLE NS_IMETHOD GetPrintToFile(bool *aPrintToFile) = 0;
  NS_SCRIPTABLE NS_IMETHOD SetPrintToFile(bool aPrintToFile) = 0;
  ...
  NS_SCRIPTABLE NS_IMETHOD GetIsInitializedFromPrinter(bool *aIsInitializedFromPrinter) = 0;
  NS_SCRIPTABLE NS_IMETHOD SetIsInitializedFromPrinter(bool aIsInitializedFromPrinter) = 0;

  /* attribute boolean isInitializedFromPrefs; */
  NS_SCRIPTABLE NS_IMETHOD GetIsInitializedFromPrefs(bool *aIsInitializedFromPrefs) = 0;
  NS_SCRIPTABLE NS_IMETHOD SetIsInitializedFromPrefs(bool aIsInitializedFromPrefs) = 0;
...
#define NS_DECL_NSIPRINTSETTINGS \
  NS_SCRIPTABLE NS_IMETHOD SetPrintOptions(PRInt32 aType, bool aTurnOnOff); \
  NS_SCRIPTABLE NS_IMETHOD GetPrintOptions(PRInt32 aType, bool *_retval NS_OUTPARAM); \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetPrintBGColors(bool *aPrintBGColors); \
  NS_SCRIPTABLE NS_IMETHOD SetPrintBGColors(bool aPrintBGColors); \
  NS_SCRIPTABLE NS_IMETHOD GetPrintBGImages(bool *aPrintBGImages); \
  NS_SCRIPTABLE NS_IMETHOD SetPrintBGImages(bool aPrintBGImages); \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetIsCancelled(bool *aIsCancelled); \
  NS_SCRIPTABLE NS_IMETHOD SetIsCancelled(bool aIsCancelled); \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetPrintSilent(bool *aPrintSilent); \
  NS_SCRIPTABLE NS_IMETHOD SetPrintSilent(bool aPrintSilent); \
  NS_SCRIPTABLE NS_IMETHOD GetShrinkToFit(bool *aShrinkToFit); \
  NS_SCRIPTABLE NS_IMETHOD SetShrinkToFit(bool aShrinkToFit); \
  NS_SCRIPTABLE NS_IMETHOD GetShowPrintProgress(bool *aShowPrintProgress); \
  NS_SCRIPTABLE NS_IMETHOD SetShowPrintProgress(bool aShowPrintProgress); \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetDownloadFonts(bool *aDownloadFonts); \
  NS_SCRIPTABLE NS_IMETHOD SetDownloadFonts(bool aDownloadFonts); \
  NS_SCRIPTABLE NS_IMETHOD GetPrintReversed(bool *aPrintReversed); \
  NS_SCRIPTABLE NS_IMETHOD SetPrintReversed(bool aPrintReversed); \
  NS_SCRIPTABLE NS_IMETHOD GetPrintInColor(bool *aPrintInColor); \
  NS_SCRIPTABLE NS_IMETHOD SetPrintInColor(bool aPrintInColor); \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetPrintToFile(bool *aPrintToFile); \
  NS_SCRIPTABLE NS_IMETHOD SetPrintToFile(bool aPrintToFile); \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetIsInitializedFromPrinter(bool *aIsInitializedFromPrinter); \
  NS_SCRIPTABLE NS_IMETHOD SetIsInitializedFromPrinter(bool aIsInitializedFromPrinter); \
  NS_SCRIPTABLE NS_IMETHOD GetIsInitializedFromPrefs(bool *aIsInitializedFromPrefs); \
  NS_SCRIPTABLE NS_IMETHOD SetIsInitializedFromPrefs(bool aIsInitializedFromPrefs); \
...
#define NS_FORWARD_NSIPRINTSETTINGS(_to) \
  NS_SCRIPTABLE NS_IMETHOD SetPrintOptions(PRInt32 aType, bool aTurnOnOff) { return _to SetPrintOptions(aType, aTurnOnOff); } \
  NS_SCRIPTABLE NS_IMETHOD GetPrintOptions(PRInt32 aType, bool *_retval NS_OUTPARAM) { return _to GetPrintOptions(aType, _retval); } \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetPrintBGColors(bool *aPrintBGColors) { return _to GetPrintBGColors(aPrintBGColors); } \
  NS_SCRIPTABLE NS_IMETHOD SetPrintBGColors(bool aPrintBGColors) { return _to SetPrintBGColors(aPrintBGColors); } \
  NS_SCRIPTABLE NS_IMETHOD GetPrintBGImages(bool *aPrintBGImages) { return _to GetPrintBGImages(aPrintBGImages); } \
  NS_SCRIPTABLE NS_IMETHOD SetPrintBGImages(bool aPrintBGImages) { return _to SetPrintBGImages(aPrintBGImages); } \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetIsCancelled(bool *aIsCancelled) { return _to GetIsCancelled(aIsCancelled); } \
  NS_SCRIPTABLE NS_IMETHOD SetIsCancelled(bool aIsCancelled) { return _to SetIsCancelled(aIsCancelled); } \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetPrintSilent(bool *aPrintSilent) { return _to GetPrintSilent(aPrintSilent); } \
  NS_SCRIPTABLE NS_IMETHOD SetPrintSilent(bool aPrintSilent) { return _to SetPrintSilent(aPrintSilent); } \
  NS_SCRIPTABLE NS_IMETHOD GetShrinkToFit(bool *aShrinkToFit) { return _to GetShrinkToFit(aShrinkToFit); } \
  NS_SCRIPTABLE NS_IMETHOD SetShrinkToFit(bool aShrinkToFit) { return _to SetShrinkToFit(aShrinkToFit); } \
  NS_SCRIPTABLE NS_IMETHOD GetShowPrintProgress(bool *aShowPrintProgress) { return _to GetShowPrintProgress(aShowPrintProgress); } \
  NS_SCRIPTABLE NS_IMETHOD SetShowPrintProgress(bool aShowPrintProgress) { return _to SetShowPrintProgress(aShowPrintProgress); } \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetDownloadFonts(bool *aDownloadFonts) { return _to GetDownloadFonts(aDownloadFonts); } \
  NS_SCRIPTABLE NS_IMETHOD SetDownloadFonts(bool aDownloadFonts) { return _to SetDownloadFonts(aDownloadFonts); } \
  NS_SCRIPTABLE NS_IMETHOD GetPrintReversed(bool *aPrintReversed) { return _to GetPrintReversed(aPrintReversed); } \
  NS_SCRIPTABLE NS_IMETHOD SetPrintReversed(bool aPrintReversed) { return _to SetPrintReversed(aPrintReversed); } \
  NS_SCRIPTABLE NS_IMETHOD GetPrintInColor(bool *aPrintInColor) { return _to GetPrintInColor(aPrintInColor); } \
  NS_SCRIPTABLE NS_IMETHOD SetPrintInColor(bool aPrintInColor) { return _to SetPrintInColor(aPrintInColor); } \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetPrintToFile(bool *aPrintToFile) { return _to GetPrintToFile(aPrintToFile); } \
  NS_SCRIPTABLE NS_IMETHOD SetPrintToFile(bool aPrintToFile) { return _to SetPrintToFile(aPrintToFile); } \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetIsInitializedFromPrinter(bool *aIsInitializedFromPrinter) { return _to GetIsInitializedFromPrinter(aIsInitializedFromPrinter); } \
  NS_SCRIPTABLE NS_IMETHOD SetIsInitializedFromPrinter(bool aIsInitializedFromPrinter) { return _to SetIsInitializedFromPrinter(aIsInitializedFromPrinter); } \
  NS_SCRIPTABLE NS_IMETHOD GetIsInitializedFromPrefs(bool *aIsInitializedFromPrefs) { return _to GetIsInitializedFromPrefs(aIsInitializedFromPrefs); } \
  NS_SCRIPTABLE NS_IMETHOD SetIsInitializedFromPrefs(bool aIsInitializedFromPrefs) { return _to SetIsInitializedFromPrefs(aIsInitializedFromPrefs); } \
...
#define NS_FORWARD_SAFE_NSIPRINTSETTINGS(_to) \
  NS_SCRIPTABLE NS_IMETHOD SetPrintOptions(PRInt32 aType, bool aTurnOnOff) { return !_to ? NS_ERROR_NULL_POINTER : _to->SetPrintOptions(aType, aTurnOnOff); } \
  NS_SCRIPTABLE NS_IMETHOD GetPrintOptions(PRInt32 aType, bool *_retval NS_OUTPARAM) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetPrintOptions(aType, _retval); } \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetPrintBGColors(bool *aPrintBGColors) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetPrintBGColors(aPrintBGColors); } \
  NS_SCRIPTABLE NS_IMETHOD SetPrintBGColors(bool aPrintBGColors) { return !_to ? NS_ERROR_NULL_POINTER : _to->SetPrintBGColors(aPrintBGColors); } \
  NS_SCRIPTABLE NS_IMETHOD GetPrintBGImages(bool *aPrintBGImages) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetPrintBGImages(aPrintBGImages); } \
  NS_SCRIPTABLE NS_IMETHOD SetPrintBGImages(bool aPrintBGImages) { return !_to ? NS_ERROR_NULL_POINTER : _to->SetPrintBGImages(aPrintBGImages); } \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetIsCancelled(bool *aIsCancelled) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetIsCancelled(aIsCancelled); } \
  NS_SCRIPTABLE NS_IMETHOD SetIsCancelled(bool aIsCancelled) { return !_to ? NS_ERROR_NULL_POINTER : _to->SetIsCancelled(aIsCancelled); } \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetPrintSilent(bool *aPrintSilent) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetPrintSilent(aPrintSilent); } \
  NS_SCRIPTABLE NS_IMETHOD SetPrintSilent(bool aPrintSilent) { return !_to ? NS_ERROR_NULL_POINTER : _to->SetPrintSilent(aPrintSilent); } \
  NS_SCRIPTABLE NS_IMETHOD GetShrinkToFit(bool *aShrinkToFit) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetShrinkToFit(aShrinkToFit); } \
  NS_SCRIPTABLE NS_IMETHOD SetShrinkToFit(bool aShrinkToFit) { return !_to ? NS_ERROR_NULL_POINTER : _to->SetShrinkToFit(aShrinkToFit); } \
  NS_SCRIPTABLE NS_IMETHOD GetShowPrintProgress(bool *aShowPrintProgress) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetShowPrintProgress(aShowPrintProgress); } \
  NS_SCRIPTABLE NS_IMETHOD SetShowPrintProgress(bool aShowPrintProgress) { return !_to ? NS_ERROR_NULL_POINTER : _to->SetShowPrintProgress(aShowPrintProgress); } \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetDownloadFonts(bool *aDownloadFonts) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetDownloadFonts(aDownloadFonts); } \
  NS_SCRIPTABLE NS_IMETHOD SetDownloadFonts(bool aDownloadFonts) { return !_to ? NS_ERROR_NULL_POINTER : _to->SetDownloadFonts(aDownloadFonts); } \
  NS_SCRIPTABLE NS_IMETHOD GetPrintReversed(bool *aPrintReversed) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetPrintReversed(aPrintReversed); } \
  NS_SCRIPTABLE NS_IMETHOD SetPrintReversed(bool aPrintReversed) { return !_to ? NS_ERROR_NULL_POINTER : _to->SetPrintReversed(aPrintReversed); } \
  NS_SCRIPTABLE NS_IMETHOD GetPrintInColor(bool *aPrintInColor) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetPrintInColor(aPrintInColor); } \
  NS_SCRIPTABLE NS_IMETHOD SetPrintInColor(bool aPrintInColor) { return !_to ? NS_ERROR_NULL_POINTER : _to->SetPrintInColor(aPrintInColor); } \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetPrintToFile(bool *aPrintToFile) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetPrintToFile(aPrintToFile); } \
  NS_SCRIPTABLE NS_IMETHOD SetPrintToFile(bool aPrintToFile) { return !_to ? NS_ERROR_NULL_POINTER : _to->SetPrintToFile(aPrintToFile); } \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetIsInitializedFromPrinter(bool *aIsInitializedFromPrinter) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetIsInitializedFromPrinter(aIsInitializedFromPrinter); } \
  NS_SCRIPTABLE NS_IMETHOD SetIsInitializedFromPrinter(bool aIsInitializedFromPrinter) { return !_to ? NS_ERROR_NULL_POINTER : _to->SetIsInitializedFromPrinter(aIsInitializedFromPrinter); } \
  NS_SCRIPTABLE NS_IMETHOD GetIsInitializedFromPrefs(bool *aIsInitializedFromPrefs) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetIsInitializedFromPrefs(aIsInitializedFromPrefs); } \
  NS_SCRIPTABLE NS_IMETHOD SetIsInitializedFromPrefs(bool aIsInitializedFromPrefs) { return !_to ? NS_ERROR_NULL_POINTER : _to->SetIsInitializedFromPrefs(aIsInitializedFromPrefs); } \
...
/* void SetPrintOptions (in PRInt32 aType, in boolean aTurnOnOff); */
NS_IMETHODIMP nsPrintSettings::SetPrintOptions(PRInt32 aType, bool aTurnOnOff)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}

/* boolean GetPrintOptions (in PRInt32 aType); */
NS_IMETHODIMP nsPrintSettings::GetPrintOptions(PRInt32 aType, bool *_retval NS_OUTPARAM)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
