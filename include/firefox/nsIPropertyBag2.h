/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM /jds/packages/BUILD/SUNWfirefox-10.0.2/firefox/xpcom/ds/nsIPropertyBag2.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIPropertyBag2 : public nsIPropertyBag {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD GetPropertyAsBool(const nsAString & prop, bool *_retval NS_OUTPARAM) = 0;
  ...
  NS_SCRIPTABLE NS_IMETHOD HasKey(const nsAString & prop, bool *_retval NS_OUTPARAM) = 0;
...
#define NS_DECL_NSIPROPERTYBAG2 \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetPropertyAsBool(const nsAString & prop, bool *_retval NS_OUTPARAM); \
  ...
  NS_SCRIPTABLE NS_IMETHOD HasKey(const nsAString & prop, bool *_retval NS_OUTPARAM); 
...
#define NS_FORWARD_NSIPROPERTYBAG2(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetPropertyAsBool(const nsAString & prop, bool *_retval NS_OUTPARAM) { return _to GetPropertyAsBool(prop, _retval); } \
  ...
  NS_SCRIPTABLE NS_IMETHOD HasKey(const nsAString & prop, bool *_retval NS_OUTPARAM) { return _to HasKey(prop, _retval); } 
...
#define NS_FORWARD_SAFE_NSIPROPERTYBAG2(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetPropertyAsBool(const nsAString & prop, bool *_retval NS_OUTPARAM) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetPropertyAsBool(prop, _retval); } \
  ...
  NS_SCRIPTABLE NS_IMETHOD HasKey(const nsAString & prop, bool *_retval NS_OUTPARAM) { return !_to ? NS_ERROR_NULL_POINTER : _to->HasKey(prop, _retval); } 
...
/* boolean getPropertyAsBool (in AString prop); */
NS_IMETHODIMP nsPropertyBag2::GetPropertyAsBool(const nsAString & prop, bool *_retval NS_OUTPARAM)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
...
/* boolean hasKey (in AString prop); */
NS_IMETHODIMP nsPropertyBag2::HasKey(const nsAString & prop, bool *_retval NS_OUTPARAM)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
