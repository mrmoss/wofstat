/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM /jds/packages/BUILD/SUNWfirefox-10.0.2/firefox/netwerk/base/public/nsIProtocolHandler.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIProtocolHandler : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD AllowPort(PRInt32 port, const char * scheme, bool *_retval NS_OUTPARAM) = 0;
...
#define NS_DECL_NSIPROTOCOLHANDLER \
  ...
  NS_SCRIPTABLE NS_IMETHOD AllowPort(PRInt32 port, const char * scheme, bool *_retval NS_OUTPARAM); \
...
#define NS_FORWARD_NSIPROTOCOLHANDLER(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD AllowPort(PRInt32 port, const char * scheme, bool *_retval NS_OUTPARAM) { return _to AllowPort(port, scheme, _retval); } \
...
#define NS_FORWARD_SAFE_NSIPROTOCOLHANDLER(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD AllowPort(PRInt32 port, const char * scheme, bool *_retval NS_OUTPARAM) { return !_to ? NS_ERROR_NULL_POINTER : _to->AllowPort(port, scheme, _retval); } \
...
/* boolean allowPort (in long port, in string scheme); */
NS_IMETHODIMP nsProtocolHandler::AllowPort(PRInt32 port, const char * scheme, bool *_retval NS_OUTPARAM)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
