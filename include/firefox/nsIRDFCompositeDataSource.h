/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM /jds/packages/BUILD/SUNWfirefox-10.0.2/firefox/rdf/base/idl/nsIRDFCompositeDataSource.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIRDFCompositeDataSource : public nsIRDFDataSource {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD GetAllowNegativeAssertions(bool *aAllowNegativeAssertions) = 0;
  NS_SCRIPTABLE NS_IMETHOD SetAllowNegativeAssertions(bool aAllowNegativeAssertions) = 0;

  /* attribute boolean coalesceDuplicateArcs; */
  NS_SCRIPTABLE NS_IMETHOD GetCoalesceDuplicateArcs(bool *aCoalesceDuplicateArcs) = 0;
  NS_SCRIPTABLE NS_IMETHOD SetCoalesceDuplicateArcs(bool aCoalesceDuplicateArcs) = 0;
...
#define NS_DECL_NSIRDFCOMPOSITEDATASOURCE \
  NS_SCRIPTABLE NS_IMETHOD GetAllowNegativeAssertions(bool *aAllowNegativeAssertions); \
  NS_SCRIPTABLE NS_IMETHOD SetAllowNegativeAssertions(bool aAllowNegativeAssertions); \
  NS_SCRIPTABLE NS_IMETHOD GetCoalesceDuplicateArcs(bool *aCoalesceDuplicateArcs); \
  NS_SCRIPTABLE NS_IMETHOD SetCoalesceDuplicateArcs(bool aCoalesceDuplicateArcs); \
...
#define NS_FORWARD_NSIRDFCOMPOSITEDATASOURCE(_to) \
  NS_SCRIPTABLE NS_IMETHOD GetAllowNegativeAssertions(bool *aAllowNegativeAssertions) { return _to GetAllowNegativeAssertions(aAllowNegativeAssertions); } \
  NS_SCRIPTABLE NS_IMETHOD SetAllowNegativeAssertions(bool aAllowNegativeAssertions) { return _to SetAllowNegativeAssertions(aAllowNegativeAssertions); } \
  NS_SCRIPTABLE NS_IMETHOD GetCoalesceDuplicateArcs(bool *aCoalesceDuplicateArcs) { return _to GetCoalesceDuplicateArcs(aCoalesceDuplicateArcs); } \
  NS_SCRIPTABLE NS_IMETHOD SetCoalesceDuplicateArcs(bool aCoalesceDuplicateArcs) { return _to SetCoalesceDuplicateArcs(aCoalesceDuplicateArcs); } \
...
#define NS_FORWARD_SAFE_NSIRDFCOMPOSITEDATASOURCE(_to) \
  NS_SCRIPTABLE NS_IMETHOD GetAllowNegativeAssertions(bool *aAllowNegativeAssertions) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetAllowNegativeAssertions(aAllowNegativeAssertions); } \
  NS_SCRIPTABLE NS_IMETHOD SetAllowNegativeAssertions(bool aAllowNegativeAssertions) { return !_to ? NS_ERROR_NULL_POINTER : _to->SetAllowNegativeAssertions(aAllowNegativeAssertions); } \
  NS_SCRIPTABLE NS_IMETHOD GetCoalesceDuplicateArcs(bool *aCoalesceDuplicateArcs) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetCoalesceDuplicateArcs(aCoalesceDuplicateArcs); } \
  NS_SCRIPTABLE NS_IMETHOD SetCoalesceDuplicateArcs(bool aCoalesceDuplicateArcs) { return !_to ? NS_ERROR_NULL_POINTER : _to->SetCoalesceDuplicateArcs(aCoalesceDuplicateArcs); } \
