/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM /jds/packages/BUILD/SUNWfirefox-10.0.2/firefox/rdf/base/idl/nsIRDFContainer.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIRDFContainer : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD RemoveElement(nsIRDFNode *aElement, bool aRenumber) = 0;

  /* void InsertElementAt (in nsIRDFNode aElement, in long aIndex, in boolean aRenumber); */
  NS_SCRIPTABLE NS_IMETHOD InsertElementAt(nsIRDFNode *aElement, PRInt32 aIndex, bool aRenumber) = 0;

  /* nsIRDFNode RemoveElementAt (in long aIndex, in boolean aRenumber); */
  NS_SCRIPTABLE NS_IMETHOD RemoveElementAt(PRInt32 aIndex, bool aRenumber, nsIRDFNode * *_retval NS_OUTPARAM) = 0;
...
#define NS_DECL_NSIRDFCONTAINER \
  ...
  NS_SCRIPTABLE NS_IMETHOD RemoveElement(nsIRDFNode *aElement, bool aRenumber); \
  NS_SCRIPTABLE NS_IMETHOD InsertElementAt(nsIRDFNode *aElement, PRInt32 aIndex, bool aRenumber); \
  NS_SCRIPTABLE NS_IMETHOD RemoveElementAt(PRInt32 aIndex, bool aRenumber, nsIRDFNode * *_retval NS_OUTPARAM); \
...
#define NS_FORWARD_NSIRDFCONTAINER(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD RemoveElement(nsIRDFNode *aElement, bool aRenumber) { return _to RemoveElement(aElement, aRenumber); } \
  NS_SCRIPTABLE NS_IMETHOD InsertElementAt(nsIRDFNode *aElement, PRInt32 aIndex, bool aRenumber) { return _to InsertElementAt(aElement, aIndex, aRenumber); } \
  NS_SCRIPTABLE NS_IMETHOD RemoveElementAt(PRInt32 aIndex, bool aRenumber, nsIRDFNode * *_retval NS_OUTPARAM) { return _to RemoveElementAt(aIndex, aRenumber, _retval); } \
...
#define NS_FORWARD_SAFE_NSIRDFCONTAINER(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD RemoveElement(nsIRDFNode *aElement, bool aRenumber) { return !_to ? NS_ERROR_NULL_POINTER : _to->RemoveElement(aElement, aRenumber); } \
  NS_SCRIPTABLE NS_IMETHOD InsertElementAt(nsIRDFNode *aElement, PRInt32 aIndex, bool aRenumber) { return !_to ? NS_ERROR_NULL_POINTER : _to->InsertElementAt(aElement, aIndex, aRenumber); } \
  NS_SCRIPTABLE NS_IMETHOD RemoveElementAt(PRInt32 aIndex, bool aRenumber, nsIRDFNode * *_retval NS_OUTPARAM) { return !_to ? NS_ERROR_NULL_POINTER : _to->RemoveElementAt(aIndex, aRenumber, _retval); } \
...
/* void InsertElementAt (in nsIRDFNode aElement, in long aIndex, in boolean aRenumber); */
NS_IMETHODIMP nsRDFContainer::InsertElementAt(nsIRDFNode *aElement, PRInt32 aIndex, bool aRenumber)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}

/* nsIRDFNode RemoveElementAt (in long aIndex, in boolean aRenumber); */
NS_IMETHODIMP nsRDFContainer::RemoveElementAt(PRInt32 aIndex, bool aRenumber, nsIRDFNode * *_retval NS_OUTPARAM)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
