/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM /jds/packages/BUILD/SUNWfirefox-10.0.2/firefox/rdf/base/idl/nsIRDFContainerUtils.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIRDFContainerUtils : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD IsOrdinalProperty(nsIRDFResource *aProperty, bool *_retval NS_OUTPARAM) = 0;
  ...
  NS_SCRIPTABLE NS_IMETHOD IsContainer(nsIRDFDataSource *aDataSource, nsIRDFResource *aResource, bool *_retval NS_OUTPARAM) = 0;

  /* boolean IsEmpty (in nsIRDFDataSource aDataSource, in nsIRDFResource aResource); */
  NS_SCRIPTABLE NS_IMETHOD IsEmpty(nsIRDFDataSource *aDataSource, nsIRDFResource *aResource, bool *_retval NS_OUTPARAM) = 0;

  /* boolean IsBag (in nsIRDFDataSource aDataSource, in nsIRDFResource aResource); */
  NS_SCRIPTABLE NS_IMETHOD IsBag(nsIRDFDataSource *aDataSource, nsIRDFResource *aResource, bool *_retval NS_OUTPARAM) = 0;

  /* boolean IsSeq (in nsIRDFDataSource aDataSource, in nsIRDFResource aResource); */
  NS_SCRIPTABLE NS_IMETHOD IsSeq(nsIRDFDataSource *aDataSource, nsIRDFResource *aResource, bool *_retval NS_OUTPARAM) = 0;

  /* boolean IsAlt (in nsIRDFDataSource aDataSource, in nsIRDFResource aResource); */
  NS_SCRIPTABLE NS_IMETHOD IsAlt(nsIRDFDataSource *aDataSource, nsIRDFResource *aResource, bool *_retval NS_OUTPARAM) = 0;
...
#define NS_DECL_NSIRDFCONTAINERUTILS \
  NS_SCRIPTABLE NS_IMETHOD IsOrdinalProperty(nsIRDFResource *aProperty, bool *_retval NS_OUTPARAM); \
  ...
  NS_SCRIPTABLE NS_IMETHOD IsContainer(nsIRDFDataSource *aDataSource, nsIRDFResource *aResource, bool *_retval NS_OUTPARAM); \
  NS_SCRIPTABLE NS_IMETHOD IsEmpty(nsIRDFDataSource *aDataSource, nsIRDFResource *aResource, bool *_retval NS_OUTPARAM); \
  NS_SCRIPTABLE NS_IMETHOD IsBag(nsIRDFDataSource *aDataSource, nsIRDFResource *aResource, bool *_retval NS_OUTPARAM); \
  NS_SCRIPTABLE NS_IMETHOD IsSeq(nsIRDFDataSource *aDataSource, nsIRDFResource *aResource, bool *_retval NS_OUTPARAM); \
  NS_SCRIPTABLE NS_IMETHOD IsAlt(nsIRDFDataSource *aDataSource, nsIRDFResource *aResource, bool *_retval NS_OUTPARAM); \
...
#define NS_FORWARD_NSIRDFCONTAINERUTILS(_to) \
  NS_SCRIPTABLE NS_IMETHOD IsOrdinalProperty(nsIRDFResource *aProperty, bool *_retval NS_OUTPARAM) { return _to IsOrdinalProperty(aProperty, _retval); } \
  ...
  NS_SCRIPTABLE NS_IMETHOD IsContainer(nsIRDFDataSource *aDataSource, nsIRDFResource *aResource, bool *_retval NS_OUTPARAM) { return _to IsContainer(aDataSource, aResource, _retval); } \
  NS_SCRIPTABLE NS_IMETHOD IsEmpty(nsIRDFDataSource *aDataSource, nsIRDFResource *aResource, bool *_retval NS_OUTPARAM) { return _to IsEmpty(aDataSource, aResource, _retval); } \
  NS_SCRIPTABLE NS_IMETHOD IsBag(nsIRDFDataSource *aDataSource, nsIRDFResource *aResource, bool *_retval NS_OUTPARAM) { return _to IsBag(aDataSource, aResource, _retval); } \
  NS_SCRIPTABLE NS_IMETHOD IsSeq(nsIRDFDataSource *aDataSource, nsIRDFResource *aResource, bool *_retval NS_OUTPARAM) { return _to IsSeq(aDataSource, aResource, _retval); } \
  NS_SCRIPTABLE NS_IMETHOD IsAlt(nsIRDFDataSource *aDataSource, nsIRDFResource *aResource, bool *_retval NS_OUTPARAM) { return _to IsAlt(aDataSource, aResource, _retval); } \
...
#define NS_FORWARD_SAFE_NSIRDFCONTAINERUTILS(_to) \
  NS_SCRIPTABLE NS_IMETHOD IsOrdinalProperty(nsIRDFResource *aProperty, bool *_retval NS_OUTPARAM) { return !_to ? NS_ERROR_NULL_POINTER : _to->IsOrdinalProperty(aProperty, _retval); } \
  ...
  NS_SCRIPTABLE NS_IMETHOD IsContainer(nsIRDFDataSource *aDataSource, nsIRDFResource *aResource, bool *_retval NS_OUTPARAM) { return !_to ? NS_ERROR_NULL_POINTER : _to->IsContainer(aDataSource, aResource, _retval); } \
  NS_SCRIPTABLE NS_IMETHOD IsEmpty(nsIRDFDataSource *aDataSource, nsIRDFResource *aResource, bool *_retval NS_OUTPARAM) { return !_to ? NS_ERROR_NULL_POINTER : _to->IsEmpty(aDataSource, aResource, _retval); } \
  NS_SCRIPTABLE NS_IMETHOD IsBag(nsIRDFDataSource *aDataSource, nsIRDFResource *aResource, bool *_retval NS_OUTPARAM) { return !_to ? NS_ERROR_NULL_POINTER : _to->IsBag(aDataSource, aResource, _retval); } \
  NS_SCRIPTABLE NS_IMETHOD IsSeq(nsIRDFDataSource *aDataSource, nsIRDFResource *aResource, bool *_retval NS_OUTPARAM) { return !_to ? NS_ERROR_NULL_POINTER : _to->IsSeq(aDataSource, aResource, _retval); } \
  NS_SCRIPTABLE NS_IMETHOD IsAlt(nsIRDFDataSource *aDataSource, nsIRDFResource *aResource, bool *_retval NS_OUTPARAM) { return !_to ? NS_ERROR_NULL_POINTER : _to->IsAlt(aDataSource, aResource, _retval); } \
...
/* boolean IsOrdinalProperty (in nsIRDFResource aProperty); */
NS_IMETHODIMP nsRDFContainerUtils::IsOrdinalProperty(nsIRDFResource *aProperty, bool *_retval NS_OUTPARAM)
{
...
/* boolean IsContainer (in nsIRDFDataSource aDataSource, in nsIRDFResource aResource); */
NS_IMETHODIMP nsRDFContainerUtils::IsContainer(nsIRDFDataSource *aDataSource, nsIRDFResource *aResource, bool *_retval NS_OUTPARAM)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}

/* boolean IsEmpty (in nsIRDFDataSource aDataSource, in nsIRDFResource aResource); */
NS_IMETHODIMP nsRDFContainerUtils::IsEmpty(nsIRDFDataSource *aDataSource, nsIRDFResource *aResource, bool *_retval NS_OUTPARAM)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}

/* boolean IsBag (in nsIRDFDataSource aDataSource, in nsIRDFResource aResource); */
NS_IMETHODIMP nsRDFContainerUtils::IsBag(nsIRDFDataSource *aDataSource, nsIRDFResource *aResource, bool *_retval NS_OUTPARAM)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}

/* boolean IsSeq (in nsIRDFDataSource aDataSource, in nsIRDFResource aResource); */
NS_IMETHODIMP nsRDFContainerUtils::IsSeq(nsIRDFDataSource *aDataSource, nsIRDFResource *aResource, bool *_retval NS_OUTPARAM)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}

/* boolean IsAlt (in nsIRDFDataSource aDataSource, in nsIRDFResource aResource); */
NS_IMETHODIMP nsRDFContainerUtils::IsAlt(nsIRDFDataSource *aDataSource, nsIRDFResource *aResource, bool *_retval NS_OUTPARAM)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
