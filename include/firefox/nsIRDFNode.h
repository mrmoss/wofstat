/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM /jds/packages/BUILD/SUNWfirefox-10.0.2/firefox/rdf/base/idl/nsIRDFNode.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIRDFNode : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD EqualsNode(nsIRDFNode *aNode, bool *_retval NS_OUTPARAM) = 0;
...
#define NS_DECL_NSIRDFNODE \
  NS_SCRIPTABLE NS_IMETHOD EqualsNode(nsIRDFNode *aNode, bool *_retval NS_OUTPARAM); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSIRDFNODE(_to) \
  NS_SCRIPTABLE NS_IMETHOD EqualsNode(nsIRDFNode *aNode, bool *_retval NS_OUTPARAM) { return _to EqualsNode(aNode, _retval); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_NSIRDFNODE(_to) \
  NS_SCRIPTABLE NS_IMETHOD EqualsNode(nsIRDFNode *aNode, bool *_retval NS_OUTPARAM) { return !_to ? NS_ERROR_NULL_POINTER : _to->EqualsNode(aNode, _retval); } 
...
/* boolean EqualsNode (in nsIRDFNode aNode); */
NS_IMETHODIMP nsRDFNode::EqualsNode(nsIRDFNode *aNode, bool *_retval NS_OUTPARAM)
{
