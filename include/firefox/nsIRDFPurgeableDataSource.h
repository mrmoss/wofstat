/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM /jds/packages/BUILD/SUNWfirefox-10.0.2/firefox/rdf/base/idl/nsIRDFPurgeableDataSource.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIRDFPurgeableDataSource : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD Mark(nsIRDFResource *aSource, nsIRDFResource *aProperty, nsIRDFNode *aTarget, bool aTruthValue, bool *_retval NS_OUTPARAM) = 0;
...
#define NS_DECL_NSIRDFPURGEABLEDATASOURCE \
  NS_SCRIPTABLE NS_IMETHOD Mark(nsIRDFResource *aSource, nsIRDFResource *aProperty, nsIRDFNode *aTarget, bool aTruthValue, bool *_retval NS_OUTPARAM); \
  NS_SCRIPTABLE NS_IMETHOD Sweep(void); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSIRDFPURGEABLEDATASOURCE(_to) \
  NS_SCRIPTABLE NS_IMETHOD Mark(nsIRDFResource *aSource, nsIRDFResource *aProperty, nsIRDFNode *aTarget, bool aTruthValue, bool *_retval NS_OUTPARAM) { return _to Mark(aSource, aProperty, aTarget, aTruthValue, _retval); } \
...
#define NS_FORWARD_SAFE_NSIRDFPURGEABLEDATASOURCE(_to) \
  NS_SCRIPTABLE NS_IMETHOD Mark(nsIRDFResource *aSource, nsIRDFResource *aProperty, nsIRDFNode *aTarget, bool aTruthValue, bool *_retval NS_OUTPARAM) { return !_to ? NS_ERROR_NULL_POINTER : _to->Mark(aSource, aProperty, aTarget, aTruthValue, _retval); } \
...
/* boolean Mark (in nsIRDFResource aSource, in nsIRDFResource aProperty, in nsIRDFNode aTarget, in boolean aTruthValue); */
NS_IMETHODIMP nsRDFPurgeableDataSource::Mark(nsIRDFResource *aSource, nsIRDFResource *aProperty, nsIRDFNode *aTarget, bool aTruthValue, bool *_retval NS_OUTPARAM)
{
