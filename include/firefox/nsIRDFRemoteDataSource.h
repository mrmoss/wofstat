/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM /jds/packages/BUILD/SUNWfirefox-10.0.2/firefox/rdf/base/idl/nsIRDFRemoteDataSource.idl
 */
...
#define NS_DECL_NSIRDFREMOTEDATASOURCE \
  NS_SCRIPTABLE NS_IMETHOD GetLoaded(bool *aLoaded); \
  NS_SCRIPTABLE NS_IMETHOD Init(const char * aURI); \
  NS_SCRIPTABLE NS_IMETHOD Refresh(bool aBlocking); \
...
#define NS_FORWARD_NSIRDFREMOTEDATASOURCE(_to) \
  NS_SCRIPTABLE NS_IMETHOD GetLoaded(bool *aLoaded) { return _to GetLoaded(aLoaded); } \
  NS_SCRIPTABLE NS_IMETHOD Init(const char * aURI) { return _to Init(aURI); } \
  NS_SCRIPTABLE NS_IMETHOD Refresh(bool aBlocking) { return _to Refresh(aBlocking); } \
...
#define NS_FORWARD_SAFE_NSIRDFREMOTEDATASOURCE(_to) \
  NS_SCRIPTABLE NS_IMETHOD GetLoaded(bool *aLoaded) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetLoaded(aLoaded); } \
  NS_SCRIPTABLE NS_IMETHOD Init(const char * aURI) { return !_to ? NS_ERROR_NULL_POINTER : _to->Init(aURI); } \
  NS_SCRIPTABLE NS_IMETHOD Refresh(bool aBlocking) { return !_to ? NS_ERROR_NULL_POINTER : _to->Refresh(aBlocking); } \
