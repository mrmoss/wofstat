/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM /jds/packages/BUILD/SUNWfirefox-10.0.2/firefox/rdf/base/idl/nsIRDFResource.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIRDFResource : public nsIRDFNode {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD EqualsString(const char * aURI, bool *_retval NS_OUTPARAM) = 0;
...
#define NS_DECL_NSIRDFRESOURCE \
  ...
  NS_SCRIPTABLE NS_IMETHOD EqualsString(const char * aURI, bool *_retval NS_OUTPARAM); \
...
#define NS_FORWARD_NSIRDFRESOURCE(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD EqualsString(const char * aURI, bool *_retval NS_OUTPARAM) { return _to EqualsString(aURI, _retval); } \
...
#define NS_FORWARD_SAFE_NSIRDFRESOURCE(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD EqualsString(const char * aURI, bool *_retval NS_OUTPARAM) { return !_to ? NS_ERROR_NULL_POINTER : _to->EqualsString(aURI, _retval); } \
...
/* boolean EqualsString (in string aURI); */
NS_IMETHODIMP nsRDFResource::EqualsString(const char * aURI, bool *_retval NS_OUTPARAM)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
