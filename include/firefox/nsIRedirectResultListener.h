/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM /jds/packages/BUILD/SUNWfirefox-10.0.2/firefox/netwerk/base/public/nsIRedirectResultListener.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIRedirectResultListener : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD OnRedirectResult(bool proceeding) = 0;
...
#define NS_DECL_NSIREDIRECTRESULTLISTENER \
  NS_SCRIPTABLE NS_IMETHOD OnRedirectResult(bool proceeding); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSIREDIRECTRESULTLISTENER(_to) \
  NS_SCRIPTABLE NS_IMETHOD OnRedirectResult(bool proceeding) { return _to OnRedirectResult(proceeding); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_NSIREDIRECTRESULTLISTENER(_to) \
  NS_SCRIPTABLE NS_IMETHOD OnRedirectResult(bool proceeding) { return !_to ? NS_ERROR_NULL_POINTER : _to->OnRedirectResult(proceeding); } 
