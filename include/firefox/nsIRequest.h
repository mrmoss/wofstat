/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM /jds/packages/BUILD/SUNWfirefox-10.0.2/firefox/netwerk/base/public/nsIRequest.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIRequest : public nsISupports {
 public: 
  ...
  /* boolean isPending (); */
  NS_SCRIPTABLE NS_IMETHOD IsPending(bool *_retval NS_OUTPARAM) = 0;
...
#define NS_DECL_NSIREQUEST \
  ...
  NS_SCRIPTABLE NS_IMETHOD IsPending(bool *_retval NS_OUTPARAM); \
...
#define NS_FORWARD_NSIREQUEST(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD IsPending(bool *_retval NS_OUTPARAM) { return _to IsPending(_retval); } \
...
#define NS_FORWARD_SAFE_NSIREQUEST(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD IsPending(bool *_retval NS_OUTPARAM) { return !_to ? NS_ERROR_NULL_POINTER : _to->IsPending(_retval); } \
...
/* boolean isPending (); */
NS_IMETHODIMP nsRequest::IsPending(bool *_retval NS_OUTPARAM)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
