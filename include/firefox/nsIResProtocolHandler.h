/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM /jds/packages/BUILD/SUNWfirefox-10.0.2/firefox/netwerk/protocol/res/nsIResProtocolHandler.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIResProtocolHandler : public nsIProtocolHandler {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD HasSubstitution(const nsACString & root, bool *_retval NS_OUTPARAM) = 0;
...
#define NS_DECL_NSIRESPROTOCOLHANDLER \
  ...
  NS_SCRIPTABLE NS_IMETHOD HasSubstitution(const nsACString & root, bool *_retval NS_OUTPARAM); \
...
#define NS_FORWARD_NSIRESPROTOCOLHANDLER(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD HasSubstitution(const nsACString & root, bool *_retval NS_OUTPARAM) { return _to HasSubstitution(root, _retval); } \
...
#define NS_FORWARD_SAFE_NSIRESPROTOCOLHANDLER(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD HasSubstitution(const nsACString & root, bool *_retval NS_OUTPARAM) { return !_to ? NS_ERROR_NULL_POINTER : _to->HasSubstitution(root, _retval); } \
...
/* boolean hasSubstitution (in ACString root); */
NS_IMETHODIMP nsResProtocolHandler::HasSubstitution(const nsACString & root, bool *_retval NS_OUTPARAM)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
