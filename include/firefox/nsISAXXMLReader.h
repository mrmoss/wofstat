/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM /jds/packages/BUILD/SUNWfirefox-10.0.2/firefox/parser/xml/public/nsISAXXMLReader.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsISAXXMLReader : public nsIStreamListener {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD SetFeature(const nsAString & name, bool value) = 0;

  /* boolean getFeature (in AString name); */
  NS_SCRIPTABLE NS_IMETHOD GetFeature(const nsAString & name, bool *_retval NS_OUTPARAM) = 0;
  ...
  NS_SCRIPTABLE NS_IMETHOD GetProperty(const nsAString & name, bool *_retval NS_OUTPARAM) = 0;
...
#define NS_DECL_NSISAXXMLREADER \
  ...
  NS_SCRIPTABLE NS_IMETHOD SetFeature(const nsAString & name, bool value); \
  NS_SCRIPTABLE NS_IMETHOD GetFeature(const nsAString & name, bool *_retval NS_OUTPARAM); \
  NS_SCRIPTABLE NS_IMETHOD SetProperty(const nsAString & name, nsISupports *value); \
  NS_SCRIPTABLE NS_IMETHOD GetProperty(const nsAString & name, bool *_retval NS_OUTPARAM); \
...
#define NS_FORWARD_NSISAXXMLREADER(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD SetFeature(const nsAString & name, bool value) { return _to SetFeature(name, value); } \
  NS_SCRIPTABLE NS_IMETHOD GetFeature(const nsAString & name, bool *_retval NS_OUTPARAM) { return _to GetFeature(name, _retval); } \
  NS_SCRIPTABLE NS_IMETHOD SetProperty(const nsAString & name, nsISupports *value) { return _to SetProperty(name, value); } \
  NS_SCRIPTABLE NS_IMETHOD GetProperty(const nsAString & name, bool *_retval NS_OUTPARAM) { return _to GetProperty(name, _retval); } \
...
#define NS_FORWARD_SAFE_NSISAXXMLREADER(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD SetFeature(const nsAString & name, bool value) { return !_to ? NS_ERROR_NULL_POINTER : _to->SetFeature(name, value); } \
  NS_SCRIPTABLE NS_IMETHOD GetFeature(const nsAString & name, bool *_retval NS_OUTPARAM) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetFeature(name, _retval); } \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetProperty(const nsAString & name, bool *_retval NS_OUTPARAM) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetProperty(name, _retval); } \
...
/* boolean getFeature (in AString name); */
NS_IMETHODIMP nsSAXXMLReader::GetFeature(const nsAString & name, bool *_retval NS_OUTPARAM)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
...
/* boolean getProperty (in AString name); */
NS_IMETHODIMP nsSAXXMLReader::GetProperty(const nsAString & name, bool *_retval NS_OUTPARAM)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
