/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM /jds/packages/BUILD/SUNWfirefox-10.0.2/firefox/docshell/shistory/public/nsISHTransaction.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsISHTransaction : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD GetPersist(bool *aPersist) = 0;
  NS_SCRIPTABLE NS_IMETHOD SetPersist(bool aPersist) = 0;
...
#define NS_DECL_NSISHTRANSACTION \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetPersist(bool *aPersist); \
  NS_SCRIPTABLE NS_IMETHOD SetPersist(bool aPersist); \
...
#define NS_FORWARD_NSISHTRANSACTION(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetPersist(bool *aPersist) { return _to GetPersist(aPersist); } \
  NS_SCRIPTABLE NS_IMETHOD SetPersist(bool aPersist) { return _to SetPersist(aPersist); } \
...
#define NS_FORWARD_SAFE_NSISHTRANSACTION(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetPersist(bool *aPersist) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetPersist(aPersist); } \
  NS_SCRIPTABLE NS_IMETHOD SetPersist(bool aPersist) { return !_to ? NS_ERROR_NULL_POINTER : _to->SetPersist(aPersist); } \
