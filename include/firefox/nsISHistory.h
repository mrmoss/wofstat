/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM /jds/packages/BUILD/SUNWfirefox-10.0.2/firefox/docshell/shistory/public/nsISHistory.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsISHistory : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD GetEntryAtIndex(PRInt32 index, bool modifyIndex, nsIHistoryEntry * *_retval NS_OUTPARAM) = 0;
...
#define NS_DECL_NSISHISTORY \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetEntryAtIndex(PRInt32 index, bool modifyIndex, nsIHistoryEntry * *_retval NS_OUTPARAM); \
...
#define NS_FORWARD_NSISHISTORY(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetEntryAtIndex(PRInt32 index, bool modifyIndex, nsIHistoryEntry * *_retval NS_OUTPARAM) { return _to GetEntryAtIndex(index, modifyIndex, _retval); } \
...
#define NS_FORWARD_SAFE_NSISHISTORY(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetEntryAtIndex(PRInt32 index, bool modifyIndex, nsIHistoryEntry * *_retval NS_OUTPARAM) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetEntryAtIndex(index, modifyIndex, _retval); } \
...
/* nsIHistoryEntry getEntryAtIndex (in long index, in boolean modifyIndex); */
NS_IMETHODIMP nsSHistory::GetEntryAtIndex(PRInt32 index, bool modifyIndex, nsIHistoryEntry * *_retval NS_OUTPARAM)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
