/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM /jds/packages/BUILD/SUNWfirefox-10.0.2/firefox/security/manager/boot/public/nsISSLStatusProvider.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsISSLStatusProvider : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD GetSSLStatus(nsISSLStatus * *aSSLStatus) = 0;
...
#define NS_DECL_NSISSLSTATUSPROVIDER \
  NS_SCRIPTABLE NS_IMETHOD GetSSLStatus(nsISSLStatus * *aSSLStatus); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSISSLSTATUSPROVIDER(_to) \
  NS_SCRIPTABLE NS_IMETHOD GetSSLStatus(nsISSLStatus * *aSSLStatus) { return _to GetSSLStatus(aSSLStatus); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_NSISSLSTATUSPROVIDER(_to) \
  NS_SCRIPTABLE NS_IMETHOD GetSSLStatus(nsISSLStatus * *aSSLStatus) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetSSLStatus(aSSLStatus); } 
