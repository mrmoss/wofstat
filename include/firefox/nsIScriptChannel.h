/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM /jds/packages/BUILD/SUNWfirefox-10.0.2/firefox/dom/base/nsIScriptChannel.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIScriptChannel : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD GetExecuteAsync(bool *aExecuteAsync) = 0;
  NS_SCRIPTABLE NS_IMETHOD SetExecuteAsync(bool aExecuteAsync) = 0;
...
#define NS_DECL_NSISCRIPTCHANNEL \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetExecuteAsync(bool *aExecuteAsync); \
  NS_SCRIPTABLE NS_IMETHOD SetExecuteAsync(bool aExecuteAsync); 
...
#define NS_FORWARD_NSISCRIPTCHANNEL(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetExecuteAsync(bool *aExecuteAsync) { return _to GetExecuteAsync(aExecuteAsync); } \
  NS_SCRIPTABLE NS_IMETHOD SetExecuteAsync(bool aExecuteAsync) { return _to SetExecuteAsync(aExecuteAsync); } 
...
#define NS_FORWARD_SAFE_NSISCRIPTCHANNEL(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetExecuteAsync(bool *aExecuteAsync) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetExecuteAsync(aExecuteAsync); } \
  NS_SCRIPTABLE NS_IMETHOD SetExecuteAsync(bool aExecuteAsync) { return !_to ? NS_ERROR_NULL_POINTER : _to->SetExecuteAsync(aExecuteAsync); } 
