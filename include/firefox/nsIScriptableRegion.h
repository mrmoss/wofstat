/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM /jds/packages/BUILD/SUNWfirefox-10.0.2/firefox/gfx/src/nsIScriptableRegion.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIScriptableRegion : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD IsEqualRegion(nsIScriptableRegion *aRegion, bool *_retval NS_OUTPARAM) = 0;
  ...
  NS_SCRIPTABLE NS_IMETHOD ContainsRect(PRInt32 aX, PRInt32 aY, PRInt32 aWidth, PRInt32 aHeight, bool *_retval NS_OUTPARAM) = 0;
...
#define NS_DECL_NSISCRIPTABLEREGION \
  ...
  NS_SCRIPTABLE NS_IMETHOD IsEqualRegion(nsIScriptableRegion *aRegion, bool *_retval NS_OUTPARAM); \
  ...
  NS_SCRIPTABLE NS_IMETHOD ContainsRect(PRInt32 aX, PRInt32 aY, PRInt32 aWidth, PRInt32 aHeight, bool *_retval NS_OUTPARAM); \
...
#define NS_FORWARD_NSISCRIPTABLEREGION(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD IsEqualRegion(nsIScriptableRegion *aRegion, bool *_retval NS_OUTPARAM) { return _to IsEqualRegion(aRegion, _retval); } \
  ...
  NS_SCRIPTABLE NS_IMETHOD ContainsRect(PRInt32 aX, PRInt32 aY, PRInt32 aWidth, PRInt32 aHeight, bool *_retval NS_OUTPARAM) { return _to ContainsRect(aX, aY, aWidth, aHeight, _retval); } \
...
#define NS_FORWARD_SAFE_NSISCRIPTABLEREGION(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD IsEqualRegion(nsIScriptableRegion *aRegion, bool *_retval NS_OUTPARAM) { return !_to ? NS_ERROR_NULL_POINTER : _to->IsEqualRegion(aRegion, _retval); } \
  ...
  NS_SCRIPTABLE NS_IMETHOD ContainsRect(PRInt32 aX, PRInt32 aY, PRInt32 aWidth, PRInt32 aHeight, bool *_retval NS_OUTPARAM) { return !_to ? NS_ERROR_NULL_POINTER : _to->ContainsRect(aX, aY, aWidth, aHeight, _retval); } \
...
/* boolean isEmpty (); */
NS_IMETHODIMP nsScriptableRegion::IsEmpty(bool *_retval NS_OUTPARAM)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}

/* boolean isEqualRegion (in nsIScriptableRegion aRegion); */
NS_IMETHODIMP nsScriptableRegion::IsEqualRegion(nsIScriptableRegion *aRegion, bool *_retval NS_OUTPARAM)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
...
/* boolean containsRect (in long aX, in long aY, in long aWidth, in long aHeight); */
NS_IMETHODIMP nsScriptableRegion::ContainsRect(PRInt32 aX, PRInt32 aY, PRInt32 aWidth, PRInt32 aHeight, bool *_retval NS_OUTPARAM)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
