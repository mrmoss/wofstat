/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM /jds/packages/BUILD/SUNWfirefox-10.0.2/firefox/intl/uconv/idl/nsIScriptableUConv.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIScriptableUnicodeConverter : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD GetIsInternal(bool *aIsInternal) = 0;
  NS_SCRIPTABLE NS_IMETHOD SetIsInternal(bool aIsInternal) = 0;
...
#define NS_DECL_NSISCRIPTABLEUNICODECONVERTER \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetIsInternal(bool *aIsInternal); \
  NS_SCRIPTABLE NS_IMETHOD SetIsInternal(bool aIsInternal); 
...
#define NS_FORWARD_NSISCRIPTABLEUNICODECONVERTER(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetIsInternal(bool *aIsInternal) { return _to GetIsInternal(aIsInternal); } \
  NS_SCRIPTABLE NS_IMETHOD SetIsInternal(bool aIsInternal) { return _to SetIsInternal(aIsInternal); } 
...
#define NS_FORWARD_SAFE_NSISCRIPTABLEUNICODECONVERTER(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetIsInternal(bool *aIsInternal) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetIsInternal(aIsInternal); } \
  NS_SCRIPTABLE NS_IMETHOD SetIsInternal(bool aIsInternal) { return !_to ? NS_ERROR_NULL_POINTER : _to->SetIsInternal(aIsInternal); } 
