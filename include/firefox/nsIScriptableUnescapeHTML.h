/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM /jds/packages/BUILD/SUNWfirefox-10.0.2/firefox/toolkit/components/feeds/nsIScriptableUnescapeHTML.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIScriptableUnescapeHTML : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD ParseFragment(const nsAString & fragment, bool isXML, nsIURI *baseURI, nsIDOMElement *element, nsIDOMDocumentFragment * *_retval NS_OUTPARAM) = 0;
...
#define NS_DECL_NSISCRIPTABLEUNESCAPEHTML \
  ...
  NS_SCRIPTABLE NS_IMETHOD ParseFragment(const nsAString & fragment, bool isXML, nsIURI *baseURI, nsIDOMElement *element, nsIDOMDocumentFragment * *_retval NS_OUTPARAM); 
...
#define NS_FORWARD_NSISCRIPTABLEUNESCAPEHTML(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD ParseFragment(const nsAString & fragment, bool isXML, nsIURI *baseURI, nsIDOMElement *element, nsIDOMDocumentFragment * *_retval NS_OUTPARAM) { return _to ParseFragment(fragment, isXML, baseURI, element, _retval); } 
...
#define NS_FORWARD_SAFE_NSISCRIPTABLEUNESCAPEHTML(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD ParseFragment(const nsAString & fragment, bool isXML, nsIURI *baseURI, nsIDOMElement *element, nsIDOMDocumentFragment * *_retval NS_OUTPARAM) { return !_to ? NS_ERROR_NULL_POINTER : _to->ParseFragment(fragment, isXML, baseURI, element, _retval); } 
...
/* nsIDOMDocumentFragment parseFragment (in AString fragment, in boolean isXML, in nsIURI baseURI, in nsIDOMElement element); */
NS_IMETHODIMP nsScriptableUnescapeHTML::ParseFragment(const nsAString & fragment, bool isXML, nsIURI *baseURI, nsIDOMElement *element, nsIDOMDocumentFragment * *_retval NS_OUTPARAM)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
