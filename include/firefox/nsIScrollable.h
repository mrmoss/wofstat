/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM /jds/packages/BUILD/SUNWfirefox-10.0.2/firefox/docshell/base/nsIScrollable.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIScrollable : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD GetScrollbarVisibility(bool *verticalVisible NS_OUTPARAM, bool *horizontalVisible NS_OUTPARAM) = 0;
...
#define NS_DECL_NSISCROLLABLE \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetScrollbarVisibility(bool *verticalVisible NS_OUTPARAM, bool *horizontalVisible NS_OUTPARAM); 
...
#define NS_FORWARD_NSISCROLLABLE(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetScrollbarVisibility(bool *verticalVisible NS_OUTPARAM, bool *horizontalVisible NS_OUTPARAM) { return _to GetScrollbarVisibility(verticalVisible, horizontalVisible); } 
...
#define NS_FORWARD_SAFE_NSISCROLLABLE(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetScrollbarVisibility(bool *verticalVisible NS_OUTPARAM, bool *horizontalVisible NS_OUTPARAM) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetScrollbarVisibility(verticalVisible, horizontalVisible); } 
...
/* void getScrollbarVisibility (out boolean verticalVisible, out boolean horizontalVisible); */
NS_IMETHODIMP nsScrollable::GetScrollbarVisibility(bool *verticalVisible NS_OUTPARAM, bool *horizontalVisible NS_OUTPARAM)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
