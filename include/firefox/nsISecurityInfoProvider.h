/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM /jds/packages/BUILD/SUNWfirefox-10.0.2/firefox/netwerk/base/public/nsISecurityInfoProvider.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsISecurityInfoProvider : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD GetHasTransferredData(bool *aHasTransferredData) = 0;
...
#define NS_DECL_NSISECURITYINFOPROVIDER \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetHasTransferredData(bool *aHasTransferredData); 
...
#define NS_FORWARD_NSISECURITYINFOPROVIDER(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetHasTransferredData(bool *aHasTransferredData) { return _to GetHasTransferredData(aHasTransferredData); } 
...
#define NS_FORWARD_SAFE_NSISECURITYINFOPROVIDER(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetHasTransferredData(bool *aHasTransferredData) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetHasTransferredData(aHasTransferredData); } 
