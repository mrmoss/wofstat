/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM /jds/packages/BUILD/SUNWfirefox-10.0.2/firefox/content/base/public/nsISelectionPrivate.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsISelectionPrivate : public nsISelection {
 public: 
  ...
  NS_IMETHOD GetRangesForIntervalCOMArray(nsIDOMNode *beginNode, PRInt32 beginOffset, nsIDOMNode *endNode, PRInt32 endOffset, bool allowAdjacent, nsCOMArray<nsIDOMRange> *results) = 0;
...
#define NS_DECL_NSISELECTIONPRIVATE \
  ...
  NS_IMETHOD GetRangesForIntervalCOMArray(nsIDOMNode *beginNode, PRInt32 beginOffset, nsIDOMNode *endNode, PRInt32 endOffset, bool allowAdjacent, nsCOMArray<nsIDOMRange> *results); \
...
#define NS_FORWARD_NSISELECTIONPRIVATE(_to) \
  ...
  NS_IMETHOD GetRangesForIntervalCOMArray(nsIDOMNode *beginNode, PRInt32 beginOffset, nsIDOMNode *endNode, PRInt32 endOffset, bool allowAdjacent, nsCOMArray<nsIDOMRange> *results) { return _to GetRangesForIntervalCOMArray(beginNode, beginOffset, endNode, endOffset, allowAdjacent, results); } \
...
#define NS_FORWARD_SAFE_NSISELECTIONPRIVATE(_to) \
  ...
  NS_IMETHOD GetRangesForIntervalCOMArray(nsIDOMNode *beginNode, PRInt32 beginOffset, nsIDOMNode *endNode, PRInt32 endOffset, bool allowAdjacent, nsCOMArray<nsIDOMRange> *results) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetRangesForIntervalCOMArray(beginNode, beginOffset, endNode, endOffset, allowAdjacent, results); } \
...
/* [noscript] void GetRangesForIntervalCOMArray (in nsIDOMNode beginNode, in PRInt32 beginOffset, in nsIDOMNode endNode, in PRInt32 endOffset, in boolean allowAdjacent, in RangeArray results); */
NS_IMETHODIMP nsSelectionPrivate::GetRangesForIntervalCOMArray(nsIDOMNode *beginNode, PRInt32 beginOffset, nsIDOMNode *endNode, PRInt32 endOffset, bool allowAdjacent, nsCOMArray<nsIDOMRange> *results)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
