/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM /jds/packages/BUILD/SUNWfirefox-10.0.2/firefox/intl/lwbrk/idl/nsISemanticUnitScanner.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsISemanticUnitScanner : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD Next(const PRUnichar * text, PRInt32 length, PRInt32 pos, bool isLastBuffer, PRInt32 *begin NS_OUTPARAM, PRInt32 *end NS_OUTPARAM, bool *_retval NS_OUTPARAM) = 0;
...
#define NS_DECL_NSISEMANTICUNITSCANNER \
  ...
  NS_SCRIPTABLE NS_IMETHOD Next(const PRUnichar * text, PRInt32 length, PRInt32 pos, bool isLastBuffer, PRInt32 *begin NS_OUTPARAM, PRInt32 *end NS_OUTPARAM, bool *_retval NS_OUTPARAM); 
...
#define NS_FORWARD_NSISEMANTICUNITSCANNER(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD Next(const PRUnichar * text, PRInt32 length, PRInt32 pos, bool isLastBuffer, PRInt32 *begin NS_OUTPARAM, PRInt32 *end NS_OUTPARAM, bool *_retval NS_OUTPARAM) { return _to Next(text, length, pos, isLastBuffer, begin, end, _retval); } 
...
#define NS_FORWARD_SAFE_NSISEMANTICUNITSCANNER(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD Next(const PRUnichar * text, PRInt32 length, PRInt32 pos, bool isLastBuffer, PRInt32 *begin NS_OUTPARAM, PRInt32 *end NS_OUTPARAM, bool *_retval NS_OUTPARAM) { return !_to ? NS_ERROR_NULL_POINTER : _to->Next(text, length, pos, isLastBuffer, begin, end, _retval); } 
...
/* boolean next (in wstring text, in long length, in long pos, in boolean isLastBuffer, out long begin, out long end); */
NS_IMETHODIMP nsSemanticUnitScanner::Next(const PRUnichar * text, PRInt32 length, PRInt32 pos, bool isLastBuffer, PRInt32 *begin NS_OUTPARAM, PRInt32 *end NS_OUTPARAM, bool *_retval NS_OUTPARAM)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
