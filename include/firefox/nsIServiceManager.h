/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM /jds/packages/BUILD/SUNWfirefox-10.0.2/firefox/xpcom/components/nsIServiceManager.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIServiceManager : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD IsServiceInstantiated(const nsCID & aClass, const nsIID & aIID, bool *_retval NS_OUTPARAM) = 0;

  /* boolean isServiceInstantiatedByContractID (in string aContractID, in nsIIDRef aIID); */
  NS_SCRIPTABLE NS_IMETHOD IsServiceInstantiatedByContractID(const char * aContractID, const nsIID & aIID, bool *_retval NS_OUTPARAM) = 0;
...
#define NS_DECL_NSISERVICEMANAGER \
  ...
  NS_SCRIPTABLE NS_IMETHOD IsServiceInstantiated(const nsCID & aClass, const nsIID & aIID, bool *_retval NS_OUTPARAM); \
  NS_SCRIPTABLE NS_IMETHOD IsServiceInstantiatedByContractID(const char * aContractID, const nsIID & aIID, bool *_retval NS_OUTPARAM); 
...
#define NS_FORWARD_NSISERVICEMANAGER(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD IsServiceInstantiated(const nsCID & aClass, const nsIID & aIID, bool *_retval NS_OUTPARAM) { return _to IsServiceInstantiated(aClass, aIID, _retval); } \
  NS_SCRIPTABLE NS_IMETHOD IsServiceInstantiatedByContractID(const char * aContractID, const nsIID & aIID, bool *_retval NS_OUTPARAM) { return _to IsServiceInstantiatedByContractID(aContractID, aIID, _retval); } 
...
#define NS_FORWARD_SAFE_NSISERVICEMANAGER(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD IsServiceInstantiated(const nsCID & aClass, const nsIID & aIID, bool *_retval NS_OUTPARAM) { return !_to ? NS_ERROR_NULL_POINTER : _to->IsServiceInstantiated(aClass, aIID, _retval); } \
  NS_SCRIPTABLE NS_IMETHOD IsServiceInstantiatedByContractID(const char * aContractID, const nsIID & aIID, bool *_retval NS_OUTPARAM) { return !_to ? NS_ERROR_NULL_POINTER : _to->IsServiceInstantiatedByContractID(aContractID, aIID, _retval); } 
...
/* boolean isServiceInstantiated (in nsCIDRef aClass, in nsIIDRef aIID); */
NS_IMETHODIMP nsServiceManager::IsServiceInstantiated(const nsCID & aClass, const nsIID & aIID, bool *_retval NS_OUTPARAM)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}

/* boolean isServiceInstantiatedByContractID (in string aContractID, in nsIIDRef aIID); */
NS_IMETHODIMP nsServiceManager::IsServiceInstantiatedByContractID(const char * aContractID, const nsIID & aIID, bool *_retval NS_OUTPARAM)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
