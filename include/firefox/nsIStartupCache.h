/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM /jds/packages/BUILD/SUNWfirefox-10.0.2/firefox/startupcache/nsIStartupCache.idl
 */
...
class NS_NO_VTABLE nsIStartupCache : public nsISupports {
 public: 
  ...
  NS_IMETHOD StartupWriteComplete(bool *_retval NS_OUTPARAM) = 0;
...
#define NS_DECL_NSISTARTUPCACHE \
  ...
  NS_IMETHOD StartupWriteComplete(bool *_retval NS_OUTPARAM); \
...
#define NS_FORWARD_NSISTARTUPCACHE(_to) \
  ...
  NS_IMETHOD StartupWriteComplete(bool *_retval NS_OUTPARAM) { return _to StartupWriteComplete(_retval); } \
...
#define NS_FORWARD_SAFE_NSISTARTUPCACHE(_to) \
  ...
  NS_IMETHOD StartupWriteComplete(bool *_retval NS_OUTPARAM) { return !_to ? NS_ERROR_NULL_POINTER : _to->StartupWriteComplete(_retval); } \
...
/* boolean startupWriteComplete (); */
NS_IMETHODIMP nsStartupCache::StartupWriteComplete(bool *_retval NS_OUTPARAM)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
