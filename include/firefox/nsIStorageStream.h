/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM /jds/packages/BUILD/SUNWfirefox-10.0.2/firefox/xpcom/io/nsIStorageStream.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIStorageStream : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD GetWriteInProgress(bool *aWriteInProgress) = 0;
...
#define NS_DECL_NSISTORAGESTREAM \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetWriteInProgress(bool *aWriteInProgress); 
...
#define NS_FORWARD_NSISTORAGESTREAM(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetWriteInProgress(bool *aWriteInProgress) { return _to GetWriteInProgress(aWriteInProgress); } 
...
#define NS_FORWARD_SAFE_NSISTORAGESTREAM(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetWriteInProgress(bool *aWriteInProgress) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetWriteInProgress(aWriteInProgress); } 
