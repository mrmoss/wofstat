/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM /jds/packages/BUILD/SUNWfirefox-10.0.2/firefox/netwerk/streamconv/public/nsIStreamConverterService.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIStreamConverterService : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD CanConvert(const char * aFromType, const char * aToType, bool *_retval NS_OUTPARAM) = 0;
...
#define NS_DECL_NSISTREAMCONVERTERSERVICE \
  NS_SCRIPTABLE NS_IMETHOD CanConvert(const char * aFromType, const char * aToType, bool *_retval NS_OUTPARAM); \
...
#define NS_FORWARD_NSISTREAMCONVERTERSERVICE(_to) \
  NS_SCRIPTABLE NS_IMETHOD CanConvert(const char * aFromType, const char * aToType, bool *_retval NS_OUTPARAM) { return _to CanConvert(aFromType, aToType, _retval); } \
...
#define NS_FORWARD_SAFE_NSISTREAMCONVERTERSERVICE(_to) \
  NS_SCRIPTABLE NS_IMETHOD CanConvert(const char * aFromType, const char * aToType, bool *_retval NS_OUTPARAM) { return !_to ? NS_ERROR_NULL_POINTER : _to->CanConvert(aFromType, aToType, _retval); } \
...
/* boolean canConvert (in string aFromType, in string aToType); */
NS_IMETHODIMP nsStreamConverterService::CanConvert(const char * aFromType, const char * aToType, bool *_retval NS_OUTPARAM)
{
