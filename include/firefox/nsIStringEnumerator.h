/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM /jds/packages/BUILD/SUNWfirefox-10.0.2/firefox/xpcom/ds/nsIStringEnumerator.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIStringEnumerator : public nsISupports {
 public: 
  ...
  /* boolean hasMore (); */
  NS_SCRIPTABLE NS_IMETHOD HasMore(bool *_retval NS_OUTPARAM) = 0;
...
#define NS_DECL_NSISTRINGENUMERATOR \
  NS_SCRIPTABLE NS_IMETHOD HasMore(bool *_retval NS_OUTPARAM); \
...
#define NS_FORWARD_NSISTRINGENUMERATOR(_to) \
  NS_SCRIPTABLE NS_IMETHOD HasMore(bool *_retval NS_OUTPARAM) { return _to HasMore(_retval); } \
...
#define NS_FORWARD_SAFE_NSISTRINGENUMERATOR(_to) \
  NS_SCRIPTABLE NS_IMETHOD HasMore(bool *_retval NS_OUTPARAM) { return !_to ? NS_ERROR_NULL_POINTER : _to->HasMore(_retval); } \
...
/* boolean hasMore (); */
NS_IMETHODIMP nsStringEnumerator::HasMore(bool *_retval NS_OUTPARAM)
{
...
/* boolean hasMore (); */
NS_IMETHODIMP nsUTF8StringEnumerator::HasMore(bool *_retval NS_OUTPARAM)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
