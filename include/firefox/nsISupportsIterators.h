/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM /jds/packages/BUILD/SUNWfirefox-10.0.2/firefox/xpcom/ds/nsISupportsIterators.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIInputIterator : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD IsEqualTo(nsISupports *anotherIterator, bool *_retval NS_OUTPARAM) = 0;
...
#define NS_DECL_NSIINPUTITERATOR \
  ...
  NS_SCRIPTABLE NS_IMETHOD StepForward(void); \
  NS_SCRIPTABLE NS_IMETHOD IsEqualTo(nsISupports *anotherIterator, bool *_retval NS_OUTPARAM); \
...
#define NS_FORWARD_NSIINPUTITERATOR(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD StepForward(void) { return _to StepForward(); } \
  NS_SCRIPTABLE NS_IMETHOD IsEqualTo(nsISupports *anotherIterator, bool *_retval NS_OUTPARAM) { return _to IsEqualTo(anotherIterator, _retval); } \
...
#define NS_FORWARD_SAFE_NSIINPUTITERATOR(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD StepForward(void) { return !_to ? NS_ERROR_NULL_POINTER : _to->StepForward(); } \
  NS_SCRIPTABLE NS_IMETHOD IsEqualTo(nsISupports *anotherIterator, bool *_retval NS_OUTPARAM) { return !_to ? NS_ERROR_NULL_POINTER : _to->IsEqualTo(anotherIterator, _retval); } \
...
/* boolean isEqualTo (in nsISupports anotherIterator); */
NS_IMETHODIMP nsInputIterator::IsEqualTo(nsISupports *anotherIterator, bool *_retval NS_OUTPARAM)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
...
/* boolean isEqualTo (in nsISupports anotherIterator); */
NS_IMETHODIMP nsForwardIterator::IsEqualTo(nsISupports *anotherIterator, bool *_retval NS_OUTPARAM)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
...
/* boolean isEqualTo (in nsISupports anotherIterator); */
NS_IMETHODIMP nsBidirectionalIterator::IsEqualTo(nsISupports *anotherIterator, bool *_retval NS_OUTPARAM)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
...
/* boolean isEqualTo (in nsISupports anotherIterator); */
NS_IMETHODIMP nsRandomAccessIterator::IsEqualTo(nsISupports *anotherIterator, bool *_retval NS_OUTPARAM)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
