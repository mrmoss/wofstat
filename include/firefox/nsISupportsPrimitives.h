/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM /jds/packages/BUILD/SUNWfirefox-10.0.2/firefox/xpcom/ds/nsISupportsPrimitives.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsISupportsPRBool : public nsISupportsPrimitive {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD GetData(bool *aData) = 0;
  NS_SCRIPTABLE NS_IMETHOD SetData(bool aData) = 0;
...
#define NS_DECL_NSISUPPORTSPRBOOL \
  NS_SCRIPTABLE NS_IMETHOD GetData(bool *aData); \
  NS_SCRIPTABLE NS_IMETHOD SetData(bool aData); \
  NS_SCRIPTABLE NS_IMETHOD ToString(char * *_retval NS_OUTPARAM); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSISUPPORTSPRBOOL(_to) \
  NS_SCRIPTABLE NS_IMETHOD GetData(bool *aData) { return _to GetData(aData); } \
  NS_SCRIPTABLE NS_IMETHOD SetData(bool aData) { return _to SetData(aData); } \
  NS_SCRIPTABLE NS_IMETHOD ToString(char * *_retval NS_OUTPARAM) { return _to ToString(_retval); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_NSISUPPORTSPRBOOL(_to) \
  NS_SCRIPTABLE NS_IMETHOD GetData(bool *aData) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetData(aData); } \
  NS_SCRIPTABLE NS_IMETHOD SetData(bool aData) { return !_to ? NS_ERROR_NULL_POINTER : _to->SetData(aData); } \
  NS_SCRIPTABLE NS_IMETHOD ToString(char * *_retval NS_OUTPARAM) { return !_to ? NS_ERROR_NULL_POINTER : _to->ToString(_retval); } 
