/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM /jds/packages/BUILD/SUNWfirefox-10.0.2/firefox/netwerk/streamconv/public/nsITXTToHTMLConv.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsITXTToHTMLConv : public nsIStreamConverter {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD PreFormatHTML(bool value) = 0;
...
#define NS_DECL_NSITXTTOHTMLCONV \
  ...
  NS_SCRIPTABLE NS_IMETHOD PreFormatHTML(bool value); 
...
#define NS_FORWARD_NSITXTTOHTMLCONV(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD PreFormatHTML(bool value) { return _to PreFormatHTML(value); } 
...
#define NS_FORWARD_SAFE_NSITXTTOHTMLCONV(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD PreFormatHTML(bool value) { return !_to ? NS_ERROR_NULL_POINTER : _to->PreFormatHTML(value); } 
