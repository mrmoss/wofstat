/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM /jds/packages/BUILD/SUNWfirefox-10.0.2/firefox/xpcom/threads/nsIThread.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIThread : public nsIEventTarget {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD HasPendingEvents(bool *_retval NS_OUTPARAM) = 0;

  /* boolean processNextEvent (in boolean mayWait); */
  NS_SCRIPTABLE NS_IMETHOD ProcessNextEvent(bool mayWait, bool *_retval NS_OUTPARAM) = 0;
...
#define NS_DECL_NSITHREAD \
  ...
  NS_SCRIPTABLE NS_IMETHOD HasPendingEvents(bool *_retval NS_OUTPARAM); \
  NS_SCRIPTABLE NS_IMETHOD ProcessNextEvent(bool mayWait, bool *_retval NS_OUTPARAM); 
...
#define NS_FORWARD_NSITHREAD(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD HasPendingEvents(bool *_retval NS_OUTPARAM) { return _to HasPendingEvents(_retval); } \
  NS_SCRIPTABLE NS_IMETHOD ProcessNextEvent(bool mayWait, bool *_retval NS_OUTPARAM) { return _to ProcessNextEvent(mayWait, _retval); } 
...
#define NS_FORWARD_SAFE_NSITHREAD(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD HasPendingEvents(bool *_retval NS_OUTPARAM) { return !_to ? NS_ERROR_NULL_POINTER : _to->HasPendingEvents(_retval); } \
  NS_SCRIPTABLE NS_IMETHOD ProcessNextEvent(bool mayWait, bool *_retval NS_OUTPARAM) { return !_to ? NS_ERROR_NULL_POINTER : _to->ProcessNextEvent(mayWait, _retval); } 
...
/* boolean hasPendingEvents (); */
NS_IMETHODIMP nsThread::HasPendingEvents(bool *_retval NS_OUTPARAM)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}

/* boolean processNextEvent (in boolean mayWait); */
NS_IMETHODIMP nsThread::ProcessNextEvent(bool mayWait, bool *_retval NS_OUTPARAM)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
