/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM /jds/packages/BUILD/SUNWfirefox-10.0.2/firefox/xpcom/threads/nsIThreadManager.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIThreadManager : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD GetIsMainThread(bool *aIsMainThread) = 0;

  /* readonly attribute boolean isCycleCollectorThread; */
  NS_SCRIPTABLE NS_IMETHOD GetIsCycleCollectorThread(bool *aIsCycleCollectorThread) = 0;
...
#define NS_DECL_NSITHREADMANAGER \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetIsMainThread(bool *aIsMainThread); \
  NS_SCRIPTABLE NS_IMETHOD GetIsCycleCollectorThread(bool *aIsCycleCollectorThread); 
...
#define NS_FORWARD_NSITHREADMANAGER(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetIsMainThread(bool *aIsMainThread) { return _to GetIsMainThread(aIsMainThread); } \
  NS_SCRIPTABLE NS_IMETHOD GetIsCycleCollectorThread(bool *aIsCycleCollectorThread) { return _to GetIsCycleCollectorThread(aIsCycleCollectorThread); } 
...
#define NS_FORWARD_SAFE_NSITHREADMANAGER(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetIsMainThread(bool *aIsMainThread) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetIsMainThread(aIsMainThread); } \
  NS_SCRIPTABLE NS_IMETHOD GetIsCycleCollectorThread(bool *aIsCycleCollectorThread) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetIsCycleCollectorThread(aIsCycleCollectorThread); } 
