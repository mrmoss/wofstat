/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM /jds/packages/BUILD/SUNWfirefox-10.0.2/firefox/security/manager/ssl/public/nsITokenDialogs.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsITokenDialogs : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD ChooseToken(nsIInterfaceRequestor *ctx, const PRUnichar * *tokenNameList, PRUint32 count, PRUnichar * *tokenName NS_OUTPARAM, bool *canceled NS_OUTPARAM) = 0;
...
#define NS_DECL_NSITOKENDIALOGS \
  NS_SCRIPTABLE NS_IMETHOD ChooseToken(nsIInterfaceRequestor *ctx, const PRUnichar * *tokenNameList, PRUint32 count, PRUnichar * *tokenName NS_OUTPARAM, bool *canceled NS_OUTPARAM); \
...
#define NS_FORWARD_NSITOKENDIALOGS(_to) \
  NS_SCRIPTABLE NS_IMETHOD ChooseToken(nsIInterfaceRequestor *ctx, const PRUnichar * *tokenNameList, PRUint32 count, PRUnichar * *tokenName NS_OUTPARAM, bool *canceled NS_OUTPARAM) { return _to ChooseToken(ctx, tokenNameList, count, tokenName, canceled); } \
...
#define NS_FORWARD_SAFE_NSITOKENDIALOGS(_to) \
  NS_SCRIPTABLE NS_IMETHOD ChooseToken(nsIInterfaceRequestor *ctx, const PRUnichar * *tokenNameList, PRUint32 count, PRUnichar * *tokenName NS_OUTPARAM, bool *canceled NS_OUTPARAM) { return !_to ? NS_ERROR_NULL_POINTER : _to->ChooseToken(ctx, tokenNameList, count, tokenName, canceled); } \
...
/* void ChooseToken (in nsIInterfaceRequestor ctx, [array, size_is (count)] in wstring tokenNameList, in unsigned long count, out wstring tokenName, out boolean canceled); */
NS_IMETHODIMP nsTokenDialogs::ChooseToken(nsIInterfaceRequestor *ctx, const PRUnichar * *tokenNameList, PRUint32 count, PRUnichar * *tokenName NS_OUTPARAM, bool *canceled NS_OUTPARAM)
{
