/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM /jds/packages/BUILD/SUNWfirefox-10.0.2/firefox/editor/txmgr/idl/nsITransaction.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsITransaction : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD GetIsTransient(bool *aIsTransient) = 0;

  /* boolean merge (in nsITransaction aTransaction); */
  NS_SCRIPTABLE NS_IMETHOD Merge(nsITransaction *aTransaction, bool *_retval NS_OUTPARAM) = 0;
...
#define NS_DECL_NSITRANSACTION \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetIsTransient(bool *aIsTransient); \
  NS_SCRIPTABLE NS_IMETHOD Merge(nsITransaction *aTransaction, bool *_retval NS_OUTPARAM); 
...
#define NS_FORWARD_NSITRANSACTION(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetIsTransient(bool *aIsTransient) { return _to GetIsTransient(aIsTransient); } \
  NS_SCRIPTABLE NS_IMETHOD Merge(nsITransaction *aTransaction, bool *_retval NS_OUTPARAM) { return _to Merge(aTransaction, _retval); } 
...
#define NS_FORWARD_SAFE_NSITRANSACTION(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetIsTransient(bool *aIsTransient) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetIsTransient(aIsTransient); } \
  NS_SCRIPTABLE NS_IMETHOD Merge(nsITransaction *aTransaction, bool *_retval NS_OUTPARAM) { return !_to ? NS_ERROR_NULL_POINTER : _to->Merge(aTransaction, _retval); } 
...
/* boolean merge (in nsITransaction aTransaction); */
NS_IMETHODIMP nsTransaction::Merge(nsITransaction *aTransaction, bool *_retval NS_OUTPARAM)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
