/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM /jds/packages/BUILD/SUNWfirefox-10.0.2/firefox/editor/txmgr/idl/nsITransactionList.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsITransactionList : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD ItemIsBatch(PRInt32 aIndex, bool *_retval NS_OUTPARAM) = 0;
...
#define NS_DECL_NSITRANSACTIONLIST \
  ...
  NS_SCRIPTABLE NS_IMETHOD ItemIsBatch(PRInt32 aIndex, bool *_retval NS_OUTPARAM); \
...
#define NS_FORWARD_NSITRANSACTIONLIST(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD ItemIsBatch(PRInt32 aIndex, bool *_retval NS_OUTPARAM) { return _to ItemIsBatch(aIndex, _retval); } \
...
#define NS_FORWARD_SAFE_NSITRANSACTIONLIST(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD ItemIsBatch(PRInt32 aIndex, bool *_retval NS_OUTPARAM) { return !_to ? NS_ERROR_NULL_POINTER : _to->ItemIsBatch(aIndex, _retval); } \
...
/* boolean itemIsBatch (in long aIndex); */
NS_IMETHODIMP nsTransactionList::ItemIsBatch(PRInt32 aIndex, bool *_retval NS_OUTPARAM)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
