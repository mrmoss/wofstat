/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM /jds/packages/BUILD/SUNWfirefox-10.0.2/firefox/widget/public/nsITransferable.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsITransferable : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD IsLargeDataSet(bool *_retval NS_OUTPARAM) = 0;
...
#define NS_DECL_NSITRANSFERABLE \
  ...
  NS_SCRIPTABLE NS_IMETHOD IsLargeDataSet(bool *_retval NS_OUTPARAM); \
...
#define NS_FORWARD_NSITRANSFERABLE(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD IsLargeDataSet(bool *_retval NS_OUTPARAM) { return _to IsLargeDataSet(_retval); } \
...
#define NS_FORWARD_SAFE_NSITRANSFERABLE(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD IsLargeDataSet(bool *_retval NS_OUTPARAM) { return !_to ? NS_ERROR_NULL_POINTER : _to->IsLargeDataSet(_retval); } \
...
/* boolean isLargeDataSet (); */
NS_IMETHODIMP nsTransferable::IsLargeDataSet(bool *_retval NS_OUTPARAM)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
