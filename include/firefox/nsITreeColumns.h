/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM /jds/packages/BUILD/SUNWfirefox-10.0.2/firefox/layout/xul/base/src/tree/public/nsITreeColumns.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsITreeColumn : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD GetPrimary(bool *aPrimary) = 0;

  /* readonly attribute boolean cycler; */
  NS_SCRIPTABLE NS_IMETHOD GetCycler(bool *aCycler) = 0;

  /* readonly attribute boolean editable; */
  NS_SCRIPTABLE NS_IMETHOD GetEditable(bool *aEditable) = 0;

  /* readonly attribute boolean selectable; */
  NS_SCRIPTABLE NS_IMETHOD GetSelectable(bool *aSelectable) = 0;
...
#define NS_DECL_NSITREECOLUMN \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetPrimary(bool *aPrimary); \
  NS_SCRIPTABLE NS_IMETHOD GetCycler(bool *aCycler); \
  NS_SCRIPTABLE NS_IMETHOD GetEditable(bool *aEditable); \
  NS_SCRIPTABLE NS_IMETHOD GetSelectable(bool *aSelectable); \
...
#define NS_FORWARD_NSITREECOLUMN(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetPrimary(bool *aPrimary) { return _to GetPrimary(aPrimary); } \
  NS_SCRIPTABLE NS_IMETHOD GetCycler(bool *aCycler) { return _to GetCycler(aCycler); } \
  NS_SCRIPTABLE NS_IMETHOD GetEditable(bool *aEditable) { return _to GetEditable(aEditable); } \
  NS_SCRIPTABLE NS_IMETHOD GetSelectable(bool *aSelectable) { return _to GetSelectable(aSelectable); } \
...
#define NS_FORWARD_SAFE_NSITREECOLUMN(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetPrimary(bool *aPrimary) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetPrimary(aPrimary); } \
  NS_SCRIPTABLE NS_IMETHOD GetCycler(bool *aCycler) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetCycler(aCycler); } \
  NS_SCRIPTABLE NS_IMETHOD GetEditable(bool *aEditable) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetEditable(aEditable); } \
  NS_SCRIPTABLE NS_IMETHOD GetSelectable(bool *aSelectable) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetSelectable(aSelectable); } \
