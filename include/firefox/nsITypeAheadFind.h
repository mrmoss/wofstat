/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM /jds/packages/BUILD/SUNWfirefox-10.0.2/firefox/toolkit/components/typeaheadfind/nsITypeAheadFind.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsITypeAheadFind : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD Find(const nsAString & aSearchString, bool aLinksOnly, PRUint16 *_retval NS_OUTPARAM) = 0;

  /* unsigned short findAgain (in boolean findBackwards, in boolean aLinksOnly); */
  NS_SCRIPTABLE NS_IMETHOD FindAgain(bool findBackwards, bool aLinksOnly, PRUint16 *_retval NS_OUTPARAM) = 0;
  ...
  NS_SCRIPTABLE NS_IMETHOD GetCaseSensitive(bool *aCaseSensitive) = 0;
  NS_SCRIPTABLE NS_IMETHOD SetCaseSensitive(bool aCaseSensitive) = 0;
...
#define NS_DECL_NSITYPEAHEADFIND \
  ...
  NS_SCRIPTABLE NS_IMETHOD Find(const nsAString & aSearchString, bool aLinksOnly, PRUint16 *_retval NS_OUTPARAM); \
  NS_SCRIPTABLE NS_IMETHOD FindAgain(bool findBackwards, bool aLinksOnly, PRUint16 *_retval NS_OUTPARAM); \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetCaseSensitive(bool *aCaseSensitive); \
  NS_SCRIPTABLE NS_IMETHOD SetCaseSensitive(bool aCaseSensitive); \
...
#define NS_FORWARD_NSITYPEAHEADFIND(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD Find(const nsAString & aSearchString, bool aLinksOnly, PRUint16 *_retval NS_OUTPARAM) { return _to Find(aSearchString, aLinksOnly, _retval); } \
  NS_SCRIPTABLE NS_IMETHOD FindAgain(bool findBackwards, bool aLinksOnly, PRUint16 *_retval NS_OUTPARAM) { return _to FindAgain(findBackwards, aLinksOnly, _retval); } \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetCaseSensitive(bool *aCaseSensitive) { return _to GetCaseSensitive(aCaseSensitive); } \
  NS_SCRIPTABLE NS_IMETHOD SetCaseSensitive(bool aCaseSensitive) { return _to SetCaseSensitive(aCaseSensitive); } \
...
#define NS_FORWARD_SAFE_NSITYPEAHEADFIND(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD Find(const nsAString & aSearchString, bool aLinksOnly, PRUint16 *_retval NS_OUTPARAM) { return !_to ? NS_ERROR_NULL_POINTER : _to->Find(aSearchString, aLinksOnly, _retval); } \
  NS_SCRIPTABLE NS_IMETHOD FindAgain(bool findBackwards, bool aLinksOnly, PRUint16 *_retval NS_OUTPARAM) { return !_to ? NS_ERROR_NULL_POINTER : _to->FindAgain(findBackwards, aLinksOnly, _retval); } \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetCaseSensitive(bool *aCaseSensitive) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetCaseSensitive(aCaseSensitive); } \
  NS_SCRIPTABLE NS_IMETHOD SetCaseSensitive(bool aCaseSensitive) { return !_to ? NS_ERROR_NULL_POINTER : _to->SetCaseSensitive(aCaseSensitive); } \
...
/* unsigned short find (in AString aSearchString, in boolean aLinksOnly); */
NS_IMETHODIMP nsTypeAheadFind::Find(const nsAString & aSearchString, bool aLinksOnly, PRUint16 *_retval NS_OUTPARAM)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}

/* unsigned short findAgain (in boolean findBackwards, in boolean aLinksOnly); */
NS_IMETHODIMP nsTypeAheadFind::FindAgain(bool findBackwards, bool aLinksOnly, PRUint16 *_retval NS_OUTPARAM)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
