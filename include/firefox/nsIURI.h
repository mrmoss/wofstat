/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM /jds/packages/BUILD/SUNWfirefox-10.0.2/firefox/netwerk/base/public/nsIURI.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIURI : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD Equals(nsIURI *other, bool *_retval NS_OUTPARAM) = 0;

  /* boolean schemeIs (in string scheme); */
  NS_SCRIPTABLE NS_IMETHOD SchemeIs(const char * scheme, bool *_retval NS_OUTPARAM) = 0;
  ...
  NS_SCRIPTABLE NS_IMETHOD EqualsExceptRef(nsIURI *other, bool *_retval NS_OUTPARAM) = 0;
  ...
  NS_SCRIPTABLE NS_IMETHOD GetHasRef(bool *aHasRef) = 0;
...
#define NS_DECL_NSIURI \
  ...
  NS_SCRIPTABLE NS_IMETHOD Equals(nsIURI *other, bool *_retval NS_OUTPARAM); \
  NS_SCRIPTABLE NS_IMETHOD SchemeIs(const char * scheme, bool *_retval NS_OUTPARAM); \
  ...
  NS_SCRIPTABLE NS_IMETHOD EqualsExceptRef(nsIURI *other, bool *_retval NS_OUTPARAM); \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetHasRef(bool *aHasRef); 
...
#define NS_FORWARD_NSIURI(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD Equals(nsIURI *other, bool *_retval NS_OUTPARAM) { return _to Equals(other, _retval); } \
  NS_SCRIPTABLE NS_IMETHOD SchemeIs(const char * scheme, bool *_retval NS_OUTPARAM) { return _to SchemeIs(scheme, _retval); } \
  ...
  NS_SCRIPTABLE NS_IMETHOD EqualsExceptRef(nsIURI *other, bool *_retval NS_OUTPARAM) { return _to EqualsExceptRef(other, _retval); } \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetHasRef(bool *aHasRef) { return _to GetHasRef(aHasRef); } 
...
#define NS_FORWARD_SAFE_NSIURI(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD Equals(nsIURI *other, bool *_retval NS_OUTPARAM) { return !_to ? NS_ERROR_NULL_POINTER : _to->Equals(other, _retval); } \
  NS_SCRIPTABLE NS_IMETHOD SchemeIs(const char * scheme, bool *_retval NS_OUTPARAM) { return !_to ? NS_ERROR_NULL_POINTER : _to->SchemeIs(scheme, _retval); } \
  ...
  NS_SCRIPTABLE NS_IMETHOD EqualsExceptRef(nsIURI *other, bool *_retval NS_OUTPARAM) { return !_to ? NS_ERROR_NULL_POINTER : _to->EqualsExceptRef(other, _retval); } \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetHasRef(bool *aHasRef) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetHasRef(aHasRef); } 
...
/* boolean equals (in nsIURI other); */
NS_IMETHODIMP nsURI::Equals(nsIURI *other, bool *_retval NS_OUTPARAM)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}

/* boolean schemeIs (in string scheme); */
NS_IMETHODIMP nsURI::SchemeIs(const char * scheme, bool *_retval NS_OUTPARAM)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
...
/* boolean equalsExceptRef (in nsIURI other); */
NS_IMETHODIMP nsURI::EqualsExceptRef(nsIURI *other, bool *_retval NS_OUTPARAM)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
