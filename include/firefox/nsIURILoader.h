/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM /jds/packages/BUILD/SUNWfirefox-10.0.2/firefox/uriloader/base/nsIURILoader.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIURILoader : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD OpenURI(nsIChannel *aChannel, bool aIsContentPreferred, nsIInterfaceRequestor *aWindowContext) = 0;
...
#define NS_DECL_NSIURILOADER \
  ...
  NS_SCRIPTABLE NS_IMETHOD OpenURI(nsIChannel *aChannel, bool aIsContentPreferred, nsIInterfaceRequestor *aWindowContext); \
...
#define NS_FORWARD_NSIURILOADER(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD OpenURI(nsIChannel *aChannel, bool aIsContentPreferred, nsIInterfaceRequestor *aWindowContext) { return _to OpenURI(aChannel, aIsContentPreferred, aWindowContext); } \
...
#define NS_FORWARD_SAFE_NSIURILOADER(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD OpenURI(nsIChannel *aChannel, bool aIsContentPreferred, nsIInterfaceRequestor *aWindowContext) { return !_to ? NS_ERROR_NULL_POINTER : _to->OpenURI(aChannel, aIsContentPreferred, aWindowContext); } \
