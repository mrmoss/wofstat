/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM /jds/packages/BUILD/SUNWfirefox-10.0.2/firefox/editor/idl/nsIURIRefObject.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIURIRefObject : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD RewriteAllURIs(const nsAString & aOldPat, const nsAString & aNewPat, bool aMakeRel) = 0;
...
#define NS_DECL_NSIURIREFOBJECT \
  ...
  NS_SCRIPTABLE NS_IMETHOD RewriteAllURIs(const nsAString & aOldPat, const nsAString & aNewPat, bool aMakeRel); 
...
#define NS_FORWARD_NSIURIREFOBJECT(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD RewriteAllURIs(const nsAString & aOldPat, const nsAString & aNewPat, bool aMakeRel) { return _to RewriteAllURIs(aOldPat, aNewPat, aMakeRel); } 
...
#define NS_FORWARD_SAFE_NSIURIREFOBJECT(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD RewriteAllURIs(const nsAString & aOldPat, const nsAString & aNewPat, bool aMakeRel) { return !_to ? NS_ERROR_NULL_POINTER : _to->RewriteAllURIs(aOldPat, aNewPat, aMakeRel); } 
