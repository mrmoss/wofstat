/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM /jds/packages/BUILD/SUNWfirefox-10.0.2/firefox/xpcom/io/nsIUnicharLineInputStream.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIUnicharLineInputStream : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD ReadLine(nsAString & aLine NS_OUTPARAM, bool *_retval NS_OUTPARAM) = 0;
...
#define NS_DECL_NSIUNICHARLINEINPUTSTREAM \
  NS_SCRIPTABLE NS_IMETHOD ReadLine(nsAString & aLine NS_OUTPARAM, bool *_retval NS_OUTPARAM); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSIUNICHARLINEINPUTSTREAM(_to) \
  NS_SCRIPTABLE NS_IMETHOD ReadLine(nsAString & aLine NS_OUTPARAM, bool *_retval NS_OUTPARAM) { return _to ReadLine(aLine, _retval); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_NSIUNICHARLINEINPUTSTREAM(_to) \
  NS_SCRIPTABLE NS_IMETHOD ReadLine(nsAString & aLine NS_OUTPARAM, bool *_retval NS_OUTPARAM) { return !_to ? NS_ERROR_NULL_POINTER : _to->ReadLine(aLine, _retval); } 
...
/* boolean readLine (out AString aLine); */
NS_IMETHODIMP nsUnicharLineInputStream::ReadLine(nsAString & aLine NS_OUTPARAM, bool *_retval NS_OUTPARAM)
{
