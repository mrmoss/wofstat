/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM /jds/packages/BUILD/SUNWfirefox-10.0.2/firefox/xpcom/io/nsIUnicharOutputStream.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIUnicharOutputStream : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD Write(PRUint32 aCount, const PRUnichar *c, bool *_retval NS_OUTPARAM) = 0;

  /* boolean writeString (in AString str); */
  NS_SCRIPTABLE NS_IMETHOD WriteString(const nsAString & str, bool *_retval NS_OUTPARAM) = 0;
...
#define NS_DECL_NSIUNICHAROUTPUTSTREAM \
  NS_SCRIPTABLE NS_IMETHOD Write(PRUint32 aCount, const PRUnichar *c, bool *_retval NS_OUTPARAM); \
  NS_SCRIPTABLE NS_IMETHOD WriteString(const nsAString & str, bool *_retval NS_OUTPARAM); \
...
#define NS_FORWARD_NSIUNICHAROUTPUTSTREAM(_to) \
  NS_SCRIPTABLE NS_IMETHOD Write(PRUint32 aCount, const PRUnichar *c, bool *_retval NS_OUTPARAM) { return _to Write(aCount, c, _retval); } \
  NS_SCRIPTABLE NS_IMETHOD WriteString(const nsAString & str, bool *_retval NS_OUTPARAM) { return _to WriteString(str, _retval); } \
...
#define NS_FORWARD_SAFE_NSIUNICHAROUTPUTSTREAM(_to) \
  NS_SCRIPTABLE NS_IMETHOD Write(PRUint32 aCount, const PRUnichar *c, bool *_retval NS_OUTPARAM) { return !_to ? NS_ERROR_NULL_POINTER : _to->Write(aCount, c, _retval); } \
  NS_SCRIPTABLE NS_IMETHOD WriteString(const nsAString & str, bool *_retval NS_OUTPARAM) { return !_to ? NS_ERROR_NULL_POINTER : _to->WriteString(str, _retval); } \
...
/* boolean write (in unsigned long aCount, [array, size_is (aCount), const] in PRUnichar c); */
NS_IMETHODIMP nsUnicharOutputStream::Write(PRUint32 aCount, const PRUnichar *c, bool *_retval NS_OUTPARAM)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}

/* boolean writeString (in AString str); */
NS_IMETHODIMP nsUnicharOutputStream::WriteString(const nsAString & str, bool *_retval NS_OUTPARAM)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
