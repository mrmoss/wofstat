/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM /jds/packages/BUILD/SUNWfirefox-10.0.2/firefox/toolkit/components/url-classifier/nsIUrlClassifierPrefixSet.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIUrlClassifierPrefixSet : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD Contains(PRUint32 aPrefix, bool *_retval NS_OUTPARAM) = 0;
...
#define NS_DECL_NSIURLCLASSIFIERPREFIXSET \
  ...
  NS_SCRIPTABLE NS_IMETHOD Contains(PRUint32 aPrefix, bool *_retval NS_OUTPARAM); \
...
#define NS_FORWARD_NSIURLCLASSIFIERPREFIXSET(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD Contains(PRUint32 aPrefix, bool *_retval NS_OUTPARAM) { return _to Contains(aPrefix, _retval); } \
...
#define NS_FORWARD_SAFE_NSIURLCLASSIFIERPREFIXSET(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD Contains(PRUint32 aPrefix, bool *_retval NS_OUTPARAM) { return !_to ? NS_ERROR_NULL_POINTER : _to->Contains(aPrefix, _retval); } \
...
/* boolean contains (in unsigned long aPrefix); */
NS_IMETHODIMP nsUrlClassifierPrefixSet::Contains(PRUint32 aPrefix, bool *_retval NS_OUTPARAM)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
