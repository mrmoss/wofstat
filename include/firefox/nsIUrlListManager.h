/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM /jds/packages/BUILD/SUNWfirefox-10.0.2/firefox/toolkit/components/url-classifier/nsIUrlListManager.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIUrlListManager : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD RegisterTable(const nsACString & tableName, bool requireMac, bool *_retval NS_OUTPARAM) = 0;
...
#define NS_DECL_NSIURLLISTMANAGER \
  ...
  NS_SCRIPTABLE NS_IMETHOD RegisterTable(const nsACString & tableName, bool requireMac, bool *_retval NS_OUTPARAM); \
...
#define NS_FORWARD_NSIURLLISTMANAGER(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD RegisterTable(const nsACString & tableName, bool requireMac, bool *_retval NS_OUTPARAM) { return _to RegisterTable(tableName, requireMac, _retval); } \
...
#define NS_FORWARD_SAFE_NSIURLLISTMANAGER(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD RegisterTable(const nsACString & tableName, bool requireMac, bool *_retval NS_OUTPARAM) { return !_to ? NS_ERROR_NULL_POINTER : _to->RegisterTable(tableName, requireMac, _retval); } \
...
/* boolean registerTable (in ACString tableName, in boolean requireMac); */
NS_IMETHODIMP nsUrlListManager::RegisterTable(const nsACString & tableName, bool requireMac, bool *_retval NS_OUTPARAM)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
