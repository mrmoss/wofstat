/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM /jds/packages/BUILD/SUNWfirefox-10.0.2/firefox/security/manager/ssl/public/nsIUserCertPicker.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIUserCertPicker : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD PickByUsage(nsIInterfaceRequestor *ctx, const PRUnichar * selectedNickname, PRInt32 certUsage, bool allowInvalid, bool allowDuplicateNicknames, bool *canceled NS_OUTPARAM, nsIX509Cert * *_retval NS_OUTPARAM) = 0;
...
#define NS_DECL_NSIUSERCERTPICKER \
  NS_SCRIPTABLE NS_IMETHOD PickByUsage(nsIInterfaceRequestor *ctx, const PRUnichar * selectedNickname, PRInt32 certUsage, bool allowInvalid, bool allowDuplicateNicknames, bool *canceled NS_OUTPARAM, nsIX509Cert * *_retval NS_OUTPARAM); 
...
/* nsIX509Cert pickByUsage (in nsIInterfaceRequestor ctx, in wstring selectedNickname, in long certUsage, in boolean allowInvalid, in boolean allowDuplicateNicknames, out boolean canceled); */
NS_IMETHODIMP nsUserCertPicker::PickByUsage(nsIInterfaceRequestor *ctx, const PRUnichar * selectedNickname, PRInt32 certUsage, bool allowInvalid, bool allowDuplicateNicknames, bool *canceled NS_OUTPARAM, nsIX509Cert * *_retval NS_OUTPARAM)
{
