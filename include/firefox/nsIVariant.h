/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM /jds/packages/BUILD/SUNWfirefox-10.0.2/firefox/xpcom/ds/nsIVariant.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIVariant : public nsISupports {
 public: 
  ...
  NS_IMETHOD GetAsBool(bool *_retval NS_OUTPARAM) = 0;
...
#define NS_DECL_NSIVARIANT \
  ...
  NS_IMETHOD GetAsBool(bool *_retval NS_OUTPARAM); \
...
#define NS_FORWARD_NSIVARIANT(_to) \
  ...
  NS_IMETHOD GetAsBool(bool *_retval NS_OUTPARAM) { return _to GetAsBool(_retval); } \
...
#define NS_FORWARD_SAFE_NSIVARIANT(_to) \
  ...
  NS_IMETHOD GetAsBool(bool *_retval NS_OUTPARAM) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetAsBool(_retval); } \
...
/* [noscript] boolean getAsBool (); */
NS_IMETHODIMP nsVariant::GetAsBool(bool *_retval NS_OUTPARAM)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIWritableVariant : public nsIVariant {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD GetWritable(bool *aWritable) = 0;
  NS_SCRIPTABLE NS_IMETHOD SetWritable(bool aWritable) = 0;
  ...
  NS_SCRIPTABLE NS_IMETHOD SetAsBool(bool aValue) = 0;
...
#define NS_DECL_NSIWRITABLEVARIANT \
  NS_SCRIPTABLE NS_IMETHOD GetWritable(bool *aWritable); \
  NS_SCRIPTABLE NS_IMETHOD SetWritable(bool aWritable); \
  ...
  NS_SCRIPTABLE NS_IMETHOD SetAsBool(bool aValue); \
...
#define NS_FORWARD_NSIWRITABLEVARIANT(_to) \
  NS_SCRIPTABLE NS_IMETHOD GetWritable(bool *aWritable) { return _to GetWritable(aWritable); } \
  NS_SCRIPTABLE NS_IMETHOD SetWritable(bool aWritable) { return _to SetWritable(aWritable); } \
  ...
  NS_SCRIPTABLE NS_IMETHOD SetAsBool(bool aValue) { return _to SetAsBool(aValue); } \
...
#define NS_FORWARD_SAFE_NSIWRITABLEVARIANT(_to) \
  NS_SCRIPTABLE NS_IMETHOD GetWritable(bool *aWritable) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetWritable(aWritable); } \
  NS_SCRIPTABLE NS_IMETHOD SetWritable(bool aWritable) { return !_to ? NS_ERROR_NULL_POINTER : _to->SetWritable(aWritable); } \
  ...
  NS_SCRIPTABLE NS_IMETHOD SetAsBool(bool aValue) { return !_to ? NS_ERROR_NULL_POINTER : _to->SetAsBool(aValue); } \
