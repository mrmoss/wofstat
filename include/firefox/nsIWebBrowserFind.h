/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM /jds/packages/BUILD/SUNWfirefox-10.0.2/firefox/embedding/components/find/public/nsIWebBrowserFind.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIWebBrowserFind : public nsISupports {
 public: 
  ...
  /* boolean findNext (); */
  NS_SCRIPTABLE NS_IMETHOD FindNext(bool *_retval NS_OUTPARAM) = 0;
  ...
  NS_SCRIPTABLE NS_IMETHOD GetFindBackwards(bool *aFindBackwards) = 0;
  NS_SCRIPTABLE NS_IMETHOD SetFindBackwards(bool aFindBackwards) = 0;

  /* attribute boolean wrapFind; */
  NS_SCRIPTABLE NS_IMETHOD GetWrapFind(bool *aWrapFind) = 0;
  NS_SCRIPTABLE NS_IMETHOD SetWrapFind(bool aWrapFind) = 0;

  /* attribute boolean entireWord; */
  NS_SCRIPTABLE NS_IMETHOD GetEntireWord(bool *aEntireWord) = 0;
  NS_SCRIPTABLE NS_IMETHOD SetEntireWord(bool aEntireWord) = 0;

  /* attribute boolean matchCase; */
  NS_SCRIPTABLE NS_IMETHOD GetMatchCase(bool *aMatchCase) = 0;
  NS_SCRIPTABLE NS_IMETHOD SetMatchCase(bool aMatchCase) = 0;

  /* attribute boolean searchFrames; */
  NS_SCRIPTABLE NS_IMETHOD GetSearchFrames(bool *aSearchFrames) = 0;
  NS_SCRIPTABLE NS_IMETHOD SetSearchFrames(bool aSearchFrames) = 0;
...
#define NS_DECL_NSIWEBBROWSERFIND \
  NS_SCRIPTABLE NS_IMETHOD FindNext(bool *_retval NS_OUTPARAM); \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetFindBackwards(bool *aFindBackwards); \
  NS_SCRIPTABLE NS_IMETHOD SetFindBackwards(bool aFindBackwards); \
  NS_SCRIPTABLE NS_IMETHOD GetWrapFind(bool *aWrapFind); \
  NS_SCRIPTABLE NS_IMETHOD SetWrapFind(bool aWrapFind); \
  NS_SCRIPTABLE NS_IMETHOD GetEntireWord(bool *aEntireWord); \
  NS_SCRIPTABLE NS_IMETHOD SetEntireWord(bool aEntireWord); \
  NS_SCRIPTABLE NS_IMETHOD GetMatchCase(bool *aMatchCase); \
  NS_SCRIPTABLE NS_IMETHOD SetMatchCase(bool aMatchCase); \
  NS_SCRIPTABLE NS_IMETHOD GetSearchFrames(bool *aSearchFrames); \
  NS_SCRIPTABLE NS_IMETHOD SetSearchFrames(bool aSearchFrames); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSIWEBBROWSERFIND(_to) \
  NS_SCRIPTABLE NS_IMETHOD FindNext(bool *_retval NS_OUTPARAM) { return _to FindNext(_retval); } \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetFindBackwards(bool *aFindBackwards) { return _to GetFindBackwards(aFindBackwards); } \
  NS_SCRIPTABLE NS_IMETHOD SetFindBackwards(bool aFindBackwards) { return _to SetFindBackwards(aFindBackwards); } \
  NS_SCRIPTABLE NS_IMETHOD GetWrapFind(bool *aWrapFind) { return _to GetWrapFind(aWrapFind); } \
  NS_SCRIPTABLE NS_IMETHOD SetWrapFind(bool aWrapFind) { return _to SetWrapFind(aWrapFind); } \
  NS_SCRIPTABLE NS_IMETHOD GetEntireWord(bool *aEntireWord) { return _to GetEntireWord(aEntireWord); } \
  NS_SCRIPTABLE NS_IMETHOD SetEntireWord(bool aEntireWord) { return _to SetEntireWord(aEntireWord); } \
  NS_SCRIPTABLE NS_IMETHOD GetMatchCase(bool *aMatchCase) { return _to GetMatchCase(aMatchCase); } \
  NS_SCRIPTABLE NS_IMETHOD SetMatchCase(bool aMatchCase) { return _to SetMatchCase(aMatchCase); } \
  NS_SCRIPTABLE NS_IMETHOD GetSearchFrames(bool *aSearchFrames) { return _to GetSearchFrames(aSearchFrames); } \
  NS_SCRIPTABLE NS_IMETHOD SetSearchFrames(bool aSearchFrames) { return _to SetSearchFrames(aSearchFrames); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_NSIWEBBROWSERFIND(_to) \
  NS_SCRIPTABLE NS_IMETHOD FindNext(bool *_retval NS_OUTPARAM) { return !_to ? NS_ERROR_NULL_POINTER : _to->FindNext(_retval); } \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetFindBackwards(bool *aFindBackwards) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetFindBackwards(aFindBackwards); } \
  NS_SCRIPTABLE NS_IMETHOD SetFindBackwards(bool aFindBackwards) { return !_to ? NS_ERROR_NULL_POINTER : _to->SetFindBackwards(aFindBackwards); } \
  NS_SCRIPTABLE NS_IMETHOD GetWrapFind(bool *aWrapFind) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetWrapFind(aWrapFind); } \
  NS_SCRIPTABLE NS_IMETHOD SetWrapFind(bool aWrapFind) { return !_to ? NS_ERROR_NULL_POINTER : _to->SetWrapFind(aWrapFind); } \
  NS_SCRIPTABLE NS_IMETHOD GetEntireWord(bool *aEntireWord) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetEntireWord(aEntireWord); } \
  NS_SCRIPTABLE NS_IMETHOD SetEntireWord(bool aEntireWord) { return !_to ? NS_ERROR_NULL_POINTER : _to->SetEntireWord(aEntireWord); } \
  NS_SCRIPTABLE NS_IMETHOD GetMatchCase(bool *aMatchCase) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetMatchCase(aMatchCase); } \
  NS_SCRIPTABLE NS_IMETHOD SetMatchCase(bool aMatchCase) { return !_to ? NS_ERROR_NULL_POINTER : _to->SetMatchCase(aMatchCase); } \
  NS_SCRIPTABLE NS_IMETHOD GetSearchFrames(bool *aSearchFrames) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetSearchFrames(aSearchFrames); } \
  NS_SCRIPTABLE NS_IMETHOD SetSearchFrames(bool aSearchFrames) { return !_to ? NS_ERROR_NULL_POINTER : _to->SetSearchFrames(aSearchFrames); } 
...
/* boolean findNext (); */
NS_IMETHODIMP nsWebBrowserFind::FindNext(bool *_retval NS_OUTPARAM)
{
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIWebBrowserFindInFrames : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD GetSearchSubframes(bool *aSearchSubframes) = 0;
  NS_SCRIPTABLE NS_IMETHOD SetSearchSubframes(bool aSearchSubframes) = 0;

  /* attribute boolean searchParentFrames; */
  NS_SCRIPTABLE NS_IMETHOD GetSearchParentFrames(bool *aSearchParentFrames) = 0;
  NS_SCRIPTABLE NS_IMETHOD SetSearchParentFrames(bool aSearchParentFrames) = 0;
...
#define NS_DECL_NSIWEBBROWSERFINDINFRAMES \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetSearchSubframes(bool *aSearchSubframes); \
  NS_SCRIPTABLE NS_IMETHOD SetSearchSubframes(bool aSearchSubframes); \
  NS_SCRIPTABLE NS_IMETHOD GetSearchParentFrames(bool *aSearchParentFrames); \
  NS_SCRIPTABLE NS_IMETHOD SetSearchParentFrames(bool aSearchParentFrames); 
...
#define NS_FORWARD_NSIWEBBROWSERFINDINFRAMES(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetSearchSubframes(bool *aSearchSubframes) { return _to GetSearchSubframes(aSearchSubframes); } \
  NS_SCRIPTABLE NS_IMETHOD SetSearchSubframes(bool aSearchSubframes) { return _to SetSearchSubframes(aSearchSubframes); } \
  NS_SCRIPTABLE NS_IMETHOD GetSearchParentFrames(bool *aSearchParentFrames) { return _to GetSearchParentFrames(aSearchParentFrames); } \
  NS_SCRIPTABLE NS_IMETHOD SetSearchParentFrames(bool aSearchParentFrames) { return _to SetSearchParentFrames(aSearchParentFrames); } 
...
#define NS_FORWARD_SAFE_NSIWEBBROWSERFINDINFRAMES(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetSearchSubframes(bool *aSearchSubframes) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetSearchSubframes(aSearchSubframes); } \
  NS_SCRIPTABLE NS_IMETHOD SetSearchSubframes(bool aSearchSubframes) { return !_to ? NS_ERROR_NULL_POINTER : _to->SetSearchSubframes(aSearchSubframes); } \
  NS_SCRIPTABLE NS_IMETHOD GetSearchParentFrames(bool *aSearchParentFrames) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetSearchParentFrames(aSearchParentFrames); } \
  NS_SCRIPTABLE NS_IMETHOD SetSearchParentFrames(bool aSearchParentFrames) { return !_to ? NS_ERROR_NULL_POINTER : _to->SetSearchParentFrames(aSearchParentFrames); } 
