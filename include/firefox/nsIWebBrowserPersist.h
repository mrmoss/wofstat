/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM /jds/packages/BUILD/SUNWfirefox-10.0.2/firefox/embedding/components/webbrowserpersist/public/nsIWebBrowserPersist.idl
 */
