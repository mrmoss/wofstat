/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM /jds/packages/BUILD/SUNWfirefox-10.0.2/firefox/embedding/browser/webBrowser/nsIWebBrowserPrint.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIWebBrowserPrint : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD GetDoingPrint(bool *aDoingPrint) = 0;

  /* readonly attribute boolean doingPrintPreview; */
  NS_SCRIPTABLE NS_IMETHOD GetDoingPrintPreview(bool *aDoingPrintPreview) = 0;

  /* readonly attribute boolean isFramesetDocument; */
  NS_SCRIPTABLE NS_IMETHOD GetIsFramesetDocument(bool *aIsFramesetDocument) = 0;

  /* readonly attribute boolean isFramesetFrameSelected; */
  NS_SCRIPTABLE NS_IMETHOD GetIsFramesetFrameSelected(bool *aIsFramesetFrameSelected) = 0;

  /* readonly attribute boolean isIFrameSelected; */
  NS_SCRIPTABLE NS_IMETHOD GetIsIFrameSelected(bool *aIsIFrameSelected) = 0;

  /* readonly attribute boolean isRangeSelection; */
  NS_SCRIPTABLE NS_IMETHOD GetIsRangeSelection(bool *aIsRangeSelection) = 0;
...
#define NS_DECL_NSIWEBBROWSERPRINT \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetDoingPrint(bool *aDoingPrint); \
  NS_SCRIPTABLE NS_IMETHOD GetDoingPrintPreview(bool *aDoingPrintPreview); \
  NS_SCRIPTABLE NS_IMETHOD GetIsFramesetDocument(bool *aIsFramesetDocument); \
  NS_SCRIPTABLE NS_IMETHOD GetIsFramesetFrameSelected(bool *aIsFramesetFrameSelected); \
  NS_SCRIPTABLE NS_IMETHOD GetIsIFrameSelected(bool *aIsIFrameSelected); \
  NS_SCRIPTABLE NS_IMETHOD GetIsRangeSelection(bool *aIsRangeSelection); \
...
#define NS_FORWARD_NSIWEBBROWSERPRINT(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetDoingPrint(bool *aDoingPrint) { return _to GetDoingPrint(aDoingPrint); } \
  NS_SCRIPTABLE NS_IMETHOD GetDoingPrintPreview(bool *aDoingPrintPreview) { return _to GetDoingPrintPreview(aDoingPrintPreview); } \
  NS_SCRIPTABLE NS_IMETHOD GetIsFramesetDocument(bool *aIsFramesetDocument) { return _to GetIsFramesetDocument(aIsFramesetDocument); } \
  NS_SCRIPTABLE NS_IMETHOD GetIsFramesetFrameSelected(bool *aIsFramesetFrameSelected) { return _to GetIsFramesetFrameSelected(aIsFramesetFrameSelected); } \
  NS_SCRIPTABLE NS_IMETHOD GetIsIFrameSelected(bool *aIsIFrameSelected) { return _to GetIsIFrameSelected(aIsIFrameSelected); } \
  NS_SCRIPTABLE NS_IMETHOD GetIsRangeSelection(bool *aIsRangeSelection) { return _to GetIsRangeSelection(aIsRangeSelection); } \
...
#define NS_FORWARD_SAFE_NSIWEBBROWSERPRINT(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetDoingPrint(bool *aDoingPrint) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetDoingPrint(aDoingPrint); } \
  NS_SCRIPTABLE NS_IMETHOD GetDoingPrintPreview(bool *aDoingPrintPreview) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetDoingPrintPreview(aDoingPrintPreview); } \
  NS_SCRIPTABLE NS_IMETHOD GetIsFramesetDocument(bool *aIsFramesetDocument) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetIsFramesetDocument(aIsFramesetDocument); } \
  NS_SCRIPTABLE NS_IMETHOD GetIsFramesetFrameSelected(bool *aIsFramesetFrameSelected) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetIsFramesetFrameSelected(aIsFramesetFrameSelected); } \
  NS_SCRIPTABLE NS_IMETHOD GetIsIFrameSelected(bool *aIsIFrameSelected) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetIsIFrameSelected(aIsIFrameSelected); } \
  NS_SCRIPTABLE NS_IMETHOD GetIsRangeSelection(bool *aIsRangeSelection) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetIsRangeSelection(aIsRangeSelection); } \
