/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM /jds/packages/BUILD/SUNWfirefox-10.0.2/firefox/docshell/base/nsIWebNavigation.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIWebNavigation : public nsISupports {
 public: 
  ...
  enum { LOAD_FLAGS_URI_IS_UTF8 = 524288U };
