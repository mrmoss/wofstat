/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM /jds/packages/BUILD/SUNWfirefox-10.0.2/firefox/uriloader/base/nsIWebProgress.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIWebProgress : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD GetIsLoadingDocument(bool *aIsLoadingDocument) = 0;
...
#define NS_DECL_NSIWEBPROGRESS \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetIsLoadingDocument(bool *aIsLoadingDocument); 
...
#define NS_FORWARD_NSIWEBPROGRESS(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetIsLoadingDocument(bool *aIsLoadingDocument) { return _to GetIsLoadingDocument(aIsLoadingDocument); } 
...
#define NS_FORWARD_SAFE_NSIWEBPROGRESS(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetIsLoadingDocument(bool *aIsLoadingDocument) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetIsLoadingDocument(aIsLoadingDocument); } 
