/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM /jds/packages/BUILD/SUNWfirefox-10.0.2/firefox/xpcom/ds/nsIWritablePropertyBag2.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIWritablePropertyBag2 : public nsIPropertyBag2 {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD SetPropertyAsBool(const nsAString & prop, bool value) = 0;
...
#define NS_DECL_NSIWRITABLEPROPERTYBAG2 \
  ...
  NS_SCRIPTABLE NS_IMETHOD SetPropertyAsBool(const nsAString & prop, bool value); \
...
#define NS_FORWARD_NSIWRITABLEPROPERTYBAG2(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD SetPropertyAsBool(const nsAString & prop, bool value) { return _to SetPropertyAsBool(prop, value); } \
...
#define NS_FORWARD_SAFE_NSIWRITABLEPROPERTYBAG2(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD SetPropertyAsBool(const nsAString & prop, bool value) { return !_to ? NS_ERROR_NULL_POINTER : _to->SetPropertyAsBool(prop, value); } \
