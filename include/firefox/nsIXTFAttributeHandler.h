/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM /jds/packages/BUILD/SUNWfirefox-10.0.2/firefox/content/xtf/public/nsIXTFAttributeHandler.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIXTFAttributeHandler : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD HandlesAttribute(nsIAtom *name, bool *_retval NS_OUTPARAM) = 0;
  ...
  NS_SCRIPTABLE NS_IMETHOD HasAttribute(nsIAtom *name, bool *_retval NS_OUTPARAM) = 0;
...
#define NS_DECL_NSIXTFATTRIBUTEHANDLER \
  NS_SCRIPTABLE NS_IMETHOD HandlesAttribute(nsIAtom *name, bool *_retval NS_OUTPARAM); \
  ...
  NS_SCRIPTABLE NS_IMETHOD HasAttribute(nsIAtom *name, bool *_retval NS_OUTPARAM); \
...
#define NS_FORWARD_NSIXTFATTRIBUTEHANDLER(_to) \
  NS_SCRIPTABLE NS_IMETHOD HandlesAttribute(nsIAtom *name, bool *_retval NS_OUTPARAM) { return _to HandlesAttribute(name, _retval); } \
  ...
  NS_SCRIPTABLE NS_IMETHOD HasAttribute(nsIAtom *name, bool *_retval NS_OUTPARAM) { return _to HasAttribute(name, _retval); } \
...
#define NS_FORWARD_SAFE_NSIXTFATTRIBUTEHANDLER(_to) \
  NS_SCRIPTABLE NS_IMETHOD HandlesAttribute(nsIAtom *name, bool *_retval NS_OUTPARAM) { return !_to ? NS_ERROR_NULL_POINTER : _to->HandlesAttribute(name, _retval); } \
  ...
  NS_SCRIPTABLE NS_IMETHOD HasAttribute(nsIAtom *name, bool *_retval NS_OUTPARAM) { return !_to ? NS_ERROR_NULL_POINTER : _to->HasAttribute(name, _retval); } \
...
/* boolean handlesAttribute (in nsIAtom name); */
NS_IMETHODIMP nsXTFAttributeHandler::HandlesAttribute(nsIAtom *name, bool *_retval NS_OUTPARAM)
{
...
/* boolean hasAttribute (in nsIAtom name); */
NS_IMETHODIMP nsXTFAttributeHandler::HasAttribute(nsIAtom *name, bool *_retval NS_OUTPARAM)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
