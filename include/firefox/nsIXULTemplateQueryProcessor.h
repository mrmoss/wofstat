/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM /jds/packages/BUILD/SUNWfirefox-10.0.2/firefox/content/xul/templates/public/nsIXULTemplateQueryProcessor.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIXULTemplateQueryProcessor : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD GetDatasource(nsIArray *aDataSources, nsIDOMNode *aRootNode, bool aIsTrusted, nsIXULTemplateBuilder *aBuilder, bool *aShouldDelayBuilding NS_OUTPARAM, nsISupports * *_retval NS_OUTPARAM) = 0;
...
#define NS_DECL_NSIXULTEMPLATEQUERYPROCESSOR \
  NS_SCRIPTABLE NS_IMETHOD GetDatasource(nsIArray *aDataSources, nsIDOMNode *aRootNode, bool aIsTrusted, nsIXULTemplateBuilder *aBuilder, bool *aShouldDelayBuilding NS_OUTPARAM, nsISupports * *_retval NS_OUTPARAM); \
...
#define NS_FORWARD_NSIXULTEMPLATEQUERYPROCESSOR(_to) \
  NS_SCRIPTABLE NS_IMETHOD GetDatasource(nsIArray *aDataSources, nsIDOMNode *aRootNode, bool aIsTrusted, nsIXULTemplateBuilder *aBuilder, bool *aShouldDelayBuilding NS_OUTPARAM, nsISupports * *_retval NS_OUTPARAM) { return _to GetDatasource(aDataSources, aRootNode, aIsTrusted, aBuilder, aShouldDelayBuilding, _retval); } \
...
#define NS_FORWARD_SAFE_NSIXULTEMPLATEQUERYPROCESSOR(_to) \
  NS_SCRIPTABLE NS_IMETHOD GetDatasource(nsIArray *aDataSources, nsIDOMNode *aRootNode, bool aIsTrusted, nsIXULTemplateBuilder *aBuilder, bool *aShouldDelayBuilding NS_OUTPARAM, nsISupports * *_retval NS_OUTPARAM) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetDatasource(aDataSources, aRootNode, aIsTrusted, aBuilder, aShouldDelayBuilding, _retval); } \
...
/* nsISupports getDatasource (in nsIArray aDataSources, in nsIDOMNode aRootNode, in boolean aIsTrusted, in nsIXULTemplateBuilder aBuilder, out boolean aShouldDelayBuilding); */
NS_IMETHODIMP nsXULTemplateQueryProcessor::GetDatasource(nsIArray *aDataSources, nsIDOMNode *aRootNode, bool aIsTrusted, nsIXULTemplateBuilder *aBuilder, bool *aShouldDelayBuilding NS_OUTPARAM, nsISupports * *_retval NS_OUTPARAM)
{
