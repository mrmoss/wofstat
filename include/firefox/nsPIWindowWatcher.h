/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM /jds/packages/BUILD/SUNWfirefox-10.0.2/firefox/embedding/components/windowwatcher/public/nsPIWindowWatcher.idl
 */
...
class NS_NO_VTABLE nsPIWindowWatcher : public nsISupports {
 public: 
  ...
  NS_IMETHOD OpenWindowJS(nsIDOMWindow *aParent, const char * aUrl, const char * aName, const char * aFeatures, bool aDialog, nsIArray *aArgs, nsIDOMWindow * *_retval NS_OUTPARAM) = 0;
...
#define NS_DECL_NSPIWINDOWWATCHER \
  ...
  NS_IMETHOD OpenWindowJS(nsIDOMWindow *aParent, const char * aUrl, const char * aName, const char * aFeatures, bool aDialog, nsIArray *aArgs, nsIDOMWindow * *_retval NS_OUTPARAM); \
...
#define NS_FORWARD_NSPIWINDOWWATCHER(_to) \
  ...
  NS_IMETHOD OpenWindowJS(nsIDOMWindow *aParent, const char * aUrl, const char * aName, const char * aFeatures, bool aDialog, nsIArray *aArgs, nsIDOMWindow * *_retval NS_OUTPARAM) { return _to OpenWindowJS(aParent, aUrl, aName, aFeatures, aDialog, aArgs, _retval); } \
...
#define NS_FORWARD_SAFE_NSPIWINDOWWATCHER(_to) \
  ...
  NS_IMETHOD OpenWindowJS(nsIDOMWindow *aParent, const char * aUrl, const char * aName, const char * aFeatures, bool aDialog, nsIArray *aArgs, nsIDOMWindow * *_retval NS_OUTPARAM) { return !_to ? NS_ERROR_NULL_POINTER : _to->OpenWindowJS(aParent, aUrl, aName, aFeatures, aDialog, aArgs, _retval); } \
...
/* nsIDOMWindow openWindowJS (in nsIDOMWindow aParent, in string aUrl, in string aName, in string aFeatures, in boolean aDialog, in nsIArray aArgs); */
NS_IMETHODIMP _MYCLASS_::OpenWindowJS(nsIDOMWindow *aParent, const char * aUrl, const char * aName, const char * aFeatures, bool aDialog, nsIArray *aArgs, nsIDOMWindow * *_retval NS_OUTPARAM)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
