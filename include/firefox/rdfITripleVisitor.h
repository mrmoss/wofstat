/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM /jds/packages/BUILD/SUNWfirefox-10.0.2/firefox/rdf/base/idl/rdfITripleVisitor.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE rdfITripleVisitor : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD Visit(nsIRDFNode *aSubject, nsIRDFResource *aPredicate, nsIRDFNode *aObject, bool aTruthValue) = 0;
...
#define NS_DECL_RDFITRIPLEVISITOR \
  NS_SCRIPTABLE NS_IMETHOD Visit(nsIRDFNode *aSubject, nsIRDFResource *aPredicate, nsIRDFNode *aObject, bool aTruthValue); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_RDFITRIPLEVISITOR(_to) \
  NS_SCRIPTABLE NS_IMETHOD Visit(nsIRDFNode *aSubject, nsIRDFResource *aPredicate, nsIRDFNode *aObject, bool aTruthValue) { return _to Visit(aSubject, aPredicate, aObject, aTruthValue); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_RDFITRIPLEVISITOR(_to) \
  NS_SCRIPTABLE NS_IMETHOD Visit(nsIRDFNode *aSubject, nsIRDFResource *aPredicate, nsIRDFNode *aObject, bool aTruthValue) { return !_to ? NS_ERROR_NULL_POINTER : _to->Visit(aSubject, aPredicate, aObject, aTruthValue); } 
