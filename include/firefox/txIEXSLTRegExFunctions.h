/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM /jds/packages/BUILD/SUNWfirefox-10.0.2/firefox/content/xslt/public/txIEXSLTRegExFunctions.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE txIEXSLTRegExFunctions : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD Test(const nsAString & aString, const nsAString & aRegEx, const nsAString & aFlags, bool *_retval NS_OUTPARAM) = 0;
...
#define NS_DECL_TXIEXSLTREGEXFUNCTIONS \
  ...
  NS_SCRIPTABLE NS_IMETHOD Test(const nsAString & aString, const nsAString & aRegEx, const nsAString & aFlags, bool *_retval NS_OUTPARAM); 
...
#define NS_FORWARD_TXIEXSLTREGEXFUNCTIONS(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD Test(const nsAString & aString, const nsAString & aRegEx, const nsAString & aFlags, bool *_retval NS_OUTPARAM) { return _to Test(aString, aRegEx, aFlags, _retval); } 
...
#define NS_FORWARD_SAFE_TXIEXSLTREGEXFUNCTIONS(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD Test(const nsAString & aString, const nsAString & aRegEx, const nsAString & aFlags, bool *_retval NS_OUTPARAM) { return !_to ? NS_ERROR_NULL_POINTER : _to->Test(aString, aRegEx, aFlags, _retval); } 
...
/* boolean test (in DOMString aString, in DOMString aRegEx, in DOMString aFlags); */
NS_IMETHODIMP txEXSLTRegExFunctions::Test(const nsAString & aString, const nsAString & aRegEx, const nsAString & aFlags, bool *_retval NS_OUTPARAM)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
