/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM /jds/packages/BUILD/SUNWfirefox-10.0.2/firefox/js/xpconnect/idl/xpccomponents.idl
 */
...
#define NS_IXPCCOMPONENTS_UTILS_IID_STR "11785c1f-346f-475c-950e-fe1bacce70f1"

#define NS_IXPCCOMPONENTS_UTILS_IID \
  {0x11785c1f, 0x346f, 0x475c, \
    { 0x95, 0x0e, 0xfe, 0x1b, 0xac, 0xce, 0x70, 0xf1 }}
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIXPCComponents_Utils : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD GetStrict(bool *aStrict) = 0;
  NS_SCRIPTABLE NS_IMETHOD SetStrict(bool aStrict) = 0;

  /* attribute boolean werror; */
  NS_SCRIPTABLE NS_IMETHOD GetWerror(bool *aWerror) = 0;
  NS_SCRIPTABLE NS_IMETHOD SetWerror(bool aWerror) = 0;

  /* attribute boolean atline; */
  NS_SCRIPTABLE NS_IMETHOD GetAtline(bool *aAtline) = 0;
  NS_SCRIPTABLE NS_IMETHOD SetAtline(bool aAtline) = 0;

  /* attribute boolean xml; */
  NS_SCRIPTABLE NS_IMETHOD GetXml(bool *aXml) = 0;
  NS_SCRIPTABLE NS_IMETHOD SetXml(bool aXml) = 0;

  /* attribute boolean relimit; */
  NS_SCRIPTABLE NS_IMETHOD GetRelimit(bool *aRelimit) = 0;
  NS_SCRIPTABLE NS_IMETHOD SetRelimit(bool aRelimit) = 0;

  /* attribute boolean tracejit; */
  NS_SCRIPTABLE NS_IMETHOD GetTracejit(bool *aTracejit) = 0;
  NS_SCRIPTABLE NS_IMETHOD SetTracejit(bool aTracejit) = 0;

  /* attribute boolean methodjit; */
  NS_SCRIPTABLE NS_IMETHOD GetMethodjit(bool *aMethodjit) = 0;
  NS_SCRIPTABLE NS_IMETHOD SetMethodjit(bool aMethodjit) = 0;

  /* attribute boolean jitprofiling; */
  NS_SCRIPTABLE NS_IMETHOD GetJitprofiling(bool *aJitprofiling) = 0;
  NS_SCRIPTABLE NS_IMETHOD SetJitprofiling(bool aJitprofiling) = 0;

  /* attribute boolean methodjit_always; */
  NS_SCRIPTABLE NS_IMETHOD GetMethodjit_always(bool *aMethodjit_always) = 0;
  NS_SCRIPTABLE NS_IMETHOD SetMethodjit_always(bool aMethodjit_always) = 0;
...
#define NS_DECL_NSIXPCCOMPONENTS_UTILS \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetStrict(bool *aStrict); \
  NS_SCRIPTABLE NS_IMETHOD SetStrict(bool aStrict); \
  NS_SCRIPTABLE NS_IMETHOD GetWerror(bool *aWerror); \
  NS_SCRIPTABLE NS_IMETHOD SetWerror(bool aWerror); \
  NS_SCRIPTABLE NS_IMETHOD GetAtline(bool *aAtline); \
  NS_SCRIPTABLE NS_IMETHOD SetAtline(bool aAtline); \
  NS_SCRIPTABLE NS_IMETHOD GetXml(bool *aXml); \
  NS_SCRIPTABLE NS_IMETHOD SetXml(bool aXml); \
  NS_SCRIPTABLE NS_IMETHOD GetRelimit(bool *aRelimit); \
  NS_SCRIPTABLE NS_IMETHOD SetRelimit(bool aRelimit); \
  NS_SCRIPTABLE NS_IMETHOD GetTracejit(bool *aTracejit); \
  NS_SCRIPTABLE NS_IMETHOD SetTracejit(bool aTracejit); \
  NS_SCRIPTABLE NS_IMETHOD GetMethodjit(bool *aMethodjit); \
  NS_SCRIPTABLE NS_IMETHOD SetMethodjit(bool aMethodjit); \
  NS_SCRIPTABLE NS_IMETHOD GetJitprofiling(bool *aJitprofiling); \
  NS_SCRIPTABLE NS_IMETHOD SetJitprofiling(bool aJitprofiling); \
  NS_SCRIPTABLE NS_IMETHOD GetMethodjit_always(bool *aMethodjit_always); \
  NS_SCRIPTABLE NS_IMETHOD SetMethodjit_always(bool aMethodjit_always); \
...
#define NS_FORWARD_NSIXPCCOMPONENTS_UTILS(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetStrict(bool *aStrict) { return _to GetStrict(aStrict); } \
  NS_SCRIPTABLE NS_IMETHOD SetStrict(bool aStrict) { return _to SetStrict(aStrict); } \
  NS_SCRIPTABLE NS_IMETHOD GetWerror(bool *aWerror) { return _to GetWerror(aWerror); } \
  NS_SCRIPTABLE NS_IMETHOD SetWerror(bool aWerror) { return _to SetWerror(aWerror); } \
  NS_SCRIPTABLE NS_IMETHOD GetAtline(bool *aAtline) { return _to GetAtline(aAtline); } \
  NS_SCRIPTABLE NS_IMETHOD SetAtline(bool aAtline) { return _to SetAtline(aAtline); } \
  NS_SCRIPTABLE NS_IMETHOD GetXml(bool *aXml) { return _to GetXml(aXml); } \
  NS_SCRIPTABLE NS_IMETHOD SetXml(bool aXml) { return _to SetXml(aXml); } \
  NS_SCRIPTABLE NS_IMETHOD GetRelimit(bool *aRelimit) { return _to GetRelimit(aRelimit); } \
  NS_SCRIPTABLE NS_IMETHOD SetRelimit(bool aRelimit) { return _to SetRelimit(aRelimit); } \
  NS_SCRIPTABLE NS_IMETHOD GetTracejit(bool *aTracejit) { return _to GetTracejit(aTracejit); } \
  NS_SCRIPTABLE NS_IMETHOD SetTracejit(bool aTracejit) { return _to SetTracejit(aTracejit); } \
  NS_SCRIPTABLE NS_IMETHOD GetMethodjit(bool *aMethodjit) { return _to GetMethodjit(aMethodjit); } \
  NS_SCRIPTABLE NS_IMETHOD SetMethodjit(bool aMethodjit) { return _to SetMethodjit(aMethodjit); } \
  NS_SCRIPTABLE NS_IMETHOD GetJitprofiling(bool *aJitprofiling) { return _to GetJitprofiling(aJitprofiling); } \
  NS_SCRIPTABLE NS_IMETHOD SetJitprofiling(bool aJitprofiling) { return _to SetJitprofiling(aJitprofiling); } \
  NS_SCRIPTABLE NS_IMETHOD GetMethodjit_always(bool *aMethodjit_always) { return _to GetMethodjit_always(aMethodjit_always); } \
  NS_SCRIPTABLE NS_IMETHOD SetMethodjit_always(bool aMethodjit_always) { return _to SetMethodjit_always(aMethodjit_always); } \
...
#define NS_FORWARD_SAFE_NSIXPCCOMPONENTS_UTILS(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetStrict(bool *aStrict) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetStrict(aStrict); } \
  NS_SCRIPTABLE NS_IMETHOD SetStrict(bool aStrict) { return !_to ? NS_ERROR_NULL_POINTER : _to->SetStrict(aStrict); } \
  NS_SCRIPTABLE NS_IMETHOD GetWerror(bool *aWerror) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetWerror(aWerror); } \
  NS_SCRIPTABLE NS_IMETHOD SetWerror(bool aWerror) { return !_to ? NS_ERROR_NULL_POINTER : _to->SetWerror(aWerror); } \
  NS_SCRIPTABLE NS_IMETHOD GetAtline(bool *aAtline) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetAtline(aAtline); } \
  NS_SCRIPTABLE NS_IMETHOD SetAtline(bool aAtline) { return !_to ? NS_ERROR_NULL_POINTER : _to->SetAtline(aAtline); } \
  NS_SCRIPTABLE NS_IMETHOD GetXml(bool *aXml) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetXml(aXml); } \
  NS_SCRIPTABLE NS_IMETHOD SetXml(bool aXml) { return !_to ? NS_ERROR_NULL_POINTER : _to->SetXml(aXml); } \
  NS_SCRIPTABLE NS_IMETHOD GetRelimit(bool *aRelimit) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetRelimit(aRelimit); } \
  NS_SCRIPTABLE NS_IMETHOD SetRelimit(bool aRelimit) { return !_to ? NS_ERROR_NULL_POINTER : _to->SetRelimit(aRelimit); } \
  NS_SCRIPTABLE NS_IMETHOD GetTracejit(bool *aTracejit) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetTracejit(aTracejit); } \
  NS_SCRIPTABLE NS_IMETHOD SetTracejit(bool aTracejit) { return !_to ? NS_ERROR_NULL_POINTER : _to->SetTracejit(aTracejit); } \
  NS_SCRIPTABLE NS_IMETHOD GetMethodjit(bool *aMethodjit) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetMethodjit(aMethodjit); } \
  NS_SCRIPTABLE NS_IMETHOD SetMethodjit(bool aMethodjit) { return !_to ? NS_ERROR_NULL_POINTER : _to->SetMethodjit(aMethodjit); } \
  NS_SCRIPTABLE NS_IMETHOD GetJitprofiling(bool *aJitprofiling) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetJitprofiling(aJitprofiling); } \
  NS_SCRIPTABLE NS_IMETHOD SetJitprofiling(bool aJitprofiling) { return !_to ? NS_ERROR_NULL_POINTER : _to->SetJitprofiling(aJitprofiling); } \
  NS_SCRIPTABLE NS_IMETHOD GetMethodjit_always(bool *aMethodjit_always) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetMethodjit_always(aMethodjit_always); } \
  NS_SCRIPTABLE NS_IMETHOD SetMethodjit_always(bool aMethodjit_always) { return !_to ? NS_ERROR_NULL_POINTER : _to->SetMethodjit_always(aMethodjit_always); } \
...
/* attribute boolean strict; */
NS_IMETHODIMP nsXPCComponents_Utils::GetStrict(bool *aStrict)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
NS_IMETHODIMP nsXPCComponents_Utils::SetStrict(bool aStrict)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}

/* attribute boolean werror; */
NS_IMETHODIMP nsXPCComponents_Utils::GetWerror(bool *aWerror)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
NS_IMETHODIMP nsXPCComponents_Utils::SetWerror(bool aWerror)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}

/* attribute boolean atline; */
NS_IMETHODIMP nsXPCComponents_Utils::GetAtline(bool *aAtline)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
NS_IMETHODIMP nsXPCComponents_Utils::SetAtline(bool aAtline)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}

/* attribute boolean xml; */
NS_IMETHODIMP nsXPCComponents_Utils::GetXml(bool *aXml)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
NS_IMETHODIMP nsXPCComponents_Utils::SetXml(bool aXml)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}

/* attribute boolean relimit; */
NS_IMETHODIMP nsXPCComponents_Utils::GetRelimit(bool *aRelimit)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
NS_IMETHODIMP nsXPCComponents_Utils::SetRelimit(bool aRelimit)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}

/* attribute boolean tracejit; */
NS_IMETHODIMP nsXPCComponents_Utils::GetTracejit(bool *aTracejit)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
NS_IMETHODIMP nsXPCComponents_Utils::SetTracejit(bool aTracejit)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}

/* attribute boolean methodjit; */
NS_IMETHODIMP nsXPCComponents_Utils::GetMethodjit(bool *aMethodjit)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
NS_IMETHODIMP nsXPCComponents_Utils::SetMethodjit(bool aMethodjit)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}

/* attribute boolean jitprofiling; */
NS_IMETHODIMP nsXPCComponents_Utils::GetJitprofiling(bool *aJitprofiling)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
NS_IMETHODIMP nsXPCComponents_Utils::SetJitprofiling(bool aJitprofiling)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}

/* attribute boolean methodjit_always; */
NS_IMETHODIMP nsXPCComponents_Utils::GetMethodjit_always(bool *aMethodjit_always)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
NS_IMETHODIMP nsXPCComponents_Utils::SetMethodjit_always(bool aMethodjit_always)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
