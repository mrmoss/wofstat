/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM /jds/packages/BUILD/SUNWfirefox-10.0.2/firefox/js/xpconnect/idl/xpcjsid.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIJSID : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD Equals(nsIJSID *other, bool *_retval NS_OUTPARAM) = 0;
...
#define NS_DECL_NSIJSID \
  ...
  NS_SCRIPTABLE NS_IMETHOD Equals(nsIJSID *other, bool *_retval NS_OUTPARAM); \
...
#define NS_FORWARD_NSIJSID(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD Equals(nsIJSID *other, bool *_retval NS_OUTPARAM) { return _to Equals(other, _retval); } \
...
#define NS_FORWARD_SAFE_NSIJSID(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD Equals(nsIJSID *other, bool *_retval NS_OUTPARAM) { return !_to ? NS_ERROR_NULL_POINTER : _to->Equals(other, _retval); } \
...
/* boolean equals (in nsIJSID other); */
NS_IMETHODIMP nsJSID::Equals(nsIJSID *other, bool *_retval NS_OUTPARAM)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
