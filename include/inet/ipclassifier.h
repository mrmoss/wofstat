...
#pragma ident	"@(#)ipclassifier.h	1.30	11/08/30 SMI"
...
/* XXX: Needs to be moved to stream.h along with other STRUIO flags */
#define	STRUIO_EAGER	0x20
#define	STRUIO_POLICY	0x40
