...
#pragma ident	"@(#)ksslapi.h	1.3	12/04/02 SMI"
...
/* values of bit flags passed to/from kssl_input() */
#define	KSSL_MORE	0x1	/* indication that there are records in queue */
#define	KSSL_CTL	0x2	/* keep processing the SSL record queue */

kssl_cmd_t kssl_input(kssl_ctx_t, mblk_t *, mblk_t **, int *,
