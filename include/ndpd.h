...
#pragma ident	"@(#)ndpd.h	1.2	07/02/27 SMI"
...
#define	phyint_MaxRtrAdvInterval phyint_config[I_MaxRtrAdvInterval].cf_value
#define	phyint_MinRtrAdvInterval phyint_config[I_MinRtrAdvInterval].cf_value
#define	phyint_AdvManagedFlag	phyint_config[I_AdvManagedFlag].cf_value
#define	phyint_AdvOtherConfigFlag phyint_config[I_AdvOtherConfigFlag].cf_value
...
#define	phyint_AdvDefaultLifetime phyint_config[I_AdvDefaultLifetime].cf_value
#define	phyint_StatelessAddrConf phyint_config[I_StatelessAddrConf].cf_value
...
#define	phyint_TmpMaxDesyncFactor phyint_config[I_TmpMaxDesyncFactor].cf_value
#define	phyint_StatefulAddrConf phyint_config[I_StatefulAddrConf].cf_value
