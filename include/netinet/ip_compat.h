...
#pragma ident	"@(#)ip_compat.h	1.15	10/11/02 SMI"
...
/*
 * The DTRACE_PROBE* macros are defined in sys/sdt.h. The file is included if
 * and only if we are compiling IPF as a Solaris kernel module. For all other
 * compilation modes (different platform or userspace ipftest application) we
 * need to define empty macros.
 */
#ifndef	DTRACE_PROBE
