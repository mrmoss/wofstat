...
#pragma ident	"@(#)nfs4_clnt.h	1.59	11/10/20 SMI"
...
typedef struct mntinfo4 {
	...
	zone_ref_t	mi_zone_ref;	/* Reference to mi_zone */
...
extern int	do_nfs4getfh_otw(mntinfo4_t *, servinfo4_t *,
			vtype_t *, int, cred_t *);
...
/*
 * Flags for do_nfs4getfh_otw and nfs4getfh_otw.
 */
