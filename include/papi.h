...
#pragma ident	"@(#)papi.h	1.6	12/03/07 SMI"
...
typedef union {
	...
	long long long_integer;			/* PAPI_LONGINTEGER value */
...
extern char **papiServiceGetAllStatusMessages(papi_service_t handle);
...
extern char *lp_get_user_name();
extern char *lp_localhostname();
