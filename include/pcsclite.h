 ...
 *
 * $Id: pcsclite.h,v 1.1 2004/06/10 19:52:34 ehersked Exp $
 */

#ifndef	_PCSCLITE_H_
#define	_PCSCLITE_H_

#pragma ident	"@(#)pcsclite.h	1.2 04/06/08"

#ifdef __cplusplus
extern "C" {
#endif

#ifndef NODEF_WINTYPES_H
...
/*
 * enhanced (32K) Tx/Rx Buffer
 */
#define	MAX_BUFFER_SIZE			(1<<15)

/*
 * To allow larger data reads/writes
 */
#define	PCSCLITE_SERVER_ATTEMPTS	200
#endif
