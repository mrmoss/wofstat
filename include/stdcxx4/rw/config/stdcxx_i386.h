...
// configured for /ws/on10-tools/SUNWspro/SS12/bin/CC-5.9 on SunOS 5.10
...
#define _RWSTD_OS_RELEASE "5.10"
#define _RWSTD_OS_VERSION "Generic"
#define _RWSTD_OS_MAJOR 5
#define _RWSTD_OS_MINOR 10
