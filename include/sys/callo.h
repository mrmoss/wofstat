...
#pragma ident	"@(#)callo.h	1.26	12/03/09 SMI"
...
typedef struct callout_table {
	...
	hrtime_t	ct_heap_interval;	/* adjusted debugger time */
	hrtime_t	ct_queue_interval;	/* adjusted debugger time */

#ifdef _LP64
	char		ct_pad[48];	/* cache alignment */
#else
	char		ct_pad[60];	/* cache alignment */
#endif
	/*
