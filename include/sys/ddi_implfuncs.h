...
#pragma ident	"@(#)ddi_implfuncs.h	1.58	12/08/01 SMI"
...
int resolve_pathname_noalias(char *, dev_info_t **, dev_t *, int *);
...
/*
 * calls to set/reset DEVI_NOATTACH flag in devi_flags.
 */
void i_ddi_set_noattach(dev_info_t *);
void i_ddi_reset_noattach(dev_info_t *);
