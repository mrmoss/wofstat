...
#pragma ident	"@(#)ddidmareq.h	1.32	11/03/21 SMI"
...
/*
 * It's possible that this should be #if __sparc / #elif __i386 / #else err
 * but I don't know for sure.  If the apparently-extended code on i386
 * is the wave of the future, and sparc is staying behind for historical
 * reasons, that argues for exactly #if __sparc / #else everything else,
 * just as it is here.  A comment's needed, of course.
 */
#if defined(__sparc)
