...
#pragma ident	"@(#)dlpi.h	1.47	10/02/10 SMI"	/* SVr4.0 1.2	*/
 ...
 * dls layer.
 */
typedef uint_t	(*rx_srings_cnt)(void *, boolean_t, int, uint_t, uint_t,
    uint_t);
typedef struct dl_capab_dls_s {
	...
	rx_srings_cnt		dls_compute_soft_ring_count;
