...
#pragma ident	"@(#)dtrace.h	1.25	12/08/30 SMI"
...
#define	DTRACE_DFLT_BUFSIZE	(0x400000)	/* 4m default buffer size */
#define	DTRACE_DFLT_BUFSIZE_STR	"4m"		/* default buffer size string */
#define	DTRACE_MIN_BUFFER_SIZE	(8)
...
extern void *dtrace_cpulist_get(processorid_t *);
extern void dtrace_cpulist_free(void *);
extern int dtrace_cpulist_includes(void *, processorid_t);
