...
#ifndef	_SYS_FIBRE_CHANNEL_IMPL_FC_ERROR_H
#define	_SYS_FIBRE_CHANNEL_IMPL_FC_ERROR_H

#pragma ident	"@(#)fc_error.h	1.5	09/05/19 SMI"
#include <sys/note.h>
...
#endif	/* _SYS_FIBRE_CHANNEL_IMPL_FC_ERROR_H */
