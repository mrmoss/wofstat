...
#pragma ident	"@(#)fcp.h	1.12	12/02/08 SMI"
...
/* FCP response len should have either 4 or 8 bytes length per specification */
#define		FCP_RSP_VALID_4		0x4
#define		FCP_RSP_VALID_8		0x8
