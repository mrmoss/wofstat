...
#pragma ident	"@(#)ufs_inode.h	2.192	12/05/31 SMI"
...
#define	ICOMPRESS	0x0004		/* compressed file */
...
extern	void	ufs_thread_init(struct ufs_q *, int, int);
...
extern	void	ufs_delete_init(struct ufsvfs *, int, int);
