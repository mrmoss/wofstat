...
#pragma ident	"@(#)modctl.h	1.113	12/06/26 SMI"
...
#define	MODHPOPS_SET_STATE_CEILING	7
#define	MODHPOPS_CLEAR_STATE_CEILING	8

/*
 * subcmds for MODIOVOPS
 */
#define	MODIOVOPS_GET_PF_LIST		1
#define	MODIOVOPS_SET_PF_SIGNATURE	2
...
typedef struct modctl {
	...
	struct modctl_list *mod_dependents;	/* mods depending on this. */
					/* mod_dependents is DEBUG only */
