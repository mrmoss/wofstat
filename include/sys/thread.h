...
#pragma ident	"@(#)thread.h	1.162	12/01/23 SMI"
...
#define	t_dtrace_reg	_tdu._tds._t_dtrace_reg
	...
	kmutex_t	t_fdlock;	/* protects a_fd and a_nfd of afd_t */
...
#define	T_DONTDTRACE	0x2000	/* disable DTrace probes */
#define	T_PUSHPAGE	0x4000	/* thread can tap pageout reserve */
