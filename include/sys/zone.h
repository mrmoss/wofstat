...
#pragma ident	"@(#)zone.h	1.26	12/01/23 SMI"
...
typedef enum zone_cmd {
	...
	Z_MOUNT, Z_UNMOUNT, Z_FORCEBOOT, Z_FORCEMOUNT
} zone_cmd_t;
 ...
 * the global zone's (i.e., the physical system's) hostid.
 */
