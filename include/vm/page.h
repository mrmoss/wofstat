...
#pragma ident	"@(#)page.h	1.188	12/09/03 SMI"
 ...
 *   PP_SHIFT = highbit(sz) - 1 + (ISP2(sz) == 0)
 */
#define	PP_SHIFT		7
...
#define	PG_KFLT		0x0100		/* alloc from kernel page freelist */
#define	PG_NORMALPRI	0x0200		/* PG_WAIT like priority, but */
					/* non-blocking */
...
#define	PGR_PGCPSZC0	0x4	/* original page had PGI_PGCPSZC0 bit set */
...
#define	P_KFLT		0x08		/* allocated from kernel free list */
#define	P_USERKFLT	0x04		/* user pages from kernel free list */
